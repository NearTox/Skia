...
struct SkOTTableEmbeddedBitmapLocation {
    ...
    struct BitmapSizeTable {
        SK_OT_ULONG
        indexSubTableArrayOffset;     // offset to indexSubtableArray from beginning of EBLC.
        ...
        union Flags {
            struct Field {
                // 0-7
                SK_OT_BYTE_BITFIELD(Horizontal,  // Horizontal small glyph metrics
    ...
    struct IndexSubTableArray {
        ...
        SK_OT_ULONG additionalOffsetToIndexSubtable;  // add to
                                                      // BitmapSizeTable::indexSubTableArrayOffset
                                                      // to get offset from beginning of 'EBLC'
    ...
    struct IndexSubTable2 {
        ...
        SkOTTableEmbeddedBitmapData::BigGlyphMetrics
                bigMetrics;  // all glyphs have the same metrics; glyph data may be compressed,
