...
struct SkOTTableOS2_V4 {
  ...
  union Type {
    struct Field {
      // 8-15
      SK_OT_BYTE_BITFIELD(
          NoSubsetting, Bitmap, Reserved10, Reserved11, Reserved12, Reserved13, Reserved14,
          Reserved15)
      // 0-7
      SK_OT_BYTE_BITFIELD(
          Reserved00, Restricted, PreviewPrint, Editable, Reserved04, Reserved05, Reserved06,
          Reserved07)
    } field;
    struct Raw {
  ...
  union UnicodeRange {
    struct Field {
      // l0 24-31
      SK_OT_BYTE_BITFIELD(
          Thai, Lao, Georgian, Balinese, HangulJamo, LatinExtendedAdditional, GreekExtended,
          GeneralPunctuation)
      // l0 16-23
      SK_OT_BYTE_BITFIELD(Bengali, Gurmukhi, Gujarati, Oriya, Tamil, Telugu, Kannada, Malayalam)
      // l0 8-15
      ...
      SK_OT_BYTE_BITFIELD(
          ...
          SpacingModifierLetters, CombiningDiacriticalMarks, GreekAndCoptic)

      // l1 24-31
      SK_OT_BYTE_BITFIELD(
          Hangul, NonPlane0, Phoenician, CJKUnifiedIdeographs, PrivateUseArea,
          CJKCompatibilityIdeographs, AlphabeticPresentationForms, ArabicPresentationFormsA)
      // l1 16-23
      SK_OT_BYTE_BITFIELD(
          CJKSymbolsAndPunctuation, Hiragana, Katakana, Bopomofo, HangulCompatibilityJamo, PhagsPa,
          EnclosedCJKLettersAndMonths, CJKCompatibility)
      // l1 8-15
      SK_OT_BYTE_BITFIELD(
      ...
      SK_OT_BYTE_BITFIELD(
          ...
          LetterlikeSymbols, NumberForms, Arrows, MathematicalOperators, MiscellaneousTechnical)

      // l2 24-31
      SK_OT_BYTE_BITFIELD(
          MusicalSymbols, MathematicalAlphanumericSymbols, PrivateUse, VariationSelectors, Tags,
          Limbu, TaiLe, NewTaiLue)
      // l2 16-23
      SK_OT_BYTE_BITFIELD(
          Khmer, Mongolian, Braille, Yi, Tagalog_Hanunoo_Buhid_Tagbanwa, OldItalic, Gothic, Deseret)
      // l2 8-15
      SK_OT_BYTE_BITFIELD(
          Thaana, Sinhala, Myanmar, Ethiopic, Cherokee, UnifiedCanadianSyllabics, Ogham, Runic)
      // l2 0-7
      SK_OT_BYTE_BITFIELD(
      ...
      // l3 24-31
      SK_OT_BYTE_BITFIELD(
          PhaistosDisc, Carian_Lycian_Lydian, DominoTiles_MahjongTiles, Reserved123, Reserved124,
          Reserved125, Reserved126, Reserved127)
      // l3 16-23
      SK_OT_BYTE_BITFIELD(
          Sundanese, Lepcha, OlChiki, Saurashtra, KayahLi, Rejang, Cham, AncientSymbols)
      // l3 8-15
      SK_OT_BYTE_BITFIELD(
          OldPersian, Shavian, Osmanya, CypriotSyllabary, Kharoshthi, TaiXuanJingSymbols, Cuneiform,
          CountingRodNumerals)
      // l3 0-7
      SK_OT_BYTE_BITFIELD(
          Buginese, Glagolitic, Tifinagh, YijingHexagramSymbols, SylotiNagri, LinearB_AegeanNumbers,
          AncientGreekNumbers, Ugaritic)
    } field;
    struct Raw {
      struct l0 {
  ...
  union Selection {
    struct Field {
      // 8-15
      SK_OT_BYTE_BITFIELD(
          WWS, Oblique, Reserved10, Reserved11, Reserved12, Reserved13, Reserved14, Reserved15)
      // 0-7
      SK_OT_BYTE_BITFIELD(
          Italic, Underscore, Negative, Outlined, Strikeout, Bold, Regular, UseTypoMetrics)
    } field;
    struct Raw {
  ...
  union CodePageRange {
    struct Field {
      // l0 24-31
      SK_OT_BYTE_BITFIELD(
          Reserved24, Reserved25, Reserved26, Reserved27, Reserved28, MacintoshCharacterSet,
          OEMCharacterSet, SymbolCharacterSet)
      // l0 16-23
      SK_OT_BYTE_BITFIELD(
          Thai_874, JISJapan_932, ChineseSimplified_936, KoreanWansung_949, ChineseTraditional_950,
          KoreanJohab_1361, Reserved22, Reserved23)
      // l0 8-15
      SK_OT_BYTE_BITFIELD(
          Vietnamese, Reserved09, Reserved10, Reserved11, Reserved12, Reserved13, Reserved14,
          Reserved15)
      // l0 0-7
      SK_OT_BYTE_BITFIELD(
          Latin1_1252, Latin2EasternEurope_1250, Cyrillic_1251, Greek_1253, Turkish_1254,
          Hebrew_1255, Arabic_1256, WindowsBaltic_1257)

      // l1 24-31
      SK_OT_BYTE_BITFIELD(
          IBMTurkish_857, IBMCyrillic_855, Latin2_852, MSDOSBaltic_775, Greek_737, Arabic_708,
          WELatin1_850, US_437)
      // l1 16-23
      SK_OT_BYTE_BITFIELD(
          IBMGreek_869, MSDOSRussian_866, MSDOSNordic_865, Arabic_864, MSDOSCanadianFrench_863,
          Hebrew_862, MSDOSIcelandic_861, MSDOSPortuguese_860)
      // l1 8-15
      SK_OT_BYTE_BITFIELD(
          Reserved40, Reserved41, Reserved42, Reserved43, Reserved44, Reserved45, Reserved46,
          Reserved47)
      // l1 0-7
      SK_OT_BYTE_BITFIELD(
          Reserved32, Reserved33, Reserved34, Reserved35, Reserved36, Reserved37, Reserved38,
          Reserved39)
    } field;
    struct Raw {
      struct l0 {
