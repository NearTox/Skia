...
struct SkOTTableOS2_V1 {
  ...
  union UnicodeRange {
    struct Field {
      // l0 24-31
      SK_OT_BYTE_BITFIELD(
          Thai, Lao, BasicGeorgian, GeorgianExtended, HangulJamo, LatinExtendedAdditional,
          GreekExtended, GeneralPunctuation)
      // l0 16-23
      SK_OT_BYTE_BITFIELD(Bengali, Gurmukhi, Gujarati, Oriya, Tamil, Telugu, Kannada, Malayalam)
      // l0 8-15
      SK_OT_BYTE_BITFIELD(
          GreekSymbolsAndCoptic, Cyrillic, Armenian, BasicHebrew, HebrewExtendedAB, BasicArabic,
          ArabicExtended, Devanagari)
      // l0 0-7
      SK_OT_BYTE_BITFIELD(
          BasicLatin, Latin1Supplement, LatinExtendedA, LatinExtendedB, IPAExtensions,
          SpacingModifierLetters, CombiningDiacriticalMarks, BasicGreek)

      // l1 24-31
      SK_OT_BYTE_BITFIELD(
          Hangul, Reserved057, Reserved058, CJKUnifiedIdeographs, PrivateUseArea,
      ...
      // l2 16-23
      SK_OT_BYTE_BITFIELD(
          Reserved080, Reserved081, Reserved082, Reserved083, Reserved084, Reserved085, Reserved086,
          Reserved087)
      // l2 8-15
      SK_OT_BYTE_BITFIELD(
          Reserved072, Reserved073, Reserved074, Reserved075, Reserved076, Reserved077, Reserved078,
          Reserved079)
      // l2 0-7
      SK_OT_BYTE_BITFIELD(
          CombiningHalfMarks, CJKCompatibilityForms, SmallFormVariants, ArabicPresentationFormsB,
          HalfwidthAndFullwidthForms, Specials, Reserved70, Reserved71)
