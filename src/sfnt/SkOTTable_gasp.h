    ...
    union behavior {
      struct Field {
        ...
        SK_OT_BYTE_BITFIELD(
            ...
            Reserved04, Reserved05, Reserved06, Reserved07)
      } field;
      struct Raw {
...
#include <stddef.h>
static_assert(
    offsetof(SkOTTableGridAndScanProcedure, numRanges) == 2,
    "SkOTTableGridAndScanProcedure_numRanges_not_at_2");
static_assert(
    sizeof(SkOTTableGridAndScanProcedure) == 4, "sizeof_SkOTTableGridAndScanProcedure_not_4");
