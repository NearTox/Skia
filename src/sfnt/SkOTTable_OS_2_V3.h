...
struct SkOTTableOS2_V3 {
  ...
  union UnicodeRange {
    struct Field {
      // l0 24-31
      SK_OT_BYTE_BITFIELD(
          Thai, Lao, Georgian, Reserved027, HangulJamo, LatinExtendedAdditional, GreekExtended,
          GeneralPunctuation)
      // l0 16-23
      SK_OT_BYTE_BITFIELD(Bengali, Gurmukhi, Gujarati, Oriya, Tamil, Telugu, Kannada, Malayalam)
      // l0 8-15
      SK_OT_BYTE_BITFIELD(
          Reserved008, Cyrillic, Armenian, Hebrew, Reserved012, Arabic, Reserved014, Devanagari)
      // l0 0-7
      SK_OT_BYTE_BITFIELD(
      ...
      // l1 24-31
      SK_OT_BYTE_BITFIELD(
          Hangul, NonPlane0, Reserved058, CJKUnifiedIdeographs, PrivateUseArea,
      ...
      SK_OT_BYTE_BITFIELD(
          ...
          Reserved053, EnclosedCJKLettersAndMonths, CJKCompatibility)
      // l1 8-15
      SK_OT_BYTE_BITFIELD(
      ...
      SK_OT_BYTE_BITFIELD(
          ...
          Reserved093, Reserved094, Reserved095)
      // l2 16-23
      SK_OT_BYTE_BITFIELD(
      ...
      // l3 24-31
      SK_OT_BYTE_BITFIELD(
          Reserved120, Reserved121, Reserved122, Reserved123, Reserved124, Reserved125, Reserved126,
          Reserved127)
      // l3 16-23
      SK_OT_BYTE_BITFIELD(
      ...
      // l3 8-15
      SK_OT_BYTE_BITFIELD(
          Reserved104, Reserved105, Reserved106, Reserved107, Reserved108, Reserved109, Reserved110,
          Reserved111)
      // l3 0-7
      SK_OT_BYTE_BITFIELD(
          Reserved096, Reserved097, Reserved098, Reserved099, Reserved100, Reserved101, Reserved102,
          Reserved103)
    } field;
    struct Raw {
      struct l0 {
  ...
  union Selection {
    struct Field {
      // 8-15
      SK_OT_BYTE_BITFIELD(
          Reserved08, Reserved09, Reserved10, Reserved11, Reserved12, Reserved13, Reserved14,
          Reserved15)
      // 0-7
      SK_OT_BYTE_BITFIELD(
