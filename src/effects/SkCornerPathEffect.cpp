...
bool SkCornerPathEffect::onFilterPath(
    ...
    switch (verb = iter.next(pts, false)) {
      ...
      case SkPath::kClose_Verb:
        if (firstStep.fX || firstStep.fY) {
          dst->quadTo(
              lastCorner.fX, lastCorner.fY, lastCorner.fX + firstStep.fX,
      ...
      case SkPath::kDone_Verb:
        ...
        return true;
      default: SkDEBUGFAIL("default should not be reached"); return false;
    }
