...
bool Sk1DPathEffect::onFilterPath(
    SkPath* dst, const SkPath& src, SkStrokeRec*, const SkRect*) const {
...
SkPath1DPathEffect::SkPath1DPathEffect(
...
bool SkPath1DPathEffect::onFilterPath(
...
SkScalar SkPath1DPathEffect::next(SkPath* dst, SkScalar distance, SkPathMeasure& meas) const {
  ...
  switch (fStyle) {
    ...
    case kMorph_Style: morphpath(dst, fPath, meas, distance); break;
    default: SkDEBUGFAIL("unknown Style enum"); break;
  }
  return fAdvance;
}
