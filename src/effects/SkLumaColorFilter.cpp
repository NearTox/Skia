...
skvm::Color SkLumaColorFilter::onProgram(
...
SkLumaColorFilter::SkLumaColorFilter() noexcept : INHERITED() {}

sk_sp<SkFlattenable> SkLumaColorFilter::CreateProc(SkReadBuffer&) { return Make(); }
