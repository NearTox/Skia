...
class GrMorphologyEffect : public GrFragmentProcessor {
 public:
  static std::unique_ptr<GrFragmentProcessor> Make(
      sk_sp<GrTextureProxy> proxy, MorphDirection dir, int radius, MorphType type) {
 ...
 private:
  ...
  GrMorphologyEffect(
      sk_sp<GrTextureProxy>, MorphDirection, int radius, MorphType, const float range[2]);
...
GrMorphologyEffect::GrMorphologyEffect(
    sk_sp<GrTextureProxy> proxy, MorphDirection direction, int radius, MorphType type,
    const float range[2])
...
static void apply_morphology_rect(
    ...
    const SkIRect& srcRect, const SkIRect& dstRect, int radius, MorphType morphType,
    const float bounds[2], MorphDirection direction) {
  GrPaint paint;
