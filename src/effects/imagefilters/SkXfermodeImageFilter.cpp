...
sk_sp<SkSpecialImage> SkXfermodeImageFilterImpl::filterImageGPU(
  ...
  if (backgroundProxy) {
    ...
    bgFP = GrSimpleTextureEffect::Make(
        std::move(backgroundProxy), background->alphaType(), bgMatrix,
        GrSamplerState::Filter::kNearest);
    bgFP = GrDomainEffect::Make(
        std::move(bgFP), GrTextureDomain::MakeTexelDomain(bgSubset, GrTextureDomain::kDecal_Mode),
  ...
  if (foregroundProxy) {
    ...
    auto foregroundFP = GrSimpleTextureEffect::Make(
