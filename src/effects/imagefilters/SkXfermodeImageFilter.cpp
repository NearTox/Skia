...
sk_sp<SkSpecialImage> SkXfermodeImageFilterImpl::onFilterImage(
...
SkIRect SkXfermodeImageFilterImpl::onFilterBounds(
...
void SkXfermodeImageFilterImpl::drawForeground(
...
sk_sp<SkSpecialImage> SkXfermodeImageFilterImpl::filterImageGPU(
  ...
  if (backgroundView.asTextureProxy()) {
    ...
    bgFP = GrTextureEffect::MakeTexelSubset(
        backgroundView.detachProxy(), background->alphaType(), bgMatrix, sampler, bgSubset, caps);
  ...
  if (foregroundView.asTextureProxy()) {
    ...
    auto fgFP = GrTextureEffect::MakeTexelSubset(
        foregroundView.detachProxy(), foreground->alphaType(), fgMatrix, sampler, fgSubset, caps);
