...
sk_sp<SkImageFilter> SkImageFilters::Arithmetic(
  ...
  return SkArithmeticImageFilter::Make(
      k1, k2, k3, k4, enforcePMColor, std::move(background), std::move(foreground), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::DisplacementMap(
  ...
  return SkDisplacementMapEffect::Make(
      xChannelSelector, yChannelSelector, scale, std::move(displacement), std::move(color), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::DropShadow(
  ...
  return SkDropShadowImageFilter::Make(
      dx, dy, sigmaX, sigmaY, color, SkDropShadowImageFilter::kDrawShadowAndForeground_ShadowMode,
      std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::DropShadowOnly(
  ...
  // pass a constant bool into the internal factory.
  return SkDropShadowImageFilter::Make(
      dx, dy, sigmaX, sigmaY, color, SkDropShadowImageFilter::kDrawShadowOnly_ShadowMode,
      std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::MatrixConvolution(
  ...
  return SkMatrixConvolutionImageFilter::Make(
      kernelSize, kernel, gain, bias, kernelOffset, tileMode, convolveAlpha, std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::Shader(
...
sk_sp<SkImageFilter> SkImageFilters::DistantLitDiffuse(
  ...
  return SkLightingImageFilter::MakeDistantLitDiffuse(
      direction, lightColor, surfaceScale, kd, std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::PointLitDiffuse(
  ...
  return SkLightingImageFilter::MakePointLitDiffuse(
      location, lightColor, surfaceScale, kd, std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::SpotLitDiffuse(
  ...
  return SkLightingImageFilter::MakeSpotLitDiffuse(
      location, target, falloffExponent, cutoffAngle, lightColor, surfaceScale, kd,
      std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::DistantLitSpecular(
  ...
  return SkLightingImageFilter::MakeDistantLitSpecular(
      direction, lightColor, surfaceScale, ks, shininess, std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::PointLitSpecular(
  ...
  return SkLightingImageFilter::MakePointLitSpecular(
      location, lightColor, surfaceScale, ks, shininess, std::move(input), &r);
}
...
sk_sp<SkImageFilter> SkImageFilters::SpotLitSpecular(
  ...
  return SkLightingImageFilter::MakeSpotLitSpecular(
      location, target, falloffExponent, cutoffAngle, lightColor, surfaceScale, ks, shininess,
      std::move(input), &r);
}
