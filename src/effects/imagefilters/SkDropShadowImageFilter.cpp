...
sk_sp<SkImageFilter> SkImageFilters::DropShadow(
  ...
  return SkDropShadowImageFilter::Make(
      dx, dy, sigmaX, sigmaY, color, /* shadowOnly */ false, std::move(input), cropRect);
}
...
sk_sp<SkImageFilter> SkImageFilters::DropShadowOnly(
    ...
    sk_sp<SkImageFilter> input, const CropRect& cropRect) {
  return SkDropShadowImageFilter::Make(
      dx, dy, sigmaX, sigmaY, color, /* shadowOnly */ true, std::move(input), cropRect);
}
...
sk_sp<SkSpecialImage> SkDropShadowImageFilter::onFilterImage(
