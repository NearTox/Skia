...
static void rect_memcpy(
    void* dst, size_t dstRB, const void* src, size_t srcRB, size_t copyBytes, int rows) {
...
bool SkShaderMF::filterMask(
  ...
  rect_memcpy(
      dst->fImage, dst->fRowBytes, src.fImage, src.fRowBytes, src.fBounds.width() * sizeof(uint8_t),
      src.fBounds.height());
