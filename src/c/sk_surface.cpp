...
void sk_path_cubic_to(sk_path_t* cpath, float x0, float y0, float x1, float y1, float x2,
                      float y2) {
...
sk_surface_t* sk_surface_new_raster_direct(const sk_imageinfo_t* cinfo, void* pixels,
    ...
    SkSurfaceProps surfProps(0, geo);
    return (sk_surface_t*)SkSurface::MakeRasterDirect(*info, pixels, rowBytes, &surfProps)
            .release();
}
