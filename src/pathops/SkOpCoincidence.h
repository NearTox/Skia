...
class SkOpCoincidence {
 public:
  ...
  void debugMarkCollapsed(
      SkPathOpsDebug::GlitchLog*, const SkCoincidentSpans* coin, const SkOpPtT* test) const;
...
#if DEBUG_COIN
  void debugRelease(
      SkPathOpsDebug::GlitchLog*, const SkCoincidentSpans*, const SkCoincidentSpans*) const;
 ...
 private:
  void add(
      ...
      const SkOpPtT* oppPtTEnd) {
    this->add(
        const_cast<SkOpPtT*>(coinPtTStart), const_cast<SkOpPtT*>(coinPtTEnd),
  ...
  bool addIfMissing(
      const SkOpPtT* over1s, const SkOpPtT* over2s, double tStart, double tEnd,
      SkOpSegment* coinSeg, SkOpSegment* oppSeg,
  ...
  bool checkOverlap(
      SkCoincidentSpans* check, const SkOpSegment* coinSeg, const SkOpSegment* oppSeg,
  ...
  bool contains(
      ...
      double oppT) const;
#if DEBUG_COIN
  void debugAddIfMissing(
      SkPathOpsDebug::GlitchLog*, const SkCoincidentSpans* outer, const SkOpPtT* over1s,
      const SkOpPtT* over1e) const;
  void debugAddIfMissing(
      SkPathOpsDebug::GlitchLog*, const SkOpPtT* over1s, const SkOpPtT* over2s, double tStart,
      double tEnd, const SkOpSegment* coinSeg, const SkOpSegment* oppSeg, bool* added,
      const SkOpPtT* over1e, const SkOpPtT* over2e) const;
  void debugAddEndMovedSpans(
  ...
  static double TRange(
      ...
      const SkOpSegment* coinPtT SkDEBUGPARAMS(const SkOpPtT* overE));
