...
struct SkDCurve {
    ...
    SkDPoint conicTop(const SkPoint curve[3], SkScalar curveWeight, double s, double e,
                      double* topT);
    ...
    void setConicBounds(const SkPoint curve[3], SkScalar curveWeight, double s, double e,
                        SkPathOpsBounds*);
...
extern SkDPoint (SkDCurve::*const Top[])(const SkPoint curve[], SkScalar cWeight, double tStart,
                                         double tEnd, double* topT);
...
static void (*const CurveDIntersectRay[])(const SkDCurve&, const SkDLine&, SkIntersections*) = {
        nullptr, dline_intersect_ray, dquad_intersect_ray, dconic_intersect_ray,
...
static int (*const CurveIntercept[])(const SkPoint[], SkScalar, SkScalar, double*) = {
        nullptr,           nullptr,           line_intercept_h,  line_intercept_v,
        quad_intercept_h,  quad_intercept_v,  conic_intercept_h, conic_intercept_v,
        cubic_intercept_h, cubic_intercept_v,
};
