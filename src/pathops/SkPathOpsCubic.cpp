...
bool SkDCubic::isLinear(int startIndex, int endIndex) const {
    ...
    double tiniest =
            SkTMin(SkTMin(SkTMin(SkTMin(SkTMin(SkTMin(SkTMin(fPts[0].fX, fPts[0].fY), fPts[1].fX),
                                               fPts[1].fY),
                                        fPts[2].fX),
                                 fPts[2].fY),
                          fPts[3].fX),
                   fPts[3].fY);
    double largest =
            SkTMax(SkTMax(SkTMax(SkTMax(SkTMax(SkTMax(SkTMax(fPts[0].fX, fPts[0].fY), fPts[1].fX),
                                               fPts[1].fY),
                                        fPts[2].fX),
                                 fPts[2].fY),
                          fPts[3].fX),
...
int SkDCubic::searchRoots(double extremeTs[6], int extrema, double axisIntercept, SearchAxis xAxis,
...
int SkDCubic::RootsReal(double A, double B, double C, double D, double s[3]) {
    ...
    SK_SNPRINTF(str, sizeof(str), "Solve[%1.19g x^3 + %1.19g x^2 + %1.19g x + %1.19g == 0, x]", A,
                B, C, D);
...
void SkDCubic::subDivide(const SkDPoint& a, const SkDPoint& d, double t1, double t2,
