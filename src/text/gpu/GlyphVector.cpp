...
GlyphVector::GlyphVector(sk_sp<SkStrike>&& strike, SkSpan<Variant> glyphs)
    : fSkStrike{std::move(strike)}, fGlyphs{glyphs} {
...
std::optional<GlyphVector> GlyphVector::MakeFromBuffer(
    SkReadBuffer& buffer, const SkStrikeClient* client, SubRunAllocator* alloc) {
