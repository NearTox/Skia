...
skgpu::graphite::Recorder* SkSurface_Base::onGetRecorder() { return nullptr; }
...
bool SkSurface_Base::onReplaceBackendTexture(
...
void SkSurface_Base::onAsyncRescaleAndReadPixels(
    const SkImageInfo& info, const SkIRect& origSrcRect, SkSurface::RescaleGamma rescaleGamma,
    RescaleMode rescaleMode, SkSurface::ReadPixelsCallback callback,
...
void SkSurface_Base::onAsyncRescaleAndReadPixelsYUV420(
    ...
    const SkISize& dstSize, RescaleGamma rescaleGamma, RescaleMode, ReadPixelsCallback callback,
...
sk_sp<const SkCapabilities> SkSurface::capabilities() { return asSB(this)->onCapabilities(); }

sk_sp<SkImage> SkSurface::makeImageSnapshot() { return asSB(this)->refCachedImage(); }
...
skgpu::graphite::Recorder* SkSurface::recorder() { return asSB(this)->onGetRecorder(); }
...
bool SkSurface::replaceBackendTexture(
  ...
  return asSB(this)->onReplaceBackendTexture(
      backendTexture, origin, mode, textureReleaseProc, releaseContext);
}

void SkSurface::resolveMSAA() { asSB(this)->onResolveMSAA(); }
...
void SkSurface::flush() { this->flush({}); }
#else
...
sk_sp<SkSurface> SkSurface::MakeRenderTarget(
    GrRecordingContext*, SkBudgeted, const SkImageInfo&, int, GrSurfaceOrigin,
