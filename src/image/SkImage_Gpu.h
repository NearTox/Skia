...
class SkImage_Gpu final : public SkImage_GpuBase {
 ...
 private:
  SkImage_Gpu(
      sk_sp<GrDirectContext>, GrSurfaceProxyView volatileSrc, sk_sp<GrSurfaceProxy> stableCopy,
      sk_sp<GrRenderTask> copyTask, int volatileSrcTargetCount, SkColorInfo);
  ...
  std::unique_ptr<GrFragmentProcessor> onAsFragmentProcessor(
      GrRecordingContext*, SkSamplingOptions, const SkTileMode[], const SkMatrix&, const SkRect*,
