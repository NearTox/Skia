...
class SkImage_GpuBase : public SkImage_Base {
 public:
  SkImage_GpuBase(
      sk_sp<GrContext>, int width, int height, uint32_t uniqueID, SkColorType, SkAlphaType,
      sk_sp<SkColorSpace>) noexcept;
  ...
  bool onIsValid(GrContext*) const noexcept final;
