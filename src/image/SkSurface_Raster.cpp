...
class SkSurface_Raster : public SkSurface_Base {
 public:
  SkSurface_Raster(
      const SkImageInfo&, void*, size_t rb, void (*releaseProc)(void* pixels, void* context),
      void* context, const SkSurfaceProps*);
...
SkSurface_Raster::SkSurface_Raster(
    const SkImageInfo& info, void* pixels, size_t rb,
...
sk_sp<SkSurface> SkSurface::MakeRasterDirect(
...
sk_sp<SkSurface> SkSurface::MakeRaster(
    const SkImageInfo& info, size_t rowBytes, const SkSurfaceProps* props) {
...
sk_sp<SkSurface> SkSurface::MakeRasterN32Premul(
