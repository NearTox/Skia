...
SkImage_GpuYUVA::SkImage_GpuYUVA(
    ...
    sk_sp<GrTextureProxy> proxies[], int numProxies, const SkYUVAIndex yuvaIndices[4],
...
sk_sp<SkImage> SkImage_GpuYUVA::onReinterpretColorSpace(sk_sp<SkColorSpace> newCS) const {
  return sk_make_sp<SkImage_GpuYUVA>(
      ...
      fNumProxies, fYUVAIndices, fOrigin, std::move(newCS));
}
...
sk_sp<SkImage> SkImage::MakeFromYUVATextures(
  ...
  return sk_make_sp<SkImage_GpuYUVA>(
      ...
      tempTextureProxies, numTextures, yuvaIndices, imageOrigin, imageColorSpace);
}
...
sk_sp<SkImage> SkImage::MakeFromYUVAPixmaps(
  ...
  return sk_make_sp<SkImage_GpuYUVA>(
      ...
      yuvColorSpace, tempTextureProxies, numPixmaps, yuvaIndices, imageOrigin, imageColorSpace);
}
...
sk_sp<SkImage> SkImage_GpuYUVA::MakePromiseYUVATexture(
  ...
  return sk_make_sp<SkImage_GpuYUVA>(
      ...
      numTextures, yuvaIndices, imageOrigin, std::move(imageColorSpace));
}
