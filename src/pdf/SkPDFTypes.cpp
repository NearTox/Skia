...
SkPDFUnion::~SkPDFUnion() {
  switch (fType) {
    case Type::kNameSkS:
    case Type::kStringSkS: fSkString.~SkString(); return;
...
SkPDFUnion::SkPDFUnion(SkPDFUnion&& that) : fType(that.fType) {
  ...
  switch (fType) {
    ...
    case Type::kName:
    case Type::kString: fStaticString = that.fStaticString; break;
    case Type::kNameSkS:
    case Type::kStringSkS: new (&fSkString) SkString(std::move(that.fSkString)); break;
...
void SkPDFUnion::emitObject(SkWStream* stream) const {
  switch (fType) {
    ...
    case Type::kNameSkS:
      ...
      return;
    case Type::kStringSkS: write_string(stream, fSkString.c_str(), fSkString.size()); return;
...
void SkPDFArray::appendString(const char value[]) { this->append(SkPDFUnion::String(value)); }
