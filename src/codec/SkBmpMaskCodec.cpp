 ...
 */
SkBmpMaskCodec::SkBmpMaskCodec(
    SkEncodedInfo&& info, std::unique_ptr<SkStream> stream, uint16_t bitsPerPixel, SkMasks* masks,
 ...
 */
SkCodec::Result SkBmpMaskCodec::onGetPixels(
...
SkCodec::Result SkBmpMaskCodec::onPrepareToDecode(
  ...
  fMaskSwizzler.reset(SkMaskSwizzler::CreateMaskSwizzler(
      swizzlerInfo, srcIsOpaque, fMasks.get(), this->bitsPerPixel(), options));
