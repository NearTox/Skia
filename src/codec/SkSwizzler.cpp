...
static void swizzle_bit_to_grayscale(
    void* SK_RESTRICT dstRow, const uint8_t* SK_RESTRICT src, int dstWidth, int bpp, int deltaSrc,
...
static void swizzle_bit_to_f16(
  ...
  constexpr uint64_t kBlack = (((uint64_t)0) << 0) | (((uint64_t)0) << 16) | (((uint64_t)0) << 32) |
...
static void swizzle_index_to_565(
    void* SK_RESTRICT dstRow, const uint8_t* SK_RESTRICT src, int dstWidth, int bytesPerPixel,
...
static void swizzle_grayalpha_to_a8(
    void* dst, const uint8_t* src, int width, int bpp, int deltaSrc, int offset,
    const SkPMColor[]) {
  src += offset;
  uint8_t* dst8 = (uint8_t*)dst;
...
std::unique_ptr<SkSwizzler> SkSwizzler::MakeSimple(
    int srcBPP, const SkImageInfo& dstInfo, const SkCodec::Options& options) {
  ...
  return Make(
      dstInfo, &copy, proc, nullptr /*ctable*/, srcBPP, dstInfo.bytesPerPixel(), options,
      nullptr /*frame*/);
}

std::unique_ptr<SkSwizzler> SkSwizzler::Make(
    const SkEncodedInfo& encodedInfo, const SkPMColor* ctable, const SkImageInfo& dstInfo,
  ...
  switch (encodedInfo.color()) {
      ...
      switch (encodedInfo.bitsPerComponent()) {
        case 1:
          switch (dstInfo.colorType()) {
            ...
            case kBGRA_8888_SkColorType: proc = &swizzle_bit_to_n32; break;
            case kRGB_565_SkColorType: proc = &swizzle_bit_to_565; break;
            case kGray_8_SkColorType: proc = &swizzle_bit_to_grayscale; break;
            case kRGBA_F16_SkColorType: proc = &swizzle_bit_to_f16; break;
            default: return nullptr;
          }
          break;
        case 8:
          switch (dstInfo.colorType()) {
            ...
            case kGray_8_SkColorType:
              ...
              fastProc = &copy;
              break;
            case kRGB_565_SkColorType: proc = &swizzle_gray_to_565; break;
            default: return nullptr;
          }
          break;
        default: return nullptr;
    ...
    case SkEncodedInfo::kGrayAlpha_Color:
      switch (dstInfo.colorType()) {
        ...
        case kBGRA_8888_SkColorType:
          ...
          break;
        case kAlpha_8_SkColorType: proc = &swizzle_grayalpha_to_a8; break;
        default: return nullptr;
      }
      break;
    case SkEncodedInfo::kPalette_Color:
      ...
      switch (encodedInfo.bitsPerComponent()) {
        ...
        case 4:
          switch (dstInfo.colorType()) {
            case kRGBA_8888_SkColorType:
            case kBGRA_8888_SkColorType: proc = &swizzle_small_index_to_n32; break;
            case kRGB_565_SkColorType: proc = &swizzle_small_index_to_565; break;
            default: return nullptr;
          }
          break;
        case 8:
          switch (dstInfo.colorType()) {
            ...
            case kBGRA_8888_SkColorType:
              ...
              break;
            case kRGB_565_SkColorType: proc = &swizzle_index_to_565; break;
            default: return nullptr;
          }
          break;
        default: return nullptr;
    ...
    case SkEncodedInfo::kRGBA_Color:
      switch (dstInfo.colorType()) {
        case kRGBA_8888_SkColorType:
          if (16 == encodedInfo.bitsPerComponent()) {
            proc = premultiply ? &swizzle_rgba16_to_rgba_premul : &swizzle_rgba16_to_rgba_unpremul;
            break;
          }
        ...
        case kBGRA_8888_SkColorType:
          if (16 == encodedInfo.bitsPerComponent()) {
            proc = premultiply ? &swizzle_rgba16_to_bgra_premul : &swizzle_rgba16_to_bgra_unpremul;
            break;
          }
    ...
    case SkEncodedInfo::kBGR_Color:
      switch (dstInfo.colorType()) {
        ...
        case kRGBA_8888_SkColorType:
          ...
          fastProc = &fast_swizzle_rgb_to_bgra;
          break;
        case kRGB_565_SkColorType: proc = &swizzle_bgr_to_565; break;
        default: return nullptr;
      }
      break;
    case SkEncodedInfo::kBGRX_Color:
      switch (dstInfo.colorType()) {
        case kBGRA_8888_SkColorType: proc = &swizzle_rgb_to_rgba; break;
        case kRGBA_8888_SkColorType: proc = &swizzle_rgb_to_bgra; break;
        case kRGB_565_SkColorType: proc = &swizzle_bgr_to_565; break;
        default: return nullptr;
      }
      break;
    ...
    case SkEncodedInfo::kInvertedCMYK_Color:
      switch (dstInfo.colorType()) {
        ...
        case kBGRA_8888_SkColorType:
          ...
          break;
        case kRGB_565_SkColorType: proc = &swizzle_cmyk_to_565; break;
        default: return nullptr;
      }
      break;
    default: return nullptr;
...
std::unique_ptr<SkSwizzler> SkSwizzler::Make(
    const SkImageInfo& dstInfo, RowProc fastProc, RowProc proc, const SkPMColor* ctable, int srcBPP,
  ...
  return std::unique_ptr<SkSwizzler>(new SkSwizzler(
      fastProc, proc, ctable, srcOffset, srcWidth, dstOffset, dstWidth, srcBPP, dstBPP));
}

SkSwizzler::SkSwizzler(
    RowProc fastProc, RowProc proc, const SkPMColor* ctable, int srcOffset, int srcWidth,
...
void SkSwizzler::swizzle(void* dst, const uint8_t* SK_RESTRICT src) {
  ...
  fActualProc(
      SkTAddOffset<void>(dst, fDstOffsetBytes), src, fSwizzleWidth, fSrcBPP, fSampleX * fSrcBPP,
      fSrcOffsetUnits, fColorTable);
}
