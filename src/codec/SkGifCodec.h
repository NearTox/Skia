...
class SkGifCodec : public SkCodec {
 ...
 protected:
  ...
  SkEncodedImageFormat onGetEncodedFormat() const override { return SkEncodedImageFormat::kGIF; }
  ...
  Result onStartIncrementalDecode(
      const SkImageInfo& /*dstInfo*/, void*, size_t, const SkCodec::Options&) override;

  Result onIncrementalDecode(int*) override;

  const SkFrameHolder* getFrameHolder() const override { return fReader.get(); }
