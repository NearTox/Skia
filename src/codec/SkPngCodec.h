...
class SkPngCodec : public SkCodec {
 ...
 protected:
  ...
  SkPngCodec(
      SkEncodedInfo&&, std::unique_ptr<SkStream>, SkPngChunkReader*, void* png_ptr, void* info_ptr,
      int bitDepth);
  ...
  Result onStartIncrementalDecode(
      const SkImageInfo& dstInfo, void* pixels, size_t rowBytes, const SkCodec::Options&) override;
