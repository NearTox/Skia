...
class SkBmpMaskCodec : public SkBmpBaseCodec {
 public:
   ...
   */
  SkBmpMaskCodec(
      SkEncodedInfo&& info, std::unique_ptr<SkStream>, uint16_t bitsPerPixel, SkMasks* masks,
 ...
 private:
  ...
  int decodeRows(
      const SkImageInfo& dstInfo, void* dst, size_t dstRowBytes, const Options& opts) override;
