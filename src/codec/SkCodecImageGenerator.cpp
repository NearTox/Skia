...
SkCodecImageGenerator::SkCodecImageGenerator(
    std::unique_ptr<SkCodec> codec, sk_sp<SkData> data, std::optional<SkAlphaType> at)
    : INHERITED(adjust_info(codec.get(), at)), fCodec(std::move(codec)), fData(std::move(data)) {}
