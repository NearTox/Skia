...
void SkNWayCanvas::onDrawPoints(
...
void SkNWayCanvas::onDrawImageRect(
...
void SkNWayCanvas::onDrawImageLattice(
...
void SkNWayCanvas::onDrawEdgeAAImageSet(
  ...
  Iter iter(fList);
  while (iter.next()) {
    iter->experimental_DrawEdgeAAImageSet(set, count, dstClips, preViewMatrices, paint, constraint);
  }
}
#endif

void SkNWayCanvas::onDrawImage2(
...
void SkNWayCanvas::onDrawImageRect2(
...
void SkNWayCanvas::onDrawImageLattice2(
...
void SkNWayCanvas::onDrawAtlas2(
    const SkImage* image, const SkRSXform xform[], const SkRect tex[], const SkColor colors[],
...
void SkNWayCanvas::onDrawTextBlob(
...
void SkNWayCanvas::onDrawPicture(
...
void SkNWayCanvas::onDrawEdgeAAQuad(
...
void SkNWayCanvas::onDrawEdgeAAImageSet2(
    const ImageSetEntry set[], int count, const SkPoint dstClips[],
