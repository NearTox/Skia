...
SkScalar SkInterpolatorBase::ComputeRelativeT(
    SkMSec time, SkMSec prevTime, SkMSec nextTime, const SkScalar blend[4]) {
...
SkInterpolatorBase::Result SkInterpolatorBase::timeToT(
    SkMSec time, SkScalar* T, int* indexPtr, bool* exactPtr) const {
...
static const SkScalar gIdentityBlend[4] = {0.33333333f, 0.33333333f, 0.66666667f, 0.66666667f};

bool SkInterpolator::setKeyFrame(
    int index, SkMSec time, const SkScalar values[], const SkScalar blend[4]) {
...
static inline Dot14 Dot14Mul(Dot14 a, Dot14 b) { return (a * b + Dot14_HALF) >> 14; }
