...
static inline CGFloat SkCGRectGetMinX(const CGRect& rect) { return rect.origin.x; }

static inline CGFloat SkCGRectGetMaxX(const CGRect& rect) {
  return rect.origin.x + rect.size.width;
}

static inline CGFloat SkCGRectGetMinY(const CGRect& rect) { return rect.origin.y; }

static inline CGFloat SkCGRectGetMaxY(const CGRect& rect) {
  return rect.origin.y + rect.size.height;
}

static inline CGFloat SkCGRectGetWidth(const CGRect& rect) { return rect.size.width; }
