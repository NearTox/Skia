...
public:
    ...
    static void BreakupClusters(size_t utf8Begin, size_t utf8End, SkSpan<const uint32_t> clusters,
    ...
    static void VisualizeClusters(const char utf8[], size_t utf8Begin, size_t utf8End,
                                  SkSpan<const SkGlyphID> glyphIDs, SkSpan<const uint32_t> clusters,
                                  const VisualizeClustersCallback& processMToN);

private:
    void displayMToN(size_t codePointCount, SkSpan<const char> utf8,
