...
void AutoCallLua::pushEncodedText(SkTextEncoding enc, const void* text, size_t length) {
  switch (enc) {
    case SkTextEncoding::kUTF8: this->pushString((const char*)text, length, "text"); break;
    case SkTextEncoding::kUTF16:
      this->pushString(SkStringFromUTF16((const uint16_t*)text, length), "text");
      break;
    case SkTextEncoding::kGlyphID:
      this->pushArrayU16((const uint16_t*)text, SkToInt(length >> 1), "glyphs");
      break;
    case SkTextEncoding::kUTF32: break;
  }
}

///////////////////////////////////////////////////////////////////////////////

void SkLuaCanvas::pushThis() { SkLua(fL).pushCanvas(this); }
...
void SkLuaCanvas::didSetMatrix(const SkMatrix& matrix) { this->INHERITED::didSetMatrix(matrix); }
...
void SkLuaCanvas::onDrawDRRect(const SkRRect& outer, const SkRRect& inner, const SkPaint& paint) {
  AUTO_LUA("drawDRRect");
...
void SkLuaCanvas::onDrawImageRect(
...
void SkLuaCanvas::onDrawTextBlob(
...
void SkLuaCanvas::onDrawPicture(
