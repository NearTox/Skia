...
class GrTextureEffect : public GrFragmentProcessor {
 public:
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(
      sk_sp<GrSurfaceProxy>, SkAlphaType, const SkMatrix& = SkMatrix::I(),
   ...
   */
  static std::unique_ptr<GrFragmentProcessor> Make(
      sk_sp<GrSurfaceProxy>, SkAlphaType, const SkMatrix&, GrSamplerState, const GrCaps& caps);
   ...
   */
  static std::unique_ptr<GrFragmentProcessor> MakeTexelSubset(
      sk_sp<GrSurfaceProxy>, SkAlphaType, const SkMatrix&, GrSamplerState, const SkIRect& subset,
      const GrCaps& caps);
  /**
  ...
  static std::unique_ptr<GrFragmentProcessor> MakeSubset(
      sk_sp<GrSurfaceProxy>, SkAlphaType, const SkMatrix&, GrSamplerState, const SkRect& subset,
      const GrCaps& caps);
 ...
 private:
  ...
  struct Sampling {
    ...
    Sampling(
        const GrSurfaceProxy& proxy, GrSamplerState sampler, const SkRect&, bool, const SkRect*,
        const GrCaps&);
