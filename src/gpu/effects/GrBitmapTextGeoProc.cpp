...
GrBitmapTextGeoProc::GrBitmapTextGeoProc(
    ...
    const GrSurfaceProxyView* views, int numActiveViews, GrSamplerState params, GrMaskFormat format,
...
GrGeometryProcessor* GrBitmapTextGeoProc::TestCreate(GrProcessorTestData* d) {
  ...
  GrMaskFormat format;
  switch (ct) {
    case GrColorType::kAlpha_8: format = kA8_GrMaskFormat; break;
    case GrColorType::kBGR_565: format = kA565_GrMaskFormat; break;
