...
class GrGLDistanceFieldA8TextGeoProc : public GrGLSLGeometryProcessor {
 public:
  ...
  void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
    ...
    // emit transforms
    this->emitTransforms(
        vertBuilder, varyingHandler, uniformHandler, dfTexEffect.inPosition().asShaderVar(),
        dfTexEffect.localMatrix(), args.fFPCoordTransformHandler);
 ...
 public:
  ...
  void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
    ...
    if (dfPathEffect.matrix().hasPerspective()) {
      ...
      // emit transforms
      this->emitTransforms(
          vertBuilder, varyingHandler, uniformHandler, dfPathEffect.inPosition().asShaderVar(),
      ...
      this->emitTransforms(
          vertBuilder, varyingHandler, uniformHandler, dfPathEffect.inPosition().asShaderVar(),
          dfPathEffect.matrix(), args.fFPCoordTransformHandler);
    }
