...
return color;
        ...
        args.fUniformHandler->getUniformCStr(mVar), args.fUniformHandler->getUniformCStr(vVar),
        (_outer.clampRGBOutput ? "true" : "false"), (_outer.premulOutput ? "true" : "false"));
  }
...
void GrColorMatrixFragmentProcessor::onGetGLSLProcessorKey(
