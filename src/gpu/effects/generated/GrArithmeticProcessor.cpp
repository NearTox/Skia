...
class GrGLSLArithmeticProcessor : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    (void)enforcePMColor;
    kVar = args.fUniformHandler->addUniform(&_outer, kFragment_GrShaderFlag, kFloat4_GrSLType, "k");
    SkString _sample385 = this->invokeChild(0, args);
    fragBuilder->codeAppendf(R"SkSL(half4 src = %s;)SkSL", _sample385.c_str());
...
void GrArithmeticProcessor::onGetGLSLProcessorKey(
...
SkString GrArithmeticProcessor::onDumpInfo() const {
  return SkStringPrintf(
      "(k=float4(%f, %f, %f, %f), enforcePMColor=%s)", k.x, k.y, k.z, k.w,
