...
class GrRectBlurEffect : public GrFragmentProcessor {
 public:
  static std::unique_ptr<GrFragmentProcessor> MakeIntegralFP(
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(
      ...
      const GrShaderCaps& caps, const SkRect& srcRect, const SkMatrix& viewMatrix,
    ...
    return std::unique_ptr<GrFragmentProcessor>(new GrRectBlurEffect(
        std::move(inputFP), insetRect, !invM.isIdentity(), invM, std::move(integral), isFast));
  }
 ...
 private:
  GrRectBlurEffect(
      std::unique_ptr<GrFragmentProcessor> inputFP, SkRect rect, bool applyInvVM, SkMatrix invVM,
