...
static GrSurfaceProxyView create_profile_texture(
...
std::unique_ptr<GrFragmentProcessor> GrCircleBlurFragmentProcessor::Make(
  ...
  return std::unique_ptr<GrFragmentProcessor>(
      new GrCircleBlurFragmentProcessor(circle, textureRadius, solidRadius, std::move(profile)));
}
...
class GrGLSLCircleBlurFragmentProcessor : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    (void)solidRadius;
    circleDataVar =
        args.fUniformHandler->addUniform(kFragment_GrShaderFlag, kHalf4_GrSLType, "circleData");
