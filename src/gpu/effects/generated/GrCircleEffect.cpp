 ...
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    fragBuilder->codeAppendf(
        ...
        args.fUniformHandler->getUniformCStr(circleVar),
        args.fUniformHandler->getUniformCStr(circleVar),
        args.fUniformHandler->getUniformCStr(circleVar), (int)_outer.edgeType, (int)_outer.edgeType,
        (int)_outer.edgeType, args.fOutputColor, args.fInputColor, args.fOutputColor,
        args.fInputColor);
  }
