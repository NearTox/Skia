...
class GrConstColorProcessor : public GrFragmentProcessor {
 public:
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(
      std::unique_ptr<GrFragmentProcessor> inputFP, SkPMColor4f color, InputMode mode) {
 ...
 private:
  GrConstColorProcessor(
      std::unique_ptr<GrFragmentProcessor> inputFP, SkPMColor4f color, InputMode mode) noexcept
      : INHERITED(
