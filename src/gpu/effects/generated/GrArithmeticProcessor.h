 ...
 public:
  static std::unique_ptr<GrFragmentProcessor> Make(
    ...
    return std::unique_ptr<GrFragmentProcessor>(new GrArithmeticProcessor(
        ...
        SkV4{inputs.fK[0], inputs.fK[1], inputs.fK[2], inputs.fK[3]}, inputs.fEnforcePMColor));
  }
  GrArithmeticProcessor(const GrArithmeticProcessor& src);
  std::unique_ptr<GrFragmentProcessor> clone() const override;
  const char* name() const noexcept override { return "ArithmeticProcessor"; }
  SkV4 k;
  bool enforcePMColor;

 private:
  GrArithmeticProcessor(
      std::unique_ptr<GrFragmentProcessor> srcFP, std::unique_ptr<GrFragmentProcessor> dstFP,
      SkV4 k, bool enforcePMColor)
