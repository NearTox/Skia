...
class GrGLSLHighContrastFilterEffect : public GrGLSLFragmentProcessor {
 public:
  GrGLSLHighContrastFilterEffect() noexcept = default;
  void emitCode(EmitArgs& args) override {
    ...
    (void)linearize;
    contrastModVar = args.fUniformHandler->addUniform(
        &_outer, kFragment_GrShaderFlag, kHalf_GrSLType, "contrastMod");
    SkString HSLToRGB_name;
    const GrShaderVar HSLToRGB_args[] = {
        GrShaderVar("p", kHalf_GrSLType), GrShaderVar("q", kHalf_GrSLType),
        GrShaderVar("t", kHalf_GrSLType)};
    fragBuilder->emitFunction(
        kHalf_GrSLType, "HSLToRGB", 3, HSLToRGB_args,
...
void GrHighContrastFilterEffect::onGetGLSLProcessorKey(
...
bool GrHighContrastFilterEffect::onIsEqual(const GrFragmentProcessor& other) const noexcept {
