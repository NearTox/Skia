...
class GrMixerEffect : public GrFragmentProcessor {
 public:
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(
      std::unique_ptr<GrFragmentProcessor> inputFP, std::unique_ptr<GrFragmentProcessor> fp0,
      std::unique_ptr<GrFragmentProcessor> fp1, float weight) {
 ...
 private:
  GrMixerEffect(
      ...
      std::unique_ptr<GrFragmentProcessor> fp1, float weight)
      : INHERITED(
            kGrMixerEffect_ClassID, (OptimizationFlags)ProcessorOptimizationFlags(inputFP.get()) &
