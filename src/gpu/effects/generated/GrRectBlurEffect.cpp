...
class GrGLSLRectBlurEffect : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    rectVar = args.fUniformHandler->addUniform(kFragment_GrShaderFlag, kFloat4_GrSLType, "rect");
    if (!highPrecision) {
      proxyRectHalfVar = args.fUniformHandler->addUniform(
    ...
    profileSizeVar =
        args.fUniformHandler->addUniform(kFragment_GrShaderFlag, kHalf_GrSLType, "profileSize");
