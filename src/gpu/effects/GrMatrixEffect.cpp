...
class GrGLSLMatrixEffect : public GrGLSLFragmentProcessor {
 ...
 private:
  void onSetData(const GrGLSLProgramDataManager& pdman, const GrFragmentProcessor& proc) override {
...
GrMatrixEffect::GrMatrixEffect(const GrMatrixEffect& src)
    : INHERITED(kGrMatrixEffect_ClassID, src.optimizationFlags()), fMatrix(src.fMatrix) {
