...
void GrTextureDomain::GLDomain::sampleTexture(
  ...
  builder->appendTextureLookupAndModulate(
      inModulateColor, sampler, "clampedCoord", kFloat2_GrSLType);
  builder->codeAppend(";");
...
void GrTextureDomain::GLDomain::setData(
    ...
    GrTextureProxy* proxy, const GrSamplerState& sampler) {
...
GrTextureDomainEffect::GrTextureDomainEffect(
  ...
  SkASSERT(
      (modeX != GrTextureDomain::kRepeat_Mode && modeY != GrTextureDomain::kRepeat_Mode) ||
   ...
   public:
    void emitCode(EmitArgs& args) override {
      ...
      fGLDomain.sampleTexture(
          ...
          args.fTexSamplers[0], args.fInputColor);
    }
