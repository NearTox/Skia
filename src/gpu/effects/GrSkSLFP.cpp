...
class GrGLSLSkSLFP : public GrGLSLFragmentProcessor {
 public:
  ...
  SkSL::String expandFormatArgs(
      ...
      std::vector<SkSL::Compiler::FormatArg>::const_iterator& fmtArg, const char* coordsName) {
    SkSL::String result;
        ...
        switch (c) {
          case 's': {
            ...
            switch (arg.fKind) {
              ...
              case SkSL::Compiler::FormatArg::Kind::kCoords: result += coordsName; break;
              ...
              case SkSL::Compiler::FormatArg::Kind::kChildProcessor: {
                SkSL::String coords = this->expandFormatArgs(arg.fCoords, args, fmtArg, coordsName);
  ...
  void emitCode(EmitArgs& args) override {
    ...
    for (const auto& f : fArgs.fFunctions) {
      ...
      SkSL::String body = this->expandFormatArgs(f.fBody.c_str(), args, fmtArgIter, coords.c_str());
    ...
    fragBuilder->codeAppend(
        this->expandFormatArgs(fArgs.fCode.c_str(), args, fmtArgIter, coords.c_str()).c_str());
...
std::unique_ptr<GrSkSLFP> GrSkSLFP::Make(
    GrContext_Base* context, sk_sp<SkRuntimeEffect> effect, const char* name, sk_sp<SkData> inputs,
...
GrSkSLFP::GrSkSLFP(
    ...
    sk_sp<SkRuntimeEffect> effect, const char* name, sk_sp<SkData> inputs, const SkMatrix* matrix)
  ...
  switch (type) {
    case 0: {
      ...
      auto result = GrSkSLFP::Make(
          d->context(), effect, "Dither", SkData::MakeWithCopy(&rangeType, sizeof(rangeType)));
      return std::unique_ptr<GrFragmentProcessor>(result.release());
    }
    case 1: {
    ...
    case 2: {
      ...
      auto result = GrSkSLFP::Make(
          d->context(), effect, "Overdraw", SkData::MakeWithCopy(&inputs, sizeof(inputs)));
      return std::unique_ptr<GrFragmentProcessor>(result.release());
    }
  }
