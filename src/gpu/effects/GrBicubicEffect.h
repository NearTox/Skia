...
class GrBicubicEffect : public GrFragmentProcessor {
 public:
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(
      GrSurfaceProxyView view, SkAlphaType, const SkMatrix&, SkImage::CubicResampler, Direction);
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(
      ...
      const GrSamplerState::WrapMode wrapY, SkImage::CubicResampler, Direction, const GrCaps&);
  ...
  static std::unique_ptr<GrFragmentProcessor> MakeSubset(
      GrSurfaceProxyView view, SkAlphaType, const SkMatrix&, const GrSamplerState::WrapMode wrapX,
      const GrSamplerState::WrapMode wrapY, const SkRect& subset, SkImage::CubicResampler,
  ...
  static std::unique_ptr<GrFragmentProcessor> MakeSubset(
      GrSurfaceProxyView view, SkAlphaType, const SkMatrix&, const GrSamplerState::WrapMode wrapX,
      const GrSamplerState::WrapMode wrapY, const SkRect& subset, const SkRect& domain,
      SkImage::CubicResampler, Direction, const GrCaps&);
   ...
   */
  static std::unique_ptr<GrFragmentProcessor> Make(
      std::unique_ptr<GrFragmentProcessor>, SkAlphaType, const SkMatrix&, SkImage::CubicResampler,
      Direction);
 ...
 private:
  ...
  GrBicubicEffect(std::unique_ptr<GrFragmentProcessor>, SkImage::CubicResampler, Direction, Clamp);
