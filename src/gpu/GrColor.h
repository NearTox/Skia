 ...
 */
static constexpr inline GrColor GrColorPackRGBA(unsigned r, unsigned g, unsigned b, unsigned a) {
...
static constexpr inline float GrNormalizeByteToFloat(uint8_t value) {
