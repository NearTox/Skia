...
class GrOpsTask : public GrRenderTask {
 ...
 public:
  ...
  void addDrawOp(
      GrDrawingManager*, GrOp::Owner, const GrProcessorSet::Analysis&, GrAppliedClip&&,
      const DstProxyView&, GrTextureResolveManager, const GrCaps&);
 ...
 private:
  ...
  class OpChain {
   public:
    ...
    GrOp::Owner appendOp(
        GrOp::Owner op, GrProcessorSet::Analysis, const DstProxyView*, const GrAppliedClip*,
        const GrCaps&, GrRecordingContext::Arenas*, GrAuditTrail*);
   ...
   private:
    ...
    bool tryConcat(
        ...
        const SkRect& bounds, const GrCaps&, GrRecordingContext::Arenas*, GrAuditTrail*);
  ...
  void recordOp(
      GrOp::Owner, GrProcessorSet::Analysis, GrAppliedClip*, const DstProxyView*, const GrCaps&);
