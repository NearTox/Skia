...
sk_sp<GrContext> GrContext::MakeGL() { return GrDirectContext::MakeGL(); }
...
sk_sp<GrContext> GrContext::MakeMock(
...
sk_sp<GrContext> GrContext::MakeVulkan(
...
sk_sp<GrContext> GrContext::MakeDirect3D(
