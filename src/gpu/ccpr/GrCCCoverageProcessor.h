 ...
 public:
  ...
  class Shader {
   public:
    ...
    void emitFragmentCode(
        const GrCCCoverageProcessor&, GrGLSLFPFragmentBuilder*, const char* skOutputColor,
    ...
    static void CalcWind(
        const GrCCCoverageProcessor&, GrGLSLVertexGeoBuilder*, const char* pts,
    ...
    static void CalcEdgeCoverageAtBloatVertex(
        GrGLSLVertexGeoBuilder*, const char* leftPt, const char* rightPt,
        const char* rasterVertexDir, const char* outputCoverage);

    // Calculates an edge's coverage at two conservative raster vertices.
    // (See CalcEdgeCoverageAtBloatVertex).
    static void CalcEdgeCoveragesAtBloatVertices(
        GrGLSLVertexGeoBuilder*, const char* leftPt, const char* rightPt, const char* bloatDir1,
    ...
    static void CalcCornerAttenuation(
   ...
   protected:
    ...
    virtual void onEmitFragmentCode(GrGLSLFPFragmentBuilder*, const char* outputCoverage) const = 0;
...
inline void GrCCCoverageProcessor::TriPointInstance::set(
    const SkPoint& p0, const SkPoint& p1, const SkPoint& p2, const Sk2f& trans) {
