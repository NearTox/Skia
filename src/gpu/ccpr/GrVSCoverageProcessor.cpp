...
void GrVSCoverageProcessor::reset(PrimitiveType primitiveType, GrResourceProvider* rp) {
  ...
  if (4 == this->numInputPoints() || this->hasInputWeight()) {
    ...
    GR_STATIC_ASSERT(
        sizeof(TriPointInstance::fX) == GrVertexAttribTypeSize(kFloat3_GrVertexAttribType));
    GR_STATIC_ASSERT(
        sizeof(TriPointInstance::fY) == GrVertexAttribTypeSize(kFloat3_GrVertexAttribType));
...
void GrVSCoverageProcessor::appendMesh(
  ...
  mesh.setIndexedInstanced(
      fIndexBuffer, fNumIndicesPerInstance, std::move(instanceBuffer), instanceCount, baseInstance,
      primitiveRestart);
