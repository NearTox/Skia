...
public:
    ...
    void drawStrokes(GrOpFlushState*, GrCCCoverageProcessor*, BatchID,
...
private:
    ...
    void drawConnectingGeometry(GrOpFlushState*, const GrPipeline&, const GrCCCoverageProcessor&,
                                const Batch&, const InstanceTallies* startIndices[2],
                                int startScissorSubBatch, const SkIRect& drawBounds) const;
