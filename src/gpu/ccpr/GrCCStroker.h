...
class GrCCStroker {
 public:
  ...
  // not yet supported.
  void parseDeviceSpaceStroke(
      const SkPath&, const SkPoint* deviceSpacePts, const SkStrokeRec&, float strokeDevWidth,
      GrScissorTest, const SkIRect& clippedDevIBounds, const SkIVector& devToAtlasOffset);
 ...
 private:
  ...
  void drawConnectingGeometry(
      GrOpFlushState*, const GrPipeline&, const GrCCCoverageProcessor&, const Batch&,
