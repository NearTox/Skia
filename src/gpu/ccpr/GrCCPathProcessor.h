...
inline void GrCCPathProcessor::Instance::set(const GrOctoBounds& octoBounds,
    ...
    if (DoEvenOddFill::kNo == doEvenOddFill) {
        ...
        fDevBounds.setLTRB(octoBounds.right(), octoBounds.top(), octoBounds.left(),
                           octoBounds.bottom());
        fDevBounds45.setLTRB(octoBounds.bottom45(), octoBounds.right45(), octoBounds.top45(),
                             octoBounds.left45());
    }
