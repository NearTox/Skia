...
static GrPathRendering::FillType convert_skpath_filltype(SkPathFillType fill) {
  switch (fill) {
    ...
    case SkPathFillType::kInverseWinding: return GrPathRendering::kWinding_FillType;
    case SkPathFillType::kEvenOdd:
    case SkPathFillType::kInverseEvenOdd: return GrPathRendering::kEvenOdd_FillType;
  }
}
