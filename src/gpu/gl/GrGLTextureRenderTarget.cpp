...
GrGLTextureRenderTarget::GrGLTextureRenderTarget(
    ...
    : GrSurface(gpu, texDesc.fSize, texDesc.fConfig, GrProtected::kNo),
      ...
      GrGLRenderTarget(gpu, texDesc.fSize, texDesc.fFormat, texDesc.fConfig, sampleCount, rtIDs) {
...
size_t GrGLTextureRenderTarget::onGpuMemorySize() const {
  ...
  return GrSurface::ComputeSize(
      caps, this->backendFormat(), this->width(), this->height(), this->numSamplesOwnedPerPixel(),
