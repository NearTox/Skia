...
class GrGLTexture : public GrTexture {
 public:
  ...
  static sk_sp<GrGLTexture> MakeWrapped(
      GrGLGpu*, const GrSurfaceDesc&, GrMipMapsStatus, const IDDesc&, sk_sp<GrGLTextureParameters>,
 ...
 protected:
  ...
  GrGLTexture(
      GrGLGpu*, const GrSurfaceDesc&, const IDDesc&, sk_sp<GrGLTextureParameters>, GrMipMapsStatus);
