...
class GrGLBuffer : public GrGpuBuffer {
 public:
  static sk_sp<GrGLBuffer> Make(
      GrGLGpu*, size_t size, GrGpuBufferType intendedType, GrAccessPattern,
 ...
 protected:
  GrGLBuffer(
      GrGLGpu*, size_t size, GrGpuBufferType intendedType, GrAccessPattern, const void* data);
 ...
 private:
  ...
  const GrGLCaps& glCaps() const noexcept;
