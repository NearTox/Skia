...
void GrGLCaps::getTexImageFormats(
...
static GrPixelConfig validate_sized_format(
    GrGLFormat format, GrColorType ct, GrGLStandard standard) {
  switch (ct) {
    ...
    case GrColorType::kRGB_888x:
      if (format == GrGLFormat::kRGB8) {
        ...
        return kRGB_888X_GrPixelConfig;
          ...
          format == GrGLFormat::kCOMPRESSED_RGB8_ETC2 ||
...
GrColorType GrGLCaps::getYUVAColorTypeFromBackendFormat(
  ...
  switch (format.asGLFormat()) {
    ...
    case GrGLFormat::kALPHA8:      // kAlpha_8_as_Alpha_GrPixelConfig/<missing kGray_8_as_Alpha>
      return isAlphaChannel ? GrColorType::kAlpha_8 : GrColorType::kGray_8;
...
std::vector<GrCaps::TestFormatColorTypeCombination> GrGLCaps::getTestingCombinations() const {
  std::vector<GrCaps::TestFormatColorTypeCombination> combos = {
      ...
      {GrColorType::kRGBA_F32, GrBackendFormat::MakeGL(GR_GL_RGBA32F, GR_GL_TEXTURE_2D)},
      {GrColorType::kR_16, GrBackendFormat::MakeGL(GR_GL_R16, GR_GL_TEXTURE_2D)},
