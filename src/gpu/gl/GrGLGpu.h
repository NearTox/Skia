...
class GrGLGpu final : public GrGpu {
 public:
  ...
  void clearStencilClip(
      const GrScissorState&, bool insideStencilMask, GrRenderTarget*, GrSurfaceOrigin);

  void beginCommandBuffer(
      GrRenderTarget*, const SkIRect& bounds, GrSurfaceOrigin,
      const GrOpsRenderPass::LoadAndStoreInfo& colorLoadStore,
      const GrOpsRenderPass::StencilLoadAndStoreInfo& stencilLoadStore);

  void endCommandBuffer(
      GrRenderTarget*, const GrOpsRenderPass::LoadAndStoreInfo& colorLoadStore,
      const GrOpsRenderPass::StencilLoadAndStoreInfo& stencilLoadStore);
 ...
 private:
  ...
  class ProgramCache : public ::SkNoncopyable {
   ...
   private:
    ...
    sk_sp<GrGLProgram> findOrCreateProgram(
        GrRenderTarget*, const GrProgramDesc&, const GrProgramInfo&, Stats::ProgramCacheResult*);
  ...
  void setNeedsFlush() noexcept { fNeedsGLFlush = true; }
