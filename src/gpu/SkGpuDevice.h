...
class SkGpuDevice : public BASE_DEVICE {
 public:
  ...
  static sk_sp<SkGpuDevice> Make(
      GrRecordingContext*, std::unique_ptr<GrSurfaceDrawContext>, InitContents);
  ...
  void replaceSurfaceDrawContext(
      std::unique_ptr<GrSurfaceDrawContext>, SkSurface::ContentChangeMode mode);
 ...
 private:
  ...
  void drawProducerLattice(
      GrTextureProducer*, std::unique_ptr<SkLatticeIter>, const SkRect& dst, SkFilterMode,
      const SkPaint&);

  void drawStrokedLine(const SkPoint pts[2], const SkPaint&);

  static std::unique_ptr<GrSurfaceDrawContext> MakeSurfaceDrawContext(
      GrRecordingContext*, SkBudgeted, const SkImageInfo&, int sampleCount, GrSurfaceOrigin,
