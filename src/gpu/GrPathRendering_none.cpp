...
void GrGLPathRendering::setProgramPathFragmentInputTransform(
    GrGLuint, GrGLint, GrGLenum, GrGLint, const SkMatrix&) {}
...
void GrGLPathRendering::onDrawPath(
    ...
    const GrPipeline::FixedDynamicState&, const GrStencilSettings&, const GrPath*) {}

void GrGLPathRendering::onStencilPath(const StencilPathArgs&, const GrPath*) {}

std::unique_ptr<GrOp> GrStencilPathOp::Make(
    GrRecordingContext*, const SkMatrix&, bool, GrPathRendering::FillType, bool,
    const GrScissorState&, const GrPath*) {
  return nullptr;
}
