...
std::unique_ptr<GrSurfaceDrawContext> GrSurfaceDrawContext::Make(
  ...
  return std::make_unique<GrSurfaceDrawContext>(
      context, std::move(readView), std::move(writeView), colorType, std::move(colorSpace),
      surfaceProps, flushTimeOpsTask);
}

std::unique_ptr<GrSurfaceDrawContext> GrSurfaceDrawContext::Make(
    GrRecordingContext* context, sk_sp<SkColorSpace> colorSpace, SkBackingFit fit,
  ...
  auto rtc = std::make_unique<GrSurfaceDrawContext>(
      context, std::move(readView), std::move(writeView), GrColorType::kUnknown,
...
GrSurfaceDrawContext::~GrSurfaceDrawContext() { ASSERT_SINGLE_OWNER }
...
void GrSurfaceDrawContext::drawGlyphRunList(
  ...
  if (blob == nullptr || !blob->canReuse(drawPaint, drawMatrix)) {
    ...
    for (auto& glyphRun : glyphRunList) {
      fGlyphPainter.processGlyphRun(
          glyphRun, viewMatrix.localToDevice(), drawOrigin, drawPaint, fSurfaceProps, supportsSDFT,
          options, blob.get());
    }
  }
...
void GrSurfaceDrawContext::drawPaint(
...
void GrSurfaceDrawContext::drawFilledQuad(
...
void GrSurfaceDrawContext::drawTexturedQuad(
...
void GrSurfaceDrawContext::drawRect(
...
void GrSurfaceDrawContext::drawQuadSet(
...
void GrSurfaceDrawContext::stencilPath(
  ...
  GrAppliedHardClip appliedClip(
      this->dimensions(), this->asSurfaceProxy()->backingStoreDimensions());
  ...
  GrOp::Owner op = GrStencilPathOp::Make(
      fContext, viewMatrix, doStencilMSAA == GrAA::kYes, appliedClip.hasStencilClip(),
      appliedClip.scissorState(), std::move(path));
  if (!op) {
    return;
  }
...
void GrSurfaceDrawContext::drawTextureSet(
...
void GrSurfaceDrawContext::drawVertices(
...
void GrSurfaceDrawContext::drawAtlas(
...
void GrSurfaceDrawContext::drawRRect(
...
bool GrSurfaceDrawContext::drawFastShadow(
...
bool GrSurfaceDrawContext::drawFilledDRRect(
    const GrClip* clip, GrPaint&& paint, GrAA aa, const SkMatrix& viewMatrix,
...
void GrSurfaceDrawContext::drawDRRect(
...
void GrSurfaceDrawContext::drawRegion(
    const GrClip* clip, GrPaint&& paint, GrAA aa, const SkMatrix& viewMatrix,
...
void GrSurfaceDrawContext::drawOval(
...
void GrSurfaceDrawContext::drawArc(
    const GrClip* clip, GrPaint&& paint, GrAA aa, const SkMatrix& viewMatrix, const SkRect& oval,
...
void GrSurfaceDrawContext::drawImageLattice(
...
void GrSurfaceDrawContext::drawDrawable(
...
bool GrSurfaceDrawContext::waitOnSemaphores(
...
void GrSurfaceDrawContext::drawPath(
...
void GrSurfaceDrawContext::drawShape(
    const GrClip* clip, GrPaint&& paint, GrAA aa, const SkMatrix& viewMatrix,
...
bool GrSurfaceDrawContext::drawAndStencilPath(
...
void GrSurfaceDrawContext::drawShapeUsingPathRenderer(
    const GrClip* clip, GrPaint&& paint, GrAA aa, const SkMatrix& viewMatrix,
...
void GrSurfaceDrawContext::addDrawOp(
