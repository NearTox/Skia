...
GrSurfaceProxy::LazySurfaceDesc GrRenderTargetProxy::callbackDesc() const {
  ...
  return {
      this->dimensions(),   SkBackingFit::kExact, GrRenderable::kYes,
      GrMipmapped::kNo,     this->numSamples(),   this->backendFormat(),
      GrTextureType::kNone, this->isProtected(),  this->isBudgeted(),
  };
}
