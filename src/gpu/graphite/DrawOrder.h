...
class DrawOrder {
 public:
  ...
  inline static constexpr CompressedPaintersOrder kNoIntersection =
  ...
  explicit DrawOrder(PaintersDepth originalOrder)
      : fPaintOrder(kNoIntersection), fStencilIndex(kUnassigned), fDepth(originalOrder) {}

  DrawOrder(PaintersDepth originalOrder, CompressedPaintersOrder compressedOrder)
      : fPaintOrder(compressedOrder), fStencilIndex(kUnassigned), fDepth(originalOrder) {}
