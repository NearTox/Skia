...
const Renderer& Renderer::StencilTessellatedCurvesAndTris(SkPathFillType fillType) {
  ...
  static const Renderer kWindingRenderer{
      "StencilTessellatedCurvesAndTris[winding]", &kWindingStencilFan, &kWindingStencilCurves,
      cover_step()};
  static const Renderer kInverseWindingRenderer{
      "StencilTessellatedCurvesAndTris[inverse-winding]", &kWindingStencilFan,
      &kWindingStencilCurves, inverse_cover_step()};
  static const Renderer kEvenOddRenderer{
      "StencilTessellatedCurvesAndTris[evenodd]", &kEvenOddStencilFan, &kEvenOddStencilCurves,
      cover_step()};
  static const Renderer kInverseEvenOddRenderer{
      "StencilTessellatedCurvesAndTris[inverse-evenodd]", &kEvenOddStencilFan,
      &kEvenOddStencilCurves, inverse_cover_step()};
...
const Renderer& Renderer::StencilTessellatedWedges(SkPathFillType fillType) {
  ...
  static const Renderer kWindingRenderer{
      "StencilTessellatedWedges[winding]", &kWindingStencilWedges, cover_step()};
  static const Renderer kInverseWindingRenderer{
      "StencilTessellatedWedges[inverse-winding]", &kWindingStencilWedges, inverse_cover_step()};
  static const Renderer kEvenOddRenderer{
      "StencilTessellatedWedges[evenodd]", &kEvenOddStencilWedges, cover_step()};
  static const Renderer kInverseEvenOddRenderer{
      "StencilTessellatedWedges[inverse-evenodd]", &kEvenOddStencilWedges, inverse_cover_step()};
