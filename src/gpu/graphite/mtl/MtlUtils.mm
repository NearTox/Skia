...
bool SkSLToMSL(
    const MtlGpu* gpu, const std::string& sksl, SkSL::ProgramKind programKind,
...
sk_cfp<id<MTLLibrary>> MtlCompileShaderLibrary(
    const MtlGpu* gpu, const std::string& msl, ShaderErrorHandler* errorHandler) {
