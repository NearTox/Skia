...
class MtlSampler : public Sampler {
 public:
  static sk_sp<MtlSampler> Make(
      const MtlGpu*, const SkSamplingOptions& samplingOptions, SkTileMode xTileMode,
 ...
 private:
  MtlSampler(const MtlGpu* gpu, sk_cfp<id<MTLSamplerState>>);
