...
class ClipStack {
 public:
  ...
  std::pair<Clip, CompressedPaintersOrder> applyClipToDraw(
      const BoundsManager*, const Transform&, const Shape&, const SkStrokeRec&, PaintersDepth z);
 ...
 private:
  ...
  enum class SimplifyResult { kEmpty, kAOnly, kBOnly, kBoth };
  ...
  class RawElement : private Element {
   public:
    ...
    std::pair<bool, CompressedPaintersOrder> updateForDraw(
