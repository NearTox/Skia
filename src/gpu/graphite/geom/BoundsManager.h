...
class BoundsManager {
 public:
  ...
  virtual void recordDraw(
      const Rect& bounds, CompressedPaintersOrder order, PaintersDepth z,
...
class NaiveBoundsManager final : public BoundsManager {
 public:
  ...
  void reset() override { fLatestDraw = CompressedPaintersOrder::First(); }
...
class BruteForceBoundsManager : public BoundsManager {
 public:
  ...
  void reset() override { fRects.reset(); }
