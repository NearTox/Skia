...
class RenderStep {
 public:
  ...
  SkEnumBitMask<DepthStencilFlags> depthStencilFlags() const {
    return (fDepthStencilSettings.fStencilTestEnabled ? DepthStencilFlags::kStencil
 ...
 protected:
  ...
  RenderStep(
      std::string_view className, std::string_view variantName, SkEnumBitMask<Flags> flags,
      std::initializer_list<SkUniform> uniforms, PrimitiveType primitiveType,
      DepthStencilSettings depthStencilSettings, std::initializer_list<Attribute> vertexAttrs,
