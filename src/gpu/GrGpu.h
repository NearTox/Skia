 ...
 public:
  ...
  bool writePixels(
    ...
    return this->writePixels(
        surface, left, top, width, height, surfaceColorType, srcColorType, &mipLevel, 1,
        prepForTexSampling);
  }
...
#  endif
  ...
  GrBackendTexture createBackendTexture(
      SkISize dimensions, const GrBackendFormat&, GrRenderable, const BackendTextureData* data,
      int numMipLevels, GrProtected isProtected);
 ...
 private:
  virtual GrBackendTexture onCreateBackendTexture(
      SkISize dimensions, const GrBackendFormat&, GrRenderable, const BackendTextureData*,
      int numMipLevels, GrProtected isProtected) = 0;
  ...
  virtual bool onReadPixels(
      ...
      GrColorType dstColorType, void* buffer, size_t rowBytes) = 0;
  ...
  virtual bool onTransferPixelsTo(
      GrTexture*, int left, int top, int width, int height, GrColorType textiueColorType,
      GrColorType bufferColorType, GrGpuBuffer* transferBuffer, size_t offset, size_t rowBytes) = 0;
