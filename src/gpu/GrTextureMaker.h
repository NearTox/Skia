...
class GrTextureMaker : public GrTextureProducer {
 ...
 protected:
  GrTextureMaker(
      GrRecordingContext* context, int width, int height, const GrColorSpaceInfo& info,
   ...
   */
  virtual sk_sp<GrTextureProxy> refOriginalTextureProxy(
      bool willBeMipped, AllowedTexGenType genType) = 0;
