...
#  ifdef SK_GL
    case GrBackendApi::kOpenGL: fGLSync = that.fGLSync; break;
#  endif
#  ifdef SK_VULKAN
    case GrBackendApi::kVulkan: fVkSemaphore = that.fVkSemaphore; break;
#  endif
#  ifdef SK_METAL
    case GrBackendApi::kMetal:
      ...
      break;
#  endif
    case GrBackendApi::kDirect3D: this->assignD3DFenceInfo(*that.fD3DFenceInfo); break;
