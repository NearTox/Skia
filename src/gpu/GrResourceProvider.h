...
class GrResourceProvider {
 public:
  ...
  sk_sp<GrTexture> createTexture(
      ...
      GrProtected, const GrMipLevel& mipLevel);
  ...
  sk_sp<GrTexture> findAndRefScratchTexture(
      ...
      int renderTargetSampleCnt, GrMipmapped, GrProtected);
  ...
  sk_sp<const GrGpuBuffer> findOrMakeStaticBuffer(
      GrGpuBufferType intendedType, size_t size, const GrUniqueKey& key, InitializeBufferFn);
 ...
 private:
  ...
  sk_sp<GrTexture> getExactScratch(
      ...
      int renderTargetSampleCnt, SkBudgeted, GrMipmapped, GrProtected);
