...
sk_sp<GrTextureProxy> GrRefCachedBitmapTextureProxy(
    GrRecordingContext*, const SkBitmap&, const GrSamplerState&, SkScalar scaleAdjust[2]);
...
sk_sp<GrTextureProxy> GrMakeCachedBitmapProxy(
    GrProxyProvider*, const SkBitmap& bitmap, SkBackingFit fit = SkBackingFit::kExact);
...
sk_sp<GrTextureProxy> GrMakeCachedImageProxy(
    GrProxyProvider*, sk_sp<SkImage> srcImage, SkBackingFit fit = SkBackingFit::kExact);
