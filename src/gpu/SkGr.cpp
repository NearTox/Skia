...
sk_sp<GrTextureProxy> GrCopyBaseMipMapToTextureProxy(
    GrRecordingContext* ctx, GrTextureProxy* baseProxy, GrColorType srcColorType) {
  SkASSERT(baseProxy);
...
GrPixelConfig SkColorType2GrPixelConfig(const SkColorType type) {
  switch (type) {
    ...
    case kRGBA_F32_SkColorType: return kUnknown_GrPixelConfig;
    case kR8G8_unorm_SkColorType: return kRG_88_GrPixelConfig;
    case kR16G16_unorm_SkColorType: return kRG_1616_GrPixelConfig;
    case kA16_unorm_SkColorType: return kAlpha_16_GrPixelConfig;
    case kA16_float_SkColorType: return kAlpha_half_GrPixelConfig;
    case kR16G16_float_SkColorType: return kRG_half_GrPixelConfig;
    case kR16G16B16A16_unorm_SkColorType: return kRGBA_16161616_GrPixelConfig;
  }
  SkUNREACHABLE;
}
