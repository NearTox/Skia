...
class TessellationHelper {
 public:
  ...
  void outset(const skvx::Vec<4, float>& edgeDistances, GrQuad* deviceOutset, GrQuad* localOutset);
  ...
  void getEdgeEquations(skvx::Vec<4, float>* a, skvx::Vec<4, float>* b, skvx::Vec<4, float>* c);
 ...
 private:
  ...
  struct Vertices {
    ...
    // numerically sound.
    void moveAlong(const EdgeVectors& edgeVectors, const skvx::Vec<4, float>& signedEdgeDistances);
    ...
    void moveTo(
        const skvx::Vec<4, float>& x2d, const skvx::Vec<4, float>& y2d,
  ...
  int adjustDegenerateVertices(const skvx::Vec<4, float>& signedEdgeDistances, Vertices* vertices);
