...
class GrAATriangulator : private GrTriangulator {
 ...
 private:
  ...
  void extractBoundaries(
      const VertexList& inMesh, VertexList* innerVertices, const Comparator&) const;
  ...
  void makeEvent(
      SSEdge*, Vertex* v, SSEdge* other, Vertex* dest, EventList* events, const Comparator&) const;
