...
class GrShape {
 public:
  ...
  void asPath(SkPath* out) const {
    switch (fType) {
      case Type::kEmpty: out->reset(); break;
      ...
      case Type::kArc:
        SkPathPriv::CreateDrawArcPath(
            ...
            fArcData.fUseCenter, fStyle.isSimpleFill());
      ...
      case Type::kLine:
        ...
        break;
      case Type::kPath: *out = this->path(); break;
    }
  }
  ...
  bool knownToBeConvex() const {
    switch (fType) {
      ...
      case Type::kArc:
        return SkPathPriv::DrawArcIsConvex(
            fArcData.fSweepAngleDegrees, SkToBool(fArcData.fUseCenter), fStyle.isSimpleFill());
  ...
  bool inverseFilled() const {
    ...
    switch (fType) {
      ...
      case Type::kInvertedEmpty: ret = true; break;
      case Type::kRRect: ret = fRRectData.fInverted; break;
      case Type::kArc: ret = fArcData.fInverted; break;
      case Type::kLine: ret = fLineData.fInverted; break;
      case Type::kPath: ret = this->path().isInverseFillType(); break;
    }
  ...
  bool knownToBeClosed() const {
    switch (fType) {
      ...
      case Type::kInvertedEmpty: return true;
      case Type::kRRect: return true;
      case Type::kArc: return fArcData.fUseCenter;
  ...
  uint32_t segmentMask() const {
    switch (fType) {
      ...
      case Type::kRRect:
        if (fRRectData.fRRect.getType() == SkRRect::kOval_Type) {
          return SkPath::kConic_SegmentMask;
            ...
            fRRectData.fRRect.getType() == SkRRect::kRect_Type ||
      ...
      case Type::kArc:
        ...
        return SkPath::kConic_SegmentMask;
      case Type::kLine: return SkPath::kLine_SegmentMask;
      case Type::kPath: return this->path().getSegmentMasks();
    }
    return 0;
  }
