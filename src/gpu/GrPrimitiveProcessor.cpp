...
uint32_t GrPrimitiveProcessor::computeCoordTransformsKey(const GrFragmentProcessor& fp) const {
  ...
  switch (fp.sampleUsage().fKind) {
    case SkSL::SampleUsage::Kind::kNone: key |= kNone_SampleMatrix_Flag; break;
    case SkSL::SampleUsage::Kind::kUniform: key |= kUniform_SampleMatrix_Flag; break;
    case SkSL::SampleUsage::Kind::kVariable: key |= kVariable_SampleMatrix_Flag; break;
  }
