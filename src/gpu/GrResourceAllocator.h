...
class GrResourceAllocator {
 public:
  GrResourceAllocator(
      ...
      GrDeinstantiateProxyTracker* tracker SkDEBUGCODE(, int numOpLists))
      : fResourceProvider(resourceProvider),
        fDeinstantiateTracker(tracker) SkDEBUGCODE(, fNumOpLists(numOpLists)) {}
  ...
  void addInterval(
      GrSurfaceProxy*, unsigned int start, unsigned int end,
      ActualUse actualUse SkDEBUGCODE(, bool isDirectDstRead = false));

  enum class AssignError { kNoError, kFailedProxyInstantiation };
