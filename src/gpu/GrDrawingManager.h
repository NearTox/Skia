...
class GrDrawingManager {
 public:
  ...
  std::unique_ptr<GrTextureContext> makeTextureContext(
      sk_sp<GrSurfaceProxy>, GrColorType, SkAlphaType, sk_sp<SkColorSpace>);
  ...
  void newWaitRenderTask(
      sk_sp<GrSurfaceProxy> proxy, std::unique_ptr<sk_sp<GrSemaphore>[]>, int numSemaphores);
 ...
 private:
  ...
  GrDrawingManager(
      GrRecordingContext*, const GrPathRendererChain::Options&, const GrTextContext::Options&,
