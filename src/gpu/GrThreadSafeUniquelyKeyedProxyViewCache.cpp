...
GrThreadSafeUniquelyKeyedProxyViewCache::Entry* GrThreadSafeUniquelyKeyedProxyViewCache::getEntry(
...
GrSurfaceProxyView GrThreadSafeUniquelyKeyedProxyViewCache::add(
    const GrUniqueKey& key, const GrSurfaceProxyView& view) {
  SkAutoSpinlock lock{fSpinLock};
...
GrSurfaceProxyView GrThreadSafeUniquelyKeyedProxyViewCache::findOrAdd(
