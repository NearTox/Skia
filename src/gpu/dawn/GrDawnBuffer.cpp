...
dawn::BufferUsageBit GrGpuBufferTypeToDawnUsageBit(GrGpuBufferType type) {
  switch (type) {
    case GrGpuBufferType::kVertex: return dawn::BufferUsageBit::Vertex;
    case GrGpuBufferType::kIndex: return dawn::BufferUsageBit::Index;
    case GrGpuBufferType::kXferCpuToGpu: return dawn::BufferUsageBit::CopySrc;
    case GrGpuBufferType::kXferGpuToCpu: return dawn::BufferUsageBit::CopyDst;
    default: SkASSERT(!"buffer type not supported by Dawn"); return dawn::BufferUsageBit::Vertex;
  }
}
}  // namespace
...
GrDawnBuffer::GrDawnBuffer(
    ...
    : INHERITED(gpu, sizeInBytes, type, pattern), fData(nullptr) {
...
GrDawnBuffer::~GrDawnBuffer() { delete[] fData; }
