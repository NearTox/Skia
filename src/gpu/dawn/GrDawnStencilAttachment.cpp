...
GrDawnStencilAttachment::GrDawnStencilAttachment(
    GrDawnGpu* gpu, SkISize dimensions, int bits, int samples, wgpu::Texture texture,
    wgpu::TextureView view)
    : INHERITED(gpu, dimensions, bits, samples, GrProtected::kNo), fTexture(texture), fView(view) {
  this->registerWithCache(SkBudgeted::kYes);
}

GrDawnStencilAttachment* GrDawnStencilAttachment::Create(
...
void GrDawnStencilAttachment::onRelease() { GrStencilAttachment::onRelease(); }

void GrDawnStencilAttachment::onAbandon() { GrStencilAttachment::onAbandon(); }
