...
class GrDawnTexture : public GrTexture {
 public:
  static sk_sp<GrDawnTexture> Make(
      GrDawnGpu*, const SkISize& size, GrPixelConfig config, dawn::TextureFormat format,
      GrRenderable, int sampleCnt, SkBudgeted, int mipLevels, GrMipMapsStatus);

  static sk_sp<GrDawnTexture> MakeWrapped(
      GrDawnGpu*, const SkISize& size, GrPixelConfig config, GrRenderable, int sampleCnt,
 ...
 protected:
  GrDawnTexture(
      GrDawnGpu*, const SkISize& size, GrPixelConfig config, dawn::TextureView,
