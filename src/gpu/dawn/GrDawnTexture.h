...
class GrDawnTexture : public GrTexture {
 public:
  ...
  void upload(
      GrColorType, const GrMipLevel texels[], int mipLevels, wgpu::CommandEncoder copyEncoder);
  void upload(
      GrColorType, const GrMipLevel texels[], int mipLevels, const SkIRect& dstRect,
