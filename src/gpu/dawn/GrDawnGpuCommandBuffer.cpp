...
void GrDawnGpuTextureCommandBuffer::copy(
...
dawn::LoadOp to_dawn_load_op(GrLoadOp loadOp) {
  switch (loadOp) {
    ...
    default: SK_ABORT("Invalid LoadOp"); return dawn::LoadOp::Load;
  }
}
...
void GrDawnGpuRTCommandBuffer::transferFrom(
...
void GrDawnGpuRTCommandBuffer::inlineUpload(
    GrOpFlushState* state, GrDeferredTextureUploadFn& upload) {}

void GrDawnGpuRTCommandBuffer::copy(
    GrSurface* src, const SkIRect& srcRect, const SkIPoint& dstPoint) {}

////////////////////////////////////////////////////////////////////////////////

void GrDawnGpuRTCommandBuffer::bindGeometry(
    const GrBuffer* indexBuffer, const GrBuffer* vertexBuffer, const GrBuffer* instanceBuffer) {}

void GrDawnGpuRTCommandBuffer::onDraw(
...
void GrDawnGpuRTCommandBuffer::sendInstancedMeshToGpu(
...
void GrDawnGpuRTCommandBuffer::sendIndexedInstancedMeshToGpu(
