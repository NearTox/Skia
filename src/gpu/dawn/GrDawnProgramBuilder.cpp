...
static wgpu::BlendFactor to_dawn_blend_factor(GrBlendCoeff coeff) {
  switch (coeff) {
    case kZero_GrBlendCoeff: return wgpu::BlendFactor::Zero;
    case kOne_GrBlendCoeff: return wgpu::BlendFactor::One;
    case kSC_GrBlendCoeff: return wgpu::BlendFactor::Src;
    case kISC_GrBlendCoeff: return wgpu::BlendFactor::OneMinusSrc;
    case kDC_GrBlendCoeff: return wgpu::BlendFactor::Dst;
    case kIDC_GrBlendCoeff: return wgpu::BlendFactor::OneMinusDst;
    case kSA_GrBlendCoeff: return wgpu::BlendFactor::SrcAlpha;
    case kISA_GrBlendCoeff: return wgpu::BlendFactor::OneMinusSrcAlpha;
    case kDA_GrBlendCoeff: return wgpu::BlendFactor::DstAlpha;
    case kIDA_GrBlendCoeff: return wgpu::BlendFactor::OneMinusDstAlpha;
    case kConstC_GrBlendCoeff: return wgpu::BlendFactor::Constant;
    case kIConstC_GrBlendCoeff: return wgpu::BlendFactor::OneMinusConstant;
...
static wgpu::BlendFactor to_dawn_blend_factor_for_alpha(GrBlendCoeff coeff) {
  switch (coeff) {
    ...
    case kSC_GrBlendCoeff: return wgpu::BlendFactor::SrcAlpha;
    case kISC_GrBlendCoeff: return wgpu::BlendFactor::OneMinusSrcAlpha;
    case kDC_GrBlendCoeff: return wgpu::BlendFactor::DstAlpha;
    case kIDC_GrBlendCoeff: return wgpu::BlendFactor::OneMinusDstAlpha;
...
static wgpu::BlendOperation to_dawn_blend_operation(GrBlendEquation equation) {
  switch (equation) {
    case kAdd_GrBlendEquation: return wgpu::BlendOperation::Add;
    case kSubtract_GrBlendEquation: return wgpu::BlendOperation::Subtract;
    case kReverseSubtract_GrBlendEquation: return wgpu::BlendOperation::ReverseSubtract;
...
sk_sp<GrDawnProgram> GrDawnProgramBuilder::Build(
  ...
  colorTargetState.writeMask = writeColor ? wgpu::ColorWriteMask::All : wgpu::ColorWriteMask::None;
