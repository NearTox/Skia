...
void GrDawnOpsRenderPass::applyState(
    const GrProgramInfo& programInfo, const GrPrimitiveType primitiveType) {
  sk_sp<GrDawnProgram> program =
      fGpu->getOrCreateRenderPipeline(fRenderTarget, programInfo, primitiveType);
