...
static wgpu::LoadOp to_dawn_load_op(GrLoadOp loadOp) {
  switch (loadOp) {
    case GrLoadOp::kLoad: return wgpu::LoadOp::Load;
    ...
    case GrLoadOp::kClear: return wgpu::LoadOp::Clear;
...
void GrDawnOpsRenderPass::onClearStencilClip(
    const GrScissorState& scissor, bool insideStencilMask) {
...
void GrDawnOpsRenderPass::onEnd() { fPassEncoder.EndPass(); }
...
void GrDawnOpsRenderPass::onSetScissorRect(const SkIRect& scissor) {
  ...
  fPassEncoder.SetScissorRect(
      nativeScissorRect.fX, nativeScissorRect.fY, nativeScissorRect.fWidth,
      nativeScissorRect.fHeight);
}
...
void GrDawnOpsRenderPass::onDrawInstanced(
...
void GrDawnOpsRenderPass::onDrawIndexed(
...
void GrDawnOpsRenderPass::onDrawIndexedInstanced(
