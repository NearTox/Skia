...
bool GrPixelConfigToDawnFormat(GrPixelConfig config, wgpu::TextureFormat* format) {
  switch (config) {
    ...
    case kGray_8_GrPixelConfig: *format = wgpu::TextureFormat::RGBA8Unorm; return true;
    case kBGRA_8888_GrPixelConfig: *format = wgpu::TextureFormat::BGRA8Unorm; return true;
    case kAlpha_8_GrPixelConfig:
    case kAlpha_8_as_Red_GrPixelConfig: *format = wgpu::TextureFormat::R8Unorm; return true;
