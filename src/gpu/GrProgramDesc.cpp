...
static void add_fp_sampler_keys(
    GrProcessorKeyBuilder* b, const GrFragmentProcessor& fp, const GrCaps& caps) {
...
static void add_pp_sampler_keys(
    GrProcessorKeyBuilder* b, const GrPrimitiveProcessor& pp, const GrCaps& caps) {
 ...
 */
static bool gen_fp_meta_key(
    const GrFragmentProcessor& fp, const GrCaps& caps, uint32_t transformKey,
...
static bool gen_pp_meta_key(
    const GrPrimitiveProcessor& pp, const GrCaps& caps, uint32_t transformKey,
    GrProcessorKeyBuilder* b) {
  size_t processorKeySize = b->size();
...
static bool gen_frag_proc_and_meta_keys(
    const GrPrimitiveProcessor& primProc, const GrFragmentProcessor& fp, const GrCaps& caps,
    GrProcessorKeyBuilder* b) {
