...
static constexpr GrStencilTest gUserStencilTestToRaw[kGrUserStencilTestCount] = {
    ...
    GrStencilTest::kAlways, GrStencilTest::kNever, GrStencilTest::kGreater, GrStencilTest::kGEqual,
    GrStencilTest::kLess, GrStencilTest::kLEqual, GrStencilTest::kEqual, GrStencilTest::kNotEqual};
