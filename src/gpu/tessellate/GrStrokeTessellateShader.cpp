 ...
 private:
  void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
    ...
    if (!shader.viewMatrix().isIdentity()) {
      ...
      fAffineMatrixUniform = uniHandler->addUniform(
          nullptr, kTessEvaluation_GrShaderFlag, kFloat4_GrSLType, "affineMatrix", nullptr);
    }
  ...
  void setData(
    ...
    switch (shader.fStroke.getJoin()) {
      ...
      case SkPaint::kMiter_Join: numSegmentsInJoin = (shader.fStroke.getMiter() > 0) ? 2 : 1; break;
...
SkString GrStrokeTessellateShader::getTessControlShaderGLSL(
  ...
  code.appendf(
      "const float kMaxTessellationSegments = %i;\n", shaderCaps.maxTessellationSegments());
...
SkString GrStrokeTessellateShader::getTessEvaluationShaderGLSL(
  ...
  code.appendf(
      "#define MAX_TESSELLATION_SEGMENTS_LOG2 %i\n",
