...
class GrStrokeTessellateShader::Impl : public GrGLSLGeometryProcessor {
 ...
 private:
  void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
    ...
    fTessControlArgsUniform = uniHandler->addUniform(
        nullptr, kTessControl_GrShaderFlag | kTessEvaluation_GrShaderFlag, kFloat4_GrSLType,
        "tessControlArgs", nullptr);
    if (!shader.viewMatrix().isIdentity()) {
      ...
      fAffineMatrixUniform = uniHandler->addUniform(
          nullptr, kTessEvaluation_GrShaderFlag, kFloat2x2_GrSLType, "affineMatrix", nullptr);
    }
