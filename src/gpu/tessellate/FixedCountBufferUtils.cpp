...
void write_curve_index_buffer_base_index(
    VertexWriter vertexWriter, size_t bufferSize, uint16_t baseIndex) {
...
void FixedCountWedges::WriteIndexBuffer(VertexWriter vertexWriter, size_t bufferSize) {
  ...
  write_curve_index_buffer_base_index(
      std::move(vertexWriter), bufferSize - sizeof(uint16_t) * 3,
      /*baseIndex=*/1);
}
