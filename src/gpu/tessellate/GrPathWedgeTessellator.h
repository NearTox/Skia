...
class GrPathWedgeTessellator : public GrPathTessellator {
 public:
  ...
  static GrPathTessellator* Make(
      SkArenaAlloc*, const SkMatrix& viewMatrix, const SkPMColor4f&, int numPathVerbs,
 ...
 private:
  GrPathWedgeTessellator(GrPathTessellationShader* shader) : GrPathTessellator(shader) {}
