...
class GrStencilPathShader : public GrPathShader {
 ...
 protected:
  constexpr static Attribute kSinglePointAttrib{
...
class GrStencilTriangleShader : public GrStencilPathShader {
 public:
  GrStencilTriangleShader(const SkMatrix& viewMatrix)
      : GrStencilPathShader(
...
class GrTessellateCubicShader : public GrStencilPathShader {
 public:
  GrTessellateCubicShader(const SkMatrix& viewMatrix)
      : GrStencilPathShader(
            kTessellate_GrTessellateCubicShader_ClassID, viewMatrix, GrPrimitiveType::kPatches, 4) {
    this->setVertexAttributes(&kSinglePointAttrib, 1);
  }
  const char* name() const noexcept override { return "tessellate_GrTessellateCubicShader"; }
...
class GrTessellateWedgeShader : public GrStencilPathShader {
 public:
  ...
  const char* name() const noexcept override { return "tessellate_GrTessellateWedgeShader"; }
...
class GrMiddleOutCubicShader : public GrStencilPathShader {
 public:
  ...
  static GrDrawIndexedIndirectCommand MakeDrawCubicsIndirectCmd(
      int resolveLevel, uint32_t instanceCount, uint32_t baseInstance) {
  ...
  static GrDrawIndexedIndirectCommand MakeDrawTrianglesIndirectCmd(
  ...
  GrMiddleOutCubicShader(const SkMatrix& viewMatrix)
      : GrStencilPathShader(
            kTessellate_GrMiddleOutCubicShader_ClassID, viewMatrix, GrPrimitiveType::kTriangles) {
