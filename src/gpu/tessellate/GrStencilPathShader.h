...
class GrStencilPathShader : public GrPathShader {
 public:
  GrStencilPathShader(
      ...
      int tessellationPatchVertexCount = 0) noexcept
 ...
 private:
  void getGLSLProcessorKey(const GrShaderCaps&, GrProcessorKeyBuilder* b) const noexcept final {
...
class GrStencilTriangleShader : public GrStencilPathShader {
 public:
  GrStencilTriangleShader(const SkMatrix& viewMatrix) noexcept
      : GrStencilPathShader(
...
class GrStencilCubicShader : public GrStencilPathShader {
 public:
  GrStencilCubicShader(const SkMatrix& viewMatrix) noexcept
      : GrStencilPathShader(
            kTessellate_GrStencilCubicShader_ClassID, viewMatrix, GrPrimitiveType::kPatches, 4) {}
  const char* name() const noexcept override { return "tessellate_GrStencilCubicShader"; }
...
class GrStencilWedgeShader : public GrStencilPathShader {
 public:
  GrStencilWedgeShader(const SkMatrix& viewMatrix) noexcept
      : GrStencilPathShader(
            kTessellate_GrStencilWedgeShader_ClassID, viewMatrix, GrPrimitiveType::kPatches, 5) {}
  const char* name() const noexcept override { return "tessellate_GrStencilWedgeShader"; }
