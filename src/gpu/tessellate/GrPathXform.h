...
class GrPathXform {
 ...
 public:
  ...
  SK_ALWAYS_INLINE void mapLineToCubic(
      GrVertexWriter* writer, SkPoint startPt, SkPoint endPt) const {
  ...
  SK_ALWAYS_INLINE void mapConicToPatch(
      GrVertexWriter* writer, const SkPoint pts[3], float w) const {
