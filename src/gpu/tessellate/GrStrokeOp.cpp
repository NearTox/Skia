...
void GrStrokeOp::prePrepareColorProgram(
    SkArenaAlloc* arena, GrStrokeTessellateShader* strokeTessellateShader,
  ...
  fColorProgram = GrPathShader::MakeProgramInfo(
      strokeTessellateShader, arena, writeView, pipelineFlags, std::move(fProcessors),
      std::move(clip), dstProxyView, renderPassXferBarriers, &GrUserStencilSettings::kUnused, caps);
}
