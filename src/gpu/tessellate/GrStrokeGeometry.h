...
class GrStrokeGeometry {
 public:
  ...
  GrStrokeGeometry(int numSkPoints = 0, int numSkVerbs = 0) noexcept
 ...
 private:
  ...
  void cubicTo(
      Verb leftJoinVerb, const SkPoint[4], float maxCurvatureT, float leftMaxCurvatureT,
...
inline bool GrStrokeGeometry::IsInternalJoinVerb(Verb verb) noexcept {
  switch (verb) {
