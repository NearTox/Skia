...
class GrTessellatePathOp : public GrDrawOp {
 private:
  ...
  const char* name() const noexcept override { return "GrTessellatePathOp"; }
  ...
  // other cubic draws.
  void prepareMiddleOutTrianglesAndCubics(
      GrMeshDrawOp::Target*, GrResolveLevelCounter* = nullptr,
  ...
  void prepareIndirectOuterCubicsAndTriangles(
      GrMeshDrawOp::Target*, const GrResolveLevelCounter&, SkPoint* cubicData,
