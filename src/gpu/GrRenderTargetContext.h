...
class SK_API GrRenderTargetContext : public GrSurfaceContext {
 public:
  ...
  void fillRectWithLocalMatrix(
      const GrClip& clip, GrPaint&& paint, GrAA, const SkMatrix& viewMatrix, const SkRect& rect,
   ...
   */
  void drawTexture(
      const GrClip& clip, sk_sp<GrTextureProxy>, GrSamplerState::Filter, SkBlendMode mode,
      const SkPMColor4f&, const SkRect& srcRect, const SkRect& dstRect, GrAA, GrQuadAAFlags,
  ...
  void drawTextureQuad(
      const GrClip& clip, sk_sp<GrTextureProxy>, GrSamplerState::Filter, SkBlendMode mode,
      const SkPMColor4f&, const SkPoint srcQuad[4], const SkPoint dstQuad[4], GrAA, GrQuadAAFlags,
  ...
  void asyncReadPixels(
      const SkImageInfo& info, int x, int y, ReadPixelsCallback callback,
 ...
 protected:
  ...
  sk_sp<GrRenderTargetContext> rescale(
      const SkImageInfo& info, const SkIRect& srcRect, SkSurface::RescaleGamma rescaleGamma,
