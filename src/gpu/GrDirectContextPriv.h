...
class GrDirectContextPriv : public GrRecordingContextPriv {
 public:
  ...
  GrSemaphoresSubmitted flushSurfaces(
      ...
      const GrFlushInfo& = {}, const GrBackendSurfaceMutableState* newState = nullptr);
  ...
  GrAtlasManager* getAtlasManager() { return this->context()->onGetAtlasManager(); }

  // This accessor should only ever be called by the GrOpFlushState.
  GrSmallPathAtlasMgr* getSmallPathAtlasMgr() { return this->context()->onGetSmallPathAtlasMgr(); }
 ...
 private:
  explicit GrDirectContextPriv(GrDirectContext* dContext) noexcept
      : GrRecordingContextPriv(dContext) {}
...
inline GrDirectContextPriv GrDirectContext::priv() noexcept { return GrDirectContextPriv(this); }

// NOLINTNEXTLINE(readability-const-return-type)
inline const GrDirectContextPriv GrDirectContext::priv() const noexcept {
