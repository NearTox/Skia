...
std::unique_ptr<GrMtlSemaphore> GrMtlSemaphore::MakeWrapped(GrMTLHandle event, uint64_t value) {
...
GrMtlSemaphore::GrMtlSemaphore(id<MTLEvent> event, uint64_t value) : fEvent(event), fValue(value) {}
