...
class GrMtlRenderCommandEncoder {
 public:
  ...
  void setViewport(const MTLViewport& viewport) { [fCommandEncoder setViewport:viewport]; }
  ...
  void setVertexBuffer(id<MTLBuffer> buffer, NSUInteger offset, NSUInteger index) {
    ...
    if (fCurrentVertexBuffer[index] != buffer || fCurrentVertexOffset[index] != offset) {
      [fCommandEncoder setVertexBuffer:buffer offset:offset atIndex:index];
  ...
  void setFragmentBuffer(id<MTLBuffer> buffer, NSUInteger offset, NSUInteger index) {
    ...
    if (fCurrentFragmentBuffer[index] != buffer || fCurrentFragmentOffset[index] != offset) {
      [fCommandEncoder setFragmentBuffer:buffer offset:offset atIndex:index];
  ...
  void setFragmentBufferOffset(NSUInteger offset, NSUInteger index)
    ...
    if (fCurrentFragmentOffset[index] != offset) {
      [fCommandEncoder setFragmentBufferOffset:offset atIndex:index];
      fCurrentFragmentOffset[index] = offset;
    }
  }
  ...
  void setVertexBytes(const void* bytes, NSUInteger length, NSUInteger index)
      SK_API_AVAILABLE(macos(10.11), ios(8.3)) {
    [fCommandEncoder setVertexBytes:bytes length:length atIndex:index];
  }
  void setFragmentBytes(const void* bytes, NSUInteger length, NSUInteger index)
      SK_API_AVAILABLE(macos(10.11), ios(8.3)) {
    [fCommandEncoder setFragmentBytes:bytes length:length atIndex:index];
  }

  void setFragmentTexture(id<MTLTexture> texture, NSUInteger index) {
    SkASSERT(index < 16);
    if (fCurrentTexture[index] != texture) {
      [fCommandEncoder setFragmentTexture:texture atIndex:index];
  ...
  void setFragmentSamplerState(GrMtlSampler* sampler, NSUInteger index) {
    if (fCurrentSampler[index] != sampler) {
      [fCommandEncoder setFragmentSamplerState:sampler->mtlSampler() atIndex:index];
  ...
  void setStencilFrontBackReferenceValues(uint32_t frontReferenceValue, uint32_t backReferenceValue)
      SK_API_AVAILABLE(macos(10.11), ios(9.0)) {
    [fCommandEncoder setStencilFrontReferenceValue:frontReferenceValue
  ...
  void setScissorRect(const MTLScissorRect& scissorRect) {
    if (fCurrentScissorRect.x != scissorRect.x || fCurrentScissorRect.y != scissorRect.y ||
  ...
  void drawPrimitives(
      MTLPrimitiveType primitiveType, NSUInteger vertexStart, NSUInteger vertexCount) {
    [fCommandEncoder drawPrimitives:primitiveType vertexStart:vertexStart vertexCount:vertexCount];
  }
  void drawPrimitives(
      MTLPrimitiveType primitiveType, NSUInteger vertexStart, NSUInteger vertexCount,
      NSUInteger instanceCount, NSUInteger baseInstance) SK_API_AVAILABLE(macos(10.11), ios(9.0)) {
  ...
  void drawPrimitives(
      MTLPrimitiveType primitiveType, id<MTLBuffer> indirectBuffer, NSUInteger indirectBufferOffset)
      SK_API_AVAILABLE(macos(10.11), ios(9.0)) {
    [fCommandEncoder drawPrimitives:primitiveType
  ...
  void drawIndexedPrimitives(
      MTLPrimitiveType primitiveType, NSUInteger indexCount, MTLIndexType indexType,
      id<MTLBuffer> indexBuffer, NSUInteger indexBufferOffset) {
  ...
  void drawIndexedPrimitives(
      MTLPrimitiveType primitiveType, NSUInteger indexCount, MTLIndexType indexType,
      id<MTLBuffer> indexBuffer, NSUInteger indexBufferOffset, NSUInteger instanceCount,
      NSInteger baseVertex, NSUInteger baseInstance) SK_API_AVAILABLE(macos(10.11), ios(9.0)) {
    [fCommandEncoder drawIndexedPrimitives:primitiveType
                                indexCount:indexCount
                                 indexType:indexType
                               indexBuffer:indexBuffer
  ...
  void drawIndexedPrimitives(
      MTLPrimitiveType primitiveType, MTLIndexType indexType, id<MTLBuffer> indexBuffer,
      NSUInteger indexBufferOffset, id<MTLBuffer> indirectBuffer, NSUInteger indirectBufferOffset)
      SK_API_AVAILABLE(macos(10.11), ios(9.0)) {
    [fCommandEncoder drawIndexedPrimitives:primitiveType
                                 indexType:indexType
                               indexBuffer:indexBuffer
 ...
 private:
  GrMtlRenderCommandEncoder(id<MTLRenderCommandEncoder> encoder) : fCommandEncoder(encoder) {}
