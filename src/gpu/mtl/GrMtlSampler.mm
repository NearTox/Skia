...
static inline MTLSamplerAddressMode wrap_mode_to_mtl_sampler_address(
  ...
  switch (wrapMode) {
    case GrSamplerState::WrapMode::kClamp: return MTLSamplerAddressModeClampToEdge;
    case GrSamplerState::WrapMode::kRepeat: return MTLSamplerAddressModeRepeat;
    case GrSamplerState::WrapMode::kMirrorRepeat: return MTLSamplerAddressModeMirrorRepeat;
...
GrMtlSampler* GrMtlSampler::Create(
    const GrMtlGpu* gpu, const GrSamplerState& samplerState, uint32_t maxMipLevel) {
  static MTLSamplerMinMagFilter mtlMinMagFilterModes[] = {
      MTLSamplerMinMagFilterNearest, MTLSamplerMinMagFilterLinear, MTLSamplerMinMagFilterLinear};
  ...
  samplerDesc.sAddressMode =
      wrap_mode_to_mtl_sampler_address(samplerState.wrapModeX(), gpu->mtlCaps());
  samplerDesc.tAddressMode =
      wrap_mode_to_mtl_sampler_address(samplerState.wrapModeY(), gpu->mtlCaps());
  ...
  return new GrMtlSampler(
      [gpu->device() newSamplerStateWithDescriptor:samplerDesc],
      GenerateKey(samplerState, maxMipLevel));
}

GrMtlSampler::Key GrMtlSampler::GenerateKey(
    const GrSamplerState& samplerState, uint32_t maxMipLevel) {
