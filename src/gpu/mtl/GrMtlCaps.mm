...
void GrMtlCaps::onDumpJSON(SkJSONWriter* writer) const {
  ...
  switch (fPlatform) {
    case Platform::kMac: writer->appendString("Platform", "Mac"); break;
    case Platform::kIOS: writer->appendString("Platform", "iOS"); break;
    default: writer->appendString("Platform", "unknown"); break;
  }
