...
GrMtlCaps::GrMtlCaps(
    const GrContextOptions& contextOptions, const id<MTLDevice> device, MTLFeatureSet featureSet)
...
bool GrMtlCaps::canCopyAsBlit(
    GrPixelConfig dstConfig, int dstSampleCount, GrPixelConfig srcConfig, int srcSampleCount,
...
int GrMtlCaps::maxRenderTargetSampleCount(
    GrColorType grColorType, const GrBackendFormat& format) const {
  if (!format.getMtlFormat()) {
    return 0;
  }
...
int GrMtlCaps::getRenderTargetSampleCount(
    int requestedCount, GrColorType grColorType, const GrBackendFormat& format) const {
  if (!format.getMtlFormat()) {
    return 0;
  }
...
size_t GrMtlCaps::GetFormatIndex(MTLPixelFormat pixelFormat) {
  static_assert(
      SK_ARRAY_COUNT(kMtlFormats) == GrMtlCaps::kNumMtlFormats,
...
GrPixelConfig validate_sized_format(GrMTLPixelFormat grFormat, GrColorType ct) {
  ...
  switch (ct) {
    ...
    case GrColorType::kABGR_4444: return kUnknown_GrPixelConfig; break;
#else
    case GrColorType::kBGR_565:
...
GrPixelConfig GrMtlCaps::validateBackendRenderTarget(
...
GrPixelConfig GrMtlCaps::onGetConfigFromBackendFormat(
...
static GrPixelConfig get_yuva_config(GrMTLPixelFormat grFormat) {
  ...
  switch (format) {
    case MTLPixelFormatA8Unorm: return kAlpha_8_as_Alpha_GrPixelConfig; break;
    case MTLPixelFormatR8Unorm: return kAlpha_8_as_Red_GrPixelConfig; break;
    case MTLPixelFormatRG8Unorm: return kRG_88_GrPixelConfig; break;
    case MTLPixelFormatRGBA8Unorm: return kRGBA_8888_GrPixelConfig; break;
    case MTLPixelFormatBGRA8Unorm: return kBGRA_8888_GrPixelConfig; break;
    case MTLPixelFormatRGB10A2Unorm: return kRGBA_1010102_GrPixelConfig; break;
    case MTLPixelFormatR16Unorm: return kR_16_GrPixelConfig; break;
    case MTLPixelFormatRG16Unorm: return kRG_1616_GrPixelConfig; break;
    // Experimental (for Y416 and mutant P016/P010)
    case MTLPixelFormatRGBA16Unorm: return kRGBA_16161616_GrPixelConfig; break;
    case MTLPixelFormatRG16Float: return kRG_half_GrPixelConfig; break;
    default: return kUnknown_GrPixelConfig; break;
  }
}
...
#  endif
    case GrColorType::kRGBA_8888: return MTLPixelFormatRGBA8Unorm == format;
    case GrColorType::kRGBA_8888_SRGB: return MTLPixelFormatRGBA8Unorm_sRGB == format;
    case GrColorType::kRGB_888x:
      GR_STATIC_ASSERT(
...
#  endif
    case GrColorType::kRG_88: return MTLPixelFormatRG8Unorm == format;
    case GrColorType::kBGRA_8888:
      return MTLPixelFormatBGRA8Unorm == format || MTLPixelFormatBGRA8Unorm_sRGB == format;
    case GrColorType::kRGBA_1010102: return MTLPixelFormatRGB10A2Unorm == format;
    case GrColorType::kGray_8: return MTLPixelFormatR8Unorm == format;
    case GrColorType::kAlpha_F16: return MTLPixelFormatR16Float == format;
    case GrColorType::kRGBA_F16: return MTLPixelFormatRGBA16Float == format;
    case GrColorType::kRGBA_F16_Clamped: return MTLPixelFormatRGBA16Float == format;
    case GrColorType::kRGBA_F32: return MTLPixelFormatRGBA32Float == format;
    case GrColorType::kR_16: return MTLPixelFormatR16Unorm == format;
    case GrColorType::kRG_1616: return MTLPixelFormatRG16Unorm == format;
    // Experimental (for Y416 and mutant P016/P010)
    case GrColorType::kRGBA_16161616: return MTLPixelFormatRGBA16Unorm == format;
    case GrColorType::kRG_F16: return MTLPixelFormatRG16Float == format;
  }
...
static GrSwizzle get_swizzle(const GrBackendFormat& format, GrColorType colorType, bool forOutput) {
  ...
  switch (colorType) {
    ...
    case GrColorType::kGray_8:
      ...
      break;
    case GrColorType::kRGB_888x: return GrSwizzle::RGB1();
...
GrCaps::SupportedRead GrMtlCaps::supportedReadPixelsColorType(
  ...
  switch (*grMtlFormat) {
    case MTLPixelFormatRGBA8Unorm: return {GrSwizzle::RGBA(), GrColorType::kRGBA_8888};
    ...
    case MTLPixelFormatBGRA8Unorm: return {GrSwizzle::RGBA(), GrColorType::kBGRA_8888};
#ifdef SK_BIULD_FOR_IOS
    case MTLPixelFormatB5G6R5Unorm: return {GrSwizzle::RGBA(), GrColorType::kBGR_565};
#endif
    ...
    case MTLPixelFormatR16Float: return {GrSwizzle::RGBA(), GrColorType::kAlpha_F16};
    case MTLPixelFormatRG8Unorm: return {GrSwizzle::RGBA(), GrColorType::kRG_88};
    case MTLPixelFormatRGB10A2Unorm: return {GrSwizzle::RGBA(), GrColorType::kRGBA_1010102};
#ifdef SK_BIULD_FOR_IOS
    case MTLPixelFormatABGR4Unorm: return {GrSwizzle::RGBA(), GrColorType::kABGR_4444};
#endif
    case MTLPixelFormatRGBA32Float: return {GrSwizzle::RGBA(), GrColorType::kRGBA_F32};
    case MTLPixelFormatRGBA8Unorm_sRGB: return {GrSwizzle::RGBA(), GrColorType::kRGBA_8888_SRGB};
    case MTLPixelFormatR16Unorm: return {GrSwizzle::RGBA(), GrColorType::kR_16};
    case MTLPixelFormatRG16Unorm: return {GrSwizzle::RGBA(), GrColorType::kRG_1616};
    // Experimental (for Y416 and mutant P016/P010)
    case MTLPixelFormatRGBA16Unorm: return {GrSwizzle::RGBA(), GrColorType::kRGBA_16161616};
    case MTLPixelFormatRG16Float: return {GrSwizzle::RGBA(), GrColorType::kRG_F16};
