...
GrMtlPipelineState* GrMtlPipelineStateBuilder::CreatePipelineState(
    GrMtlGpu* gpu, GrRenderTarget* renderTarget, const GrProgramInfo& programInfo, Desc* desc) {
...
GrMtlPipelineState* GrMtlPipelineStateBuilder::finalize(
    GrRenderTarget* renderTarget, const GrProgramInfo& programInfo, Desc* desc) {
  ...
  pipelineDescriptor.colorAttachments[0] =
      create_color_attachment(renderTarget->config(), programInfo.pipeline());
...
bool GrMtlPipelineStateBuilder::Desc::Build(
    Desc* desc, GrRenderTarget* renderTarget, const GrProgramInfo& programInfo,
    GrPrimitiveType primitiveType, GrMtlGpu* gpu) {
