...
class GrMtlPipelineStateBuilder : public GrGLSLProgramBuilder {
 public:
  ...
  static GrMtlPipelineState* CreatePipelineState(
      GrMtlGpu*, const GrProgramDesc&, const GrProgramInfo&,
      const GrMtlPrecompiledLibraries* precompiledLibs = nullptr);

  static bool PrecompileShaders(
      GrMtlGpu*, const SkData&, GrMtlPrecompiledLibraries* precompiledLibs);
 ...
 private:
  ...
  void storeShadersInCache(
      const SkSL::String shaders[], const SkSL::Program::Inputs inputs[], SkSL::Program::Settings*,
      sk_sp<SkData>, bool isSkSL);
