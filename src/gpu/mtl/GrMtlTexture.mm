...
sk_sp<GrMtlTexture> GrMtlTexture::MakeNewTexture(
    GrMtlGpu* gpu, SkBudgeted budgeted, const GrSurfaceDesc& desc, MTLTextureDescriptor* texDesc,
    GrMipMapsStatus mipMapsStatus) {
...
sk_sp<GrMtlTexture> GrMtlTexture::MakeWrappedTexture(
  ...
  return sk_sp<GrMtlTexture>(
      new GrMtlTexture(gpu, kWrapped, desc, texture, mipMapsStatus, cacheable, ioType));
}
