...
static inline uint32_t grsltype_to_mtl_size(GrSLType type) {
  switch (type) {
    ...
    case kByte3_GrSLType: return 4 * sizeof(int8_t);
    ...
    case kUByte3_GrSLType: return 4 * sizeof(uint8_t);
    ...
    case kShort3_GrSLType: return 4 * sizeof(int16_t);
...
static void get_ubo_aligned_offset(
    uint32_t* uniformOffset, uint32_t* currentOffset, uint32_t* maxAlignment, GrSLType type,
    int arrayCount) {
