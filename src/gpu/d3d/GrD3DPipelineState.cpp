...
void GrD3DPipelineState::bindBuffers(
    GrD3DGpu* gpu, sk_sp<const GrBuffer> indexBuffer, sk_sp<const GrBuffer> instanceBuffer,
  ...
  commandList->setVertexBuffers(
      0, std::move(vertexBuffer), fVertexStride, std::move(instanceBuffer), fInstanceStride);
