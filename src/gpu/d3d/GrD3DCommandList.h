...
class GrD3DCommandList {
 public:
  ...
  void copyBufferToTexture(
      const GrD3DBuffer* srcBuffer, const GrD3DTextureResource* dstTexture,
      uint32_t subresourceCount, D3D12_PLACED_SUBRESOURCE_FOOTPRINT* bufferFootprints, int left,
      int top);
