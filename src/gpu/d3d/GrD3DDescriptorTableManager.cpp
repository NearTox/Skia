...
GrD3DDescriptorTableManager::createShaderOrConstantResourceTable(GrD3DGpu* gpu, unsigned int size) {
...
std::unique_ptr<GrD3DDescriptorTable> GrD3DDescriptorTableManager::Heap::allocateTable(
  ...
  return std::unique_ptr<GrD3DDescriptorTable>(new GrD3DDescriptorTable(
