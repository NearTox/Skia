...
static constexpr DXGI_FORMAT kDxgiFormats[] = {
    ...
    DXGI_FORMAT_B8G8R8A8_UNORM,      DXGI_FORMAT_B5G6R5_UNORM,
    DXGI_FORMAT_R16G16B16A16_FLOAT,  DXGI_FORMAT_R16_FLOAT,
    DXGI_FORMAT_R8G8_UNORM,          DXGI_FORMAT_R10G10B10A2_UNORM,
    DXGI_FORMAT_B4G4R4A4_UNORM,      DXGI_FORMAT_R32G32B32A32_FLOAT,
    DXGI_FORMAT_R8G8B8A8_UNORM_SRGB, DXGI_FORMAT_BC1_UNORM,
...
GrColorType GrD3DCaps::getYUVAColorTypeFromBackendFormat(
  ...
  switch (dxgiFormat) {
    case DXGI_FORMAT_R8_UNORM: return isAlphaChannel ? GrColorType::kAlpha_8 : GrColorType::kGray_8;
