...
class GrD3DPipelineStateBuilder : public GrGLSLProgramBuilder {
 public:
   ...
   */
  static sk_sp<GrD3DPipelineState> MakePipelineState(
      GrD3DGpu*, GrRenderTarget*, const GrProgramDesc&, const GrProgramInfo&);
 ...
 private:
  GrD3DPipelineStateBuilder(GrD3DGpu*, GrRenderTarget*, const GrProgramDesc&, const GrProgramInfo&);
