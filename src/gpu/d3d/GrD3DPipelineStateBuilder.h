...
class GrD3DPipelineStateBuilder : public GrGLSLProgramBuilder {
 public:
   ...
   */
  static std::unique_ptr<GrD3DPipelineState> MakePipelineState(
      GrD3DGpu*, GrD3DRenderTarget*, const GrProgramDesc&, const GrProgramInfo&);

  static sk_sp<GrD3DPipeline> MakeComputePipeline(
      GrD3DGpu*, GrD3DRootSignature*, const char* shader);
 ...
 private:
  ...
  gr_cp<ID3DBlob> compileD3DProgram(
