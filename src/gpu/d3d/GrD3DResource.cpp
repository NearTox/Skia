...
void GrD3DResource::setResourceState(const GrD3DGpu* gpu, D3D12_RESOURCE_STATES newResourceState) {
...
ID3D12Resource* GrD3DResource::CreateResource(
    GrD3DGpu* gpu, const D3D12_RESOURCE_DESC& desc, D3D12_RESOURCE_STATES resourceState) {
  ...
  SkDEBUGCODE(HRESULT hr =) gpu->device()->CreateCommittedResource(
      &heapProperties, D3D12_HEAP_FLAG_NONE, &desc, resourceState, nullptr,
