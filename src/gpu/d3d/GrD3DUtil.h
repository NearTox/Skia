...
static constexpr GrColorFormatDesc GrDxgiFormatDesc(DXGI_FORMAT format) {
  switch (format) {
    ...
    case DXGI_FORMAT_R8_UNORM: return GrColorFormatDesc::MakeR(8, GrColorTypeEncoding::kUnorm);
    ...
    case DXGI_FORMAT_R16_FLOAT: return GrColorFormatDesc::MakeR(16, GrColorTypeEncoding::kFloat);
    case DXGI_FORMAT_R8G8_UNORM: return GrColorFormatDesc::MakeRG(8, GrColorTypeEncoding::kUnorm);
    ...
    case DXGI_FORMAT_R16_UNORM: return GrColorFormatDesc::MakeR(16, GrColorTypeEncoding::kUnorm);
