...
GrD3DTextureRenderTarget::GrD3DTextureRenderTarget(
    ...
    : GrSurface(gpu, dimensions, info.fProtected),
      ...
      GrD3DRenderTarget(gpu, dimensions, sampleCnt, info, state, msaaInfo, std::move(msaaState)) {
...
GrD3DTextureRenderTarget::GrD3DTextureRenderTarget(
    ...
    sk_sp<GrD3DResourceState> msaaState, GrMipMapsStatus mipMapsStatus, GrWrapCacheable cacheable)
    : GrSurface(gpu, dimensions, info.fProtected),
      GrD3DTextureResource(info, state),
      GrD3DTexture(gpu, dimensions, info, state, mipMapsStatus),
      GrD3DRenderTarget(gpu, dimensions, sampleCnt, info, state, msaaInfo, std::move(msaaState)) {
...
GrD3DTextureRenderTarget::GrD3DTextureRenderTarget(
    ...
    sk_sp<GrD3DResourceState> state, GrMipMapsStatus mipMapsStatus, GrWrapCacheable cacheable)
    : GrSurface(gpu, dimensions, info.fProtected),
      GrD3DTextureResource(info, state),
      GrD3DTexture(gpu, dimensions, info, state, mipMapsStatus),
      GrD3DRenderTarget(gpu, dimensions, info, state) {
...
static std::pair<GrD3DTextureResourceInfo, sk_sp<GrD3DResourceState>> create_msaa_resource(
  ...
  if (!GrD3DTextureResource::InitTextureResourceInfo(
          gpu, msTextureDesc, info.fProtected, &msInfo)) {
    return {};
  }
