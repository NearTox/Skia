...
class GrShaderVar {
 public:
   ...
   */
  void set(
      GrSLType type, const SkString& name, TypeModifier typeModifier = kNone_TypeModifier,
      const char* layoutQualifier = nullptr, const char* extraModifiers = nullptr,
   ...
   */
  void set(
      GrSLType type, const char* name, TypeModifier typeModifier = kNone_TypeModifier,
      const char* layoutQualifier = nullptr, const char* extraModifiers = nullptr,
      bool useUniformFloatArrays = USE_UNIFORM_FLOAT_ARRAYS) {
    SkASSERT(kVoid_GrSLType != type);
    fType = type;
   ...
   */
  void set(
      GrSLType type, const SkString& name, int count, TypeModifier typeModifier,
      const char* layoutQualifier = nullptr, const char* extraModifiers = nullptr,
      bool useUniformFloatArrays = USE_UNIFORM_FLOAT_ARRAYS) {
    SkASSERT(kVoid_GrSLType != type);
    fType = type;
   ...
   */
  void set(
      GrSLType type, const char* name, int count, TypeModifier typeModifier,
      const char* layoutQualifier = nullptr, const char* extraModifiers = nullptr,
      bool useUniformFloatArrays = USE_UNIFORM_FLOAT_ARRAYS) {
    SkASSERT(kVoid_GrSLType != type);
    fType = type;
