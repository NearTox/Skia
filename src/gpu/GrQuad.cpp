...
static void map_quad_general(const V4f& qx, const V4f& qy, const SkMatrix& m, V4f* xs, V4f* ys,
                             V4f* ws) {
...
static void map_rect_general(const SkRect& rect, const SkMatrix& matrix, V4f* xs, V4f* ys,
                             V4f* ws) {
...
void GrResolveAATypeForQuad(GrAAType requestedAAType, GrQuadAAFlags requestedEdgeFlags,
                            const Q& quad, GrQuadType knownType, GrAAType* outAAType,
...
template void GrResolveAATypeForQuad(GrAAType, GrQuadAAFlags, const GrQuad&, GrQuadType, GrAAType*,
                                     GrQuadAAFlags*);
