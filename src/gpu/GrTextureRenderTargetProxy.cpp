...
GrTextureRenderTargetProxy::GrTextureRenderTargetProxy(
    ...
    : GrSurfaceProxy(
      ...
      ,
      GrRenderTargetProxy(
          LazyInstantiateCallback(), lazyType, format, desc, origin, fit, budgeted, surfaceFlags,
          WrapsVkSecondaryCB::kNo),
      GrTextureProxy(
          LazyInstantiateCallback(), lazyType, format, desc, origin, mipMapped, fit, budgeted,
          surfaceFlags) {}
...
// GrRenderTargetProxy) so its constructor must be explicitly called.
GrTextureRenderTargetProxy::GrTextureRenderTargetProxy(
    sk_sp<GrSurface> surf, GrSurfaceOrigin origin)
...
bool GrTextureRenderTargetProxy::instantiate(GrResourceProvider* resourceProvider) {
  ...
  if (!this->instantiateImpl(
          resourceProvider, this->numStencilSamples(), this->needsStencil(), kDescFlags,
