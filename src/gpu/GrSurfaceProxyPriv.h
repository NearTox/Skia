...
public:
    ...
    bool ignoredByResourceAllocator() const noexcept {
        return fProxy->ignoredByResourceAllocator();
    }
...
private:
    ...
    GrSurfaceProxyPriv& operator=(const GrSurfaceProxyPriv&) noexcept;  // unimpl
