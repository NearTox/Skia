...
DrawableOp::DrawableOp(std::unique_ptr<SkDrawable::GpuDrawHandler> drawable, const SkRect& bounds)
    : GrOp(ClassID()), fDrawable(std::move(drawable)) {
