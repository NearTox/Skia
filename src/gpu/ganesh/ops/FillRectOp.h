...
class FillRectOp {
 public:
  ...
  static GrOp::Owner Make(
      GrRecordingContext*, GrPaint&&, GrAAType, DrawQuad*, const GrUserStencilSettings* = nullptr,
  ...
  static GrOp::Owner MakeNonAARect(
      GrRecordingContext*, GrPaint&&, const SkMatrix& view, const SkRect&,
      const GrUserStencilSettings* = nullptr);

  // Bulk API for drawing quads with a single op
  // TODO(michaelludwig) - remove if the bulk API is not useful for SkiaRenderer
  static void AddFillRectOps(
      SurfaceDrawContext*, const GrClip*, GrRecordingContext*, GrPaint&&, GrAAType,
      const SkMatrix& viewMatrix, const GrQuadSetEntry quads[], int quadCount,
      const GrUserStencilSettings* = nullptr);
 ...
 private:
  ...
  static GrOp::Owner MakeOp(
      ...
      const GrQuadSetEntry quads[], int quadCount, const GrUserStencilSettings*, int* numConsumed);
};
