 ...
 public:
  ...
  struct Geometry {
    Geometry(
        ...
        SkIRect clipRect, sk_sp<SkRefCnt>&& supportData, const SkPMColor4f& color) noexcept
        : fSubRun{subRun},
    ...
    static Geometry* Make(
        const sktext::gpu::AtlasSubRun& subRun, const SkMatrix& drawMatrix, SkPoint drawOrigin,
        SkIRect clipRect, sk_sp<SkRefCnt>&& supportData, const SkPMColor4f& color,
        SkArenaAlloc* alloc);
 ...
 private:
  ...
  skgpu::MaskFormat maskFormat() const {
    switch (this->maskType()) {
      case MaskType::kLCDCoverage: return skgpu::MaskFormat::kA565;
      case MaskType::kColorBitmap: return skgpu::MaskFormat::kARGB;
      ...
      case MaskType::kLCDBGRDistanceField: return skgpu::MaskFormat::kA8;
    }
    // SkUNREACHABLE;
