...
void GrGLCaps::init(
  ...
  fTextureUsageSupport = GR_IS_GR_GL_ES(standard) && ctxInfo.hasExtension("GL_ANGLE_texture_usage");
  ...
  if (GR_IS_GR_GL(standard)) {
    fSampleLocationsSupport =
        version >= GR_GL_VER(3, 2) || ctxInfo.hasExtension("GL_ARB_texture_multisample");
  } else if (GR_IS_GR_GL_ES(standard)) {
  ...
  fImagingSupport = GR_IS_GR_GL(standard) && ctxInfo.hasExtension("GL_ARB_imaging");
  ...
  if (ctxInfo.vendor() == GrGLVendor::kARM || ctxInfo.vendor() == GrGLVendor::kImagination ||
  ...
  if (GR_IS_GR_GL(standard)) {
    ...
    fVertexArrayObjectSupport =
        version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_OES_vertex_array_object");
  } else if (GR_IS_GR_WEBGL(standard)) {
  ...
  if (GR_IS_GR_GL(standard)) {
    ...
    fDrawInstancedSupport =
        version >= GR_GL_VER(3, 2) || (ctxInfo.hasExtension("GL_ARB_draw_instanced") &&
                                       ctxInfo.hasExtension("GL_ARB_instanced_arrays"));
  } else if (GR_IS_GR_GL_ES(standard)) {
    fDrawInstancedSupport = version >= GR_GL_VER(3, 0) ||
  ...
  if (GR_IS_GR_GL(standard)) {
    fClearTextureSupport =
        (version >= GR_GL_VER(4, 4) || ctxInfo.hasExtension("GL_ARB_clear_texture"));
  } else if (GR_IS_GR_GL_ES(standard)) {
  ...
  if (GR_IS_GR_GL(standard)) {
    shaderCaps->fDualSourceBlendingSupport =
        (version >= GR_GL_VER(3, 3) || ctxInfo.hasExtension("GL_ARB_blend_func_extended")) &&
        ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;

    shaderCaps->fShaderDerivativeSupport = true;

    shaderCaps->fIntegerSupport =
        version >= GR_GL_VER(3, 0) && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;

    shaderCaps->fNonsquareMatrixSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;
    shaderCaps->fInverseHyperbolicSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;
  } else if (GR_IS_GR_GL_ES(standard)) {
    ...
    shaderCaps->fIntegerSupport =
        ...
        version >= GR_GL_VER(3, 0) && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;
    shaderCaps->fNonsquareMatrixSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;
  ...
  if (GR_IS_GR_GL(standard)) {
    if (version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_ARB_framebuffer_object") ||
        ctxInfo.hasExtension("GL_EXT_framebuffer_blit")) {
      fBlitFramebufferFlags = 0;
    }
  } else if (GR_IS_GR_GL_ES(standard)) {
    if (version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_NV_framebuffer_blit")) {
      ...
      fBlitFramebufferFlags =
          kNoScalingOrMirroring_BlitFramebufferFlag | kResolveMustBeFull_BlitFrambufferFlag |
          kNoMSAADst_BlitFramebufferFlag | kNoFormatConversion_BlitFramebufferFlag |
          kRectsMustMatchForMSAASrc_BlitFramebufferFlag;
    }
  ...
  if (GR_IS_GR_GL(standard)) {
    ...
    fNPOTTextureTileSupport =
        version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_OES_texture_npot");
  ...
  bool isD3DANGLE = angle_backend_is_d3d(ctxInfo.angleBackend()) || ctxInfo.isOverCommandBuffer();
  ...
  if (GR_IS_GR_GL(standard)) {
    fBaseVertexBaseInstanceSupport =
        version >= GR_GL_VER(4, 2) || ctxInfo.hasExtension("GL_ARB_base_instance");
    if (fBaseVertexBaseInstanceSupport) {
      fNativeDrawIndirectSupport =
          version >= GR_GL_VER(4, 0) || ctxInfo.hasExtension("GL_ARB_draw_indirect");
    ...
    fBaseVertexBaseInstanceSupport =
        ctxInfo.hasExtension("WEBGL_draw_instanced_base_vertex_base_instance");
    if (fBaseVertexBaseInstanceSupport &&
  ...
  if (fProgramBinarySupport) {
    ...
    if (count > 0) {
      ...
      GR_GL_GetIntegerv(
          gli, GR_GL_PROGRAM_BINARY_FORMATS,
  ...
  if (!contextOptions.fDisableDriverCorrectnessWorkarounds) {
    this->applyDriverCorrectnessWorkarounds(
...
const char* get_glsl_version_decl_string(
    GrGLStandard standard, SkSL::GLSLGeneration generation, bool isCoreProfile) {
  if (GR_IS_GR_GL(standard)) {
    switch (generation) {
      case SkSL::GLSLGeneration::k110: return "#version 110\n";
      case SkSL::GLSLGeneration::k130: return "#version 130\n";
      case SkSL::GLSLGeneration::k140: return "#version 140\n";
    ...
    switch (generation) {
      case SkSL::GLSLGeneration::k100es: return "#version 100\n";
      case SkSL::GLSLGeneration::k300es: return "#version 300 es\n";
      case SkSL::GLSLGeneration::k310es: return "#version 310 es\n";
      case SkSL::GLSLGeneration::k320es: return "#version 320 es\n";
      default: break;
    }
  }
  return "<no version>";
...
bool is_float_fp32(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli, GrGLenum precision) {
  if (GR_IS_GR_GL(ctxInfo.standard()) && ctxInfo.version() < GR_GL_VER(4, 1) &&
...
void GrGLCaps::initGLSL(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli) {
  ...
  if (GR_IS_GR_GL(standard)) {
    shaderCaps->fFlatInterpolationSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;
  } else if (GR_IS_GR_GL_ES(standard) || GR_IS_GR_WEBGL(standard)) {
  ...
  shaderCaps->fVersionDeclString =
      get_glsl_version_decl_string(standard, shaderCaps->fGLSLGeneration, fIsCoreProfile);
  ...
  if (ctxInfo.hasExtension("GL_OES_EGL_image_external")) {
    if (ctxInfo.glslGeneration() == SkSL::GLSLGeneration::k100es) {
      ...
      shaderCaps->fExternalTextureExtensionString = "GL_OES_EGL_image_external";
        ...
        ctxInfo.hasExtension("GL_OES_EGL_image_external_essl3") ||
  ...
  if (GR_IS_GR_GL(standard)) {
    shaderCaps->fBitManipulationSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k400;
  } else if (GR_IS_GR_GL_ES(standard) || GR_IS_GR_WEBGL(standard)) {
    shaderCaps->fBitManipulationSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k310es;
  }
  ...
  if (GR_IS_GR_GL(standard)) {
    shaderCaps->fBuiltinFMASupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k400;
  } else if (GR_IS_GR_GL_ES(standard)) {
    shaderCaps->fBuiltinFMASupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k320es;
  }

  shaderCaps->fBuiltinDeterminantSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k150;
}

void GrGLCaps::initFSAASupport(
    const GrContextOptions& contextOptions, const GrGLContextInfo& ctxInfo,
    const GrGLInterface* gli) {
  if (GR_IS_GR_GL(ctxInfo.standard())) {
    if (ctxInfo.version() >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_ARB_framebuffer_object")) {
      fMSFBOType = kStandard_MSFBOType;
        ...
        ctxInfo.hasExtension("GL_EXT_framebuffer_multisample") &&
        ctxInfo.hasExtension("GL_EXT_framebuffer_blit")) {
      fMSFBOType = kStandard_MSFBOType;
    }
...
void GrGLCaps::initBlendEqationSupport(const GrGLContextInfo& ctxInfo) {
  ...
  if (ctxInfo.hasExtension("GL_NV_blend_equation_advanced_coherent")) {
    ...
    shaderCaps->fAdvBlendEqInteraction = GrShaderCaps::kAutomatic_AdvBlendEqInteraction;
      ...
      ctxInfo.hasExtension("GL_KHR_blend_equation_advanced_coherent") && layoutQualifierSupport) {
    fBlendEquationSupport = kAdvancedCoherent_BlendEquationSupport;
...
void GrGLCaps::initStencilSupport(const GrGLContextInfo& ctxInfo) {
  ...
  if (GR_IS_GR_GL(ctxInfo.standard())) {
    bool supportsPackedDS = ctxInfo.version() >= GR_GL_VER(3, 0) ||
...
void GrGLCaps::getTexImageExternalFormatAndType(
...
void GrGLCaps::getTexSubImageExternalFormatAndType(
    GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType,
    GrGLenum* externalFormat, GrGLenum* externalType) const {
  this->getExternalFormat(
      surfaceFormat, surfaceColorType, memoryColorType, kTexImage_ExternalFormatUsage,
      externalFormat, externalType);
}

void GrGLCaps::getReadPixelsFormat(
    GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType,
    GrGLenum* externalFormat, GrGLenum* externalType) const {
  this->getExternalFormat(
      surfaceFormat, surfaceColorType, memoryColorType, kReadPixels_ExternalFormatUsage,
      externalFormat, externalType);
}

void GrGLCaps::getExternalFormat(
    GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType,
    ExternalFormatUsage usage, GrGLenum* externalFormat, GrGLenum* externalType) const {
  SkASSERT(externalFormat && externalType);
  *externalFormat =
      this->getFormatInfo(surfaceFormat).externalFormat(surfaceColorType, memoryColorType, usage);
  *externalType =
      this->getFormatInfo(surfaceFormat).externalType(surfaceColorType, memoryColorType);
}
...
void GrGLCaps::initFormatTable(
  ...
  if (GR_IS_GR_GL(standard)) {
    ...
    texStorageSupported =
        version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_EXT_texture_storage");
  } else if (GR_IS_GR_WEBGL(standard)) {
  ...
  // Format: RGBA8
  {
    ...
    bool supportsBGRAColorType = GR_IS_GR_GL(standard) && (version >= GR_GL_VER(1, 2) ||
    ...
    // Format: RGBA8, Surface: kRGBA_8888
    {
      ...
      ctInfo.fExternalIOFormats =
          std::make_unique<ColorTypeInfo::ExternalIOFormats[]>(ctInfo.fExternalIOFormatCount);
      int ioIdx = 0;
      ...
      // Format: RGBA8, Surface: kRGBA_8888, Data: kBGRA_8888
      {
        ...
        ioFormat.fExternalReadFormat = formatWorkarounds.fDisallowBGRA8ReadPixels ? 0 : GR_GL_BGRA;
  ...
  // Format: R8
  {
    ...
    if (r8Support) {
      info.fFlags |= FormatInfo::kTexturable_Flag | FormatInfo::kTransfers_Flag | msaaRenderFlags;
    }
  ...
  // Format: ALPHA8
  {
    bool alpha8IsValidForGL =
        GR_IS_GR_GL(standard) && (!fIsCoreProfile || version <= GR_GL_VER(3, 0));
    ...
    if (alpha8IsValidForGL) {
      ...
      alpha8IsRenderable =
          ctxInfo.version() >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_ARB_framebuffer_object");
    }
  ...
  // Format: LUMINANCE8_ALPHA8
  {
    ...
    if (la8Supported) {
      ...
      // Format: LUMINANCE8_ALPHA8, Surface: kGrayAlpha_88
      {
        ...
        if (fColorTypeToFormatTable[idx] == GrGLFormat::kUnknown) {
          this->setColorTypeFormat(GrColorType::kGrayAlpha_88, GrGLFormat::kLUMINANCE8_ALPHA8);
        }
  ...
  // Format: RGBA16F
  {
    ...
    if (GR_IS_GR_GL(standard)) {
      ...
      if (version >= GR_GL_VER(3, 0)) {
        rgba16FTextureSupport = true;
        rgba16FRenderTargetSupport = version >= GR_GL_VER(3, 2) ||
  ...
  // Format: RGB10_A2
  {
    ...
    if (GR_IS_GR_GL(standard) || (GR_IS_GR_GL_ES(standard) && version >= GR_GL_VER(3, 0))) {
      info.fFlags = FormatInfo::kTexturable_Flag | FormatInfo::kTransfers_Flag | msaaRenderFlags;
        ...
        GR_IS_GR_GL_ES(standard) && ctxInfo.hasExtension("GL_EXT_texture_type_2_10_10_10_REV")) {
      info.fFlags = FormatInfo::kTexturable_Flag | FormatInfo::kTransfers_Flag;
    }  // No WebGL support
  ...
  // Format: SRGB8_ALPHA8
  {
    ...
    if (srgb8Alpha8TextureSupport) {
      ...
      if (srgb8Alpha8RenderTargetSupport) {
        info.fFlags |= formatWorkarounds.fDisableSRGBRenderWithMSAAForMacAMD ? nonMSAARenderFlags
                                                                             : msaaRenderFlags;
      }
    }
...
void GrGLCaps::setupSampleCounts(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli) {
  ...
  for (int i = 0; i < kGrGLColorFormatCount; ++i) {
    if (FormatInfo::kFBOColorAttachmentWithMSAA_Flag & fFormatTable[i].fFlags) {
      ...
      if ((GR_IS_GR_GL(standard) &&
           (version >= GR_GL_VER(4, 2) || ctxInfo.hasExtension("GL_ARB_internalformat_query"))) ||
          (GR_IS_GR_GL_ES(standard) && version >= GR_GL_VER(3, 0))) {
        int count;
        ...
        GR_GL_GetInternalformativ(
            gli, GR_GL_RENDERBUFFER, glFormat, GR_GL_NUM_SAMPLE_COUNTS, 1, &count);
        if (count) {
          std::unique_ptr<int[]> temp(new int[count]);
          GR_GL_GetInternalformativ(
              gli, GR_GL_RENDERBUFFER, glFormat, GR_GL_SAMPLES, count, temp.get());
...
bool GrGLCaps::canCopyTexSubImage(
...
bool GrGLCaps::onCanCopySurface(
  ...
  return this->canCopyTexSubImage(
             dstFormat, has_msaa_render_buffer(dst, *this), dstTexTypePtr, srcFormat,
             has_msaa_render_buffer(src, *this), srcTexTypePtr) ||
         this->canCopyAsBlit(
             dstFormat, dstSampleCnt, dstTexTypePtr, srcFormat, srcSampleCnt, srcTexTypePtr,
             src->getBoundsRect(), src->priv().isExact(), srcRect, dstPoint) ||
         this->canCopyAsDraw(dstFormat, SkToBool(srcTex));
}

GrCaps::DstCopyRestrictions GrGLCaps::getDstCopyRestrictions(
    const GrRenderTargetProxy* src, GrColorType colorType) const {
  // If the src is a texture, we can implement the blit as a draw assuming the config is
  // renderable.
  if (src->asTextureProxy() &&
      !this->isFormatAsColorTypeRenderable(colorType, src->backendFormat())) {
    return {};
  }
  ...
  if (src->numSamples() > 1 && (fBlitFramebufferFlags & kResolveMustBeFull_BlitFrambufferFlag)) {
    ...
    // Mirroring causes rects to mismatch later, don't allow it.
      ...
      src->numSamples() > 1 &&
      (fBlitFramebufferFlags & kRectsMustMatchForMSAASrc_BlitFramebufferFlag)) {
    blitFramebufferRestrictions.fRectsMustMatch = GrSurfaceProxy::RectsMustMatch::kYes;
  }
  ...
  {
    bool srcIsMSAARenderbuffer = src->numSamples() > 1 && this->usesMSAARenderBuffers();
...
void GrGLCaps::applyDriverCorrectnessWorkarounds(
    ...
    const GrGLInterface* glInterface, GrShaderCaps* shaderCaps,
    FormatWorkarounds* formatWorkarounds) {
  ...
  if (ctxInfo.vendor() == GrGLVendor::kQualcomm || ctxInfo.renderer() == GrGLRenderer::kMali4xx ||
...
#  endif
  ...
  if (fMipmapLevelControlSupport && !ctxInfo.isOverCommandBuffer() &&  // http://crbug.com/1224110
      (contextOptions.fDoManualMipmapping || ctxInfo.vendor() == GrGLVendor::kIntel ||
  ...
  if (ctxInfo.renderer() == GrGLRenderer::kAdreno430 ||
      ...
      ctxInfo.renderer() == GrGLRenderer::kAdreno5xx_other ||
      ctxInfo.driver() == GrGLDriver::kIntel || ctxInfo.isOverCommandBuffer() ||
  ...
  if ((ctxInfo.vendor() == GrGLVendor::kIntel || ctxInfo.angleVendor() == GrGLVendor::kIntel) &&
      (ctxInfo.renderer() < GrGLRenderer::kIntelIceLake || !contextOptions.fAllowMSAAOnNewIntel)) {
    fMSFBOType = kNone_MSFBOType;
  }
  ...
  if (ctxInfo.renderer() == GrGLRenderer::kMaliT && ctxInfo.driver() == GrGLDriver::kARM &&
  ...
  if (ctxInfo.renderer() == GrGLRenderer::kMaliG && ctxInfo.driver() == GrGLDriver::kARM &&
        ...
        if (ioInfo.fExternalReadFormat != 0) {
          if (formatInfo.fHaveQueriedImplementationReadSupport ||
            ...
            if (formatInfo.fFlags & FormatInfo::kTransfers_Flag) {
              transferOffsetAlignment = offset_alignment_for_transfer_buffer(ioInfo.fExternalType);
            }
...
GrCaps::SupportedWrite GrGLCaps::supportedWritePixelsColorType(
...
bool GrGLCaps::isFormatAsColorTypeRenderable(
...
void GrGLCaps::didQueryImplementationReadSupport(
    GrGLFormat format, GrGLenum readFormat, GrGLenum readType) const {
  ...
  for (int i = 0; i < formatInfo.fColorTypeInfoCount; ++i) {
    ...
    for (int j = 0; j < surfCTInfo.fExternalIOFormatCount; ++j) {
      ...
      if (readCTInfo.fRequiresImplementationReadQuery) {
        if (readCTInfo.fExternalReadFormat != readFormat || readCTInfo.fExternalType != readType) {
...
bool GrGLCaps::onAreColorTypeAndFormatCompatible(
...
GrBackendFormat GrGLCaps::getBackendFormatFromCompressionType(
  ...
  switch (compressionType) {
    case SkImage::CompressionType::kNone: return {};
    ...
    case SkImage::CompressionType::kBC1_RGB8_UNORM:
      if (this->isFormatTexturable(GrGLFormat::kCOMPRESSED_RGB8_BC1)) {
        return GrBackendFormat::MakeGL(GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT, GR_GL_TEXTURE_2D);
      }
      return {};
    case SkImage::CompressionType::kBC1_RGBA8_UNORM:
      if (this->isFormatTexturable(GrGLFormat::kCOMPRESSED_RGBA8_BC1)) {
        return GrBackendFormat::MakeGL(GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, GR_GL_TEXTURE_2D);
      }
      return {};
  }
...
skgpu::Swizzle GrGLCaps::onGetReadSwizzle(
    const GrBackendFormat& format, GrColorType colorType) const {
  GrGLFormat glFormat = format.asGLFormat();
  const auto& info = this->getFormatInfo(glFormat);
  for (int i = 0; i < info.fColorTypeInfoCount; ++i) {
  ...
  SkDEBUGFAILF(
      "Illegal color type (%d) and format (%d) combination.", (int)colorType, (int)glFormat);
  return {};
}

skgpu::Swizzle GrGLCaps::getWriteSwizzle(
    const GrBackendFormat& format, GrColorType colorType) const {
  ...
  SkDEBUGFAILF(
      "Illegal color type (%d) and format (%d) combination.", (int)colorType,
      (int)format.asGLFormat());
  return {};
}
...
GrProgramDesc GrGLCaps::makeDesc(
...
std::vector<GrCaps::TestFormatColorTypeCombination> GrGLCaps::getTestingCombinations() const {
  std::vector<GrCaps::TestFormatColorTypeCombination> combos = {
      {GrColorType::kAlpha_8, GrBackendFormat::MakeGL(GR_GL_ALPHA8, GR_GL_TEXTURE_2D)},
      {GrColorType::kAlpha_8, GrBackendFormat::MakeGL(GR_GL_R8, GR_GL_TEXTURE_2D)},
      {GrColorType::kBGR_565, GrBackendFormat::MakeGL(GR_GL_RGB565, GR_GL_TEXTURE_2D)},
      {GrColorType::kABGR_4444, GrBackendFormat::MakeGL(GR_GL_RGBA4, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGBA_8888, GrBackendFormat::MakeGL(GR_GL_RGBA8, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGBA_8888_SRGB, GrBackendFormat::MakeGL(GR_GL_SRGB8_ALPHA8, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGB_888x, GrBackendFormat::MakeGL(GR_GL_RGBA8, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGB_888x, GrBackendFormat::MakeGL(GR_GL_RGB8, GR_GL_TEXTURE_2D)},
      ...
      {GrColorType::kRG_88, GrBackendFormat::MakeGL(GR_GL_RG8, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGBA_1010102, GrBackendFormat::MakeGL(GR_GL_RGB10_A2, GR_GL_TEXTURE_2D)},
      {GrColorType::kGray_8, GrBackendFormat::MakeGL(GR_GL_LUMINANCE8, GR_GL_TEXTURE_2D)},
      {GrColorType::kGray_8, GrBackendFormat::MakeGL(GR_GL_R8, GR_GL_TEXTURE_2D)},
      {GrColorType::kGrayAlpha_88,
       GrBackendFormat::MakeGL(GR_GL_LUMINANCE8_ALPHA8, GR_GL_TEXTURE_2D)},
      {GrColorType::kAlpha_F16, GrBackendFormat::MakeGL(GR_GL_R16F, GR_GL_TEXTURE_2D)},
      {GrColorType::kAlpha_F16, GrBackendFormat::MakeGL(GR_GL_LUMINANCE16F, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGBA_F16, GrBackendFormat::MakeGL(GR_GL_RGBA16F, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGBA_F16_Clamped, GrBackendFormat::MakeGL(GR_GL_RGBA16F, GR_GL_TEXTURE_2D)},
      {GrColorType::kAlpha_16, GrBackendFormat::MakeGL(GR_GL_R16, GR_GL_TEXTURE_2D)},
      {GrColorType::kRG_1616, GrBackendFormat::MakeGL(GR_GL_RG16, GR_GL_TEXTURE_2D)},
      {GrColorType::kRGBA_16161616, GrBackendFormat::MakeGL(GR_GL_RGBA16, GR_GL_TEXTURE_2D)},
      {GrColorType::kRG_F16, GrBackendFormat::MakeGL(GR_GL_RG16F, GR_GL_TEXTURE_2D)},
  };

  if (GR_IS_GR_GL(fStandard)) {
    combos.push_back(
        {GrColorType::kBGRA_8888, GrBackendFormat::MakeGL(GR_GL_RGBA8, GR_GL_TEXTURE_2D)});
    combos.push_back(
        {GrColorType::kBGRA_1010102, GrBackendFormat::MakeGL(GR_GL_RGB10_A2, GR_GL_TEXTURE_2D)});
  } else {
    SkASSERT(GR_IS_GR_GL_ES(fStandard) || GR_IS_GR_WEBGL(fStandard));

    combos.push_back(
        {GrColorType::kBGRA_8888, GrBackendFormat::MakeGL(GR_GL_BGRA8, GR_GL_TEXTURE_2D)});
  }
  if (this->rectangleTextureSupport()) {
    ...
    for (size_t i = 0; i < count2D; ++i) {
      ...
      combos.push_back(
          {combo2D.fColorType, GrBackendFormat::MakeGL(formatEnum, GR_GL_TEXTURE_RECTANGLE)});
    }
  }
  return combos;
}
