...
std::unique_ptr<SkSL::Program> GrSkSLtoGLSL(
    const GrGLGpu* gpu, SkSL::ProgramKind programKind, const std::string& sksl,
    const SkSL::Program::Settings& settings, std::string* glsl,
...
GrGLuint GrGLCompileAndAttachShader(
    const GrGLContext& glCtx, GrGLuint programId, GrGLenum type, const std::string& glsl,
