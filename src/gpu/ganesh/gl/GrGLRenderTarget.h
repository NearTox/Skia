...
class GrGLRenderTarget : public GrRenderTarget {
 public:
  ...
  void bind(bool useMultisampleFBO) { this->bindInternal(GR_GL_FRAMEBUFFER, useMultisampleFBO); }
 ...
 protected:
  ...
  GrGLRenderTarget(
      GrGLGpu*, const SkISize&, GrGLFormat, int sampleCount, const IDs&, std::string_view label);
