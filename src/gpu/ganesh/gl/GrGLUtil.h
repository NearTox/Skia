...
#define GR_GL_VER(major, minor) \
  ((static_cast<uint32_t>(major) << 16) | static_cast<uint32_t>(minor))
#define GR_GLSL_VER(major, minor) \
  ((static_cast<uint32_t>(major) << 16) | static_cast<uint32_t>(minor))
#define GR_GL_DRIVER_VER(major, minor, point)                                    \
  ((static_cast<uint64_t>(major) << 32) | (static_cast<uint64_t>(minor) << 16) | \
...
static constexpr GrColorFormatDesc GrGLFormatDesc(GrGLFormat format) {
  switch (format) {
    ...
    case GrGLFormat::kRGBA8: return GrColorFormatDesc::MakeRGBA(8, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kR8: return GrColorFormatDesc::MakeR(8, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kALPHA8: return GrColorFormatDesc::MakeAlpha(8, GrColorTypeEncoding::kUnorm);
    ...
    case GrGLFormat::kBGRA8: return GrColorFormatDesc::MakeRGBA(8, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRGB565:
      return GrColorFormatDesc::MakeRGB(5, 6, 5, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRGBA16F: return GrColorFormatDesc::MakeRGBA(16, GrColorTypeEncoding::kFloat);
    case GrGLFormat::kR16F: return GrColorFormatDesc::MakeR(16, GrColorTypeEncoding::kFloat);
    case GrGLFormat::kRGB8: return GrColorFormatDesc::MakeRGB(8, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRGBX8: return GrColorFormatDesc::MakeRGB(8, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRG8: return GrColorFormatDesc::MakeRG(8, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRGB10_A2:
      return GrColorFormatDesc::MakeRGBA(10, 2, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRGBA4: return GrColorFormatDesc::MakeRGBA(4, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kSRGB8_ALPHA8:
      return GrColorFormatDesc::MakeRGBA(8, GrColorTypeEncoding::kSRGBUnorm);
    case GrGLFormat::kR16: return GrColorFormatDesc::MakeR(16, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRG16: return GrColorFormatDesc::MakeRG(16, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRGBA16: return GrColorFormatDesc::MakeRGBA(16, GrColorTypeEncoding::kUnorm);
    case GrGLFormat::kRG16F: return GrColorFormatDesc::MakeRG(16, GrColorTypeEncoding::kFloat);
...
static constexpr int GrGLFormatStencilBits(GrGLFormat format) {
  switch (format) {
    case GrGLFormat::kSTENCIL_INDEX8: return 8;
    case GrGLFormat::kSTENCIL_INDEX16: return 16;
    case GrGLFormat::kDEPTH24_STENCIL8: return 8;
...
static constexpr bool GrGLFormatIsPackedDepthStencil(GrGLFormat format) {
  switch (format) {
    case GrGLFormat::kDEPTH24_STENCIL8: return true;
    case GrGLFormat::kCOMPRESSED_ETC1_RGB8:
    case GrGLFormat::kCOMPRESSED_RGB8_ETC2:
    case GrGLFormat::kCOMPRESSED_RGB8_BC1:
    case GrGLFormat::kCOMPRESSED_RGBA8_BC1:
...
static constexpr bool GrGLFormatIsSRGB(GrGLFormat format) {
  switch (format) {
    case GrGLFormat::kSRGB8_ALPHA8: return true;
    case GrGLFormat::kCOMPRESSED_ETC1_RGB8:
    case GrGLFormat::kCOMPRESSED_RGB8_ETC2:
    case GrGLFormat::kCOMPRESSED_RGB8_BC1:
    case GrGLFormat::kCOMPRESSED_RGBA8_BC1:
