...
class GrGLSLProgramDataManager {
 public:
   ...
   * same size.
   */
  void setRuntimeEffectUniforms(
      SkSpan<const SkRuntimeEffect::Uniform>, SkSpan<const UniformHandle>,
      SkSpan<const Specialized>, const void* src) const;

  void setRuntimeEffectUniforms(
      SkSpan<const SkRuntimeEffect::Uniform> uniforms, SkSpan<const UniformHandle> handles,
