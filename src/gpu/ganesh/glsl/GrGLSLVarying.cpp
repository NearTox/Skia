...
static bool use_flat_interpolation(
  ...
  switch (interpolation) {
    ...
    case Interpolation::kMustBeFlat: SkASSERT(shaderCaps.fFlatInterpolationSupport); return true;
  }
...
void GrGLSLVaryingHandler::getFragDecls(SkString* inputDecls, SkString* outputDecls) const {
  ...
  SkASSERT(
      SkSL::GLSLGeneration::k110 != fProgramBuilder->shaderCaps()->fGLSLGeneration ||
      fFragOutputs.empty());
