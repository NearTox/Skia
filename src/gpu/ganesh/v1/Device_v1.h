...
class Device final : public BaseDevice {
 public:
  ...
  void resolveMSAA() override { fSurfaceDrawContext->resolveMSAA(); }
 ...
 private:
  ...
  void testingOnly_drawGlyphRunListWithSlug(
  ...
  void drawImageQuad(
      const SkImage*, const SkRect* src, const SkRect* dst, const SkPoint dstClip[4],
