...
class BlendFormula {
 public:
  ...
  constexpr BlendFormula(
      OutputType primaryOut, OutputType secondaryOut, skgpu::BlendEquation equation,
  ...
  skgpu::BlendCoeff srcCoeff() const { return static_cast<skgpu::BlendCoeff>(fSrcCoeff); }

  skgpu::BlendCoeff dstCoeff() const { return static_cast<skgpu::BlendCoeff>(fDstCoeff); }

  OutputType primaryOutput() const { return fPrimaryOutputType; }

  OutputType secondaryOutput() const { return fSecondaryOutputType; }
 ...
 private:
  ...
  static constexpr Properties GetProperties(
      OutputType PrimaryOut, OutputType SecondaryOut, skgpu::BlendEquation BlendEquation,
      skgpu::BlendCoeff SrcCoeff, skgpu::BlendCoeff DstCoeff);
...
constexpr BlendFormula::Properties BlendFormula::GetProperties(
  ...
  return
      ...
      SkASSERT(
          (kNone_OutputType == PrimaryOut) == !skgpu::BlendCoeffsUseSrcColor(SrcCoeff, DstCoeff)),
...
static constexpr BlendFormula MakeSAModulateFormula(
    skgpu::BlendCoeff srcCoeff, skgpu::BlendCoeff dstCoeff) {
  return BlendFormula(
      BlendFormula::kSAModulate_OutputType, BlendFormula::kNone_OutputType,
      skgpu::BlendEquation::kAdd, srcCoeff, dstCoeff);
}
...
static constexpr BlendFormula MakeCoverageFormula(
  ...
  return BlendFormula(
      BlendFormula::kModulate_OutputType, oneMinusDstCoeffModulateOutput,
...
static constexpr BlendFormula MakeCoverageSrcCoeffZeroFormula(
  ...
  return BlendFormula(
      ...
      skgpu::BlendEquation::kReverseSubtract, skgpu::BlendCoeff::kDC, skgpu::BlendCoeff::kOne);
}
...
static constexpr BlendFormula MakeCoverageDstCoeffZeroFormula(skgpu::BlendCoeff srcCoeff) {
  return BlendFormula(
      BlendFormula::kModulate_OutputType, BlendFormula::kCoverage_OutputType,
...
static constexpr BlendFormula gBlendTable[2][2][(int)SkBlendMode::kLastCoeffMode + 1] = {
    /*>> No coverage, input color unknown <<*/ {
        ...
        /*>> Has coverage, input color unknown <<*/ {
            ...
            /* src-atop */ MakeCoeffFormula(skgpu::BlendCoeff::kDA, skgpu::BlendCoeff::kISA),
            /* dst-atop */
            MakeCoverageFormula(BlendFormula::kISAModulate_OutputType, skgpu::BlendCoeff::kIDA),
            /* xor */ MakeCoeffFormula(skgpu::BlendCoeff::kIDA, skgpu::BlendCoeff::kISA),
            /* plus */ MakeCoeffFormula(skgpu::BlendCoeff::kOne, skgpu::BlendCoeff::kOne),
...
static constexpr BlendFormula gLCDBlendTable[(int)SkBlendMode::kLastCoeffMode + 1] = {
    /* clear */ MakeCoverageSrcCoeffZeroFormula(BlendFormula::kCoverage_OutputType),
    /* src */ MakeCoverageFormula(BlendFormula::kCoverage_OutputType, skgpu::BlendCoeff::kOne),
    /* dst */ MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kOne),
    /* src-over */
    MakeCoverageFormula(BlendFormula::kSAModulate_OutputType, skgpu::BlendCoeff::kOne),
    /* dst-over */ MakeCoeffFormula(skgpu::BlendCoeff::kIDA, skgpu::BlendCoeff::kOne),
    /* src-in */ MakeCoverageFormula(BlendFormula::kCoverage_OutputType, skgpu::BlendCoeff::kDA),
    /* dst-in */ MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISAModulate_OutputType),
    /* src-out */ MakeCoverageFormula(BlendFormula::kCoverage_OutputType, skgpu::BlendCoeff::kIDA),
    /* dst-out */ MakeSAModulateFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kISC),
    /* src-atop */
    MakeCoverageFormula(BlendFormula::kSAModulate_OutputType, skgpu::BlendCoeff::kDA),
    /* dst-atop */
    MakeCoverageFormula(BlendFormula::kISAModulate_OutputType, skgpu::BlendCoeff::kIDA),
    /* xor */ MakeCoverageFormula(BlendFormula::kSAModulate_OutputType, skgpu::BlendCoeff::kIDA),
    /* plus */ MakeCoeffFormula(skgpu::BlendCoeff::kOne, skgpu::BlendCoeff::kOne),
    /* modulate */ MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISCModulate_OutputType),
    /* screen */ MakeCoeffFormula(skgpu::BlendCoeff::kOne, skgpu::BlendCoeff::kISC),
};

static BlendFormula get_blend_formula(bool isOpaque, bool hasCoverage, SkBlendMode xfermode) {
   ...
   private:
    void emitOutputsForBlendState(const EmitArgs& args) override {
      ...
      if (blendFormula.hasSecondaryOutput()) {
        append_color_output(
            xp, fragBuilder, blendFormula.secondaryOutput(), args.fOutputSecondary,
...
std::unique_ptr<GrXferProcessor::ProgramImpl> ShaderPDXferProcessor::makeProgramImpl() const {
  class Impl : public ProgramImpl {
   private:
    ...
    void onSetData(const GrGLSLProgramDataManager& pdman, const GrXferProcessor& proc) override {
...
PDLCDXferProcessor::PDLCDXferProcessor(const SkPMColor4f& blendConstant, float alpha)
    : INHERITED(
          kPDLCDXferProcessor_ClassID, /*willReadDstColor=*/false,
   ...
   private:
    void emitOutputsForBlendState(const EmitArgs& args) override {
      ...
      fAlphaUniform = args.fUniformHandler->addUniform(
          nullptr, kFragment_GrShaderFlag, SkSLType::kHalf, "alpha", &alpha);
      GrGLSLXPFragmentBuilder* fragBuilder = args.fXPFragBuilder;
...
sk_sp<const GrXferProcessor> GrPorterDuffXPFactory::makeXferProcessor(
    const GrProcessorAnalysisColor& color, GrProcessorAnalysisCoverage coverage, const GrCaps& caps,
