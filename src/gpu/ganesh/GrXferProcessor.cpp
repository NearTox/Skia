...
void GrXferProcessor::addToKey(
    const GrShaderCaps& caps, skgpu::KeyBuilder* b, const GrSurfaceOrigin* originIfDstTexture,
...
void ProgramImpl::emitWriteSwizzle(
    GrGLSLXPFragmentBuilder* x, const skgpu::Swizzle& swizzle, const char* outColor,
