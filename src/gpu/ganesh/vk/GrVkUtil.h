...
static constexpr GrColorFormatDesc GrVkFormatDesc(VkFormat vkFormat) {
  switch (vkFormat) {
    ...
    case VK_FORMAT_R8_UNORM: return GrColorFormatDesc::MakeR(8, GrColorTypeEncoding::kUnorm);
    ...
    case VK_FORMAT_R16_SFLOAT: return GrColorFormatDesc::MakeR(16, GrColorTypeEncoding::kFloat);
    case VK_FORMAT_R8G8B8_UNORM: return GrColorFormatDesc::MakeRGB(8, GrColorTypeEncoding::kUnorm);
    case VK_FORMAT_R8G8_UNORM: return GrColorFormatDesc::MakeRG(8, GrColorTypeEncoding::kUnorm);
    ...
    case VK_FORMAT_R16_UNORM: return GrColorFormatDesc::MakeR(16, GrColorTypeEncoding::kUnorm);
    case VK_FORMAT_R16G16_UNORM: return GrColorFormatDesc::MakeRG(16, GrColorTypeEncoding::kUnorm);
    case VK_FORMAT_R16G16B16A16_UNORM:
      return GrColorFormatDesc::MakeRGBA(16, GrColorTypeEncoding::kUnorm);
    case VK_FORMAT_R16G16_SFLOAT: return GrColorFormatDesc::MakeRG(16, GrColorTypeEncoding::kFloat);
...
static constexpr int GrVkFormatStencilBits(VkFormat format) {
  switch (format) {
    ...
    case VK_FORMAT_D24_UNORM_S8_UINT: return 8;
    case VK_FORMAT_D32_SFLOAT_S8_UINT: return 8;
    default: return 0;
  }
}
...
bool GrCompileVkShaderModule(
    GrVkGpu* gpu, const std::string& shaderString, VkShaderStageFlagBits stage,
    VkShaderModule* shaderModule, VkPipelineShaderStageCreateInfo* stageInfo,
    const SkSL::Program::Settings& settings, std::string* outSPIRV,
    SkSL::Program::Inputs* outInputs);

bool GrInstallVkShaderModule(
    GrVkGpu* gpu, const std::string& spirv, VkShaderStageFlagBits stage,
    VkShaderModule* shaderModule, VkPipelineShaderStageCreateInfo* stageInfo);
