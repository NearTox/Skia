...
class GrVkTextureRenderTarget : public GrVkTexture, public GrVkRenderTarget {
 ...
 private:
  GrVkTextureRenderTarget(
      ...
      sk_sp<GrVkImage> colorAttachment, sk_sp<GrVkImage> resolveAttachment, GrMipmapStatus,
      std::string_view label);

  GrVkTextureRenderTarget(
      GrVkGpu* gpu, SkISize dimensions, sk_sp<GrVkImage> texture, sk_sp<GrVkImage> colorAttachment,
      sk_sp<GrVkImage> resolveAttachment, GrMipmapStatus, GrWrapCacheable, std::string_view label);
