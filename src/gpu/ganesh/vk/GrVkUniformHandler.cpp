...
static uint32_t sksltype_to_alignment_mask(SkSLType type) {
  switch (type) {
    ...
    case SkSLType::kUShort: return 0x1;
    case SkSLType::kShort2:  // fall through
    case SkSLType::kUShort2: return 0x3;
    case SkSLType::kShort3:  // fall through
    case SkSLType::kShort4:
    case SkSLType::kUShort3:
    case SkSLType::kUShort4: return 0x7;
    case SkSLType::kInt:
    case SkSLType::kUInt: return 0x3;
    case SkSLType::kInt2:
    case SkSLType::kUInt2: return 0x7;
    case SkSLType::kInt3:
    case SkSLType::kUInt3:
    case SkSLType::kInt4:
    case SkSLType::kUInt4: return 0xF;
    case SkSLType::kHalf:  // fall through
    case SkSLType::kFloat: return 0x3;
    case SkSLType::kHalf2:  // fall through
    case SkSLType::kFloat2: return 0x7;
    case SkSLType::kHalf3:  // fall through
    case SkSLType::kFloat3: return 0xF;
    case SkSLType::kHalf4:  // fall through
    case SkSLType::kFloat4: return 0xF;
    case SkSLType::kHalf2x2:  // fall through
    case SkSLType::kFloat2x2: return 0x7;
    case SkSLType::kHalf3x3:  // fall through
    case SkSLType::kFloat3x3: return 0xF;
    case SkSLType::kHalf4x4:  // fall through
    case SkSLType::kFloat4x4: return 0xF;
...
static inline uint32_t sksltype_to_vk_size(SkSLType type, int layout) {
  switch (type) {
    case SkSLType::kShort: return sizeof(int16_t);
    case SkSLType::kShort2: return 2 * sizeof(int16_t);
    case SkSLType::kShort3: return 3 * sizeof(int16_t);
    case SkSLType::kShort4: return 4 * sizeof(int16_t);
    case SkSLType::kUShort: return sizeof(uint16_t);
    case SkSLType::kUShort2: return 2 * sizeof(uint16_t);
    case SkSLType::kUShort3: return 3 * sizeof(uint16_t);
    case SkSLType::kUShort4: return 4 * sizeof(uint16_t);
    case SkSLType::kHalf:  // fall through
    case SkSLType::kFloat: return sizeof(float);
    case SkSLType::kHalf2:  // fall through
    case SkSLType::kFloat2: return 2 * sizeof(float);
    case SkSLType::kHalf3:  // fall through
    case SkSLType::kFloat3: return 3 * sizeof(float);
    case SkSLType::kHalf4:  // fall through
    case SkSLType::kFloat4: return 4 * sizeof(float);
    case SkSLType::kInt:  // fall through
    case SkSLType::kUInt: return sizeof(int32_t);
    case SkSLType::kInt2:  // fall through
    case SkSLType::kUInt2: return 2 * sizeof(int32_t);
    case SkSLType::kInt3:  // fall through
    case SkSLType::kUInt3: return 3 * sizeof(int32_t);
    case SkSLType::kInt4:  // fall through
    case SkSLType::kUInt4: return 4 * sizeof(int32_t);
    case SkSLType::kHalf2x2:  // fall through
    ...
    case SkSLType::kHalf3x3:  // fall through
    case SkSLType::kFloat3x3: return 12 * sizeof(float);
    case SkSLType::kHalf4x4:  // fall through
    case SkSLType::kFloat4x4: return 16 * sizeof(float);
...
static uint32_t get_aligned_offset(
    uint32_t* currentOffset, SkSLType type, int arrayCount, int layout) {
...
GrGLSLUniformHandler::UniformHandle GrVkUniformHandler::internalAddUniformArray(
    const GrProcessor* owner, uint32_t visibility, SkSLType type, const char* name, bool mangleName,
    int arrayCount, const char** outName) {
  ...
  for (int layout = 0; layout < kLayoutCount; ++layout) {
    tempInfo.fOffsets[layout] =
        get_aligned_offset(&fCurrentOffsets[layout], type, arrayCount, layout);
  }
...
GrGLSLUniformHandler::SamplerHandle GrVkUniformHandler::addSampler(
  ...
  VkUniformInfo tempInfo;
  tempInfo.fVariable = GrShaderVar{
      std::move(mangleName),
  ...
  if (ycbcrInfo && ycbcrInfo->isValid()) {
    ...
    GrVkSampler* sampler = gpu->resourceProvider().findOrCreateCompatibleSampler(state, *ycbcrInfo);
...
GrGLSLUniformHandler::SamplerHandle GrVkUniformHandler::addInputSampler(
  ...
  fInputUniform = {
      GrShaderVar{
          std::move(mangleName), SkSLType::kInput, GrShaderVar::TypeModifier::Uniform,
...
void GrVkUniformHandler::appendUniformDecls(GrShaderFlags visibility, SkString* out) const {
  for (const VkUniformInfo& sampler : fSamplers.items()) {
    SkASSERT(
        sampler.fVariable.getType() == SkSLType::kTexture2DSampler ||
  ...
  for (const VkUniformInfo& localUniform : fUniforms.items()) {
    if (!firstOffsetCheck) {
      ...
      SkASSERT(
          0 == localUniform.fOffsets[kStd140Layout] && 0 == localUniform.fOffsets[kStd430Layout]);
  ...
  if (!uniformsString.isEmpty()) {
    if (fUsePushConstants) {
      ...
      out->appendf("layout (set=%d, binding=%d) ", kUniformBufferDescSet, kUniformBinding);
    }
