...
sk_sp<const GrVkFramebuffer> GrVkFramebuffer::Make(
    ...
    GrVkImage* colorAttachment, GrVkImage* resolveAttachment, GrVkImage* stencilAttachment,
...
GrVkFramebuffer::GrVkFramebuffer(
    const GrVkGpu* gpu, VkFramebuffer framebuffer, sk_sp<GrVkImage> colorAttachment,
    sk_sp<GrVkImage> resolveAttachment, sk_sp<GrVkImage> stencilAttachment,
...
GrVkFramebuffer::GrVkFramebuffer(
    const GrVkGpu* gpu, sk_sp<GrVkImage> colorAttachment, sk_sp<const GrVkRenderPass> renderPass,
