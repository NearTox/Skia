...
class GrVkTexture : public GrTexture {
 public:
  static sk_sp<GrVkTexture> MakeNewTexture(
      ...
      GrProtected, GrMipmapStatus, std::string_view label);
 ...
 protected:
  GrVkTexture(
      GrVkGpu*, SkISize dimensions, sk_sp<GrVkImage> texture, GrMipmapStatus,
 ...
 private:
  GrVkTexture(
      GrVkGpu*, SkBudgeted, SkISize, sk_sp<GrVkImage> texture, GrMipmapStatus,
      std::string_view label);
  GrVkTexture(
      GrVkGpu*, SkISize, sk_sp<GrVkImage> texture, GrMipmapStatus, GrWrapCacheable, GrIOType,
