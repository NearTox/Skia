...
bool AllocAndBindImageMemory(GrVkGpu* gpu, VkImage image, GrMemoryless, GrVkAlloc* alloc);
...
void FlushMappedAlloc(GrVkGpu* gpu, const GrVkAlloc& alloc, VkDeviceSize offset, VkDeviceSize size);
