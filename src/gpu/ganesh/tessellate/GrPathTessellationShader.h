...
class GrPathTessellationShader : public GrTessellationShader {
 ...
 public:
  ...
  static GrPathTessellationShader* Make(
 ...
 protected:
  ...
  GrPathTessellationShader(
      ClassID classID, GrPrimitiveType primitiveType, const SkMatrix& viewMatrix,
      const SkPMColor4f& color, PatchAttribs attribs)
      : GrTessellationShader(classID, primitiveType, viewMatrix, color), fAttribs(attribs) {}
  ...
  class Impl : public ProgramImpl {
   ...
   protected:
    ...
    virtual void emitVertexCode(
        const GrShaderCaps&, const GrPathTessellationShader&, GrGLSLVertexBuilder*,
        GrGLSLVaryingHandler*, GrGPArgs*) = 0;
