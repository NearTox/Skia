...
class GrDawnGpu : public GrGpu {
 public:
  ...
  std::string SkSLToSPIRV(
      const char* shaderString, SkSL::ProgramKind, uint32_t rtFlipOffset, SkSL::Program::Inputs*);
 ...
 private:
  ...
  bool onWritePixels(
      ...
      const GrMipLevel[], int mipLevelCount, bool) override;
