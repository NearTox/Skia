...
class GrDawnTexture : public GrTexture {
 public:
  static sk_sp<GrDawnTexture> Make(
      ...
      SkBudgeted, int mipLevels, GrMipmapStatus, std::string_view label);

  static sk_sp<GrDawnTexture> MakeWrapped(
      GrDawnGpu*, SkISize dimensions, GrRenderable, int sampleCnt, GrWrapCacheable, GrIOType,
 ...
 protected:
  GrDawnTexture(
      GrDawnGpu*, SkISize dimensions, const GrDawnTextureInfo&, GrMipmapStatus,
