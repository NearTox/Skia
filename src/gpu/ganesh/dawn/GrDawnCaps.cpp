...
static skgpu::Swizzle get_swizzle(
    const GrBackendFormat& format, GrColorType colorType, bool forOutput) {
  switch (colorType) {
    ...
    case GrColorType::kRGB_888x:
      ...
      break;
    default: return skgpu::Swizzle::RGBA();
  }
