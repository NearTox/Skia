...
struct GrDawnProgram : public SkRefCnt {
  ...
  GrDawnProgram(const GrSPIRVUniformHandler::UniformInfoArray& uniforms, uint32_t uniformBufferSize)
  ...
  wgpu::BindGroup setTextures(
      GrDawnGpu*, const GrGeometryProcessor&, const GrPipeline&,
...
class GrDawnProgramBuilder : public GrGLSLProgramBuilder {
 public:
  static sk_sp<GrDawnProgram> Build(
      GrDawnGpu*, GrRenderTarget*, const GrProgramInfo&, wgpu::TextureFormat colorFormat,
      bool hasDepthStencil, wgpu::TextureFormat depthStencilFormat, GrProgramDesc*);
 ...
 private:
  GrDawnProgramBuilder(GrDawnGpu*, const GrProgramInfo&, GrProgramDesc*);
  wgpu::ShaderModule createShaderModule(
      const GrGLSLShaderBuilder&, SkSL::ProgramKind, bool flipY, SkSL::Program::Inputs* inputs);
  GrDawnGpu* fGpu;
