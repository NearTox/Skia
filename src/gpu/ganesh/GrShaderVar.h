...
class GrShaderVar {
 public:
  ...
  GrShaderVar() noexcept
      : fType(SkSLType::kVoid), fTypeModifier(TypeModifier::None), fCount(kNonArray) {}

  GrShaderVar(SkString name, SkSLType type, int arrayCount = kNonArray) noexcept
      : fType(type),
  ...
  GrShaderVar(SkString name, SkSLType type, TypeModifier typeModifier) noexcept
  ...
  GrShaderVar(SkString name, SkSLType type, TypeModifier typeModifier, int arrayCount) noexcept
      : fType(type), fTypeModifier(typeModifier), fCount(arrayCount), fName(std::move(name)) {}

  GrShaderVar(
      SkString name, SkSLType type, TypeModifier typeModifier, int arrayCount,
  ...
  /** Get the type. */
  SkSLType getType() const noexcept { return fType; }
