...
std::unique_ptr<GrD3DDescriptorHeap> GrD3DDescriptorHeap::Make(
  ...
  return std::unique_ptr<GrD3DDescriptorHeap>(new GrD3DDescriptorHeap(
...
GrD3DDescriptorHeap::GrD3DDescriptorHeap(
    const gr_cp<ID3D12DescriptorHeap>& heap, unsigned int handleIncrementSize)
    : fHeap(heap), fHandleIncrementSize(handleIncrementSize), fUniqueID(GenID()) {
