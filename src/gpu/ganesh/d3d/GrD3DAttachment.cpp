...
sk_sp<GrD3DAttachment> GrD3DAttachment::MakeStencil(
    GrD3DGpu* gpu, SkISize dimensions, int sampleCnt, DXGI_FORMAT format) {
  ...
  return sk_sp<GrD3DAttachment>(new GrD3DAttachment(
      gpu, dimensions, UsageFlags::kStencilAttachment, format, resourceDesc, info, std::move(state),
      view,
