...
std::unique_ptr<GrD3DDirectCommandList> GrD3DDirectCommandList::Make(GrD3DGpu* gpu) {
  ...
  auto grCL = new GrD3DDirectCommandList(
      std::move(allocator), std::move(commandList),
...
void GrD3DDirectCommandList::setDescriptorHeaps(
    ID3D12DescriptorHeap* srvCrvDescriptorHeap, ID3D12DescriptorHeap* samplerDescriptorHeap) {
