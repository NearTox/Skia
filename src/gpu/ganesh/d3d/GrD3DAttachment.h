...
class GrD3DAttachment : public GrAttachment, public GrD3DTextureResource {
 public:
  static sk_sp<GrD3DAttachment> MakeStencil(
 ...
 private:
  GrD3DAttachment(
      ...
      const D3D12_RESOURCE_DESC&, const GrD3DTextureResourceInfo&, sk_sp<GrD3DResourceState>,
      const GrD3DDescriptorHeap::CPUHandle& view, std::string_view label);
