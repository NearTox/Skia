...
GrD3DPipelineState::GrD3DPipelineState(
    sk_sp<GrD3DPipeline> pipeline, sk_sp<GrD3DRootSignature> rootSignature,
    ...
    std::vector<std::unique_ptr<GrFragmentProcessor::ProgramImpl>> fpImpls, size_t vertexStride,
...
void GrD3DPipelineState::setAndBindTextures(
    GrD3DGpu* gpu, const GrGeometryProcessor& geomProc,
