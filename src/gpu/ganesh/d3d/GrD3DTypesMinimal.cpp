...
GrD3DBackendSurfaceInfo::GrD3DBackendSurfaceInfo(
    const GrD3DTextureResourceInfo& info, GrD3DResourceState* state)
...
GrD3DSurfaceInfo GrD3DTextureResourceSpecHolder::getSurfaceInfo(
    uint32_t sampleCount, uint32_t levelCount, GrProtected isProtected) const {
  SkASSERT(fSpec);
