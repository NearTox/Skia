...
class GrStyledShape {
 public:
  ...
  GrStyledShape(
      const SkRRect& rrect, const SkPaint& paint, DoSimplify doSimplify = DoSimplify::kYes)
  ...
  GrStyledShape(
      const SkRRect& rrect, const GrStyle& style, DoSimplify doSimplify = DoSimplify::kYes)
  ...
  static GrStyledShape MakeArc(
      ...
      const GrStyle& style, DoSimplify = DoSimplify::kYes);
