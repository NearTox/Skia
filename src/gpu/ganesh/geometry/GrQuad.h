...
class GrQuad {
 public:
  ...
  void writeVertex(int cornerIdx, skgpu::VertexWriter& w) const { w << this->point(cornerIdx); }
...
template <>
struct skgpu::VertexWriter::is_quad<GrQuad> : std::true_type {};
