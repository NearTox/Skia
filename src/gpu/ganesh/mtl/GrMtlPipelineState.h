...
class GrMtlPipelineState {
 public:
  ...
  GrMtlPipelineState(
      GrMtlGpu*, sk_sp<GrMtlRenderPipeline> pipeline, MTLPixelFormat,
  ...
  void setTextures(
      const GrGeometryProcessor&, const GrPipeline&,
      const GrSurfaceProxy* const geomProcTextures[]);
  void bindTextures(GrMtlRenderCommandEncoder* renderCmdEncoder);

  void setDrawState(
      GrMtlRenderCommandEncoder*, const skgpu::Swizzle& writeSwizzle, const GrXferProcessor&);
 ...
 private:
  ...
  void setBlendConstants(GrMtlRenderCommandEncoder*, const skgpu::Swizzle&, const GrXferProcessor&);
