...
class GrProxyProvider {
 public:
  ...
  sk_sp<GrTextureProxy> findOrCreateProxyByUniqueKey(
      const skgpu::UniqueKey&, UseAllocator = UseAllocator::kYes);
   ...
   */
  GrSurfaceProxyView findCachedProxyWithColorTypeFallback(
      const skgpu::UniqueKey&, GrSurfaceOrigin, GrColorType, int sampleCnt);
  ...
  sk_sp<GrTextureProxy> createProxy(
      ...
      GrMipmapped, SkBackingFit, SkBudgeted, GrProtected, std::string_view label,
  ...
  sk_sp<GrTextureProxy> wrapCompressedBackendTexture(
      const GrBackendTexture&, GrWrapOwnership, GrWrapCacheable, sk_sp<skgpu::RefCntedCallback>);
  ...
  sk_sp<GrSurfaceProxy> wrapBackendRenderTarget(
      const GrBackendRenderTarget&, sk_sp<skgpu::RefCntedCallback> releaseHelper);
   ...
   */
  static sk_sp<GrTextureProxy> CreatePromiseProxy(
      GrContextThreadSafeProxy*, LazyInstantiateCallback&&, const GrBackendFormat&,
      SkISize dimensions, GrMipmapped);
  ...
  sk_sp<GrTextureProxy> createLazyProxy(
      LazyInstantiateCallback&&, const GrBackendFormat&, SkISize dimensions, GrMipmapped,
      GrMipmapStatus, GrInternalSurfaceFlags, SkBackingFit, SkBudgeted, GrProtected, UseAllocator);
  ...
  static sk_sp<GrTextureProxy> MakeFullyLazyProxy(
      ...
      GrProtected, const GrCaps&, UseAllocator);
 ...
 private:
  ...
  void processInvalidUniqueKeyImpl(
      const skgpu::UniqueKey&, GrTextureProxy*, InvalidateGPUResource, RemoveTableEntry);
   ...
   */
  sk_sp<GrTextureProxy> createMippedProxyFromBitmap(const SkBitmap&, SkBudgeted);
  ...
  typedef SkTDynamicHash<GrTextureProxy, skgpu::UniqueKey, UniquelyKeyedProxyHashTraits>
