...
class SurfaceContext {
 public:
   ...
   * conversions.
   */
  std::unique_ptr<skgpu::SurfaceFillContext> rescale(
   ...
   */
  bool rescaleInto(
      SurfaceFillContext* dst, SkIRect dstRect, SkIRect srcRect, SkImage::RescaleGamma,
      SkImage::RescaleMode);
 ...
 private:
  ...
  bool internalWritePixels(
      GrDirectContext* dContext, const GrCPixmap src[], int numLevels, SkIPoint);
