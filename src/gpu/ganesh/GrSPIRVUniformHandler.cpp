...
GrGLSLUniformHandler::UniformHandle GrSPIRVUniformHandler::internalAddUniformArray(
  ...
  tempInfo.fVariable = GrShaderVar{std::move(resolvedName),         type,
                                   GrShaderVar::TypeModifier::None, arrayCount,
...
GrGLSLUniformHandler::SamplerHandle GrSPIRVUniformHandler::addSampler(
    const GrBackendFormat&, GrSamplerState, const skgpu::Swizzle& swizzle, const char* name,
  ...
  tempInfo.fVariable = GrShaderVar{
      std::move(mangleName),  SkSLType::kSampler,         GrShaderVar::TypeModifier::Uniform,
  ...
  tempInfo.fVariable = GrShaderVar{std::move(mangleTexName),           SkSLType::kTexture2D,
  ...
  SkString reference;
  reference.printf(
      "makeSampler2D(%s, %s)", fTextures.back().fVariable.getName().c_str(),
