...
class GrVkFramebuffer : public GrVkManagedResource {
 public:
  static sk_sp<const GrVkFramebuffer> Make(
      ...
      GrVkAttachment* stencilAttachment, GrVkResourceProvider::CompatibleRPHandle);
 ...
 private:
  GrVkFramebuffer(
      ...
      sk_sp<const GrVkRenderPass> compatibleRenderPass, GrVkResourceProvider::CompatibleRPHandle);
