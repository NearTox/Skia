...
void GrVkPipelineStateDataManager::set1iv(
...
void GrVkPipelineStateDataManager::set2iv(
    UniformHandle u, int arrayCount, const int32_t v[]) const {
  const Uniform& uni = fUniforms[u.toIndex()];
  SkASSERT(uni.fType == kInt2_GrSLType || uni.fType == kShort2_GrSLType);
  SkASSERT(arrayCount > 0);
...
void GrVkPipelineStateDataManager::set3i(
...
void GrVkPipelineStateDataManager::set3iv(
    UniformHandle u, int arrayCount, const int32_t v[]) const {
  const Uniform& uni = fUniforms[u.toIndex()];
  SkASSERT(uni.fType == kInt3_GrSLType || uni.fType == kShort3_GrSLType);
  SkASSERT(arrayCount > 0);
...
void GrVkPipelineStateDataManager::set4i(
...
void GrVkPipelineStateDataManager::set4iv(
    UniformHandle u, int arrayCount, const int32_t v[]) const {
  const Uniform& uni = fUniforms[u.toIndex()];
  SkASSERT(uni.fType == kInt4_GrSLType || uni.fType == kShort4_GrSLType);
  SkASSERT(arrayCount > 0);
...
void GrVkPipelineStateDataManager::set4f(
...
void GrVkPipelineStateDataManager::setMatrix2fv(
...
void GrVkPipelineStateDataManager::setMatrix3fv(
    UniformHandle u, int arrayCount, const float m[]) const {
...
void GrVkPipelineStateDataManager::setMatrix4fv(
    UniformHandle u, int arrayCount, const float m[]) const {
...
template <int N>
inline void GrVkPipelineStateDataManager::setMatrices(
...
bool GrVkPipelineStateDataManager::uploadUniformBuffers(
    GrVkGpu* gpu, GrVkUniformBuffer* geometryBuffer, GrVkUniformBuffer* fragmentBuffer) const {
  bool updatedBuffer = false;
  if (geometryBuffer && fGeometryUniformsDirty) {
    SkAssertResult(geometryBuffer->updateData(
        gpu, fGeometryUniformData.get(), fGeometryUniformSize, &updatedBuffer));
    fGeometryUniformsDirty = false;
  }
  if (fragmentBuffer && fFragmentUniformsDirty) {
    SkAssertResult(fragmentBuffer->updateData(
        gpu, fFragmentUniformData.get(), fFragmentUniformSize, &updatedBuffer));
    fFragmentUniformsDirty = false;
  }
