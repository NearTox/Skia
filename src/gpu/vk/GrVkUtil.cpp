...
bool GrPixelConfigToVkFormat(GrPixelConfig config, VkFormat* format) {
  ...
  switch (config) {
    ...
    case kAlpha_half_as_Lum_GrPixelConfig: return false;
    case kR_16_GrPixelConfig: *format = VK_FORMAT_R16_UNORM; return true;
    case kRG_1616_GrPixelConfig: *format = VK_FORMAT_R16G16_UNORM; return true;
    // Experimental (for Y416 and mutant P016/P010)
    case kRGBA_16161616_GrPixelConfig: *format = VK_FORMAT_R16G16B16A16_UNORM; return true;
    case kRG_half_GrPixelConfig: *format = VK_FORMAT_R16G16_SFLOAT; return true;
  }
...
bool GrVkFormatColorTypePairIsValid(VkFormat format, GrColorType colorType) {
  switch (format) {
    case VK_FORMAT_R8G8B8A8_UNORM:
      return GrColorType::kRGBA_8888 == colorType || GrColorType::kRGB_888x == colorType;
    ...
    case VK_FORMAT_R8_UNORM:
      return GrColorType::kAlpha_8 == colorType || GrColorType::kGray_8 == colorType;
    case VK_FORMAT_R32G32B32A32_SFLOAT: return GrColorType::kRGBA_F32 == colorType;
    case VK_FORMAT_R16G16B16A16_SFLOAT:
      return GrColorType::kRGBA_F16 == colorType || GrColorType::kRGBA_F16_Clamped == colorType;
...
bool GrVkFormatIsSupported(VkFormat format) {
  switch (format) {
    ...
    case VK_FORMAT_R16G16_SFLOAT: return true;
    default: return false;
  }
}
