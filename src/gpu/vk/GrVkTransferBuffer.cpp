...
sk_sp<GrVkTransferBuffer> GrVkTransferBuffer::Make(
    GrVkGpu* gpu, size_t size, GrVkBuffer::Type type) {
...
GrVkTransferBuffer::GrVkTransferBuffer(
    GrVkGpu* gpu, const GrVkBuffer::Desc& desc, const GrVkBuffer::Resource* bufferResource)
    : INHERITED(
          gpu, desc.fSizeInBytes,
...
void GrVkTransferBuffer::setMemoryBacking(
