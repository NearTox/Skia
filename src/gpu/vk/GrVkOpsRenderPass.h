...
class GrVkOpsRenderPass : public GrOpsRenderPass, private GrMesh::SendToGpuImpl {
 public:
  ...
  void set(
      GrRenderTarget*, GrSurfaceOrigin, const GrOpsRenderPass::LoadAndStoreInfo&,
 ...
 private:
  ...
  GrVkPipelineState* prepareDrawState(
      ...
      const GrPipeline::DynamicStateArrays*, GrPrimitiveType);
  ...
  struct CommandBufferInfo {
    ...
    GrVkSecondaryCommandBuffer* currentCmdBuf() { return fCommandBuffer.get(); }
  };
