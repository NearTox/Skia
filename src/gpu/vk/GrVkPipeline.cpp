...
static inline VkFormat attrib_type_to_vkformat(GrVertexAttribType type) {
  switch (type) {
    ...
    case kHalf3_GrVertexAttribType: return VK_FORMAT_R16G16B16_SFLOAT;
    ...
    case kByte3_GrVertexAttribType: return VK_FORMAT_R8G8B8_SINT;
    ...
    case kUByte3_GrVertexAttribType: return VK_FORMAT_R8G8B8_UINT;
