...
bool GrVkCaps::initDescForDstCopy(
...
static int get_compatible_format_class(GrPixelConfig config) {
  switch (config) {
    ...
    case kAlpha_half_as_Red_GrPixelConfig: return 2;
    ...
    case kRGBA_1010102_GrPixelConfig: return 4;
    case kRGBA_half_GrPixelConfig:
    case kRGBA_half_Clamped_GrPixelConfig:
    case kRG_float_GrPixelConfig: return 5;
    case kRGBA_float_GrPixelConfig: return 6;
    case kRGB_ETC1_GrPixelConfig: return 7;
    case kUnknown_GrPixelConfig:
    case kAlpha_8_as_Alpha_GrPixelConfig:
    case kGray_8_as_Lum_GrPixelConfig: SK_ABORT("Unsupported Vulkan pixel config"); return 0;
  }
...
bool GrVkCaps::onCanCopySurface(
  ...
  return this->canCopyImage(
         ...
         this->canCopyAsResolve(
             ...
             srcHasYcbcr) ||
         this->canCopyAsDraw(
             dstConfig, dstSampleCnt > 0, dstHasYcbcr, srcConfig, SkToBool(src->asTextureProxy()),
             srcHasYcbcr);
}
...
void GrVkCaps::initShaderCaps(
  ...
  for (int i = 0; i < kGrPixelConfigCnt; ++i) {
    ...
    if (GrPixelConfigIsAlphaOnly(config) && kAlpha_8_as_Alpha_GrPixelConfig != config) {
      shaderCaps->fConfigTextureSwizzle[i] = GrSwizzle::RRRR();
      shaderCaps->fConfigOutputSwizzle[i] = GrSwizzle::AAAA();
    } else {
      if (kGray_8_GrPixelConfig == config || kGray_8_as_Red_GrPixelConfig == config) {
...
static bool format_is_srgb(VkFormat format) {
  switch (format) {
    ...
    case VK_FORMAT_R16_SFLOAT: return false;
    default: SK_ABORT("Unsupported VkFormat"); return false;
  }
}
...
static constexpr VkFormat kVkFormats[] = {VK_FORMAT_R8G8B8A8_UNORM,
                                          VK_FORMAT_R8_UNORM,
...
static GrPixelConfig validate_image_info(VkFormat format, SkColorType ct, bool hasYcbcrConversion) {
  ...
  switch (ct) {
    ...
    case kRGBA_1010102_SkColorType:
      ...
      break;
    case kRGB_101010x_SkColorType: return kUnknown_GrPixelConfig;
...
GrPixelConfig GrVkCaps::getConfigFromBackendFormat(
...
GrBackendFormat GrVkCaps::getBackendFormatFromGrColorType(
...
static bool format_color_type_valid_pair(VkFormat vkFormat, GrColorType colorType) {
  switch (colorType) {
    ...
    case GrColorType::kRGB_565: return VK_FORMAT_R5G6B5_UNORM_PACK16 == vkFormat;
    ...
    case GrColorType::kRG_F32: return VK_FORMAT_R32G32_SFLOAT == vkFormat;
    case GrColorType::kRGBA_F32: return VK_FORMAT_R32G32B32A32_SFLOAT == vkFormat;
    case GrColorType::kRGB_ETC1: return VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK == vkFormat;
  }
