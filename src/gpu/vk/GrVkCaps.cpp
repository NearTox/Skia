...
bool GrVkCaps::isFormatCompressed(
...
GrColorType GrVkCaps::getYUVAColorTypeFromBackendFormat(
  ...
  switch (vkFormat) {
    case VK_FORMAT_R8_UNORM: return isAlphaChannel ? GrColorType::kAlpha_8 : GrColorType::kGray_8;
...
void GrVkCaps::addExtraSamplerKey(
    GrProcessorKeyBuilder* b, const GrSamplerState& samplerState,
