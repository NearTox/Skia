...
GrVkCaps::GrVkCaps(
  ...
  this->init(
      contextOptions, vkInterface, physDev, features, physicalDeviceVersion, extensions,
      isProtected);
}
...
static int get_compatible_format_class(GrPixelConfig config) {
  switch (config) {
    ...
    case kRGB_888_GrPixelConfig: return 3;
    ...
    case kRGBA_half_Clamped_GrPixelConfig: return 5;
    case kRGBA_float_GrPixelConfig: return 6;
    case kRGB_ETC1_GrPixelConfig: return 7;
    case kUnknown_GrPixelConfig:
    case kAlpha_8_as_Alpha_GrPixelConfig:
    case kGray_8_as_Lum_GrPixelConfig:
    case kAlpha_half_as_Lum_GrPixelConfig: SK_ABORT("Unsupported Vulkan pixel config"); return 0;
...
bool GrVkCaps::canCopyAsResolve(
    GrPixelConfig dstConfig, int dstSampleCnt, bool dstHasYcbcr, GrPixelConfig srcConfig,
    int srcSampleCnt, bool srcHasYcbcr) const {
...
bool GrVkCaps::onCanCopySurface(
  ...
  return this->canCopyImage(
             dstConfig, dstSampleCnt, dstHasYcbcr, srcConfig, srcSampleCnt, srcHasYcbcr) ||
         this->canCopyAsBlit(
             dstConfig, dstSampleCnt, dstIsLinear, dstHasYcbcr, srcConfig, srcSampleCnt,
             srcIsLinear, srcHasYcbcr) ||
         this->canCopyAsResolve(
             dstConfig, dstSampleCnt, dstHasYcbcr, srcConfig, srcSampleCnt, srcHasYcbcr);
}

template <typename T>
T* get_extension_feature_struct(const VkPhysicalDeviceFeatures2& features, VkStructureType type) {
...
void GrVkCaps::init(
  ...
  auto ycbcrFeatures = get_extension_feature_struct<VkPhysicalDeviceSamplerYcbcrConversionFeatures>(
...
void GrVkCaps::initGrCaps(
    const GrVkInterface* vkInterface, VkPhysicalDevice physDev,
    const VkPhysicalDeviceProperties& properties,
    const VkPhysicalDeviceMemoryProperties& memoryProperties,
    const VkPhysicalDeviceFeatures2& features, const GrVkExtensions& extensions) {
  ...
  if (extensions.hasExtension(VK_EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME, 2) &&
    ...
    blendProps.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT;
    ...
    if (blendProps.advancedBlendAllOperations == VK_TRUE) {
      ...
      auto blendFeatures =
          get_extension_feature_struct<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT>(
              features, VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_FEATURES_EXT);
...
void GrVkCaps::initShaderCaps(
    const VkPhysicalDeviceProperties& properties, const VkPhysicalDeviceFeatures2& features) {
...
bool stencil_format_supported(
    const GrVkInterface* interface, VkPhysicalDevice physDev, VkFormat format) {
...
void GrVkCaps::FormatInfo::initSampleCounts(
    const GrVkInterface* interface, VkPhysicalDevice physDev,
    const VkPhysicalDeviceProperties& physProps, VkFormat format) {
  VkImageUsageFlags usage = VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT |
                            VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT;
  VkImageFormatProperties properties;
  GR_VK_CALL(
      interface, GetPhysicalDeviceImageFormatProperties(
                     physDev, format, VK_IMAGE_TYPE_2D, VK_IMAGE_TILING_OPTIMAL, usage,
                     0,  // createFlags
                     &properties));
...
void GrVkCaps::FormatInfo::init(
    const GrVkInterface* interface, VkPhysicalDevice physDev,
    const VkPhysicalDeviceProperties& properties, VkFormat format) {
  VkFormatProperties props;
  memset(&props, 0, sizeof(VkFormatProperties));
  GR_VK_CALL(interface, GetPhysicalDeviceFormatProperties(physDev, format, &props));
...
int GrVkCaps::getRenderTargetSampleCount(
    int requestedCount, GrColorType, const GrBackendFormat& format) const {
  if (!format.getVkFormat()) {
    return 0;
  }
...
static GrPixelConfig validate_image_info(VkFormat format, GrColorType ct, bool hasYcbcrConversion) {
  ...
  switch (ct) {
    case GrColorType::kUnknown: break;
    ...
    case GrColorType::kABGR_4444:
      if (VK_FORMAT_B4G4R4A4_UNORM_PACK16 == format || VK_FORMAT_R4G4B4A4_UNORM_PACK16 == format) {
...
GrPixelConfig GrVkCaps::validateBackendRenderTarget(
...
bool GrVkCaps::onAreColorTypeAndFormatCompatible(
...
GrPixelConfig GrVkCaps::onGetConfigFromBackendFormat(
...
static GrPixelConfig get_yuva_config(VkFormat vkFormat) {
  switch (vkFormat) {
    case VK_FORMAT_R8_UNORM: return kAlpha_8_as_Red_GrPixelConfig;
    case VK_FORMAT_R8G8B8A8_UNORM: return kRGBA_8888_GrPixelConfig;
    case VK_FORMAT_R8G8B8_UNORM: return kRGB_888_GrPixelConfig;
    case VK_FORMAT_R8G8_UNORM: return kRG_88_GrPixelConfig;
    case VK_FORMAT_B8G8R8A8_UNORM: return kBGRA_8888_GrPixelConfig;
    case VK_FORMAT_A2B10G10R10_UNORM_PACK32: return kRGBA_1010102_GrPixelConfig;
    case VK_FORMAT_R16_UNORM: return kR_16_GrPixelConfig;
    case VK_FORMAT_R16G16_UNORM: return kRG_1616_GrPixelConfig;
    // Experimental (for Y416 and mutant P016/P010)
    case VK_FORMAT_R16G16B16A16_UNORM: return kRGBA_16161616_GrPixelConfig;
    case VK_FORMAT_R16G16_SFLOAT: return kRG_half_GrPixelConfig;
...
static bool format_color_type_valid_pair(VkFormat vkFormat, GrColorType colorType) {
  switch (colorType) {
    ...
    case GrColorType::kAlpha_8: return VK_FORMAT_R8_UNORM == vkFormat;
    case GrColorType::kBGR_565: return VK_FORMAT_R5G6B5_UNORM_PACK16 == vkFormat;
    case GrColorType::kABGR_4444:
      return VK_FORMAT_B4G4R4A4_UNORM_PACK16 == vkFormat ||
             VK_FORMAT_R4G4B4A4_UNORM_PACK16 == vkFormat;
    case GrColorType::kRGBA_8888: return VK_FORMAT_R8G8B8A8_UNORM == vkFormat;
    case GrColorType::kRGBA_8888_SRGB: return VK_FORMAT_R8G8B8A8_SRGB == vkFormat;
    case GrColorType::kRGB_888x:
      GR_STATIC_ASSERT(
    ...
    case GrColorType::kRG_88: return VK_FORMAT_R8G8_UNORM == vkFormat;
    case GrColorType::kBGRA_8888: return VK_FORMAT_B8G8R8A8_UNORM == vkFormat;
    case GrColorType::kRGBA_1010102: return VK_FORMAT_A2B10G10R10_UNORM_PACK32 == vkFormat;
    case GrColorType::kGray_8: return VK_FORMAT_R8_UNORM == vkFormat;
    case GrColorType::kAlpha_F16: return VK_FORMAT_R16_SFLOAT == vkFormat;
    case GrColorType::kRGBA_F16: return VK_FORMAT_R16G16B16A16_SFLOAT == vkFormat;
    case GrColorType::kRGBA_F16_Clamped: return VK_FORMAT_R16G16B16A16_SFLOAT == vkFormat;
    case GrColorType::kRGBA_F32: return VK_FORMAT_R32G32B32A32_SFLOAT == vkFormat;
    case GrColorType::kR_16: return VK_FORMAT_R16_UNORM == vkFormat;
    case GrColorType::kRG_1616: return VK_FORMAT_R16G16_UNORM == vkFormat;
    // Experimental (for Y416 and mutant P016/P010)
    case GrColorType::kRGBA_16161616: return VK_FORMAT_R16G16B16A16_UNORM == vkFormat;
    case GrColorType::kRG_F16: return VK_FORMAT_R16G16_SFLOAT == vkFormat;
  }
...
GrCaps::SupportedRead GrVkCaps::supportedReadPixelsColorType(
  ...
  switch (*vkFormat) {
    case VK_FORMAT_R8G8B8A8_UNORM: return {GrSwizzle::RGBA(), GrColorType::kRGBA_8888};
    ...
    case VK_FORMAT_B8G8R8A8_UNORM: return {GrSwizzle::RGBA(), GrColorType::kBGRA_8888};
    case VK_FORMAT_R5G6B5_UNORM_PACK16: return {GrSwizzle::RGBA(), GrColorType::kBGR_565};
    ...
    case VK_FORMAT_R16_SFLOAT: return {GrSwizzle::RGBA(), GrColorType::kAlpha_F16};
    case VK_FORMAT_R8G8B8_UNORM: return {GrSwizzle::RGBA(), GrColorType::kRGB_888x};
    case VK_FORMAT_R8G8_UNORM: return {GrSwizzle::RGBA(), GrColorType::kRG_88};
    case VK_FORMAT_A2B10G10R10_UNORM_PACK32: return {GrSwizzle::RGBA(), GrColorType::kRGBA_1010102};
    case VK_FORMAT_B4G4R4A4_UNORM_PACK16: return {GrSwizzle::RGBA(), GrColorType::kABGR_4444};
    case VK_FORMAT_R4G4B4A4_UNORM_PACK16: return {GrSwizzle::RGBA(), GrColorType::kABGR_4444};
    case VK_FORMAT_R32G32B32A32_SFLOAT: return {GrSwizzle::RGBA(), GrColorType::kRGBA_F32};
    case VK_FORMAT_R8G8B8A8_SRGB: return {GrSwizzle::RGBA(), GrColorType::kRGBA_8888_SRGB};
    case VK_FORMAT_R16_UNORM: return {GrSwizzle::RGBA(), GrColorType::kR_16};
    case VK_FORMAT_R16G16_UNORM: return {GrSwizzle::RGBA(), GrColorType::kRG_1616};
    // Experimental (for Y416 and mutant P016/P010)
    case VK_FORMAT_R16G16B16A16_UNORM: return {GrSwizzle::RGBA(), GrColorType::kRGBA_16161616};
    case VK_FORMAT_R16G16_SFLOAT: return {GrSwizzle::RGBA(), GrColorType::kRG_F16};
    default: return {GrSwizzle(), GrColorType::kUnknown};
  }
}
