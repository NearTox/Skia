...
std::unique_ptr<GrDrawOp> Make(
    GrRecordingContext*, sk_sp<GrTextureProxy>, GrColorType srcColorType, sk_sp<GrColorSpaceXform>,
...
std::unique_ptr<GrDrawOp> MakeSet(
    ...
    GrSamplerState::Filter, Saturate, GrAAType, SkCanvas::SrcRectConstraint,
