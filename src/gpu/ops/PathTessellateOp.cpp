...
void PathTessellateOp::prepareTessellator(
  ...
  fTessellator = GrPathWedgeTessellator::Make(
      args.fArena, fViewMatrix, fColor, fPath.countVerbs(), *pipeline, *args.fCaps);
  fTessellationProgram =
      GrTessellationShader::MakeProgram(args, fTessellator->shader(), pipeline, fStencil);
}
