...
std::unique_ptr<GrDrawOp> MakePerEdge(
    ...
    const SkMatrix& viewMatrix, const SkRect& rect, const GrUserStencilSettings* stencil = nullptr);
...
std::unique_ptr<GrDrawOp> Make(
    GrRecordingContext* context, GrPaint&& paint, GrAAType aaType, const SkMatrix& viewMatrix,
    const SkRect& rect, const GrUserStencilSettings* stencil = nullptr);
// FIXME(michaelludwig) - To be removed after usages replaced with MakeGeneric
...
std::unique_ptr<GrDrawOp> MakeWithLocalRect(
    GrRecordingContext* context, GrPaint&& paint, GrAAType aaType, const SkMatrix& viewMatrix,
    const SkRect& rect, const SkRect& localRect, const GrUserStencilSettings* stencil = nullptr);
