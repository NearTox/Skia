...
protected:
    ...
    FixedFunctionFlags fixedFunctionFlags() const override {
        return (fDoAA) ? FixedFunctionFlags::kUsesHWAA | FixedFunctionFlags::kUsesStencil
...
protected:
    ...
    const GrProcessorSet::Analysis& doProcessorAnalysis(const GrCaps&, const GrAppliedClip*,
                                                        GrFSAAType, GrClampType);
...
public:
    ...
    static std::unique_ptr<GrDrawOp> Make(GrRecordingContext*, const SkMatrix& viewMatrix,
                                          GrPaint&&, GrAA, GrPath*);
