...
class GrMeshDrawOp : public GrDrawOp {
 ...
 protected:
  ...
  class PatternHelper {
   public:
    PatternHelper(
        GrMeshDrawTarget*, GrPrimitiveType, size_t vertexStride, sk_sp<const GrBuffer> indexBuffer,
    ...
    void recordDraw(
        GrMeshDrawTarget*, const GrGeometryProcessor*,
  ...
  virtual void onPrePrepareDraws(
      ...
      const GrDstProxyView&, GrXferBarrierFlags renderPassXferBarriers, GrLoadOp colorLoadOp);
