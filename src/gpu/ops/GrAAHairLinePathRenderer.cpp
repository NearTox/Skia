...
class AAHairlineOp final : public GrMeshDrawOp {
 ...
 private:
  GrGeometryProcessor* makeLineGP(
      const GrCaps&, SkArenaAlloc*, const SkMatrix* geometryProcessorViewM,
      const SkMatrix* geometryProcessorLocalM);
  GrGeometryProcessor* makeQuadGP(
      const GrCaps&, SkArenaAlloc*, const SkMatrix* geometryProcessorViewM,
      const SkMatrix* geometryProcessorLocalM);
  GrGeometryProcessor* makeConicGP(
      const GrCaps&, SkArenaAlloc*, const SkMatrix* geometryProcessorViewM,
      const SkMatrix* geometryProcessorLocalM);
...
GrGeometryProcessor* AAHairlineOp::makeLineGP(
    const GrCaps& caps, SkArenaAlloc* arena, const SkMatrix* geometryProcessorViewM,
    const SkMatrix* geometryProcessorLocalM) {
  ...
  GrGeometryProcessor* lineGP = GrDefaultGeoProcFactory::Make(
      arena, caps.shaderCaps(), color, Coverage::kAttribute_Type, localCoords,
...
GrGeometryProcessor* AAHairlineOp::makeQuadGP(
    const GrCaps& caps, SkArenaAlloc* arena, const SkMatrix* geometryProcessorViewM,
    const SkMatrix* geometryProcessorLocalM) {
...
GrGeometryProcessor* AAHairlineOp::makeConicGP(
    const GrCaps& caps, SkArenaAlloc* arena, const SkMatrix* geometryProcessorViewM,
    const SkMatrix* geometryProcessorLocalM) {
...
void AAHairlineOp::onPrepareDraws(Target* target) {
  ...
  if (lineCount) {
    ...
    GrGeometryProcessor* lineGP = this->makeLineGP(
