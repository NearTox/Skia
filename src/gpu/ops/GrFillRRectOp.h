...
public:
    ...
    static std::unique_ptr<GrFillRRectOp> Make(GrRecordingContext*, GrAAType,
                                               const SkMatrix& viewMatrix, const SkRRect&,
...
private:
    ...
    GrFillRRectOp(GrAAType, const SkRRect&, Flags, const SkMatrix& totalShapeMatrix, GrPaint&&,
