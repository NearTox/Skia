  ...
  void onPrepareDraws(Target* target) override {
    sk_sp<GrGeometryProcessor> gp;
    {
      ...
      gp = GrDefaultGeoProcFactory::Make(
          target->caps().shaderCaps(), color, coverage, localCoords, this->viewMatrix());
    }
...
bool GrDefaultPathRenderer::internalDrawPath(
  ...
  SkRect devBounds;
  GetPathDevBounds(
      path, renderTargetContext->asRenderTargetProxy()->worstCaseWidth(),
      renderTargetContext->asRenderTargetProxy()->worstCaseHeight(), viewMatrix, &devBounds);
...
GrPathRenderer::CanDrawPath GrDefaultPathRenderer::onCanDrawPath(
...
bool GrDefaultPathRenderer::onDrawPath(const DrawPathArgs& args) {
  GR_AUDIT_TRAIL_AUTO_FRAME(
      args.fRenderTargetContext->auditTrail(), "GrDefaultPathRenderer::onDrawPath");
  GrAAType aaType = (AATypeFlags::kNone != args.fAATypeFlags) ? GrAAType::kMSAA : GrAAType::kNone;
...
void GrDefaultPathRenderer::onStencilPath(const StencilPathArgs& args) {
  GR_AUDIT_TRAIL_AUTO_FRAME(
      args.fRenderTargetContext->auditTrail(), "GrDefaultPathRenderer::onStencilPath");
