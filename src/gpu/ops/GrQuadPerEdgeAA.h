...
struct VertexSpec {
 public:
  VertexSpec(
      GrQuadType deviceQuadType, ColorType colorType, GrQuadType localQuadType, bool hasLocalCoords,
      Domain domain, GrAAType aa, bool coverageAsAlpha)
      : fDeviceQuadType(static_cast<unsigned>(deviceQuadType)),
        ...
        fRequiresGeometryDomain(
            aa == GrAAType::kCoverage && deviceQuadType > GrQuadType::kRectilinear) {}
...
void* Tessellate(
    void* vertices, const VertexSpec& spec, const GrPerspQuad& deviceQuad, const SkPMColor4f& color,
    const GrPerspQuad& localQuad, const SkRect& domain, GrQuadAAFlags aa);
