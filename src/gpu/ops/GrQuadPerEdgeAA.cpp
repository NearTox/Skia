...
void Tessellator::append(
    GrQuad* deviceQuad, GrQuad* localQuad, const SkPMColor4f& color, const SkRect& uvDomain,
  ...
  if (fVertexSpec.usesCoverageAA()) {
    ...
    if (aaFlags == GrQuadAAFlags::kNone) {
      ...
      fWriteProc(
          &fVertexWriter, fVertexSpec, deviceQuad, localQuad, kFullCoverage, color, geomDomain,
          uvDomain);
      ...
      fWriteProc(
          &fVertexWriter, fVertexSpec, deviceQuad, localQuad, kZeroCoverage, color, geomDomain,
          uvDomain);
    } else {
      ...
      fWriteProc(
          &fVertexWriter, fVertexSpec, deviceQuad, localQuad, coverage, color, geomDomain,
          uvDomain);
    ...
    SkASSERT(
        fVertexSpec.coverageMode() == CoverageMode::kNone && !fVertexSpec.requiresGeometryDomain());
    fWriteProc(
        &fVertexWriter, fVertexSpec, deviceQuad, localQuad, kFullCoverage, color, kIgnoredDomain,
        uvDomain);
  }
}
