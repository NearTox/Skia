...
return half4(float(t) * scale + bias);
        ...
        scale2_3Var.isValid() ? args.fUniformHandler->getUniformCStr(scale2_3Var) : "float4(0)",
        bias2_3Var.isValid() ? args.fUniformHandler->getUniformCStr(bias2_3Var) : "float4(0)",
        _outer.intervalCount, args.fUniformHandler->getUniformCStr(thresholds1_7Var),
        scale4_5Var.isValid() ? args.fUniformHandler->getUniformCStr(scale4_5Var) : "float4(0)",
        bias4_5Var.isValid() ? args.fUniformHandler->getUniformCStr(bias4_5Var) : "float4(0)",
        ...
        bias10_11Var.isValid() ? args.fUniformHandler->getUniformCStr(bias10_11Var) : "float4(0)",
        _outer.intervalCount, args.fUniformHandler->getUniformCStr(thresholds9_13Var),
        scale12_13Var.isValid() ? args.fUniformHandler->getUniformCStr(scale12_13Var) : "float4(0)",
        bias12_13Var.isValid() ? args.fUniformHandler->getUniformCStr(bias12_13Var) : "float4(0)",
        scale14_15Var.isValid() ? args.fUniformHandler->getUniformCStr(scale14_15Var) : "float4(0)",
        bias14_15Var.isValid() ? args.fUniformHandler->getUniformCStr(bias14_15Var) : "float4(0)");
  }
 ...
 private:
  void onSetData(const GrGLSLProgramDataManager& pdman, const GrFragmentProcessor& _proc) override {
        ...
        _proc.cast<GrUnrolledBinaryGradientColorizer>();
    {
      ...
      pdman.set4fv(thresholds1_7Var, 1, reinterpret_cast<const float*>(&(_outer.thresholds1_7)));
      pdman.set4fv(thresholds9_13Var, 1, reinterpret_cast<const float*>(&(_outer.thresholds9_13)));
    }
  }
...
SkString GrUnrolledBinaryGradientColorizer::onDumpInfo() const {
  return SkStringPrintf(
      ...
      intervalCount, scale0_1.fR, scale0_1.fG, scale0_1.fB, scale0_1.fA, scale2_3.fR, scale2_3.fG,
      scale2_3.fB, scale2_3.fA, scale4_5.fR, scale4_5.fG, scale4_5.fB, scale4_5.fA, scale6_7.fR,
      scale6_7.fG, scale6_7.fB, scale6_7.fA, scale8_9.fR, scale8_9.fG, scale8_9.fB, scale8_9.fA,
      scale10_11.fR, scale10_11.fG, scale10_11.fB, scale10_11.fA, scale12_13.fR, scale12_13.fG,
      scale12_13.fB, scale12_13.fA, scale14_15.fR, scale14_15.fG, scale14_15.fB, scale14_15.fA,
      bias0_1.fR, bias0_1.fG, bias0_1.fB, bias0_1.fA, bias2_3.fR, bias2_3.fG, bias2_3.fB,
      bias2_3.fA, bias4_5.fR, bias4_5.fG, bias4_5.fB, bias4_5.fA, bias6_7.fR, bias6_7.fG,
      bias6_7.fB, bias6_7.fA, bias8_9.fR, bias8_9.fG, bias8_9.fB, bias8_9.fA, bias10_11.fR,
      bias10_11.fG, bias10_11.fB, bias10_11.fA, bias12_13.fR, bias12_13.fG, bias12_13.fB,
      bias12_13.fA, bias14_15.fR, bias14_15.fG, bias14_15.fB, bias14_15.fA, thresholds1_7.left(),
      thresholds1_7.top(), thresholds1_7.right(), thresholds1_7.bottom(), thresholds9_13.left(),
      thresholds9_13.top(), thresholds9_13.right(), thresholds9_13.bottom());
}
#endif
...
std::unique_ptr<GrFragmentProcessor> GrUnrolledBinaryGradientColorizer::Make(
  ...
  return std::unique_ptr<GrFragmentProcessor>(new GrUnrolledBinaryGradientColorizer(
      intervalCount, scales[0], scales[1], scales[2], scales[3], scales[4], scales[5], scales[6],
      scales[7], biases[0], biases[1], biases[2], biases[3], biases[4], biases[5], biases[6],
      biases[7], SkRect::MakeLTRB(thresholds[0], thresholds[1], thresholds[2], thresholds[3]),
