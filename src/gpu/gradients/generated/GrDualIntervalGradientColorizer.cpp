...
return half4(float(t) * scale + bias);
 ...
 private:
  void onSetData(const GrGLSLProgramDataManager& pdman, const GrFragmentProcessor& _proc) override {
    const GrDualIntervalGradientColorizer& _outer = _proc.cast<GrDualIntervalGradientColorizer>();
    {
...
SkString GrDualIntervalGradientColorizer::onDumpInfo() const {
  return SkStringPrintf(
      ...
      scale01.fR, scale01.fG, scale01.fB, scale01.fA, bias01.fR, bias01.fG, bias01.fB, bias01.fA,
      scale23.fR, scale23.fG, scale23.fB, scale23.fA, bias23.fR, bias23.fG, bias23.fB, bias23.fA,
      threshold);
}
#endif
