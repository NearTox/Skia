...
Device::Device(
    sk_sp<GrRecordingContext> rContext, const SkImageInfo& ii, const SkSurfaceProps& props)
...
bool Device::onClipIsAA() const { return false; }

bool Device::onClipIsWideOpen() const { return false; }

void Device::onAsRgnClip(SkRegion* region) const {}

SkBaseDevice::ClipType Device::onGetClipType() const { return ClipType::kEmpty; }

SkIRect Device::onDevClipBounds() const { return SkIRect::MakeEmpty(); }
...
bool Device::forceConservativeRasterClip() const { return true; }
