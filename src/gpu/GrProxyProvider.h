...
class GrProxyProvider {
 public:
   ...
   */
  sk_sp<GrTextureProxy> createMipMapProxy(
      const GrBackendFormat&, const GrSurfaceDesc&, GrRenderable, int renderTargetSampleCnt,
  ...
  sk_sp<GrTextureProxy> createProxy(
      const GrBackendFormat&, const GrSurfaceDesc&, GrRenderable, int renderTargetSampleCnt,
      GrSurfaceOrigin, GrMipMapped, SkBackingFit, SkBudgeted, GrProtected, GrInternalSurfaceFlags);
  ...
  sk_sp<GrTextureProxy> createProxy(
    ...
    return this->createProxy(
        format, desc, renderable, renderTargetSampleCnt, origin, GrMipMapped::kNo, fit, budgeted,
  ...
  sk_sp<GrTextureProxy> createLazyProxy(
      ...
      int renderTargetSampleCnt, GrSurfaceOrigin, GrMipMapped, GrInternalSurfaceFlags, SkBackingFit,
  ...
  sk_sp<GrRenderTargetProxy> createLazyRenderTargetProxy(
      ...
      int renderTargetSampleCnt, GrSurfaceOrigin origin, GrInternalSurfaceFlags, const TextureInfo*,
      SkBackingFit, SkBudgeted, GrProtected, bool wrapsVkSecondaryCB);
  ...
  static sk_sp<GrTextureProxy> MakeFullyLazyProxy(
      LazyInstantiateCallback&&, const GrBackendFormat&, GrRenderable, int renderTargetSampleCnt,
      GrProtected, GrSurfaceOrigin, GrPixelConfig, const GrCaps&);
  ...
  sk_sp<GrTextureProxy> testingOnly_createInstantiatedProxy(
      const GrSurfaceDesc&, GrRenderable, int renderTargetSampleCnt, GrSurfaceOrigin, SkBackingFit,
      SkBudgeted, GrProtected);
