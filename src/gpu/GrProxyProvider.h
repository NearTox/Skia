...
class GrProxyProvider {
 public:
  ...
  sk_sp<GrTextureProxy> findOrCreateProxyByUniqueKey(
      const GrUniqueKey&, UseAllocator = UseAllocator::kYes);
  ...
  GrSurfaceProxyView findCachedProxyWithColorTypeFallback(
      const GrUniqueKey&, GrSurfaceOrigin, GrColorType, int sampleCnt);
 ...
 private:
  ...
  void processInvalidUniqueKeyImpl(
      const GrUniqueKey&, GrTextureProxy*, InvalidateGPUResource, RemoveTableEntry);
