...
class GrProxyProvider {
 public:
   ...
   */
  void processInvalidUniqueKey(const GrUniqueKey&, GrTextureProxy*, InvalidateGPUResource) noexcept;
 ...
 private:
  ...
  void processInvalidUniqueKeyImpl(
      const GrUniqueKey&, GrTextureProxy*, InvalidateGPUResource, RemoveTableEntry) noexcept;
