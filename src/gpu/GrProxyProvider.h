...
class GrProxyProvider {
 public:
  ...
  sk_sp<GrTextureProxy> createProxy(
      ...
      GrSurfaceOrigin, GrMipMapped, SkBackingFit, SkBudgeted, GrProtected,
      GrInternalSurfaceFlags = GrInternalSurfaceFlags::kNone,
  ...
  sk_sp<GrTextureProxy> createLazyProxy(
      ...
      int renderTargetSampleCnt, GrSurfaceOrigin, GrMipMapped, GrMipMapsStatus,
      GrInternalSurfaceFlags, SkBackingFit, SkBudgeted, GrProtected, UseAllocator);
  ...
  sk_sp<GrRenderTargetProxy> createLazyRenderTargetProxy(
      ...
      GrMipMapsStatus, SkBackingFit, SkBudgeted, GrProtected, bool wrapsVkSecondaryCB,
  ...
  static sk_sp<GrTextureProxy> MakeFullyLazyProxy(
      ...
      GrProtected, GrSurfaceOrigin, GrPixelConfig, const GrCaps&, UseAllocator);
