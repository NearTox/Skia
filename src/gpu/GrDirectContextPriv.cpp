...
sk_sp<const GrCaps> GrDirectContextPriv::refCaps() const { return fContext->refCaps(); }
...
void GrDirectContextPriv::createDDLTask(
...
void GrDirectContextPriv::dumpCacheStatsKeyValuePairs(
...
void GrDirectContextPriv::dumpGpuStatsKeyValuePairs(
    SkTArray<SkString>* keys, SkTArray<double>* values) const {
#  if GR_GPU_STATS
...
void GrDirectContextPriv::dumpContextStatsKeyValuePairs(
    SkTArray<SkString>* keys, SkTArray<double>* values) const {
#  if GR_GPU_STATS
...
/////////////////////////////////////////////////
sk_sp<SkImage> GrDirectContextPriv::testingOnly_getFontAtlasImage(
  ...
  sk_sp<SkImage> image(new SkImage_Gpu(
      sk_ref_sp(fContext), kNeedNewImageUniqueID, views[index], colorType, kPremul_SkAlphaType,
      nullptr));
  return image;
}
