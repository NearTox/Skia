 ...
 public:
  ...
  struct EmitArgs {
    EmitArgs(
        ...
        const char* outputCoverage, const SamplerHandle* texSamplers)
  ...
  virtual SkString getTessControlShaderGLSL(
      const GrGeometryProcessor&, const char* versionAndExtensionDecls, const GrGLSLUniformHandler&,
  ...
  static uint32_t ComputeMatrixKeys(
      const GrShaderCaps& shaderCaps, const SkMatrix& viewMatrix, const SkMatrix& localMatrix) {
