...
static inline int grsltype_to_location_size(GrSLType type) {
  ...
  switch (type) {
    case kVoid_GrSLType: return 0;
    case kFloat_GrSLType:  // fall through
    case kHalf_GrSLType: return 1;
    case kFloat2_GrSLType:  // fall through
    case kHalf2_GrSLType: return 1;
    case kFloat3_GrSLType:
    case kHalf3_GrSLType: return 1;
    case kFloat4_GrSLType:
    case kHalf4_GrSLType: return 1;
    case kInt2_GrSLType:
    case kUint2_GrSLType:
    case kShort2_GrSLType:
    case kUShort2_GrSLType:
    case kByte2_GrSLType:
    case kUByte2_GrSLType: return 1;
    case kInt3_GrSLType:
    case kUint3_GrSLType:
    case kShort3_GrSLType:
    case kUShort3_GrSLType:
    case kByte3_GrSLType:
    case kUByte3_GrSLType: return 1;
    case kInt4_GrSLType:
    case kUint4_GrSLType:
    case kShort4_GrSLType:
    case kUShort4_GrSLType:
    case kByte4_GrSLType:
    case kUByte4_GrSLType: return 1;
    case kFloat2x2_GrSLType:
    case kHalf2x2_GrSLType: return 2;
