...
class GrGLSLShaderBuilder {
 public:
  ...
  /** Appends a 2D texture sample with projection if necessary. coordType must either be Vec2f or
      ...
      SamplerHandle.
      */
  void appendTextureLookup(
      SkString* out, SamplerHandle, const char* coordName,
      GrSLType coordType = kHalf2_GrSLType) const;

  /** Version of above that appends the result to the shader code instead.*/
  void appendTextureLookup(
      SamplerHandle, const char* coordName, GrSLType coordType = kHalf2_GrSLType,
  ...
  void appendTextureLookupAndModulate(
      const char* modulation, SamplerHandle, const char* coordName,
