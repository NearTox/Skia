...
class GrGLSLGeometryProcessor : public GrGLSLPrimitiveProcessor {
 ...
 protected:
  ...
  void emitTransforms(
      GrGLSLVertexBuilder*, GrGLSLVaryingHandler*, GrGLSLUniformHandler*,
      const GrShaderVar& localCoordsVar, const SkMatrix& localMatrix, FPCoordTransformHandler*);
  ...
  void emitTransforms(
    ...
    this->emitTransforms(
        vb, varyingHandler, uniformHandler, localCoordsVar, SkMatrix::I(), handler);
  }
