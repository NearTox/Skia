 ...
 public:
  ...
  class FPCoordTransformHandler : public SkNoncopyable {
   public:
    ...
    void specifyCoordsForCurrCoordTransform(
  ...
  struct EmitArgs {
    EmitArgs(
        GrGLSLVertexBuilder* vertBuilder, GrGLSLGeometryBuilder* geomBuilder,
   ...
   */
  virtual void emitTransformCode(GrGLSLVertexBuilder* vb, GrGLSLUniformHandler* uniformHandler) {}
  /**
