...
class GrGLSLFragmentProcessor {
 ...
 public:
  using TransformedCoordVars = BuilderInputProvider<
      GrGLSLPrimitiveProcessor::TransformVar, &GrFragmentProcessor::numCoordTransforms>;
  ...
  inline void invokeChild(
      int childIndex, SkString* outputColor, EmitArgs& parentArgs, SkSL::String skslCoords = "") {
   ...
   */
  void invokeChild(
      int childIndex, const char* inputColor, SkString* outputColor, EmitArgs& parentArgs,
