...
SkIRect GrFixedClip::getConservativeBounds(int w, int h) const noexcept {
...
bool GrFixedClip::apply(
    int rtWidth, int rtHeight, GrAppliedHardClip* out, SkRect* bounds) const noexcept {
  if (fScissorState.enabled()) {
