...
class GrTextBlob : public SkNVRefCnt<GrTextBlob>, public SkGlyphRunPainterInterface {
 ...
 private:
  ...
  void processDeviceMasks(
      SkSpan<const SkGlyphPos> masks, const SkStrikeSpecStorage& strikeSpec) override;

  void processSourcePaths(
      SkSpan<const SkGlyphPos> paths, const SkStrikeSpecStorage& strikeSpec) override;
  ...
  void processSourceFallback(
      SkSpan<const SkGlyphPos> masks, const SkStrikeSpecStorage& strikeSpec, bool hasW) override;
