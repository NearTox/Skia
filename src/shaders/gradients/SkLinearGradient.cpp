...
SkShaderBase::Context* SkLinearGradient::onMakeContext(const ContextRec& rec,
...
SkShaderBase::Context* SkLinearGradient::onMakeBurstPipelineContext(const ContextRec& rec,
                                                                    SkArenaAlloc* alloc) const {
