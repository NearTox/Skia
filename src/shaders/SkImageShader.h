...
class SkImageShader : public SkShaderBase {
 public:
  static sk_sp<SkShader> Make(
      ...
      const SkMatrix* localMatrix, bool clampAsIfUnpremul = false);

  static sk_sp<SkShader> MakeRaw(
      sk_sp<SkImage>, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions&,
  ...
  static sk_sp<SkShader> MakeSubset(
      sk_sp<SkImage>, const SkRect& subset, SkTileMode tmx, SkTileMode tmy,
      const SkSamplingOptions&, const SkMatrix* localMatrix, bool clampAsIfUnpremul = false);
 ...
 private:
  ...
  SkImageShader(
      sk_sp<SkImage>, const SkRect& subset, SkTileMode tmx, SkTileMode tmy,
      const SkSamplingOptions&, const SkMatrix* localMatrix, bool raw, bool clampAsIfUnpremul);
