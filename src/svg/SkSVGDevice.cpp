...
void SkSVGDevice::drawBitmapRect(
    const SkBitmap& bm, const SkRect* srcOrNull, const SkRect& dst, const SkPaint& paint,
...
void SkSVGDevice::drawGlyphRunAsPath(
    const SkGlyphRun& glyphRun, const SkPoint& origin, const SkPaint& runPaint) {
  this->drawPath(GetPath(glyphRun, origin), runPaint);
}

void SkSVGDevice::drawGlyphRunAsText(
    const SkGlyphRun& glyphRun, const SkPoint& origin, const SkPaint& runPaint) {
