...
static CGFloat CGRectGetMinX_inline(const CGRect& rect) { return rect.origin.x; }

static CGFloat CGRectGetMaxX_inline(const CGRect& rect) { return rect.origin.x + rect.size.width; }

static CGFloat CGRectGetMinY_inline(const CGRect& rect) { return rect.origin.y; }

static CGFloat CGRectGetMaxY_inline(const CGRect& rect) { return rect.origin.y + rect.size.height; }

static CGFloat CGRectGetWidth_inline(const CGRect& rect) { return rect.size.width; }
...
static unsigned CGRGBPixel_getAlpha(CGRGBPixel pixel) { return pixel & 0xFF; }
...
static CGAffineTransform MatrixToCGAffineTransform(const SkMatrix& matrix) {
  return CGAffineTransformMake(
      ScalarToCG(matrix[SkMatrix::kMScaleX]), -ScalarToCG(matrix[SkMatrix::kMSkewY]),
      -ScalarToCG(matrix[SkMatrix::kMSkewX]), ScalarToCG(matrix[SkMatrix::kMScaleY]),
      ScalarToCG(matrix[SkMatrix::kMTransX]), ScalarToCG(matrix[SkMatrix::kMTransY]));
}
...
static constexpr const uint8_t kSpiderSymbol_ttf[] = {
    ...
    ,
    ...
    ,
    ...
    0x00, 0x2e, 0x00, 0x53, 0x00, 0x70, 0x00, 0x69, 0x00, 0x64, 0x00, 0x65, 0x00, 0x72, 0x00, 0x53,
    0x00, 0x79, 0x00, 0x6d, 0x00, 0x62, 0x00, 0x6f, 0x00, 0x6c, 0x00, 0x52, 0x00, 0x65, 0x00, 0x67,
    0x00, 0x75, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x72, 0x00, 0x56, 0x00, 0x31, 0x00, 0x68, 0x00, 0x74,
    ...
    0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00, 0x66, 0x00, 0x00, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x01, 0xff, 0xff, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x0c, 0x00, 0x14, 0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00};
...
static SmoothBehavior smooth_behavior() {
  static SmoothBehavior gSmoothBehavior = [] {
    ...
    SkUniqueCFRef<CGContextRef> noSmoothContext(CGBitmapContextCreate(
        &noSmoothBitmap, 16, 16, 8, 16 * 4, colorspace.get(), BITMAP_INFO_RGB));
    SkUniqueCFRef<CGContextRef> smoothContext(
        CGBitmapContextCreate(&smoothBitmap, 16, 16, 8, 16 * 4, colorspace.get(), BITMAP_INFO_RGB));
    ...
    SkUniqueCFRef<CFDataRef> data(CFDataCreateWithBytesNoCopy(
        ...
        kCFAllocatorNull));
    SkUniqueCFRef<CTFontDescriptorRef> desc(CTFontManagerCreateFontDescriptorFromData(data.get()));
...
class Offscreen {
 public:
  Offscreen() : fRGBSpace(nullptr), fCG(nullptr), fDoAA(false), fDoLCD(false) { fSize.set(0, 0); }

  CGRGBPixel* getCG(
      const SkScalerContext_Mac& context, const SkGlyph& glyph, CGGlyph glyphID,
      size_t* rowBytesPtr, bool generateA8FromLCD);
 ...
 private:
  ...
  static int RoundSize(int dimension) { return SkNextPow2(dimension); }
};
  ...
  D map(S val) const {
    ...
    for (int i = 0; i < fMappingCount - 1; ++i) {
      if (val < fMapping[i + 1].src_val) {
        return map(
            val, fMapping[i].src_val, fMapping[i + 1].src_val, fMapping[i].dst_val,
...
static int ct_weight_to_fontstyle(CGFloat cgWeight, bool fromDataProvider) {
  ...
  static constexpr Interpolator::Mapping dataProviderWeightMappings[] = {
      {-1.00, 0},  {-0.70, 100}, {-0.50, 200}, {-0.23, 300}, {0.00, 400},  {0.20, 500},
      {0.30, 600}, {0.40, 700},  {0.60, 800},  {0.80, 900},  {1.00, 1000},
  };
...
static SkFontStyle fontstyle_from_descriptor(CTFontDescriptorRef desc, bool fromDataProvider) {
  ...
  return SkFontStyle(
      ct_weight_to_fontstyle(weight, fromDataProvider), ct_width_to_fontstyle(width),
...
class SkTypeface_Mac : public SkTypeface {
 public:
  SkTypeface_Mac(
      SkUniqueCFRef<CTFontRef> fontRef, SkUniqueCFRef<CFTypeRef> resourceRef, const SkFontStyle& fs,
      bool isFixedPitch, OpszVariation opszVariation, std::unique_ptr<SkStreamAsset> providedData)
...
static sk_sp<SkTypeface> create_from_CTFontRef(
    SkUniqueCFRef<CTFontRef> font, SkUniqueCFRef<CFTypeRef> resource, OpszVariation opszVariation,
  ...
  if (!isFromStream) {
    sk_sp<SkTypeface> face =
        SkTypefaceCache::FindByProcAndRef(find_by_CTFontRef, (void*)font.get());
    if (face) {
      return face;
    }
  }
  ...
  sk_sp<SkTypeface> face(new SkTypeface_Mac(
      std::move(font), std::move(resource), style, isFixedPitch, opszVariation,
...
sk_sp<SkTypeface> SkMakeTypefaceFromCTFont(CTFontRef font) {
  CFRetain(font);
  return create_from_CTFontRef(SkUniqueCFRef<CTFontRef>(font), nullptr, OpszVariation(), nullptr);
}
...
SkTypeface* SkCreateTypefaceFromCTFont(CTFontRef font, CFTypeRef resource) {
  ...
  return create_from_CTFontRef(
             SkUniqueCFRef<CTFontRef>(font), SkUniqueCFRef<CFTypeRef>(resource), OpszVariation(),
             nullptr)
      .release();
}
...
SkScalerContext_Mac::SkScalerContext_Mac(
    sk_sp<SkTypeface_Mac> typeface, const SkScalerContextEffects& effects, const SkDescriptor* desc)
...

{
  ...
  bool invertible = fRec.computeMatrices(
      SkScalerContextRec::kVertical_PreMatrixScale, &scale, &skTransform, nullptr, nullptr,
      nullptr);
  ...
  fCTFont = ctfont_create_exact_copy(
      ctFont, textSize, ((SkTypeface_Mac*)this->getTypeface())->fOpszVariation);
  fCGFont.reset(CTFontCopyGraphicsFont(fCTFont.get(), nullptr));
}

CGRGBPixel* Offscreen::getCG(
    const SkScalerContext_Mac& context, const SkGlyph& glyph, CGGlyph glyphID, size_t* rowBytesPtr,
...
unsigned SkScalerContext_Mac::generateGlyphCount(void) { return fGlyphCount; }

bool SkScalerContext_Mac::generateAdvance(SkGlyph* glyph) { return false; }
...
void SkScalerContext_Mac::generateMetrics(SkGlyph* glyph) {
  ...
  CGSize cgAdvance;
  CTFontGetAdvancesForGlyphs(fCTFont.get(), kCTFontOrientationHorizontal, &cgGlyph, &cgAdvance, 1);
  ...
  // vertical metrics.
  {
    ...
    CTFontGetBoundingRectsForGlyphs(
        fCTFont.get(), kCTFontOrientationHorizontal, &cgGlyph, &cgBounds, 1);
    ...
    skBounds = SkRect::MakeXYWH(
        cgBounds.origin.x, -cgBounds.origin.y - cgBounds.size.height, cgBounds.size.width,
...
void SkScalerContext_Mac::generateImage(const SkGlyph& glyph) {
  ...
  if ((glyph.fMaskFormat == SkMask::kLCD16_Format) ||
      (glyph.fMaskFormat == SkMask::kA8_Format && requestSmooth &&
  ...
  switch (glyph.fMaskFormat) {
    ...
    default: SkDEBUGFAIL("unexpected mask format"); break;
  }
}
...
void SkScalerContext_Mac::CTPathElement(void* info, const CGPathElement* element) {
  ...
  switch (element->type) {
    ...
    case kCGPathElementCloseSubpath: skPath->close(); break;

    default: SkDEBUGFAIL("Unknown path element!"); break;
  }
}
...
static void populate_glyph_to_unicode_slow(CTFontRef ctFont, CFIndex glyphCount, SkUnichar* out) {
...
static void get_plane_glyph_map(
    const uint8_t* bits, CTFontRef ctFont, CFIndex glyphCount, SkUnichar* glyphToUnicode,
    uint8_t planeIndex) {
...
static void populate_glyph_to_unicode(
    CTFontRef ctFont, CFIndex glyphCount, SkUnichar* glyphToUnicode) {
  ...
  SkUniqueCFRef<CFDataRef> bitmap(CFCharacterSetCreateBitmapRepresentation(nullptr, charSet.get()));
  if (!bitmap) {
    return;
  }
...
static void CFStringToSkString(CFStringRef src, SkString* dst) {
  ...
  CFIndex length =
      CFStringGetMaximumSizeForEncoding(CFStringGetLength(src), kCFStringEncodingUTF8) + 1;
  dst->resize(length);
...
void SkTypeface_Mac::getGlyphToUnicodeMap(SkUnichar* dstArray) const {
  SkUniqueCFRef<CTFontRef> ctFont =
      ctfont_create_exact_copy(fFontRef.get(), CTFontGetUnitsPerEm(fFontRef.get()), fOpszVariation);
...
std::unique_ptr<SkAdvancedTypefaceMetrics> SkTypeface_Mac::onGetAdvancedMetrics() const {
  ...
  if (sizeof(fsType) == this->getTableData(
                            SkTEndian_SwapBE32(SkOTTableOS2::TAG),
                            offsetof(SkOTTableOS2_V4, fsType), sizeof(fsType), &fsType)) {
  ...
  if (CTFontGetGlyphsForCharacters(ctFont.get(), stem_chars, glyphs, count)) {
    CTFontGetBoundingRectsForGlyphs(
        ctFont.get(), kCTFontOrientationHorizontal, glyphs, boundingRects, count);
...
static SK_SFNT_ULONG get_font_type_tag(CTFontRef ctFont) {
  ...
  switch (fontFormatValue) {
    case kCTFontFormatOpenTypePostScript: return SkSFNTHeader::fontType_OpenTypeCFF::TAG;
    case kCTFontFormatOpenTypeTrueType: return SkSFNTHeader::fontType_WindowsTrueType::TAG;
    case kCTFontFormatTrueType: return SkSFNTHeader::fontType_MacTrueType::TAG;
    case kCTFontFormatPostScript: return SkSFNTHeader::fontType_PostScript::TAG;
    case kCTFontFormatBitmap: return SkSFNTHeader::fontType_MacTrueType::TAG;
  ...
  *ttcIndex = 0;
  ...
  fInitStream([this] {
    ...
    for (int tableIndex = 0; tableIndex < numTables; ++tableIndex) {
      ...
      entry->checksum =
          SkEndian_SwapBE32(SkOTUtils::CalcTableChecksum((SK_OT_ULONG*)dataPtr, tableSize));
...
static bool get_variations(
    CTFontRef ctFont, CFIndex* cgAxisCount, SkAutoSTMalloc<4, SkFixed>* axisValues) {
  // In 10.10 and earlier, CTFontCopyVariationAxes and CTFontCopyVariation do not work when
  // applied to fonts which started life with CGFontCreateWithDataProvider (they simply always
  // return nullptr). As a result, we are limited to CGFontCopyVariationAxes and
  // CGFontCopyVariations here until support for 10.10 and earlier is removed.
...
std::unique_ptr<SkFontData> SkTypeface_Mac::onMakeFontData() const {
  ...
  if (get_variations(fFontRef.get(), &cgAxisCount, &axisValues)) {
    return std::make_unique<SkFontData>(std::move(stream), index, axisValues.get(), cgAxisCount);
  }
...
static SkUniqueCFRef<CFDictionaryRef> ct_variation_from_cg_variation(
    CFDictionaryRef cgVariations, CFArrayRef ctAxes) {
  SkUniqueCFRef<CFMutableDictionaryRef> ctVariation(CFDictionaryCreateMutable(
      kCFAllocatorDefault, 0, &kCFTypeDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks));
...
int SkTypeface_Mac::onGetTableTags(SkFontTableTag tags[]) const {
  ...
  if (tags) {
    for (int i = 0; i < count; ++i) {
      uintptr_t fontTag = reinterpret_cast<uintptr_t>(CFArrayGetValueAtIndex(cfArray.get(), i));
...
static SkUniqueCFRef<CFDataRef> copy_table_from_font(CTFontRef ctFont, SkFontTableTag tag) {
  SkUniqueCFRef<CFDataRef> data(
      CTFontCopyTable(ctFont, (CTFontTableTag)tag, kCTFontTableOptionNoOptions));
  if (!data) {
    SkUniqueCFRef<CGFontRef> cgFont(CTFontCopyGraphicsFont(ctFont, nullptr));
...
size_t SkTypeface_Mac::onGetTableData(
    SkFontTableTag tag, size_t offset, size_t length, void* dstData) const {
...
sk_sp<SkData> SkTypeface_Mac::onCopyTableData(SkFontTableTag tag) const {
  ...
  return SkData::MakeWithProc(
      data, length, [](const void*, void* ctx) { CFRelease((CFDataRef)ctx); },
...
#  endif
    ...
    if (smoothBehavior == SmoothBehavior::some) {
      ...
      color = SkColorSetRGB(
          SkColorGetR(color) * 1 / 2, SkColorGetG(color) * 1 / 2, SkColorGetB(color) * 1 / 2);
...
void SkTypeface_Mac::onGetFontDescriptor(SkFontDescriptor* desc, bool* isLocalStream) const {
  SkString tmpStr;
...
int SkTypeface_Mac::onCountGlyphs() const { return SkToInt(CTFontGetGlyphCount(fFontRef.get())); }
...
static CTFontVariation ctvariation_from_skfontarguments(CTFontRef ct, const SkFontArguments& args) {
  OpszVariation opsz;
  ...
  SkUniqueCFRef<CFMutableDictionaryRef> dict(CFDictionaryCreateMutable(
  ...
  for (int i = 0; i < axisCount; ++i) {
    ...
    for (int j = position.coordinateCount; j-- > 0;) {
      if (position.coordinates[j].axis == tagLong) {
        value = SkTPin(SkScalarToDouble(position.coordinates[j].value), minDouble, maxDouble);
        if (tagLong == opszTag) {
          opsz.isSet = true;
        }
        break;
...
static sk_sp<SkData> skdata_from_skstreamasset(std::unique_ptr<SkStreamAsset> stream) {
  ...
  if (const void* base = stream->getMemoryBase()) {
    return SkData::MakeWithProc(
        base, size, [](const void*, void* ctx) -> void { delete (SkStreamAsset*)ctx; },
        stream.release());
  }
...
static SkUniqueCFRef<CFDataRef> cfdata_from_skdata(sk_sp<SkData> data) {
  ...
  return SkUniqueCFRef<CFDataRef>(
      CFDataCreateWithBytesNoCopy(kCFAllocatorDefault, (const UInt8*)addr, size, alloc.get()));
}
...
static SkUniqueCFRef<CTFontRef> ctfont_from_skdata(sk_sp<SkData> data, int ttcIndex) {
  ...
  SkUniqueCFRef<CTFontDescriptorRef> desc(CTFontManagerCreateFontDescriptorFromData(cfData.get()));
  if (!desc) {
    return nullptr;
  }
...
static int compute_metric(const SkFontStyle& a, const SkFontStyle& b) {
  return sqr(a.weight() - b.weight()) + sqr((a.width() - b.width()) * 100) +
...
class SkFontStyleSet_Mac : public SkFontStyleSet {
 public:
  SkFontStyleSet_Mac(CTFontDescriptorRef desc)
      : fArray(CTFontDescriptorCreateMatchingFontDescriptors(desc, nullptr)), fCount(0) {
    if (!fArray) {
...
sk_sp<SkTypeface> SkTypeface_Mac::onMakeClone(const SkFontArguments& args) const {
  ...
  if (ctVariation.dict) {
    SkUniqueCFRef<CFMutableDictionaryRef> attributes(CFDictionaryCreateMutable(
        kCFAllocatorDefault, 0, &kCFTypeDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks));
    CFDictionaryAddValue(attributes.get(), kCTFontVariationAttribute, ctVariation.dict.get());
  ...
  return create_from_CTFontRef(
      std::move(ctVariant), nullptr, ctVariation.opsz, fStream ? fStream->duplicate() : nullptr);
}
...
class SkFontMgr_Mac : public SkFontMgr {
  ...
  static SkFontStyleSet* CreateSet(CFStringRef cfFamilyName) {
    SkUniqueCFRef<CFMutableDictionaryRef> cfAttr(CFDictionaryCreateMutable(
        kCFAllocatorDefault, 0, &kCFTypeDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks));

    CFDictionaryAddValue(cfAttr.get(), kCTFontFamilyNameAttribute, cfFamilyName);

    SkUniqueCFRef<CTFontDescriptorRef> desc(CTFontDescriptorCreateWithAttributes(cfAttr.get()));
...
#  endif
 ...
 protected:
  int onCountFamilies() const override { return fCount; }
...
#  endif
    ...
    return create_from_CTFontRef(std::move(fallbackFont), nullptr, OpszVariation(), nullptr)
        .release();
  }

  SkTypeface* onMatchFaceStyle(const SkTypeface* familyMember, const SkFontStyle&) const override {
    return nullptr;
  }
  ...
  sk_sp<SkTypeface> onMakeFromData(sk_sp<SkData> data, int ttcIndex) const override {
    ...
    return create_from_CTFontRef(
        std::move(ct), nullptr, OpszVariation(), SkMemoryStream::Make(std::move(data)));
  }

  sk_sp<SkTypeface> onMakeFromStreamIndex(
      std::unique_ptr<SkStreamAsset> stream, int ttcIndex) const override {
    if (ttcIndex != 0) {
      return nullptr;
    }
  ...
  sk_sp<SkTypeface> onMakeFromStreamArgs(
    ...
    return create_from_CTFontRef(
        std::move(ctVariant), nullptr, ctVariation.opsz, std::move(stream));
  }
  ...
  sk_sp<SkTypeface> onLegacyMakeTypeface(
      const char familyName[], SkFontStyle style) const override {
    if (familyName) {
