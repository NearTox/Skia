...
class SkTypeface_FCI : public SkTypeface_FreeType {
 ...
 public:
  static SkTypeface_FCI* Create(
      sk_sp<SkFontConfigInterface> fci, const SkFontConfigInterface::FontIdentity& fi,
      SkString familyName, const SkFontStyle& style) {
  ...
  sk_sp<SkTypeface> onMakeClone(const SkFontArguments& args) const override {
    ...
    return sk_sp<SkTypeface>(
        new SkTypeface_FCI(std::move(data), fFamilyName, this->fontStyle(), this->isFixedPitch()));
  }
