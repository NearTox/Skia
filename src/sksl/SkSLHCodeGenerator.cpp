...
Layout::CType HCodeGenerator::ParameterCType(
  ...
  if (type == *context.fTypes.fFloat || type == *context.fTypes.fHalf) {
    return Layout::CType::kFloat;
      ...
      type == *context.fTypes.fInt || type == *context.fTypes.fShort ||
    ...
    return Layout::CType::kSkPoint;
      ...
      type == *context.fTypes.fInt2 || type == *context.fTypes.fShort2 ||
      type == *context.fTypes.fByte2) {
    return Layout::CType::kSkIPoint;
  } else if (
      type == *context.fTypes.fInt4 || type == *context.fTypes.fShort4 ||
