...
class ExternalValue : public Symbol {
 public:
   ...
   */
  virtual void getCallParameterTypes(const Type** outTypes) const { SkASSERT(false); }
   ...
   */
  virtual void read(void* target) { SkASSERT(false); }
   ...
   */
  virtual void write(void* src) { SkASSERT(false); }
