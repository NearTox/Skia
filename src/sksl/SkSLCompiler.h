...
class SK_API Compiler {
 public:
  ...
  static void EnableOptimizer(OverrideFlag flag) noexcept { sOptimizer = flag; }
  static void EnableInliner(OverrideFlag flag) noexcept { sInliner = flag; }
  ...
  ErrorReporter& errorReporter() noexcept { return *fContext->fErrors; }
  ...
  Context& context() const noexcept { return *fContext; }
 ...
 private:
  class CompilerErrorReporter : public ErrorReporter {
   public:
    CompilerErrorReporter(Compiler* compiler) : fCompiler(*compiler) {}
