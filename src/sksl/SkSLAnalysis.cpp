  ...
  void visitExpression(Expression& expr) {
    switch (expr.kind()) {
      ...
      case Expression::Kind::kExternalValue: {
        ...
        if (!var.canWrite()) {
          fErrors->error(
              expr.fOffset, "cannot modify immutable external value '" + var.name() + "'");
        }
        break;
      }
...
bool Analysis::IsAssignable(
    Expression& expr, VariableReference** assignableVar, ErrorReporter* errors) {
