...
static int add_compact_entry(
    const TransitionSet& transitionSet, const std::vector<int>& data,
...
static int add_full_entry(
    const TransitionSet& transitionMap, const std::vector<int>& data,
