...
struct Variable : public Symbol {
  ...
  Variable(
      int offset, Modifiers modifiers, StringFragment name, const Type* type, bool builtin,
  ...
  bool dead() const {
    ...
    return !fWriteCount ||
           (!fReadCount && !(fModifiers.fFlags & (Modifiers::kPLS_Flag | Modifiers::kPLSOut_Flag)));
  }
