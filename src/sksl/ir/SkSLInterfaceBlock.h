...
class InterfaceBlock final : public ProgramElement {
 public:
  ...
  InterfaceBlock(
      int offset, const Variable* var, String typeName, String instanceName, ExpressionArray sizes,
  ...
  ExpressionArray& sizes() { return fSizes; }
  ...
  std::unique_ptr<ProgramElement> clone() const override {
    ...
    return std::make_unique<InterfaceBlock>(
        fOffset, &this->variable(), this->typeName(), this->instanceName(), std::move(sizesClone),
