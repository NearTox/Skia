...
VariableReference::VariableReference(Position pos, const Variable* variable, RefKind refKind)
    : INHERITED(pos, kExpressionKind, &variable->type()), fVariable(variable), fRefKind(refKind) {
...
std::string VariableReference::description() const { return std::string(this->variable()->name()); }
