...
class FieldAccess final : public Expression {
 public:
  ...
  FieldAccess(
      Position pos, std::unique_ptr<Expression> base, int fieldIndex,
  ...
  OwnerKind ownerKind() const { return fOwnerKind; }
  ...
  std::unique_ptr<Expression> clone(Position pos) const override {
    return std::make_unique<FieldAccess>(
        pos, this->base()->clone(), this->fieldIndex(), this->ownerKind());
  }
