...
class SwitchStatement final : public Statement {
 public:
  ...
  SwitchStatement(
      Position pos, bool isStatic, std::unique_ptr<Expression> value, StatementArray cases,
  ...
  static std::unique_ptr<Statement> BlockForCase(
  ...
  StatementArray& cases() { return fCases; }

  const StatementArray& cases() const { return fCases; }

  bool isStatic() const { return fIsStatic; }

  const std::shared_ptr<SymbolTable>& symbols() const { return fSymbols; }
