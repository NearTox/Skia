...
template <> struct hash<std::pair<ConstantValue, ConstantType>> {
...
private:
    ...
    void writeGLSLExtendedInstruction(const Type& type, SpvId id, SpvId floatInst, SpvId signedInst,
                                      SpvId unsignedInst, const std::vector<SpvId>& args,
                                      OutputStream& out);
