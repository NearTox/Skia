...
class IRGenerator {
 public:
  IRGenerator(const Context* context, const ShaderCapsClass* caps);
 ...
 private:
  ...
  CoercionCost callCost(const FunctionDeclaration& function, const ExpressionArray& arguments);
  std::unique_ptr<Expression> coerce(std::unique_ptr<Expression> expr, const Type& type);
  CoercionCost coercionCost(const Expression& expr, const Type& type);
  std::unique_ptr<Expression> convertBinaryExpression(
  ...
  std::unique_ptr<Expression> convertScalarConstructor(
      int offset, const Type& type, ExpressionArray params);
  ...
  std::unique_ptr<Statement> convertIf(
  ...
  std::unique_ptr<Expression> convertIndex(
  ...
  std::unique_ptr<Expression> convertTernaryExpression(
  ...
  std::unique_ptr<Statement> convertWhile(
