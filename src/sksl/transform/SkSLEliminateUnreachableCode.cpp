...
static void eliminate_unreachable_code(
    SkSpan<std::unique_ptr<ProgramElement>> elements, ProgramUsage* usage) {
    ...
    bool visitStatementPtr(std::unique_ptr<Statement>& stmt) override {
      ...
      switch (stmt->kind()) {
        ...
        case Statement::Kind::kIf: {
          ...
          fFoundFunctionExit.back() |= foundFunctionExitOnTrue && foundFunctionExitOnFalse;
          fFoundLoopExit.back() |= foundLoopExitOnTrue && foundLoopExitOnFalse;
          return result;
        }
