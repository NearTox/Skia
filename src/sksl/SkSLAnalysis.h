...
struct Analysis {
  ...
  static bool IsAssignable(
      Expression& expr, VariableReference** assignableVar, ErrorReporter* errors = nullptr);
};
...
using ProgramVisitor =
    TProgramVisitor<const Program&, const Expression&, const Statement&, const ProgramElement&>;
