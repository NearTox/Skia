...
String ASTNode::description() const {
  switch (fKind) {
    ...
    case Kind::kBool: return getBool() ? "true" : "false";
    case Kind::kBreak: return "break";
    case Kind::kCall: {
    ...
    case Kind::kContinue: return "continue";
    case Kind::kDiscard: return "discard";
    case Kind::kDo:
    ...
    case Kind::kEnumCase:
      ...
      return getString();
    case Kind::kExtension: return "#extension " + getString();
    case Kind::kField: return this->begin()->description() + "." + getString();
    case Kind::kFile: {
      String result;
      for (const auto& c : *this) {
        result += c.description();
    ...
    case Kind::kFloat: return to_string(getFloat());
    case Kind::kFor:
      return "for (" + this->begin()->description() + "; " + (this->begin() + 1)->description() +
             "; " + (this->begin() + 2)->description() + ") " + (this->begin() + 3)->description();
    case Kind::kFunction: {
    ...
    case Kind::kIdentifier: return getString();
    case Kind::kIndex:
    ...
    case Kind::kInt: return to_string(getInt());
    ...
    case Kind::kModifiers: return getModifiers().description();
    ...
    case Kind::kReturn:
      ...
      return "return;";
    case Kind::kScope: return this->begin()->description() + "::" + getString();
    case Kind::kSection: return "@section { ... }";
    ...
    case Kind::kType: return String(getTypeData().fName);
    ...
    case Kind::kWhile: {
      return "while (" + this->begin()->description() + ") " + (this->begin() + 1)->description();
    }
