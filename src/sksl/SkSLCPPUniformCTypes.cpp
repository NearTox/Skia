...
UniformCTypeMapper::UniformCTypeMapper(Layout::CType ctype, const std::vector<String>& skslTypes,
                                       const String& setUniformFormat, bool enableTracking,
                                       const String& defaultValue,
                                       const String& dirtyExpressionFormat,
...
static const std::vector<UniformCTypeMapper>& get_mappers() {
    static const std::vector<UniformCTypeMapper> registeredMappers = {
            ...
            REGISTER(Layout::CType::kSkPMColor4f, {"half4", "float4", "double4"},
                     ...
                     "{SK_FloatNaN, SK_FloatNaN, SK_FloatNaN, SK_FloatNaN}"),  // default
                                                                               // value
