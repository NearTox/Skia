...
constexpr inline SkPoint float2(float xy) noexcept { return SkPoint::Make(xy, xy); }

constexpr inline SkPoint float2(float x, float y) noexcept { return SkPoint::Make(x, y); }

constexpr inline Float4 float4(float xyzw) noexcept { return Float4(xyzw, xyzw, xyzw, xyzw); }

constexpr inline Float4 float4(float x, float y, float z, float w) noexcept {
