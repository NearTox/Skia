...
void Dehydrator::write(const Statement* s) {
  if (s) {
    switch (s->kind()) {
      ...
      case Statement::Kind::kBreak: this->writeCommand(Rehydrator::kBreak_Command); break;
      case Statement::Kind::kContinue: this->writeCommand(Rehydrator::kContinue_Command); break;
      case Statement::Kind::kDiscard: this->writeCommand(Rehydrator::kDiscard_Command); break;
      ...
      case Statement::Kind::kNop: SkDEBUGFAIL("unexpected--nop statement in finished code"); break;
