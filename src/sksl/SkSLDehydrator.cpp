...
class AutoDehydratorSymbolTable {
 public:
  ...
  ~AutoDehydratorSymbolTable() { fDehydrator->fSymbolMap.pop_back(); }
...
void Dehydrator::write(StringFragment s) { this->write(String(s)); }
...
void Dehydrator::write(const Symbol& s) {
  ...
  switch (s.kind()) {
    ...
    case Symbol::Kind::kExternal: SkASSERT(false); break;
  }
}
...
void Dehydrator::write(const Expression* e) {
  if (e) {
    switch (e->kind()) {
      ...
      case Expression::Kind::kNullLiteral: this->writeU8(Rehydrator::kNullLiteral_Command); break;
...
void Dehydrator::write(const Statement* s) {
  if (s) {
    switch (s->kind()) {
      ...
      case Statement::Kind::kBreak: this->writeU8(Rehydrator::kBreak_Command); break;
      case Statement::Kind::kContinue: this->writeU8(Rehydrator::kContinue_Command); break;
      case Statement::Kind::kDiscard: this->writeU8(Rehydrator::kDiscard_Command); break;
      ...
      case Statement::Kind::kNop: SkASSERT(false); break;
      ...
      case Statement::Kind::kSwitchCase: SkASSERT(false); break;
...
void Dehydrator::write(const ProgramElement& e) {
  switch (e.kind()) {
    ...
    case ProgramElement::Kind::kExtension: SkASSERT(false); break;
    ...
    case ProgramElement::Kind::kModifiers: SkASSERT(false); break;
    case ProgramElement::Kind::kSection: SkASSERT(false); break;
