...
void Dehydrator::write(const Symbol& s) {
  ...
  switch (s.fKind) {
    ...
    case Symbol::kExternal_Kind: SkASSERT(false); break;
  }
}
...
void Dehydrator::write(const Expression* e) {
  if (e) {
    switch (e->fKind) {
      ...
      case Expression::kNullLiteral_Kind: this->writeU8(Rehydrator::kNullLiteral_Command); break;
...
void Dehydrator::write(const Statement* s) {
  if (s) {
    switch (s->fKind) {
      ...
      case Statement::kBreak_Kind: this->writeU8(Rehydrator::kBreak_Command); break;
      case Statement::kContinue_Kind: this->writeU8(Rehydrator::kContinue_Command); break;
      case Statement::kDiscard_Kind: this->writeU8(Rehydrator::kDiscard_Command); break;
      ...
      case Statement::kNop_Kind: SkASSERT(false); break;
...
void Dehydrator::write(const ProgramElement& e) {
  switch (e.fKind) {
    ...
    case ProgramElement::kExtension_Kind: SkASSERT(false); break;
    ...
    case ProgramElement::kModifiers_Kind: SkASSERT(false); break;
    case ProgramElement::kSection_Kind: SkASSERT(false); break;
