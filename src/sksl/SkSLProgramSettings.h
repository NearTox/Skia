...
struct ProgramConfig {
  ...
  bool strictES2Mode() const {
    ...
    return fSettings.fEnforceES2Restrictions && fRequiredSkSLVersion == Version::k100 &&
  ...
  static bool IsFragment(ProgramKind kind) {
    return kind == ProgramKind::kFragment || kind == ProgramKind::kGraphiteFragment;
  }

  static bool IsVertex(ProgramKind kind) {
    return kind == ProgramKind::kVertex || kind == ProgramKind::kGraphiteVertex;
  }

  static bool IsRuntimeEffect(ProgramKind kind) {
    return (
        kind == ProgramKind::kRuntimeColorFilter || kind == ProgramKind::kRuntimeShader ||
        kind == ProgramKind::kRuntimeBlender || kind == ProgramKind::kPrivateRuntimeShader ||
        kind == ProgramKind::kMeshVertex || kind == ProgramKind::kMeshFragment);
  }
};
