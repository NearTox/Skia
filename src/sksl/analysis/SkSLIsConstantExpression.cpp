...
class ConstantExpressionVisitor : public ProgramVisitor {
 public:
  ...
  bool visitExpression(const Expression& e) override {
    ...
    switch (e.kind()) {
      // ... a literal value
      case Expression::Kind::kLiteral: return false;
      ...
      case Expression::Kind::kTypeReference: return true;
...
bool Analysis::IsConstantIndexExpression(
    const Expression& expr, const std::set<const Variable*>* loopIndices) {
