...
void PushSymbolTable() { DSLWriter::IRGenerator().pushSymbolTable(); }

void PopSymbolTable() { DSLWriter::IRGenerator().popSymbolTable(); }

std::shared_ptr<SymbolTable> CurrentSymbolTable() { return DSLWriter::IRGenerator().symbolTable(); }
