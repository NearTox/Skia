...
class SPIRVCodeGenerator : public CodeGenerator {
 ...
 private:
  ...
  void writeGLSLExtendedInstruction(
  ...
  SpvId writeComponentwiseMatrixUnary(
  ...
  void writeInstruction(SpvOp_ opCode, int32_t word1, std::string_view string, OutputStream& out);
  ...
  void writeLabel(SpvId label, BranchingLabelType type, ConditionalOpCounts ops, OutputStream& out);
