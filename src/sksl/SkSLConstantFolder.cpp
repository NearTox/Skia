...
#define RESULT(t, op) std::make_unique<t##Literal>(context, left.fOffset, leftVal op rightVal)
#define URESULT(t, op) \
  std::make_unique<t##Literal>(context, left.fOffset, (uint64_t)leftVal op(uint64_t) rightVal)
