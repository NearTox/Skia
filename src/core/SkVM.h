...
class Assembler {
 public:
  ...
  DstEqXOpY vpand, vpor, vpxor, vpandn, vpaddd, vpsubd, vpmulld, vpsubw, vpmullw, vaddps, vsubps,
      vmulps, vdivps, vminps, vmaxps, vfmadd132ps, vfmadd213ps, vfmadd231ps, vpackusdw, vpackuswb,
      vpcmpeqd, vpcmpgtd;
...
class Program {
 ...
 private:
  ...
  bool jit(
      const std::vector<Builder::Instruction>&, bool try_hoisting, std::vector<LineTableEntry>*,
      Assembler*) const;
