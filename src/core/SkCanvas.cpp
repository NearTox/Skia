...
void SkCanvas::internalRestore() {
  ...
  if (backImage) {
    ...
    this->getTopDevice()->drawSpecial(
        backImage->fImage.get(), SkMatrix::Translate(backImage->fLoc.x(), backImage->fLoc.y()),
        paint);
  }
...
bool SkCanvas::quickReject(const SkPath& path) const { return this->quickReject(path.getBounds()); }
