...
class SkFontData {
 public:
  ...
  SkFontData(
      std::unique_ptr<SkStreamAsset> stream, int index, int paletteIndex, const SkFixed* axis,
      int axisCount, const SkFontArguments::Palette::Override* paletteOverrides,
