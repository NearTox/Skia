  ...
  M(clamp_0) M(clamp_1) M(clamp_a) M(clamp_gamut) M(unpremul) M(premul) M(premul_dst) M(                                                          \
      ...
      M(from_srgb) M(to_srgb) M(black_color) M(white_color) M(uniform_color) M(                                                                   \
          ...
          M(load_a8_dst) M(store_a8) M(gather_a8) M(load_565) M(load_565_dst) M(store_565) M(                                                     \
              ...
              M(load_f16_dst) M(store_f16) M(gather_f16) M(load_af16) M(load_af16_dst) M(                                                         \
                  store_af16) M(gather_af16) M(load_rgf16) M(load_rgf16_dst) M(store_rgf16)                                                       \
                  M(gather_rgf16) M(load_f32) M(load_f32_dst) M(store_f32) M(gather_f32) M(                                                       \
                      ...
                      M(load_rg88_dst) M(store_rg88) M(gather_rg88) M(load_a16) M(load_a16_dst) M(                                                \
                          ...
                          M(gather_rg1616) M(load_16161616) M(load_16161616_dst) M(store_16161616) M(                                             \
                              ...
                              M(alpha_to_gray) M(alpha_to_gray_dst) M(bt709_luminance_or_luma_to_alpha) M(                                        \
                                  bilerp_clamp_8888) M(bicubic_clamp_8888) M(store_u16_be) M(load_src)                                            \
                                  M(store_src) M(load_dst) M(store_dst) M(scale_u8) M(scale_565) M(scale_1_float) M(                              \
