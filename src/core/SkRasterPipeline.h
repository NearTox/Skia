...
#define SK_RASTER_PIPELINE_STAGES(M)                                                                                                                        \
  M(callback)                                                                                                                                               \
  M(interpreter)                                                                                                                                            \
  M(move_src_dst) M(move_dst_src) M(clamp_0) M(clamp_1) M(clamp_a) M(clamp_gamut) M(unpremul) M(                                                            \
      premul) M(premul_dst) M(force_opaque) M(force_opaque_dst) M(set_rgb) M(unbounded_set_rgb)                                                             \
      M(swap_rb) M(swap_rb_dst) M(from_srgb) M(to_srgb) M(black_color) M(white_color) M(                                                                    \
          uniform_color) M(unbounded_uniform_color) M(uniform_color_dst) M(seed_shader) M(dither)                                                           \
          M(load_a8) M(load_a8_dst) M(store_a8) M(gather_a8) M(load_565) M(load_565_dst) M(                                                                 \
              store_565) M(gather_565) M(load_4444) M(load_4444_dst) M(store_4444) M(gather_4444)                                                           \
              M(load_f16) M(load_f16_dst) M(store_f16) M(gather_f16) M(load_af16) M(                                                                        \
                  load_af16_dst) M(store_af16) M(gather_af16) M(load_rgf16) M(load_rgf16_dst)                                                               \
                  M(store_rgf16) M(gather_rgf16) M(load_f32) M(load_f32_dst) M(store_f32) M(gather_f32) M(                                                  \
                      ...
                      M(load_rg88_dst) M(store_rg88) M(gather_rg88) M(load_a16) M(load_a16_dst) M(                                                          \
                          store_a16) M(gather_a16) M(load_rg1616) M(load_rg1616_dst) M(store_rg1616)                                                        \
                          M(gather_rg1616) M(load_16161616) M(load_16161616_dst) M(store_16161616) M(                                                       \
                              ...
                              M(alpha_to_gray) M(alpha_to_gray_dst) M(bt709_luminance_or_luma_to_alpha) M(bilerp_clamp_8888) M(                             \
                                  ...
                                  M(store_dst) M(scale_u8) M(scale_565) M(scale_1_float) M(scale_native) M(                                                 \
                                      ...
                                      M(dstin) M(dstout) M(dstover) M(srcatop) M(srcin) M(                                                                  \
                                          ...
                                          M(screen) M(xor_) M(colorburn) M(colordodge) M(darken) M(                                                         \
                                              difference) M(exclusion) M(hardlight)                                                                         \
                                              M(lighten) M(overlay) M(softlight) M(hue) M(saturation) M(                                                    \
                                                  color) M(luminosity) M(srcover_rgba_8888) M(matrix_translate)                                             \
                                                  M(matrix_scale_translate) M(                                                                              \
                                                          ...
                                                          M(gamma_) M(PQish) M(HLGish) M(                                                                   \
                                                              ...
                                                              M(decal_x) M(decal_y) M(decal_x_and_y) M(check_decal_mask) M(                                 \
                                                                  ...
                                                                  M(bicubic) M(bilinear_nx) M(bilinear_px) M(                                               \
                                                                      bilinear_ny) M(bilinear_py) M(bicubic_n3x)                                            \
                                                                      M(bicubic_n1x) M(bicubic_p1x) M(bicubic_p3x) M(                                       \
                                                                          bicubic_n3y) M(bicubic_n1y) M(bicubic_p1y)                                        \
                                                                          M(bicubic_p3y) M(save_xy) M(                                                      \
                                                                              accumulate) M(clamp_x_1) M(mirror_x_1)                                        \
                                                                              M(repeat_x_1) M(                                                              \
