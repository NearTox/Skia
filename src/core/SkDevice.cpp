...
void SkBaseDevice::drawArc(const SkRect& oval, SkScalar startAngle, SkScalar sweepAngle,
...
void SkBaseDevice::drawImageRect(const SkImage* image, const SkRect* src, const SkRect& dst,
...
void SkBaseDevice::drawImageNine(const SkImage* image, const SkIRect& center, const SkRect& dst,
                                 const SkPaint& paint) {
...
void SkBaseDevice::drawBitmapNine(const SkBitmap& bitmap, const SkIRect& center, const SkRect& dst,
                                  const SkPaint& paint) {
...
void SkBaseDevice::drawBitmapLattice(const SkBitmap& bitmap, const SkCanvas::Lattice& lattice,
                                     const SkRect& dst, const SkPaint& paint) {
    SkLatticeIter iter(lattice, dst);
...
void SkBaseDevice::drawAtlas(const SkImage* atlas, const SkRSXform xform[], const SkRect tex[],
                             const SkColor colors[], int quadCount, SkBlendMode mode,
                             const SkPaint& paint) {
...
void SkBaseDevice::drawSpecial(SkSpecialImage*, int x, int y, const SkPaint&, SkImage*,
                               const SkMatrix&) {}
...
void SkBaseDevice::LogDrawScaleFactor(const SkMatrix& view, const SkMatrix& srcToDst,
                                      SkFilterQuality filterQuality) noexcept {
