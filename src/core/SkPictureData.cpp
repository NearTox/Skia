...
template <typename T> int SafeCount(const T* obj) { return obj ? obj->count() : 0; }
...
bool new_array_from_buffer(SkReadBuffer& buffer, uint32_t inCount, SkTArray<sk_sp<T>>& array,
