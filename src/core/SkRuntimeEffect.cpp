...
SkRuntimeEffect::EffectResult SkRuntimeEffect::Make(SkString sksl) {
  ...
  auto program = compiler->convertProgram(
      SkSL::Program::kRuntimeEffect_Kind, SkSL::String(sksl.c_str(), sksl.size()), settings);
...
#undef RETURN_FAILURE
  ...
  sk_sp<SkRuntimeEffect> effect(new SkRuntimeEffect(
      std::move(sksl), std::move(program), *main, std::move(uniforms), std::move(children),
...
SkRuntimeEffect::SkRuntimeEffect(
    SkString sksl, std::unique_ptr<SkSL::Program> baseProgram, const SkSL::FunctionDefinition& main,
    std::vector<Uniform>&& uniforms, std::vector<SkString>&& children,
    std::vector<SkSL::SampleUsage>&& sampleUsages, std::vector<Varying>&& varyings,
    bool usesSampleCoords, bool allowColorFilter)
 ...
 public:
  ...
  skvm::Color onProgram(
    ...
    return SkSL::ProgramToSkVM(
        *fEffect->fBaseProgram, fEffect->fMain, p, uniform,
...
class SkRTShader : public SkShaderBase {
 public:
  ...
  skvm::Color onProgram(
    ...
    return SkSL::ProgramToSkVM(
        *fEffect->fBaseProgram, fEffect->fMain, p, uniform, device, local, sampleChild);
  }
