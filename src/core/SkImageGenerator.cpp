...
bool SkImageGenerator::getYUVA8Planes(
...
sk_sp<GrTextureProxy> SkImageGenerator::onGenerateTexture(
    GrRecordingContext*, const SkImageInfo&, const SkIPoint&, bool willNeedMipMaps) {
  return nullptr;
}
#endif
