...
SkSurfaceCharacterization SkSurfaceCharacterization::createResized(int width, int height) const {
  ...
  return SkSurfaceCharacterization(
      ...
      fOrigin, fSampleCnt, fIsTextureable, fIsMipMapped, fUsesGLFBO0, fVulkanSecondaryCBCompatible,
...
SkSurfaceCharacterization SkSurfaceCharacterization::createBackendFormat(
  ...
  return SkSurfaceCharacterization(
      ...
      fIsTextureable, fIsMipMapped, fUsesGLFBO0, fVulkanSecondaryCBCompatible, fIsProtected,
      fSurfaceProps);
}
