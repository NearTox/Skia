...
*/
static inline void sk_memset16(uint16_t buffer[], uint16_t value, int count) noexcept {
    SkOpts::memset16(buffer, value, count);
}
static inline void sk_memset32(uint32_t buffer[], uint32_t value, int count) noexcept {
    SkOpts::memset32(buffer, value, count);
}
static inline void sk_memset64(uint64_t buffer[], uint64_t value, int count) noexcept {
