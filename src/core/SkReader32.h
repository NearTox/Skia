...
class SkReader32 : SkNoncopyable {
 public:
  ...
  bool readMatrix(SkMatrix* matrix) { return this->readObjectFromMemory(matrix); }

  bool readRRect(SkRRect* rrect) { return this->readObjectFromMemory(rrect); }

  bool readRegion(SkRegion* rgn) { return this->readObjectFromMemory(rgn); }
