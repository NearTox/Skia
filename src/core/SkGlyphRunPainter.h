...
public:
    ...
    void drawForBitmapDevice(const SkGlyphRunList& glyphRunList, const SkMatrix& deviceMatrix,
...
public:
    ...
    virtual void processDeviceMasks(SkSpan<const SkGlyphPos> masks, SkStrikeInterface* strike) = 0;

    virtual void processSourcePaths(SkSpan<const SkGlyphPos> paths, SkStrikeInterface* strike,
                                    SkScalar cacheToSourceScale) = 0;
