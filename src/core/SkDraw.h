...
class SkDraw : public SkGlyphRunListPainter::BitmapDevicePainter {
 public:
  ...
  void drawPoints(
      SkCanvas::PointMode, size_t count, const SkPoint[], const SkPaint&, SkBaseDevice*) const;
  void drawRect(
      const SkRect& prePaintRect, const SkPaint&, const SkMatrix* paintMatrix,
   ...
   */
  void drawPath(
      const SkPath& path, const SkPaint& paint, const SkMatrix* prePathMatrix = nullptr,
  ...
  void drawVertices(
      SkVertices::VertexMode mode, int vertexCount, const SkPoint vertices[],
      ...
      int ptCount, const SkPaint& paint, const SkVertices::Bone bones[], int boneCount) const;
   ...
   */
  void drawPathCoverage(
      const SkPath& src, const SkPaint& paint, SkBlitter* customBlitter = nullptr) const {
 ...
 private:
  ...
  void drawPath(
      ...
      bool drawCoverage, SkBlitter* customBlitter = nullptr) const;
