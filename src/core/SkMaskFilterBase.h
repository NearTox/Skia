...
class SkMaskFilterBase : public SkMaskFilter {
  ...
  */
  virtual bool filterMask(
      SkMask* dst, const SkMask& src, const SkMatrix&, SkIPoint* margin) const = 0;
 ...
 protected:
   ...
   */
  virtual FilterReturn filterRectsToNine(
   ...
   */
  virtual FilterReturn filterRRectToNine(
 ...
 private:
   ...
   */
  bool filterPath(
      const SkPath& devPath, const SkMatrix& ctm, const SkRasterClip&, SkBlitter*,
