...
class SkBitmapDevice : public SkBaseDevice {
 public:
   ...
   */
  SkBitmapDevice(
      const SkBitmap& bitmap, const SkSurfaceProps& surfaceProps, void* externalHandle,
      const SkBitmap* coverage);

  static SkBitmapDevice* Create(
      const SkImageInfo&, const SkSurfaceProps&, bool trackCoverage, SkRasterHandleAllocator*);
