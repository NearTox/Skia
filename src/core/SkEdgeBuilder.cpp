...
template <typename Edge> static bool is_vertical(const Edge* edge) {
...
SkEdgeBuilder::Combine SkBasicEdgeBuilder::addPolyLine(SkPoint pts[], char* arg_edge,
                                                       char** arg_edgePtr) {
...
SkEdgeBuilder::Combine SkAnalyticEdgeBuilder::addPolyLine(SkPoint pts[], char* arg_edge,
                                                          char** arg_edgePtr) {
            ...
            switch (verb) {
                ...
                case SkPath::kConic_Verb: {
                    const SkPoint* quadPts =
                            quadder.computeQuads(pts, iter.conicWeight(), conicTol);
