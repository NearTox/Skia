...
struct SkBufferBlock {
  ...
  constexpr SkBufferBlock(size_t capacity) noexcept
      : fNext(nullptr), fUsed(0), fCapacity(capacity) {}
...
struct SkBufferHead {
  ...
  constexpr SkBufferHead(size_t capacity) noexcept : fRefCnt(1), fBlock(capacity) {}
