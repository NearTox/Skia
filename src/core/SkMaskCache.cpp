...
SkCachedData* SkMaskCache::FindAndRef(
    SkScalar sigma, SkBlurStyle style, const SkRRect& rrect, SkMask* mask,
...
void SkMaskCache::Add(
    SkScalar sigma, SkBlurStyle style, const SkRRect& rrect, const SkMask& mask, SkCachedData* data,
    SkResourceCache* localCache) {
  RRectBlurKey key(sigma, rrect, style);
...
SkCachedData* SkMaskCache::FindAndRef(
    SkScalar sigma, SkBlurStyle style, const SkRect rects[], int count, SkMask* mask,
    SkResourceCache* localCache) {
  MaskValue result;
...
void SkMaskCache::Add(
    SkScalar sigma, SkBlurStyle style, const SkRect rects[], int count, const SkMask& mask,
