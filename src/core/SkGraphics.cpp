...
SkGraphics::OpenTypeSVGDecoderFactory SkGraphics::SetOpenTypeSVGDecoderFactory(
    OpenTypeSVGDecoderFactory svgDecoderFactory) {
...
void SkGraphics::AllowJIT() { gSkVMAllowJIT = true; }
