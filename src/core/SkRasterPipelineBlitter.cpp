...
public:
    ...
    static SkBlitter* Create(const SkPixmap&, const SkPaint&, SkArenaAlloc*,
                             const SkRasterPipeline& shaderPipeline, bool is_opaque,
                             bool is_constant);
...
SkBlitter* SkCreateRasterPipelineBlitter(const SkPixmap& dst,
    ...
    if (!shader) {
        ...
        return SkRasterPipelineBlitter::Create(dst, paint, alloc, shaderPipeline, is_opaque,
                                               is_constant);
    }
...
void SkRasterPipelineBlitter::blitMask(const SkMask& mask, const SkIRect& clip) {
    ...
    SkASSERT(mask.fFormat == SkMask::kA8_Format || mask.fFormat == SkMask::kLCD16_Format ||
