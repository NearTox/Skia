...
size_t SkFlattenable::serialize(
    void* memory, size_t memory_size, const SkSerialProcs* procs) const {
...
sk_sp<SkFlattenable> SkFlattenable::Deserialize(
    SkFlattenable::Type type, const void* data, size_t size, const SkDeserialProcs* procs) {
