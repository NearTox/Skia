...
void SkOverdrawCanvas::onDrawVerticesObject(const SkVertices* vertices,
    ...
    fList[0]->onDrawVerticesObject(vertices, bones, boneCount, blendMode,
...
void SkOverdrawCanvas::onDrawEdgeAAQuad(const SkRect& rect, const SkPoint clip[4], QuadAAFlags aa,
