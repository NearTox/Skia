...
bool SkColorSpaceXformSteps::Required(SkColorSpace* src, SkColorSpace* dst) {
    ...
    return 0 != SkColorSpaceXformSteps(src, at, dst, at).flags.mask();
...
void SkColorSpaceXformSteps::apply(SkRasterPipeline* p, bool src_is_normalized) const {
    ...
    if (flags.linearize) {
        ...
        } else if (srcTF.a == 1 && srcTF.b == 0 && srcTF.c == 0 && srcTF.d == 0 && srcTF.e == 0 &&
                   srcTF.f == 0) {
    ...
    if (flags.encode) {
        ...
        } else if (dstTFInv.a == 1 && dstTFInv.b == 0 && dstTFInv.c == 0 && dstTFInv.d == 0 &&
                   dstTFInv.e == 0 && dstTFInv.f == 0) {
