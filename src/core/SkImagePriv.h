...
sk_sp<SkShader> SkMakeBitmapShader(
    const SkBitmap& src, SkTileMode, SkTileMode, const SkMatrix* localMatrix, SkCopyPixelsMode);
...
sk_sp<SkShader> SkMakeBitmapShaderForPaint(
    const SkPaint& paint, const SkBitmap& src, SkTileMode, SkTileMode, const SkMatrix* localMatrix,
    SkCopyPixelsMode);
