...
static constexpr inline float get_length_squared(float x, float y, float z) {
  return x * x + y * y + z * z;
}
...
static constexpr inline bool is_length_nearly_zero(
    float x, float y, float z, float* lengthSquared) {
