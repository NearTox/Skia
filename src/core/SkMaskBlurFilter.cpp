...
static void blur_row(
    BlurX blur, const Sk8h& g0, const Sk8h& g1, const Sk8h& g2, const Sk8h& g3, const Sk8h& g4,
...
static void blur_column(
    ToA8 toA8, BlurY blur, int radius, int width, const Sk8h& g0, const Sk8h& g1, const Sk8h& g2,
    const Sk8h& g3, const Sk8h& g4, const uint8_t* src, size_t srcRB, int srcH, uint8_t* dst,
    size_t dstRB) {
