...
RECORD(NoOp, 0);
RECORD(Flush, 0);
RECORD(Restore, 0, TypedMatrix matrix);
RECORD(Save, 0);
...
RECORD(ClipPath, 0, PreCachedPath path; ClipOpAndAA opAA);
...
RECORD(DrawArc, kDraw_Tag | kHasPaint_Tag, SkPaint paint; SkRect oval; SkScalar startAngle;
       SkScalar sweepAngle; unsigned useCenter);
...
RECORD(DrawImageNine, kDraw_Tag | kHasImage_Tag | kHasPaint_Tag, Optional<SkPaint> paint;
       sk_sp<const SkImage> image; SkIRect center; SkRect dst);
RECORD(DrawOval, kDraw_Tag | kHasPaint_Tag, SkPaint paint; SkRect oval);
RECORD(DrawPaint, kDraw_Tag | kHasPaint_Tag, SkPaint paint);
RECORD(DrawBehind, kDraw_Tag | kHasPaint_Tag, SkPaint paint);
RECORD(DrawPath, kDraw_Tag | kHasPaint_Tag, SkPaint paint; PreCachedPath path);
...
RECORD(DrawTextBlob, kDraw_Tag | kHasText_Tag | kHasPaint_Tag, SkPaint paint;
       sk_sp<const SkTextBlob> blob; SkScalar x; SkScalar y);
RECORD(DrawPatch, kDraw_Tag | kHasPaint_Tag, SkPaint paint; PODArray<SkPoint> cubics;
