...
class SkFixed15 {
 public:
  SkFixed15() noexcept = default;

  SkFixed15(float val) noexcept : fVal(val * 32768) { SkASSERT(0.0f <= val && val <= 1.0f); }
  explicit operator float() const noexcept { return fVal * (1 / 32768.0f); }

  static SkFixed15 Load(uint16_t val) noexcept {
    SkASSERT(val <= 32768);
    return val;
  }
  uint16_t store() const noexcept { return fVal; }

  static SkFixed15 FromU8(uint8_t val) noexcept {
  ...
  SkFixed15 operator+(SkFixed15 o) const noexcept { return fVal + o.fVal; }
  SkFixed15 operator-(SkFixed15 o) const noexcept { return fVal - o.fVal; }
  SkFixed15 operator*(SkFixed15 o) const noexcept { return (fVal * o.fVal + (1 << 14)) >> 15; }
  SkFixed15 operator<<(int bits) const noexcept { return fVal << bits; }
  SkFixed15 operator>>(int bits) const noexcept { return fVal >> bits; }

  SkFixed15& operator+=(SkFixed15 o) noexcept { return (*this = *this + o); }
  SkFixed15& operator-=(SkFixed15 o) noexcept { return (*this = *this - o); }
  SkFixed15& operator*=(SkFixed15 o) noexcept { return (*this = *this * o); }
  SkFixed15& operator<<=(int bits) noexcept { return (*this = *this << bits); }
  SkFixed15& operator>>=(int bits) noexcept { return (*this = *this >> bits); }

  bool operator==(SkFixed15 o) const noexcept { return fVal == o.fVal; }
  bool operator!=(SkFixed15 o) const noexcept { return fVal != o.fVal; }
  bool operator<=(SkFixed15 o) const noexcept { return fVal <= o.fVal; }
  bool operator>=(SkFixed15 o) const noexcept { return fVal >= o.fVal; }
  bool operator<(SkFixed15 o) const noexcept { return fVal < o.fVal; }
 ...
 private:
  SkFixed15(int val) noexcept : fVal(val) {}
