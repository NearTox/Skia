...
SkStrike::SkStrike(
    ...
    : fDesc{desc},
      ...
      fRoundingSpec{fScalerContext->isSubpixel(), fScalerContext->computeAxisAlignmentForHText()} {
...
SkGlyph* SkStrike::glyph(SkGlyphID glyphID) { return this->glyph(SkPackedGlyphID{glyphID}); }
...
SkGlyph* SkStrike::glyphOrNull(SkPackedGlyphID id) const { return fGlyphMap.findOrNull(id); }
...
SkSpan<const SkGlyphPos> SkStrike::prepareForDrawingRemoveEmpty(
