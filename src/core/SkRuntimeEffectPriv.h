...
class SkRuntimeEffectPriv {
 public:
  ...
  static SkRuntimeEffect::Uniform VarAsUniform(
      const SkSL::Variable&, const SkSL::Context&, size_t* offset);
...
inline sk_sp<SkRuntimeEffect> SkMakeCachedRuntimeEffect(
    SkRuntimeEffect::Result (*make)(SkString), const char* sksl) {
...
inline sk_sp<SkRuntimeEffect> SkMakeRuntimeEffect(
    SkRuntimeEffect::Result (*make)(SkString, const SkRuntimeEffect::Options&), const char* sksl,
