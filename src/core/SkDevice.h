...
class SkBaseDevice : public SkRefCnt {
 ...
 protected:
  ...
  enum ClipType { kEmpty_ClipType, kRect_ClipType, kComplex_ClipType };
   ...
   */
  virtual void drawBitmapRect(
      const SkBitmap&, const SkRect* srcOrNull, const SkRect& dst, const SkPaint& paint,
      SkCanvas::SrcRectConstraint) = 0;
  virtual void drawBitmapNine(
      const SkBitmap&, const SkIRect& center, const SkRect& dst, const SkPaint&);
  virtual void drawBitmapLattice(
      const SkBitmap&, const SkCanvas::Lattice&, const SkRect& dst, const SkPaint&);

  virtual void drawImageRect(
      const SkImage*, const SkRect* src, const SkRect& dst, const SkPaint&,
      SkCanvas::SrcRectConstraint);
  virtual void drawImageNine(
      const SkImage*, const SkIRect& center, const SkRect& dst, const SkPaint&);
  virtual void drawImageLattice(
      const SkImage*, const SkCanvas::Lattice&, const SkRect& dst, const SkPaint&);
  ...
  virtual void drawEdgeAAImageSet(
      ...
      const SkMatrix preViewMatrices[], const SkPaint& paint, SkCanvas::SrcRectConstraint);
  ...
  void drawGlyphRunRSXform(
      const SkFont&, const SkGlyphID[], const SkRSXform[], int count, SkPoint origin,
      const SkPaint& paint);
  ...
  struct CreateInfo {
    ...
    CreateInfo(
        ...
        bool trackCoverage, SkRasterHandleAllocator* allocator)
        : fInfo(info),
          fTileUsage(tileUsage),
...
class SkNoPixelsDevice : public SkBaseDevice {
 ...
 protected:
  ...
  void drawBitmapRect(
      const SkBitmap&, const SkRect*, const SkRect&, const SkPaint&,
      SkCanvas::SrcRectConstraint) override {}
  void drawDevice(SkBaseDevice*, int, int, const SkPaint&) override {}
  void drawGlyphRunList(const SkGlyphRunList& glyphRunList) override {}
  void drawVertices(
      const SkVertices*, const SkVertices::Bone[], int, SkBlendMode, const SkPaint&) override {}
