...
static Sk4f fma(const Sk4f& f, float m, const Sk4f& a) { return SkNx_fma(f, Sk4f(m), a); }
...
float SkFindCubicMidTangent(const SkPoint src[4]) {
  ...
  static const Sk4f kM[4] = {Sk4f(-1, 2, -1, 0), Sk4f(3, -4, 1, 0), Sk4f(-3, 2, 0, 0)};
  Sk4f C_x =
      fma(kM[0], src[0].fX, fma(kM[1], src[1].fX, fma(kM[2], src[2].fX, Sk4f(src[3].fX, 0, 0, 0))));
  Sk4f C_y =
      fma(kM[0], src[0].fY, fma(kM[1], src[1].fY, fma(kM[2], src[2].fY, Sk4f(src[3].fY, 0, 0, 0))));
