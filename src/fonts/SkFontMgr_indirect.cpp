...
SkTypeface* SkFontMgr_Indirect::onMatchFamilyStyle(
...
SkTypeface* SkFontMgr_Indirect::onMatchFamilyStyleCharacter(
...
SkTypeface* SkFontMgr_Indirect::onMatchFaceStyle(
...
sk_sp<SkTypeface> SkFontMgr_Indirect::onMakeFromStreamIndex(
...
sk_sp<SkTypeface> SkFontMgr_Indirect::onLegacyMakeTypeface(
