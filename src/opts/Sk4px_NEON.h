...
inline Sk4px::Wide Sk4px::mulWiden(const Sk16b& other) const {
  return Sk16h(
      vmull_u8(vget_low_u8(this->fVec), vget_low_u8(other.fVec)),
...
inline Sk4px Sk4px::Wide::addNarrowHi(const Sk16h& other) const {
  ...
  return Sk16b(
      vcombine_u8(vaddhn_u16(this->fLo.fVec, o.fLo.fVec), vaddhn_u16(this->fHi.fVec, o.fHi.fVec)));
}

inline Sk4px Sk4px::Wide::div255() const {
  // Calculated as (x + (x+128)>>8 +128) >> 8.  The 'r' in each instruction provides each +128.
  return Sk16b(vcombine_u8(
      vraddhn_u16(this->fLo.fVec, vrshrq_n_u16(this->fLo.fVec, 8)),
