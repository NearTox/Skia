...
class GLSLClockwiseTestProcessor : public GrGLSLGeometryProcessor {
    ...
    void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
        ...
        args.fFragBuilder->codeAppendf("%s = sk_Clockwise ? half4(0,1,0,1) : half4(1,0,0,1);",
                                       args.fOutputColor);
...
public:
    ...
    static std::unique_ptr<GrDrawOp> Make(GrRecordingContext* context, bool readSkFragCoord,
                                          int y = 0) {
