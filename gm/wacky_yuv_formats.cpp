...
static void convert_rgba_to_yuva_601_shared(
    SkColor col, uint8_t yuv[4], uint8_t off, uint8_t range) {
...
static SkPMColor convert_yuva_to_rgba_jpeg(uint8_t y, uint8_t u, uint8_t v, uint8_t a) {
  uint8_t r = SkScalarPin(SkScalarRoundToInt(1.0f * y + 1.402f * v - 0.703749f * 255), 0, 255);
  uint8_t g = SkScalarPin(
      SkScalarRoundToInt(1.0f * y - (0.344136f * u) - (0.714136f * v) + 0.531211f * 255), 0, 255);
  uint8_t b = SkScalarPin(SkScalarRoundToInt(1.0f * y + 1.772f * u - 0.889475f * 255), 0, 255);
...
static SkPMColor convert_yuva_to_rgba_601(uint8_t y, uint8_t u, uint8_t v, uint8_t a) {
  ...
  uint8_t g = SkScalarPin(
      SkScalarRoundToInt(1.164f * y - (0.391f * u) - (0.813f * v) + 0.52925f * 255), 0, 255);
...
static SkPMColor convert_yuva_to_rgba_709(uint8_t y, uint8_t u, uint8_t v, uint8_t a) {
  ...
  uint8_t g = SkScalarPin(
      SkScalarRoundToInt(1.164f * y - (0.213f * u) - (0.533f * v) + 0.30025f * 255), 0, 255);
...
class WackyYUVFormatsGM : public GM {
 public:
  WackyYUVFormatsGM(bool useTargetColorSpace, bool useDomain)
      : fUseTargetColorSpace(useTargetColorSpace), fUseDomain(useDomain) {
