...
class ConvexPathsGM : public skiagm::GM {
  ...
  void makePaths() {
    ...
    fPaths.push_back().addRect(0, 0, 100 * SK_Scalar1, 100 * SK_Scalar1, SkPathDirection::kCW);

    fPaths.push_back().addRect(0, 0, 100 * SK_Scalar1, 100 * SK_Scalar1, SkPathDirection::kCCW);

    fPaths.push_back().addCircle(
        50 * SK_Scalar1, 50 * SK_Scalar1, 50 * SK_Scalar1, SkPathDirection::kCW);

    fPaths.push_back().addOval(
        SkRect::MakeXYWH(0, 0, 50 * SK_Scalar1, 100 * SK_Scalar1), SkPathDirection::kCW);

    fPaths.push_back().addOval(
        SkRect::MakeXYWH(0, 0, 100 * SK_Scalar1, 5 * SK_Scalar1), SkPathDirection::kCCW);

    fPaths.push_back().addOval(
        SkRect::MakeXYWH(0, 0, SK_Scalar1, 100 * SK_Scalar1), SkPathDirection::kCCW);

    fPaths.push_back().addRoundRect(
        SkRect::MakeXYWH(0, 0, SK_Scalar1 * 100, SK_Scalar1 * 100), 40 * SK_Scalar1,
        20 * SK_Scalar1, SkPathDirection::kCW);
