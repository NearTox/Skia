...
class OffsetImageFilterGM : public skiagm::GM {
 ...
 protected:
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      SkIRect cropRect =
          SkIRect::MakeXYWH(i * 12, i * 8, image->width() - i * 8, image->height() - i * 12);
 ...
 private:
  static void DrawClippedImage(
      SkCanvas* canvas, const SkImage* image, const SkPaint& paint, SkScalar scale,
...
class SimpleOffsetImageFilterGM : public skiagm::GM {
 ...
 protected:
  ...
  void doDraw(
      SkCanvas* canvas, const SkRect& r, sk_sp<SkImageFilter> imgf, const SkIRect* cropR = nullptr,
