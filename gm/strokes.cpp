...
protected:
    SkString onShortName() override { return SkString("strokes_round"); }

    SkISize onISize() override { return SkISize::Make(W, H * 2); }
...
protected:
    ...
    SkString onShortName() override { return SkString("zeroPath"); }
...
protected:
    SkString onShortName() override { return SkString("strokes3"); }

    SkISize onISize() override { return SkISize::Make(1500, 1500); }
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        void (*procs[])(SkPath*, const SkRect&, SkString*) = {make0, make1, make2,
                                                              make3, make4, make5};
...
protected:
    SkString onShortName() override { return SkString("strokes_zoomed"); }
...
protected:
    SkString onShortName() override { return SkString("zero_control_stroke"); }
...
DEF_SIMPLE_GM(bigconic, canvas, 250, 250) {
    ...
    path.conicTo(SkBits2Float(0x7ef74f23), SkBits2Float(0xfef8069e), SkBits2Float(0x7ef751f6),
                 ...
                 SkBits2Float(0x3f3504f3));  // 1.64365e+38f, -1.64841e+38f, 1.64372e+38f,
                                             // -1.64834e+38f, 0.707107f
    path.conicTo(SkBits2Float(0x7ef754c8), SkBits2Float(0xfef800f5), SkBits2Float(0x7ef751f5),
                 SkBits2Float(0xfef7fe22),
                 SkBits2Float(0x3f353472));  // 1.6438e+38f, -1.64827e+38f, 1.64372e+38f,
                                             // -1.64819e+38f, 0.707832f
    ...
    path.conicTo(SkBits2Float(0x7d7a4764), SkBits2Float(0xfd7ff2b0), SkBits2Float(0x7d7a55b4),
                 SkBits2Float(0xfd8007a8),
                 SkBits2Float(0x3f3504f3));  // 2.07924e+37f, -2.12633e+37f, 2.0797e+37f,
                                             // -2.12726e+37f, 0.707107f
    path.conicTo(SkBits2Float(0x7d7a5803), SkBits2Float(0xfd8009f7), SkBits2Float(0x7d7a5ba9),
                 SkBits2Float(0xfd800bcc),
                 SkBits2Float(0x3f7cba66));  // 2.07977e+37f, -2.12741e+37f, 2.07989e+37f,
                                             // -2.12753e+37f, 0.987219f
    ...
    path.conicTo(SkBits2Float(0xfc8b395c), SkBits2Float(0x7c803870), SkBits2Float(0xfc8b4405),
                 SkBits2Float(0x7c802dd1),
                 SkBits2Float(0x3f79349d));  // -5.78314e+36f, 5.32607e+36f,
                                             // -5.78487e+36f, 5.32435e+36f, 0.973459f
    path.conicTo(SkBits2Float(0xfc8b715b), SkBits2Float(0x7c8000a5), SkBits2Float(0xfc8b442f),
                 SkBits2Float(0x7c7fa69e),
                 SkBits2Float(0x3f3504f3));  // -5.79223e+36f, 5.31702e+36f,
                                             // -5.7849e+36f, 5.30966e+36f, 0.707107f
    ...
    path.conicTo(SkBits2Float(0xfe11623c), SkBits2Float(0x7e100bdf), SkBits2Float(0xfe1167e2),
                 SkBits2Float(0x7e100636),
                 SkBits2Float(0x3f3504f3));  // -4.8312e+37f, 4.78676e+37f,
                                             // -4.83194e+37f, 4.78603e+37f, 0.707107f
    path.conicTo(SkBits2Float(0xfe116d87), SkBits2Float(0x7e10008e), SkBits2Float(0xfe1167e2),
                 SkBits2Float(0x7e0ffae8),
                 SkBits2Float(0x3f35240a));  // -4.83267e+37f, 4.78529e+37f,
                                             // -4.83194e+37f, 4.78456e+37f, 0.707581f
    ...
    path.lineTo(SkBits2Float(0xfab448de),
                SkBits2Float(0xf7b50a19));  // -4.68046e+35f, -7.34383e+33f
    ...
    path.close();
    path.moveTo(SkBits2Float(0xfab59cf2),
                SkBits2Float(0xf800007e));  // -4.71494e+35f, -1.03847e+34f
    path.lineTo(SkBits2Float(0xfaa7cc52),
                SkBits2Float(0xf800007f));  // -4.35629e+35f, -1.03848e+34f
    ...
    path.conicTo(SkBits2Float(0xfe416699), SkBits2Float(0x7e4008bf), SkBits2Float(0xfe4168f1),
                 SkBits2Float(0x7e400668),
                 SkBits2Float(0x3f6c8ed9));  // -6.42684e+37f, 6.38143e+37f,
                                             // -6.42715e+37f, 6.38113e+37f, 0.924055f
    path.conicTo(SkBits2Float(0xfe416e9a), SkBits2Float(0x7e4000c2), SkBits2Float(0xfe4168f3),
                 SkBits2Float(0x7e3ffb17),
                 SkBits2Float(0x3f3504f3));  // -6.42788e+37f, 6.38039e+37f,
                                             // -6.42715e+37f, 6.37966e+37f, 0.707107f
    ...
    path.lineTo(SkBits2Float(0xfab6c8db),
                SkBits2Float(0xf7b50b4f));  // -4.74536e+35f, -7.34402e+33f
    path.lineTo(SkBits2Float(0xfab59cf2),
                SkBits2Float(0xf800007e));  // -4.71494e+35f, -1.03847e+34f
    path.close();
    ...
    path.quadTo(SkBits2Float(0xfd05a9a6), SkBits2Float(0x7d00007f), SkBits2Float(0xfab3f4db),
    ...
    path.quadTo(SkBits2Float(0xfab6e4de), SkBits2Float(0x43480000), SkBits2Float(0x7c68f062),
