 ...
 protected:
  ...
  void drawTestCase(SkCanvas* canvas, SkScalar x, SkScalar y, SkBlendMode mode, SkBlendMode mode2) {
    const SkColor colors[]{
        SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorYELLOW, SK_ColorCYAN, SK_ColorMAGENTA,
    };
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    drawTestCase(canvas, offsetX, 3 * offsetY, SkBlendMode::kHardLight, SkBlendMode::kLuminosity);
