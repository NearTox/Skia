...
static void draw_cell(
    SkCanvas* canvas, const SkBitmap& bm, const SkMatrix& mat, SkScalar dx, SkFilterQuality lvl) {
  SkPaint paint;
...
class FilterIndiaBoxGM : public skiagm::GM {
 ...
 public:
  ...
  FilterIndiaBoxGM(const char filename[]) : fFilename(filename) { fName.printf("filterindiabox"); }

 protected:
  SkString onShortName() override { return fName; }

  SkISize onISize() override { return SkISize::Make(680, 130); }
 ...
 protected:
  ...
  SkScalar getScale() { return 192.f / fSize; }
