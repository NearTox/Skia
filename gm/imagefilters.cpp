  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    sk_sp<SkImageFilter> filters[] = {
        ...
        SkImageFilters::MatrixConvolution(
            {3, 3}, kernel, 1, 0, {0, 0}, SkTileMode::kDecal, true, nullptr),
...
DEF_SIMPLE_GM(imagefilters_effect_order, canvas, 512, 512) {
  ...
  auto edgeAmplify =
      SkHighContrastFilter::Make({false, SkHighContrastConfig::InvertStyle::kNoInvert, 0.5f});
  ...
  expectedCFPaint.setImageFilter(
      SkImageFilters::Compose(edgeDetector, SkImageFilters::ColorFilter(edgeAmplify, nullptr)));
  ...
  sk_sp<SkShader> alphaMaskShader =
      SkGradientShader::MakeRadial({128.f, 128.f}, 128.f, kAlphas, kPos, 2, SkTileMode::kClamp);
  ...
  sk_sp<SkImageFilter> edgeBlend =
      SkImageFilters::Xfermode(SkBlendMode::kSrcOver, SkImageFilters::Image(image), edgeDetector);
  ...
  expectedMaskPaint.setImageFilter(SkImageFilters::Compose(
      edgeBlend, SkImageFilters::Xfermode(SkBlendMode::kSrcIn, SkImageFilters::Paint(alphaPaint))));
