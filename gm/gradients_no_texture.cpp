...
static sk_sp<SkShader> Make2Conical(const SkPoint pts[2], const GradData& data, SkTileMode tm) {
  ...
  return SkGradientShader::MakeTwoPointConical(
      center1, radius1, center0, radius0, data.fColors, data.fPos, data.fCount, tm);
}
...
class GradientsNoTextureGM : public GM {
 public:
  GradientsNoTextureGM(bool dither) : fDither(dither) { this->setBGColor(0xFFDDDDDD); }
 ...
 protected:
  ...
  void onDraw(SkCanvas* canvas) override {
    constexpr SkPoint kPts[2] = {{0, 0}, {SkIntToScalar(50), SkIntToScalar(50)}};
...
height: 30px;
  ...
  const SkColor colors[] = {0xFF22d1cd, 0xFF22d1cd, 0xFFdf4b37, 0xFFdf4b37, 0xFF22d1cd, 0xFF22d1cd,
                            0xFFe6de36, 0xFFe6de36, 0xFF3267ff, 0xFF3267ff, 0xFF9d47d1, 0xFF9d47d1,
                            0xFF3267ff, 0xFF3267ff, 0xFF5cdd9d, 0xFF5cdd9d, 0xFF3267ff, 0xFF3267ff,
                            0xFF9d47d1, 0xFF9d47d1, 0xFF3267ff, 0xFF3267ff, 0xFFe3d082, 0xFFe3d082};
...
static void make1(ColorPos* rec) {
  const SkColor colors[] = {
      SK_ColorBLACK, SK_ColorWHITE, SK_ColorBLACK, SK_ColorWHITE, SK_ColorBLACK,
      SK_ColorWHITE, SK_ColorBLACK, SK_ColorWHITE, SK_ColorBLACK,
  };
 ...
 protected:
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    for (size_t i = 0; i < SK_ARRAY_COUNT(procs); ++i) {
      ...
      procs[i](&rec);
      paint.setShader(
          SkGradientShader::MakeLinear(pts, rec.fColors, rec.fPos, rec.fCount, SkTileMode::kClamp));
