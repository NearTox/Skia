...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        matrices.push()->setAll(1.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.005f, 1.f);
        matrices.push()->setAll(1.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.007f, -0.005f, 1.f);
                ...
                for (auto aa : {false, true}) {
                    ...
                    for (auto filter : {kNone_SkFilterQuality, kLow_SkFilterQuality,
                        ...
                        for (const auto& img : fImages) {
                            ...
                            SkRect dst = {0, 0, 3.f / 4.f * img->width(),
                                          3.f / 4.f * img->height()};
                            switch (type) {
