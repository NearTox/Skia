...
constexpr SkFontArguments::Palette::Override kColorOverridesAll[] = {
    ...
    {6, 0xffffff00}, {2, 0xff76078f},  {4, 0xffb404c4},  {1, 0xff510970},
    {6, 0xfffa00ff}, {8, 0xff888888},  {10, 0xff888888}, {9, 0xff888888},
    {7, 0xff888888}, {11, 0xff888888}, {0, 0xff310b55},  {3, 0xff9606aa},
    {5, 0xffd802e2}, {13, 0xff00ffff}, {12, 0xff00ffff}, {-1, 0xff00ff00},
};
...
class FontPaletteGM : public GM {
 ...
 protected:
  ...
  void onOnceBeforeDraw() override {
    ...
    fTypefaceCloned = fTypefaceDefault ? fTypefaceDefault->makeClone(paletteArguments) : nullptr;
  ...
  DrawResult onDraw(SkCanvas* canvas, SkString* errorMsg) override {
    ...
    for (auto& typeface : {fTypefaceFromStream, fTypefaceCloned}) {
      ...
      canvas->drawSimpleText(
          kTestGlyphs, SK_ARRAY_COUNT(kTestGlyphs) * sizeof(uint16_t), SkTextEncoding::kGlyphID, 0,
          y, defaultFont, paint);
      // Draw the overriden palette on the right.
      canvas->drawSimpleText(
          kTestGlyphs, SK_ARRAY_COUNT(kTestGlyphs) * sizeof(uint16_t), SkTextEncoding::kGlyphID,
          440, y, paletteFont, paint);
