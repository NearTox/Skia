...
class WideButtCaps : public skiagm::GM {
 ...
 protected:
  SkString onShortName() override { return SkString("widebuttcaps"); }

  SkISize onISize() override { return SkISize::Make(120 * 4, 120 * 3 + 140); }
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    this->drawStrokes(
        canvas, SkPath().lineTo(10, 0).lineTo(10, 10), SkPath().cubicTo(10, 0, 10, 0, 10, 10));
    canvas->translate(0, 120);

    this->drawStrokes(
        canvas, SkPath().lineTo(0, -10).lineTo(0, 10), SkPath().cubicTo(0, -10, 0, -10, 0, 10));
    canvas->translate(0, 120);

    this->drawStrokes(
        canvas, SkPath().lineTo(0, -10).lineTo(10, -10).lineTo(10, 10).lineTo(0, 10),
        SkPath().cubicTo(0, -10, 10, 10, 0, 10));
    canvas->translate(0, 140);

    this->drawStrokes(
        canvas, SkPath().lineTo(0, -10).lineTo(10, -10).lineTo(10, 0).lineTo(0, 0),
