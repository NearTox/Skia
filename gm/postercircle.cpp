...
protected:
    ...
    void onOnceBeforeDraw() override {
        ...
        for (int i = 0; i < kNumAngles; ++i) {
            ...
            canvas->drawRRect(
                    SkRRect::MakeRectXY(SkRect::MakeWH(kPosterSize, kPosterSize), 10.f, 10.f),
                    fillPaint);
            ...
            for (int y = 0; y < 3; ++y) {
                ...
                for (int i = 0; i < kNumAngles; ++i) {
                    ...
                    SkScalar yRotation = SkScalarMod(
                            kAngleStep * i + 360.f * SkScalarMod(fTime / yDuration, yDuration),
                            360.f);
                    ...
                    canvas->concat(
                            SkMatrix::MakeAll(model.get(0, 0), model.get(0, 1), model.get(0, 3),
