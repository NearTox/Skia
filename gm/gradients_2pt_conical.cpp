...
static sk_sp<SkShader> Make2ConicalInside(const SkPoint pts[2], const GradData& data, SkTileMode tm,
...
static sk_sp<SkShader> Make2ConicalInsideFlip(const SkPoint pts[2], const GradData& data,
    ...
    center1.set(SkScalarInterp(pts[0].fX, pts[1].fX, SkIntToScalar(3) / 5),
                SkScalarInterp(pts[0].fY, pts[1].fY, SkIntToScalar(1) / 4));
    return SkGradientShader::MakeTwoPointConical(center0, (pts[1].fX - pts[0].fX) / 2, center1,
...
static sk_sp<SkShader> Make2ConicalInsideCenter(const SkPoint pts[2], const GradData& data,
    ...
    SkPoint center0;
    center0.set(SkScalarAve(pts[0].fX, pts[1].fX), SkScalarAve(pts[0].fY, pts[1].fY));
    return SkGradientShader::MakeTwoPointConical(center0, (pts[1].fX - pts[0].fX) / 7, center0,
                                                 (pts[1].fX - pts[0].fX) / 2, data.fColors,
                                                 data.fPos, data.fCount, tm, 0, &localMatrix);
}
...
static sk_sp<SkShader> Make2ConicalInsideCenterReversed(const SkPoint pts[2], const GradData& data,
    ...
    SkPoint center0;
    center0.set(SkScalarAve(pts[0].fX, pts[1].fX), SkScalarAve(pts[0].fY, pts[1].fY));
    return SkGradientShader::MakeTwoPointConical(center0, (pts[1].fX - pts[0].fX) / 2, center0,
                                                 (pts[1].fX - pts[0].fX) / 7, data.fColors,
                                                 data.fPos, data.fCount, tm, 0, &localMatrix);
}
...
static sk_sp<SkShader> Make2ConicalZeroRad(const SkPoint pts[2], const GradData& data,
    ...
    center1.set(SkScalarInterp(pts[0].fX, pts[1].fX, SkIntToScalar(3) / 5),
                SkScalarInterp(pts[0].fY, pts[1].fY, SkIntToScalar(1) / 4));
    return SkGradientShader::MakeTwoPointConical(center1, 0.f, center0, (pts[1].fX - pts[0].fX) / 2,
                                                 data.fColors, data.fPos, data.fCount, tm, 0,
                                                 &localMatrix);
}
...
static sk_sp<SkShader> Make2ConicalZeroRadFlip(const SkPoint pts[2], const GradData& data,
    ...
    center1.set(SkScalarInterp(pts[0].fX, pts[1].fX, SkIntToScalar(3) / 5),
                SkScalarInterp(pts[0].fY, pts[1].fY, SkIntToScalar(1) / 4));
    return SkGradientShader::MakeTwoPointConical(center1, (pts[1].fX - pts[0].fX) / 2, center0, 0.f,
                                                 data.fColors, data.fPos, data.fCount, tm, 0,
                                                 &localMatrix);
}
...
static sk_sp<SkShader> Make2ConicalEdgeX(const SkPoint pts[2], const GradData& data, SkTileMode tm,
                                         const SkMatrix& localMatrix) {
    SkPoint center0, center1;
...
static sk_sp<SkShader> Make2ConicalEdgeY(const SkPoint pts[2], const GradData& data, SkTileMode tm,
                                         const SkMatrix& localMatrix) {
    SkPoint center0, center1;
    SkScalar radius0 = (pts[1].fX - pts[0].fX) / 7;
    SkScalar radius1 = (pts[1].fX - pts[0].fX) / 3;
...
static sk_sp<SkShader> Make2ConicalTouchX(const SkPoint pts[2], const GradData& data, SkTileMode tm,
                                          const SkMatrix& localMatrix) {
    SkPoint center0, center1;
    SkScalar radius0 = (pts[1].fX - pts[0].fX) / 7;
    SkScalar radius1 = (pts[1].fX - pts[0].fX) / 3;
...
static sk_sp<SkShader> Make2ConicalTouchY(const SkPoint pts[2], const GradData& data, SkTileMode tm,
                                          const SkMatrix& localMatrix) {
    SkPoint center0, center1;
    SkScalar radius0 = (pts[1].fX - pts[0].fX) / 7;
    SkScalar radius1 = (pts[1].fX - pts[0].fX) / 3;
...
static sk_sp<SkShader> Make2ConicalInsideSmallRad(const SkPoint pts[2], const GradData& data,
    ...
    center1.set(SkScalarInterp(pts[0].fX, pts[1].fX, SkIntToScalar(3) / 5),
                SkScalarInterp(pts[0].fY, pts[1].fY, SkIntToScalar(1) / 4));
    return SkGradientShader::MakeTwoPointConical(center0, 0.0000000000000000001f, center0,
                                                 (pts[1].fX - pts[0].fX) / 2, data.fColors,
                                                 data.fPos, data.fCount, tm, 0, &localMatrix);
}
