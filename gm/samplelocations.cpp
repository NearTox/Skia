...
class SampleLocationsTestOp : public GrDrawOp {
 ...
 private:
  ...
  void onExecute(GrOpFlushState* flushState, const SkRect& chainBounds) override {
    ...
    GrPipeline pipeline(
        GrScissorTest::kDisabled, SkBlendMode::kSrcOver, flushState->drawOpArgs().outputSwizzle(),
...
DrawResult SampleLocationsGM::onDraw(
  ...
  auto offscreenRTC = ctx->priv().makeDeferredRenderTargetContext(
      SkBackingFit::kExact, 200, 200, rtc->colorInfo().colorType(), nullptr, rtc->numSamples(),
