...
public:
    TrimGM() {
        SkAssertResult(
                SkParsePath::FromSVGString("M   0,100 C  10, 50 190, 50 200,100"
        ...
        SkAssertResult(
                SkParsePath::FromSVGString("M   0, 75 L 200, 75"
                                           "M 200, 91 L 200, 91"
                                           "M 200,108 L 200,108"
                                           "M 200,125 L 400,125",
                                           &fPaths.push_back()));
        ...
        SkAssertResult(
                SkParsePath::FromSVGString("M   0,100 L  50, 50"
                                           "M  50, 50 L 150,150"
                                           "M 150,150 L 250, 50"
                                           "M 250, 50 L 350,150"
                                           "M 350,150 L 400,100",
...
protected:
    ...
    SkISize onISize() override { return SkISize::Make(1400, 1000); }

    void onDraw(SkCanvas* canvas) override {
        static constexpr SkSize kCellSize = {440, 150};
        static constexpr SkScalar kOffsets[][2] = {
                {-0.33f, -0.66f}, {0, 1}, {0, 0.25f}, {0.25f, 0.75f}, {0.75f, 1}, {1, 0.75f},
        };
        ...
        for (const auto& offset : kOffsets) {
            auto start = offset[0] + fOffset, stop = offset[1] + fOffset;
