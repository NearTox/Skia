...
class ComposeShaderBitmapGM : public skiagm::GM {
 ...
 protected:
  void onOnceBeforeDraw() override {
    ...
    fAlpha8BitmapShader = fAlpha8Bitmap.makeShader(SkTileMode::kRepeat, SkTileMode::kRepeat, &s);
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    const SkRect r =
        SkRect::MakeXYWH(0, 0, SkIntToScalar(squareLength), SkIntToScalar(squareLength));
