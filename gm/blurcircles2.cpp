...
class BlurCircles2GM : public skiagm::GM {
 public:
  BlurCircles2GM() {
    ...
    fAnimBlurRadius = AnimTimer::PingPong(
 ...
 protected:
  ...
  bool onAnimate(const AnimTimer& timer) override {
    fAnimRadius =
        timer.pingPong(kRadiusPingPoingPeriod, kRadiusPingPoingShift, kMinRadius, kMaxRadius);
    fAnimBlurRadius = timer.pingPong(
        kBlurRadiusPingPoingPeriod, kBlurRadiusPingPoingShift, kMinBlurRadius, kMaxBlurRadius);
    return true;
  }
