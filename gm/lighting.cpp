  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      paint.setImageFilter(
          SkImageFilters::PointLitDiffuse(pointLocation, white, surfaceScale, kd, input, cr));
      drawClippedBitmap(canvas, paint, 0, y);

      paint.setImageFilter(
          SkImageFilters::DistantLitDiffuse(distantDirection, white, surfaceScale, kd, input, cr));
