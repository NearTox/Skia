...
protected:
    ...
    void createResultTexture(GrContext* context, int width, int height,
        ...
        *resultTexture = gpu->createTestingOnlyBackendTexture(width, height, kRGBA_8888_SkColorType,
    ...
    void onDraw(GrContext* context, GrRenderTargetContext*, SkCanvas* canvas) override {
        ...
        for (int space = kJPEG_SkYUVColorSpace; space <= kLastEnum_SkYUVColorSpace; ++space) {
            ...
            GrBackendTexture resultTexture;
            this->createYUVTextures(context, yuvTextures);
            this->createResultTexture(context, yuvTextures[0].width(), yuvTextures[0].height(),
                                      &resultTexture);
