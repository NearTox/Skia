...
static void drawTestCase(
    SkCanvas* canvas, SkScalar textScale, SkScalar strokeWidth, SkPaint::Style strokeStyle);
...
static void drawTestCase(
  ...
  paint.setStrokeWidth(strokeWidth);
  paint.setStyle(strokeStyle);
  canvas->drawSimpleText(kText, sizeof(kText) - 1, SkTextEncoding::kUTF8, 0.0f, 0.0f, font, paint);
