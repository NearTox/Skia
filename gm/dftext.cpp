...
class DFTextGM : public skiagm::GM {
 public:
  DFTextGM() { this->setBGColor(0xFFFFFFFF); }
 ...
 protected:
  ...
  SkString onShortName() override { return SkString("dftext"); }
  ...
  void onDraw(SkCanvas* inputCanvas) override {
    ...
    // check pos text
    {
      ...
      auto blob = SkTextBlob::MakeFromPosText(
          glyphs.get(), count * sizeof(SkGlyphID), pos.get(), font, SkTextEncoding::kGlyphID);
    ...
    if (fEmojiTypeface) {
      ...
      canvas->drawSimpleText(
          fEmojiText, strlen(fEmojiText), SkTextEncoding::kUTF8, 670, 90, emoiFont, paint);
    }
