...
class ShadowsGM : public GM {
 ...
 protected:
  void onOnceBeforeDraw() override {
    ...
    fBitmap.allocPixels(
        SkImageInfo::Make(20, 20, SkColorType::kAlpha_8_SkColorType, kPremul_SkAlphaType));
  ...
  SkString onShortName() override { return SkString("shadows"); }
  ...
  void onDraw(SkCanvas* canvas) override {
    sk_sp<SkDrawLooper> shadowLoopers[] = {
        ...
        SkBlurDrawLooper::Make(
            ...
            SkIntToScalar(10)),
        SkBlurDrawLooper::Make(
            SK_ColorBLACK, SkBlurMask::ConvertRadiusToSigma(SkIntToScalar(5)), SkIntToScalar(5),
            SkIntToScalar(10)),
        SkBlurDrawLooper::Make(
            0x7FFF0000, SkBlurMask::ConvertRadiusToSigma(SkIntToScalar(5)), SkIntToScalar(-5),
            SkIntToScalar(-10)),
        SkBlurDrawLooper::Make(SK_ColorBLACK, SkIntToScalar(0), SkIntToScalar(5), SkIntToScalar(5)),
    };
