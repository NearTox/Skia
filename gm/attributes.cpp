...
enum class AttrMode { kAuto, kManual, kWacky };
  ...
  AttributeTestProcessor(AttrMode mode)
    ...
    switch (fMode) {
      case AttrMode::kAuto:
        ...
        fAttributes.emplace_back("color", kUByte4_norm_GrVertexAttribType, SkSLType::kHalf4);
      ...
      case AttrMode::kManual:
        ...
        fAttributes.emplace_back("color", kUByte4_norm_GrVertexAttribType, SkSLType::kHalf4, 8);
      ...
      case AttrMode::kWacky:
        ...
        fAttributes.emplace_back("color", kUByte4_norm_GrVertexAttribType, SkSLType::kHalf4, 12);
   ...
   private:
    void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
      ...
      args.fVaryingHandler->addPassThroughAttribute(
          GrShaderVar("color", SkSLType::kHalf4), args.fOutputColor);
...
class AttributeTestOp : public GrDrawOp {
 ...
 private:
  ...
  template <typename V>
  void makeVB(GrOpFlushState* flushState, const SkRect rect) {
    V v[4];
    ...
    fVertexBuffer = flushState->resourceProvider()->createBuffer(
        v, sizeof(v), GrGpuBufferType::kVertex, kStatic_GrAccessPattern);
  }
