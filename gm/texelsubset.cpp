...
class TexelSubset : public GpuGM {
 ...
 protected:
  SkString onShortName() override {
    ...
    switch (fFilter) {
      case GrSamplerState::Filter::kNearest: name.append("_nearest"); break;
      case GrSamplerState::Filter::kBilerp: name.append("_bilerp"); break;
      case GrSamplerState::Filter::kMipMap: name.append("_mip_map"); break;
    }
