 ...
 protected:
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    for (int i = 0; i < fPaints.count(); ++i) {
      ...
      // position the roundrect, and make it at off-integer coords.
      canvas->translate(
          kXStart + SK_Scalar1 * kXStep * 2.55f + SK_Scalar1 / 4,
    ...
    for (int i = 0; i < fPaints.count(); ++i) {
      ...
      // position the roundrect, and make it at off-integer coords.
      canvas->translate(
          kXStart + SK_Scalar1 * kXStep * 4 + SK_Scalar1 / 4,
    ...
    for (int i = 0; i < fPaints.count(); ++i) {
      ...
      // position the roundrect, and make it at off-integer coords.
      canvas->translate(
          kXStart + SK_Scalar1 * kXStep * 3.25f + SK_Scalar1 / 4,
          kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4);
    ...
    for (int i = 0; i < fPaints.count(); ++i) {
      ...
      // position the roundrect, and make it at off-integer coords.
      canvas->translate(
          kXStart + SK_Scalar1 * kXStep * 2.5f + SK_Scalar1 / 4,
          kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
    ...
    auto shader = SkGradientShader::MakeRadial(
        center, 20, colors, pos, SK_ARRAY_COUNT(colors), SkTileMode::kClamp);

    for (int i = 0; i < fPaints.count(); ++i) {
      canvas->save();
      // position the path, and make it at off-integer coords.
      canvas->translate(
          kXStart + SK_Scalar1 * kXStep * 0 + SK_Scalar1 / 4,
          kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
