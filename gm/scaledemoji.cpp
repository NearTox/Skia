...
class ScaledEmojiGM : public GM {
 ...
 protected:
  ...
  SkString onShortName() override { return SkString("scaledemoji"); }
...
class ScaledEmojiPosGM : public GM {
 ...
 protected:
  ...
  SkString onShortName() override { return SkString("scaledemojipos"); }
...
class ScaledEmojiPerspectiveGM : public GM {
 ...
 protected:
  ...
  SkString onShortName() override { return SkString("scaledemojiperspective"); }
