...
static void draw_patch(SkCanvas* canvas, SkImage*, const SkRect& r, sk_sp<SkImageFilter> imf) {
  ...
  static constexpr SkPoint gCubics[SkPatchUtils::kNumCtrlPts] = {// top points
                                                                 {100, 100},
                                                                 {150, 50},
                                                                 {250, 150},
                                                                 {300, 100},
...
static void draw_atlas(
    SkCanvas* canvas, SkImage* atlas, const SkRect& r, sk_sp<SkImageFilter> imf) {
...
class ImageFiltersBaseGM : public skiagm::GM {
 ...
 protected:
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    void (*drawProc[])(SkCanvas*, SkImage*, const SkRect&, sk_sp<SkImageFilter>) = {
        draw_paint, draw_line,   draw_rect,  draw_path,
        draw_text,  draw_bitmap, draw_patch, draw_atlas};
 ...
 private:
  static sk_sp<SkImage> create_atlas_image(SkCanvas* canvas) {
    ...
    SkTextUtils::DrawString(
        atlasCanvas, "Atlas", kSize.fWidth * 0.5f, kSize.fHeight * 0.5f, font, atlasPaint,
