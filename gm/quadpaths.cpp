...
class QuadPathGM : public GM {
 ...
 protected:
  SkString onShortName() override { return SkString("quadpath"); }
  ...
  void drawPath(
      ...
      SkPaint::Join join, SkPaint::Style style, SkPath::FillType fill, SkScalar strokeWidth) {
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    path.fPath.quadTo(50 * SK_Scalar1, 20 * SK_Scalar1, 75 * SK_Scalar1, 10 * SK_Scalar1);
    ...
    for (size_t cap = 0; cap < SK_ARRAY_COUNT(gCaps); ++cap) {
      ...
      for (size_t fill = 0; fill < SK_ARRAY_COUNT(gFills); ++fill) {
        ...
        for (size_t style = 0; style < SK_ARRAY_COUNT(gStyles); ++style) {
          ...
          this->drawPath(
              path.fPath, canvas, color, rect, gCaps[cap].fCap, gCaps[cap].fJoin,
              gStyles[style].fStyle, gFills[fill].fFill, SK_Scalar1 * 10);
          ...
          canvas->drawString(gStyles[style].fName, 0, rect.height() + 12.0f, labelFont, labelPaint);
          canvas->drawString(gFills[fill].fName, 0, rect.height() + 24.0f, labelFont, labelPaint);
          canvas->drawString(gCaps[cap].fName, 0, rect.height() + 36.0f, labelFont, labelPaint);
        }
        canvas->restore();
      }
      canvas->restore();
...
class QuadClosePathGM : public GM {
 ...
 protected:
  SkString onShortName() override { return SkString("quadclosepath"); }
