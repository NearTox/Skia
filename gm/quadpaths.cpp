        ...
        for (size_t cap = 0; cap < SK_ARRAY_COUNT(gCaps); ++cap) {
            ...
            for (size_t fill = 0; fill < SK_ARRAY_COUNT(gFills); ++fill) {
                ...
                for (size_t style = 0; style < SK_ARRAY_COUNT(gStyles); ++style) {
                    ...
                    canvas->drawString(gStyles[style].fName, 0, rect.height() + 12.0f, labelFont,
                                       labelPaint);
                    canvas->drawString(gFills[fill].fName, 0, rect.height() + 24.0f, labelFont,
                                       labelPaint);
                    canvas->drawString(gCaps[cap].fName, 0, rect.height() + 36.0f, labelFont,
                                       labelPaint);
                }
                canvas->restore();
            }
