...
static void draw_blob(
    SkCanvas* canvas, const SkTextBlob* blob, const SkPaint& skPaint, const SkRect& clipRect) {
 ...
 protected:
  void onOnceBeforeDraw() override {
    ...
    ToolUtils::add_to_text_blob(
        &builder, text, font, xOffset - bounds.width() * 0.25f, yOffset - bounds.height() * 0.5f);
