...
static void show_image(
    SkCanvas* canvas, int width, int height, SkColor colors[2], ImageMakerProc proc) {
  ...
  canvas->drawImageRect(
      image, subset, dstRect, SkSamplingOptions(), nullptr, SkCanvas::kStrict_SrcRectConstraint);
  canvas->drawRect(dstRect, borderPaint);
