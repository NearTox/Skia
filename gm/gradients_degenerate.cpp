...
class DegenerateGradientGM : public skiagm::GM {
 ...
 protected:
  SkString onShortName() override { return SkString("degenerate_gradients"); }
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    draw_row(canvas, "sweep-45: empty, blue, blue, red 45 degree sector then green", make_sweep);
    draw_row(canvas, "2pt-conic-0: empty, blue, blue, green", make_2pt_conic_zero_rad);
    draw_row(canvas, "2pt-conic-1: empty, blue, blue, full red circle on green", make_2pt_conic);
  }
