...
class ClippedCubic2GM : public skiagm::GM {
 ...
 protected:
  ...
  void onOnceBeforeDraw() override {
    ...
    fPath.cubicTo(
        69.7030518991886f, 21.831149999999997f, 58.08369508178456f, 43.66448333333333f,
        34.8449814469765f, 65.5f);
    fPath.cubicTo(
        11.608591683531916f, 87.33115f, -0.010765133872116195f, 109.16448333333332f,
...
class CubicPathGM : public skiagm::GM {
 ...
 protected:
  ...
  virtual void onDraw(SkCanvas* canvas) {
    ...
    path.fPath.cubicTo(
        40 * SK_Scalar1, 20 * SK_Scalar1, 60 * SK_Scalar1, 20 * SK_Scalar1, 75 * SK_Scalar1,
        10 * SK_Scalar1);
