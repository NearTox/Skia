...
void test_fake_bowtie(SkCanvas* canvas, const SkPaint& paint) {
  ...
  canvas->drawPath(
      SkPath::Polygon({{20, 20}, {50, 40}, {80, 20}, {80, 80}, {50, 60}, {20, 80}}, false), paint);
  canvas->restore();
}
...
void test_intruding_vertex(SkCanvas* canvas, const SkPaint& paint) {
  ...
  canvas->drawPath(
      SkPath::Polygon(
          {{20, 20}, {50, 50}, {68, 20}, {68, 80}, {50, 50}, {20, 80}}, false,
          SkPathFillType::kWinding, true),
      paint);
  canvas->restore();
}
...
void test_inversion_repeat_vertex(SkCanvas* canvas, const SkPaint& paint) {
  ...
  canvas->drawPath(
      SkPath::Polygon(pts, SK_ARRAY_COUNT(pts), false, SkPathFillType::kWinding, true), paint);
  canvas->restore();
}
...
void test_fish(SkCanvas* canvas, const SkPaint& paint) {
  ...
  canvas->drawPath(
      SkPath::Polygon(
          {{20, 20}, {80, 80}, {70, 50}, {80, 20}, {20, 80}, {0, 50}}, false,
          SkPathFillType::kWinding, true),
      paint);
  canvas->restore();
}
...
void test_stairstep(SkCanvas* canvas, const SkPaint& paint) {
  ...
  canvas->drawPath(
      SkPath::Polygon({{50, 50}, {50, 20}, {80, 20}, {50, 50}, {20, 50}, {20, 80}}, false), paint);
  canvas->restore();
}
...
void test_stairstep2(SkCanvas* canvas, const SkPaint& paint) {
  ...
  canvas->drawPath(
      SkPath::Polygon({{20, 60}, {35, 80}, {50, 60}, {65, 80}, {80, 60}}, false), paint);
  canvas->restore();
}
