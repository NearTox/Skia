...
DEF_SIMPLE_GM(crbug_1177833, canvas, 400, 400) {
  ...
  // the quad would have positive coverage.
  {
    ...
    canvas->concat(SkMatrix::MakeAll(
        SkBits2Float(0xbf79250e), SkBits2Float(0x3e9da860), SkBits2Float(0x44914c8a),
    ...
    SkPoint clip[4] = {
        {SkBits2Float(0x409fff57), SkBits2Float(0x40c86a18)},
    ...
    SkColor4f color = {
        SkBits2Float(0x3f6eeef0), SkBits2Float(0x3f6eeef0), SkBits2Float(0x3f6eeef0),
  ...
  canvas->translate(-300, 0);
  {
    canvas->save();
    canvas->concat(SkMatrix::MakeAll(
        SkBits2Float(0x3f54dd8a), SkBits2Float(0xbf9096a4), SkBits2Float(0x447eae34),
    ...
    SkRect rect = {
        ...
        SkBits2Float(0x43560000)};
    SkPoint clip[4] = {
        {SkBits2Float(0x40a0000e), SkBits2Float(0x40c86b5a)},
