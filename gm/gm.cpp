...
void GpuGM::onDraw(GrContext*, GrRenderTargetContext*, SkCanvas*) { SK_ABORT("Not implemented."); }
...
template <typename Fn> static void mark(SkCanvas* canvas, SkScalar x, SkScalar y, Fn&& fn) {
    SkPaint alpha;
    alpha.setAlpha(0x50);
