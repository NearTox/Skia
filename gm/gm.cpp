...
static void draw_gpu_only_message(SkCanvas* canvas) {
  ...
  paint.setShader(bmp.makeShader(
      ...
      SkSamplingOptions(SkFilterMode::kLinear, SkMipmapMode::kNearest), localM));
