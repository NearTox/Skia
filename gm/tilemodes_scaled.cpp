...
static void setup(SkPaint* paint, const SkBitmap& bm, SkFilterQuality filter_level, SkTileMode tmx,
                  SkTileMode tmy) {
...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        constexpr SkTileMode gModes[] = {SkTileMode::kClamp, SkTileMode::kRepeat,
                                         SkTileMode::kMirror};
        ...
        for (size_t kx = 0; kx < SK_ARRAY_COUNT(gModes); kx++) {
            for (size_t ky = 0; ky < SK_ARRAY_COUNT(gModes); ky++) {
                ...
                SkTextUtils::DrawString(canvas, str.c_str(), scale * (x + r.width() / 2), y, font,
...
static sk_sp<SkShader> make_grad(SkTileMode tx, SkTileMode ty) {
    ...
    switch (index % 3) {
        ...
        case 1:
            return SkGradientShader::MakeRadial(center, rad, colors, nullptr,
