...
class DrawGlyphsGM : public skiagm::GM {
 public:
  ...
  SkString onShortName() override { return SkString("drawglyphs"); }

  SkISize onISize() override { return SkISize::Make(640, 480); }

  void onDraw(SkCanvas* canvas) override {
    canvas->drawGlyphs(
        fGlyphCount, fGlyphs.begin(), fPositions.begin(), {50, 100}, fFont, SkPaint{});

    canvas->drawGlyphs(
        fGlyphCount, fGlyphs.begin(), fPositions.begin(), {50, 120}, fFont, SkPaint{});
    ...
    canvas->drawGlyphs(
        fGlyphCount, fGlyphs.begin(), fPositions.begin(), {50, 640}, fFont, SkPaint{});

    canvas->drawGlyphs(
        fGlyphCount, fGlyphs.begin(), fXforms.begin(), {50 + fLength / 2, 160 + fRadius}, fFont,
        SkPaint{});
