 ...
 protected:
  ...
  void onOnceBeforeDraw() override {
...

    {
      ...
      unevenClosedQuad->quadTo(
          SkIntToScalar(100), SkIntToScalar(100), SkIntToScalar(75), SkIntToScalar(75));
    }
    ...
    // to assert that the computed bounding box didn't contain all the vertices.
    {
      ...
      problem1->cubicTo(
          SkIntToScalar(5), SkIntToScalar(6), SkIntToScalar(5), SkIntToScalar(4), SkIntToScalar(4),
          SkIntToScalar(0));
      problem1->close();
    }

    {
      ...
      problem2->cubicTo(
          2.75223875f, 3.24776125f, 3.00581908f, 4.51236057f, 3.7580452f, 4.37367964f);
