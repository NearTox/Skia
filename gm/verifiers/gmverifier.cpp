...
bool VerifierResult::ok() const { return fCode == Code::kOk; }

const SkString& VerifierResult::message() const { return fMessage; }

VerifierResult VerifierResult::Ok() { return VerifierResult(Code::kOk, SkString("Ok")); }
...
bool GMVerifier::needsGoldImage() const { return fInputType == InputType::kGoldImageRequired; }
