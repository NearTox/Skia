 ...
 protected:
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    for (auto sigma : {0.6f, 3.0f, 8.0f, 20.0f}) {
      canvas->save();
      sk_sp<SkImageFilter> filter(SkImageFilters::Blur(sigma, 0.0f, SkTileMode::kRepeat, nullptr));
...
DEF_SIMPLE_GM(imageblurrepeatunclipped, canvas, 256, 128) {
  ...
  SkBitmap checkerboard =
      ToolUtils::create_checkerboard_bitmap(256, 128, SK_ColorLTGRAY, SK_ColorGRAY, 8);
