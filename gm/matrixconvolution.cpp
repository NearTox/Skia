...
class MatrixConvolutionGM : public GM {
 public:
  MatrixConvolutionGM(
      SkColor colorOne, SkColor colorTwo, KernelFixture kernelFixture, const char* nameSuffix)
      : fNameSuffix(nameSuffix), fKernelFixture(kernelFixture) {
 ...
 protected:
  ...
  sk_sp<SkImageFilter> makeFilter(
    ...
    switch (fKernelFixture) {
      case kBasic_KernelFixture: {
        ...
        return SkImageFilters::MatrixConvolution(
            {3, 3}, kernel.data(), /* gain */ 0.3f, /* bias */ SkIntToScalar(100), kernelOffset,
            tileMode, convolveAlpha, nullptr, cropRect);
      }
      case kLarge_KernelFixture: {
        ...
        return SkImageFilters::MatrixConvolution(
            {7, 7}, kernel.data(), /* gain */ 0.3f, /* bias */ SkIntToScalar(100), kernelOffset,
            tileMode, convolveAlpha, nullptr, cropRect);
      }
  ...
  void draw(
      SkCanvas* canvas, int x, int y, const SkIPoint& kernelOffset, SkTileMode tileMode,
...
DEF_GM(return new MatrixConvolutionGM(
                  0xFFFFFFFF, 0x40404040, KernelFixture::kBasic_KernelFixture, "");)
DEF_GM(return new MatrixConvolutionGM(
                  0xFFFF0000, 0xFF00FF00, KernelFixture::kBasic_KernelFixture, "_color");)
DEF_GM(return new MatrixConvolutionGM(
                  0xFFFFFFFF, 0x40404040, KernelFixture::kLarge_KernelFixture, "_big");)
DEF_GM(return new MatrixConvolutionGM(
