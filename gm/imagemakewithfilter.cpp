...
static sk_sp<SkImageFilter> displacement_factory(sk_sp<SkImage> auxImage, const SkIRect* cropRect) {
  ...
  return SkImageFilters::DisplacementMap(
      SkColorChannel::kR, SkColorChannel::kG, 40.f, std::move(displacement), nullptr, cropRect);
}
...
static sk_sp<SkImageFilter> convolution_factory(sk_sp<SkImage> auxImage, const SkIRect* cropRect) {
  ...
  return SkImageFilters::MatrixConvolution(
      kernelSize, kernel, 1.f, 0.f, kernelOffset, SkTileMode::kClamp, false, nullptr, cropRect);
}
...
static sk_sp<SkImageFilter> lighting_factory(sk_sp<SkImage> auxImage, const SkIRect* cropRect) {
  ...
  sk_sp<SkImageFilter> srcToAlpha =
      SkImageFilters::ColorFilter(SkColorFilters::Matrix(kMatrix), nullptr);
  ...
  sk_sp<SkImageFilter> specular = SkImageFilters::PointLitSpecular(
      specLocation, SK_ColorRED, /* scale */ 1.f, /* ks */ 1.f, /* shine */ 8.f, srcToAlpha,
      cropRect);
...
static sk_sp<SkImageFilter> tile_factory(sk_sp<SkImage> auxImage, const SkIRect* cropRect) {
  ...
  return SkImageFilters::Tile(SkRect::MakeLTRB(25, 25, 75, 75), SkRect::MakeWH(100, 100), nullptr);
}
