...
class XfermodesGM : public skiagm::GM {
    ...
    void onOnceBeforeDraw() override {
        fBG.installPixels(SkImageInfo::Make(2, 2, kARGB_4444_SkColorType, kOpaque_SkAlphaType),
                          gData, 4);
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        for (int sourceType = 1; sourceType & kAll_SrcType; sourceType <<= 1) {
            ...
            for (size_t i = 0; i < SK_ARRAY_COUNT(gModes); i++) {
                ...
                draw_mode(canvas, gModes[i].fMode, static_cast<SrcType>(sourceType), r.fLeft,
                          r.fTop);
                canvas->restore();
