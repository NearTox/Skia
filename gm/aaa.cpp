...
DEF_SIMPLE_GM(analytic_antialias_convex, canvas, W, H) {
    ...
    path.cubicTo(SkBits2Float(0x429b9d71), SkBits2Float(0x4367a022), SkBits2Float(0x429b9d64),
    ...
    path.conicTo(SkBits2Float(0x4348ebaf), SkBits2Float(0x43981a75), SkBits2Float(0x4344f079),
