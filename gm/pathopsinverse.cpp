...
class PathOpsInverseGM : public GM {
 ...
 protected:
  ...
  SkString onShortName() override { return SkString("pathopsinverse"); }
  ...
  void onDraw(SkCanvas* canvas) override {
    ...
    for (int oneFill = 0; oneFill <= 1; ++oneFill) {
      SkPathFillType oneF = oneFill ? SkPathFillType::kInverseEvenOdd : SkPathFillType::kEvenOdd;
      for (int twoFill = 0; twoFill <= 1; ++twoFill) {
        SkPathFillType twoF = twoFill ? SkPathFillType::kInverseEvenOdd : SkPathFillType::kEvenOdd;
        one.reset();
...
DEF_SIMPLE_GM(pathops_skbug_10155, canvas, 256, 256) {
  const char* svgStr[] = {
      "M474.889 27.0952C474.889 27.1002 474.888 27.1018 474.889 27.1004L479.872 27.5019C479.883 "
      "27.3656 479.889 27.2299 479.889 27.0952L474.889 27.0952L474.889 27.0952Z",
      "M474.94 26.9405C474.93 26.9482 474.917 26.9576 474.901 26.9683L477.689 31.1186C477.789 "
      "31.0512 477.888 30.9804 477.985 30.9059L474.94 26.9405L474.94 26.9405Z"};
