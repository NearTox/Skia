...
DrawResult WindowRectanglesGM::coverClipStack(
...
DrawResult WindowRectanglesGM::onDraw(SkCanvas* canvas, SkString* errorMsg) {
  ...
  SkClipStack stack;
  stack.clipRect(
      SkRect::MakeXYWH(370.75, 80.25, 149, 100), SkMatrix::I(), SkClipOp::kDifference, false);
  stack.clipRect(
      SkRect::MakeXYWH(80.25, 420.75, 150, 100), SkMatrix::I(), SkClipOp::kDifference, true);
  stack.clipRRect(
