...
static skiagm::DrawResult draw_rotated_image(
    SkCanvas* canvas, const SkImage* image, SkString* errorMsg) {
  ...
  SkScalar scale = SkTMin(128.0f / image->width(), 128.0f / image->height());
