...
DEF_SIMPLE_GM(onebadarc, canvas, 100, 100) {
  ...
  path.conicTo(
      SkBits2Float(0x41a00000), SkBits2Float(0x42412318),  // 20, 48.2843f
...
DEF_SIMPLE_GM(circular_arc_stroke_matrix, canvas, 820, 1090) {
  ...
  matrices.push_back().setAll(-1, 0, 2 * kRadius, 0, 1, 0, 0, 0, 1);
  matrices.push_back().setAll(1, 0, 0, 0, -1, 2 * kRadius, 0, 0, 1);
  matrices.push_back().setAll(1, 0, 0, 0, -1, 2 * kRadius, 0, 0, 1);
  matrices.push_back().setAll(0, -1, 2 * kRadius, -1, 0, 2 * kRadius, 0, 0, 1);
  matrices.push_back().setAll(0, -1, 2 * kRadius, 1, 0, 0, 0, 0, 1);
  matrices.push_back().setAll(0, 1, 0, 1, 0, 0, 0, 0, 1);
  matrices.push_back().setAll(0, 1, 0, -1, 0, 2 * kRadius, 0, 0, 1);
