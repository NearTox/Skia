...
class SkSVGProperty {
 public:
  ...
  explicit SkSVGProperty(const T& value) : fState(SkSVGPropertyState::kValue) { fValue.set(value); }
  ...
  T* getMaybeNull() const { return fValue.getMaybeNull(); }
...
class SkSVGPaint {
 public:
  ...
  explicit SkSVGPaint(const SkString& iri) : fType(Type::kIRI), fColor(SK_ColorBLACK), fIRI(iri) {}
...
class SkSVGObjectBoundingBoxUnits {
 public:
  ...
  bool operator==(const SkSVGObjectBoundingBoxUnits& other) const { return fType == other.fType; }
  bool operator!=(const SkSVGObjectBoundingBoxUnits& other) const { return !(*this == other); }
...
class SkSVGFontFamily {
 public:
  ...
  explicit SkSVGFontFamily(const char family[]) : fType(Type::kFamily), fFamily(family) {}
...
class SkSVGFontStyle {
 public:
  ...
  bool operator==(const SkSVGFontStyle& other) const { return fType == other.fType; }
...
class SkSVGFontSize {
 public:
  ...
  explicit SkSVGFontSize(const SkSVGLength& s) : fType(Type::kLength), fSize(s) {}
...
class SkSVGFontWeight {
 public:
  ...
  bool operator==(const SkSVGFontWeight& other) const { return fType == other.fType; }
...
class SkSVGTextAnchor {
 public:
  ...
  bool operator==(const SkSVGTextAnchor& other) const { return fType == other.fType; }
