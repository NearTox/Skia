...
class DataResourceProvider final : public skresources::ResourceProvider {
 public:
  ...
  sk_sp<skresources::ImageAsset> loadImageAsset(
      const char rpath[], const char rname[], const char rid[]) const override {
...
bool SkSVGOpenTypeSVGDecoder::render(
    SkCanvas& canvas, int upem, SkGlyphID glyphId, SkColor foregroundColor,
