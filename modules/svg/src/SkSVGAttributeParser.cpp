...
bool SkSVGAttributeParser::parseEOSToken() { return is_eos(*fCurPos); }

bool SkSVGAttributeParser::parseSepToken() { return this->advanceWhile(is_sep); }

bool SkSVGAttributeParser::parseWSToken() { return this->advanceWhile(is_ws); }
...
bool SkSVGAttributeParser::parseFuncIRI(SkSVGStringType* iri) {
  return this->parseParenthesized(
      "url",
      [this](SkSVGStringType* iriString) -> bool {
        SkSVGIRI iri;
        if (this->parse(&iri)) {
          *iriString = iri.fIRI;
          return true;
...
bool SkSVGAttributeParser::parse(SkSVGFontFamily* family) {
  ...
  if (this->parseExpectedStringToken("inherit")) {
    *family = SkSVGFontFamily();
    ...
    auto family_name = comma ? SkString(fCurPos, comma - fCurPos) : SkString(fCurPos);
...
bool SkSVGAttributeParser::parse(SkSVGFontWeight* weight) {
  static constexpr std::tuple<const char*, SkSVGFontWeight::Type> gWeightMap[] = {
      {"normal", SkSVGFontWeight::Type::kNormal}, {"bold", SkSVGFontWeight::Type::kBold},
      {"bolder", SkSVGFontWeight::Type::kBolder}, {"lighter", SkSVGFontWeight::Type::kLighter},
      {"100", SkSVGFontWeight::Type::k100},       {"200", SkSVGFontWeight::Type::k200},
      {"300", SkSVGFontWeight::Type::k300},       {"400", SkSVGFontWeight::Type::k400},
      {"500", SkSVGFontWeight::Type::k500},       {"600", SkSVGFontWeight::Type::k600},
      {"700", SkSVGFontWeight::Type::k700},       {"800", SkSVGFontWeight::Type::k800},
      {"900", SkSVGFontWeight::Type::k900},       {"inherit", SkSVGFontWeight::Type::kInherit},
  };
