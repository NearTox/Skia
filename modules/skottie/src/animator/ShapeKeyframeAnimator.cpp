...
ShapeValue::operator SkPath() const {
  ...
  auto addCubic = [&](size_t from_vertex, size_t to_vertex) {
    ...
    const SkPoint p0 = SkPoint{(*this)[from_index + kX_Index], (*this)[from_index + kY_Index]},
                  p1 = SkPoint{(*this)[to_index + kX_Index], (*this)[to_index + kY_Index]},
                  c0 =
                      SkPoint{
                          (*this)[from_index + kOutX_Index], (*this)[from_index + kOutY_Index]} +
                      p0,
                  c1 = SkPoint{(*this)[to_index + kInX_Index], (*this)[to_index + kInY_Index]} + p1;
