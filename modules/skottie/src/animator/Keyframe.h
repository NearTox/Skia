...
class KeyframeAnimatorBase : public Animator {
 ...
 protected:
  KeyframeAnimatorBase(std::vector<Keyframe> kfs, std::vector<SkCubicMap> cms) noexcept
...
class KeyframeAnimatorBuilder : public SkNoncopyable {
 public:
  ...
  virtual sk_sp<KeyframeAnimatorBase> make(
      const AnimationBuilder&, const skjson::ArrayValue&, void* target_value) = 0;
