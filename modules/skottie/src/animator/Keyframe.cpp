...
bool KeyframeAnimatorBuilder::parseKeyframes(
...
class KeyframeAnimator final : public KeyframeAnimatorBase {
 public:
  class Builder final : public KeyframeAnimatorBuilder {
   public:
    sk_sp<KeyframeAnimatorBase> make(
        const AnimationBuilder& abuilder, const skjson::ArrayValue& jkfs,
      ...
      return sk_sp<KeyframeAnimatorBase>(new KeyframeAnimator(
          std::move(fKFs), std::move(fCMs), std::move(fValues), static_cast<T*>(target_value)));
    }
