...
class CornerPinAdapter final : public AnimatablePropertyContainer {
 public:
  static sk_sp<CornerPinAdapter> Make(
 ...
 private:
  CornerPinAdapter(
      const skjson::ArrayValue& jprops, const AnimationBuilder& abuilder, const SkSize& layer_size)
    ...
    const SkPoint src[] =
        {{0, 0},
         ...
         {0, fLayerSize.height()}},
                  ...
                  dst[] = {{fUL.x, fUL.y}, {fUR.x, fUR.y}, {fLR.x, fLR.y}, {fLL.x, fLL.y}};
