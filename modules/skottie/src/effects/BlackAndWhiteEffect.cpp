...
//
// (inspired by
// https://github.com/RoyiAvital/StackExchangeCodes/blob/master/SignalProcessing/Q688/ApplyBlackWhiteFilter.m)
...
class BlackAndWhiteAdapter final
    : public DiscardableAdapterBase<BlackAndWhiteAdapter, sksg::ExternalColorFilter> {
 public:
  ...
  void onSync() override {
    struct {
      float normalized_coeffs[6];
        ...
        (fCoeffs[0]) / 100, (fCoeffs[1]) / 100, (fCoeffs[2]) / 100,
