...
class PolystarGeometryAdapter final
 ...
 public:
  ...
  PolystarGeometryAdapter(
      const skjson::ObjectValue& jstar, const AnimationBuilder* abuilder, Type t)
      : fType(t) {
 ...
 private:
  ...
  ScalarValue fPointCount = 0, fRotation = 0, fInnerRadius = 0, fOuterRadius = 0,
              fInnerRoundness = 0, fOuterRoundness = 0;
};
