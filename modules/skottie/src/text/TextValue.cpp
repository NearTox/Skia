...
bool ValueTraits<TextValue>::FromJSON(
  ...
  v->fHAlign =
      gAlignMap[SkTMin<size_t>(ParseDefault<size_t>((*jtxt)["j"], 0), SK_ARRAY_COUNT(gAlignMap))];
  ...
  v->fResize = gResizeMap[SkTMin<size_t>(
      ParseDefault<size_t>((*jtxt)["sk_rs"], 0), SK_ARRAY_COUNT(gResizeMap))];
