...
class TextAdapter final : public AnimatablePropertyContainer {
 ...
 private:
  ...
  void pushPropsToFragment(
      const TextAnimator::ResolvedProps&, const FragmentRec&, const SkV2& frag_offset,
      const SkV2& grouping_alignment, const TextAnimator::DomainSpan*) const;
  ...
  bool fHasBlurAnimator : 1, fRequiresAnchorPoint : 1, fRequiresLineAdjustments : 1;
};
