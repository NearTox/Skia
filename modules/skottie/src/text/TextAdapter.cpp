...
SkV2 TextAdapter::fragmentAnchorPoint(
    const FragmentRec& rec, const SkVector& grouping_alignment,
  ...
  const auto ap = SkV2{
      ab.centerX() + ab.width() * 0.5f * grouping_alignment.fX,
...
void TextAdapter::pushPropsToFragment(
    ...
    const SkVector& grouping_alignment, const TextAnimator::DomainSpan* grouping_span) const {
