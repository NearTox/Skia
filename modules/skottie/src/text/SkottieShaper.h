 ...
 public:
  ...
  struct TextDesc {
    ...
    SkScalar fTextSize = 0,
        ...
        fLineHeight = 0, fLineShift = 0, fAscent = 0;
  ...
  static Result Shape(
      const SkString& text, const TextDesc& desc, const SkPoint& textPoint,
  ...
  static Result Shape(
      const SkString& text, const TextDesc& desc, const SkRect& textBox, const sk_sp<SkFontMgr>&);
