...
TextAnimator::ResolvedProps TextAnimator::modulateProps(
  ...
  const auto modulate_opacity = [](float o0, float o1, float t) { return o0 + o0 * (o1 - 1) * t; };
  ...
  modulated_props.fill_color =
      adjust_opacity(modulated_props.fill_color, fTextProps.fill_opacity * 0.01f, clamped_amount);
  modulated_props.stroke_color = adjust_opacity(
      modulated_props.stroke_color, fTextProps.stroke_opacity * 0.01f, clamped_amount);
  modulated_props.opacity =
      modulate_opacity(modulated_props.opacity, fTextProps.opacity * 0.01f, clamped_amount);
