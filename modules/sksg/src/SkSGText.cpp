...
SkPoint Text::alignedPosition(SkScalar advance) const noexcept {
  ...
  switch (fAlign) {
    case SkTextUtils::kLeft_Align: break;
    case SkTextUtils::kCenter_Align: aligned.offset(-advance / 2, 0); break;
    case SkTextUtils::kRight_Align: aligned.offset(-advance, 0); break;
  }
