...
public:
    ...
    static std::unique_ptr<FontRunIterator> MakeFontMgrRunIterator(const char* utf8,
                                                                   size_t utf8Bytes,
                                                                   const SkFont& font,
...
#ifdef SK_SHAPER_HARFBUZZ_AVAILABLE
    static std::unique_ptr<SkShaper::BiDiRunIterator> MakeIcuBiDiRunIterator(const char* utf8,
                                                                             size_t utf8Bytes,
                                                                             uint8_t bidiLevel);
#endif
...
#ifdef SK_SHAPER_HARFBUZZ_AVAILABLE
    static std::unique_ptr<SkShaper::ScriptRunIterator> MakeHbIcuScriptRunIterator(
    ...
    static std::unique_ptr<SkShaper::LanguageRunIterator> MakeStdLanguageRunIterator(
            const char* utf8, size_t utf8Bytes);
    ...
    virtual void shape(const char* utf8, size_t utf8Bytes, const SkFont& srcFont, bool leftToRight,
                       SkScalar width, RunHandler*) const = 0;

    virtual void shape(const char* utf8, size_t utf8Bytes, FontRunIterator&, BiDiRunIterator&,
