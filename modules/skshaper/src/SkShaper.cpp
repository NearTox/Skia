...
std::unique_ptr<SkShaper::ScriptRunIterator> SkShaper::MakeScriptRunIterator(
...
class FontMgrRunIterator final : public SkShaper::FontRunIterator {
 public:
  FontMgrRunIterator(
      const char* utf8, size_t utf8Bytes, const SkFont& font, sk_sp<SkFontMgr> fallbackMgr,
      const char* requestName, SkFontStyle requestStyle, const SkShaper::LanguageRunIterator* lang)
      : fCurrent(utf8),
        fBegin(utf8),
  ...
  FontMgrRunIterator(
      ...
      : FontMgrRunIterator(
            ...
            font.refTypefaceOrDefault()->fontStyle(), nullptr) {}
...
std::unique_ptr<SkShaper::FontRunIterator> SkShaper::MakeFontMgrRunIterator(
  ...
  return skstd::make_unique<FontMgrRunIterator>(
      utf8, utf8Bytes, font, std::move(fallback), requestName, requestStyle, language);
}

std::unique_ptr<SkShaper::LanguageRunIterator> SkShaper::MakeStdLanguageRunIterator(
...
sk_sp<SkTextBlob> SkTextBlobBuilderRunHandler::makeBlob() { return fBuilder.make(); }
