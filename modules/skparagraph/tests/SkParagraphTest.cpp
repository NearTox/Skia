...
UNIX_ONLY_TEST(SkParagraph_InlinePlaceholderParagraph, reporter) {
  ...
  PlaceholderStyle placeholder1(
      50, 50, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 0);
  builder.addPlaceholder(placeholder1);
  builder.addText(text, len);
  builder.addPlaceholder(placeholder1);

  PlaceholderStyle placeholder2(
      5, 50, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 50);
...
UNIX_ONLY_TEST(SkParagraph_InlinePlaceholderBaselineParagraph, reporter) {
  ...
  PlaceholderStyle placeholder(
      55, 50, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 38.347f);
...
UNIX_ONLY_TEST(SkParagraph_InlinePlaceholderAboveBaselineParagraph, reporter) {
  ...
  PlaceholderStyle placeholder(
      55, 50, PlaceholderAlignment::kAboveBaseline, TextBaseline::kAlphabetic, 903129.129308f);
  builder.addPlaceholder(placeholder);
  builder.addText(text, len);
...
UNIX_ONLY_TEST(SkParagraph_InlinePlaceholderBelowBaselineParagraph, reporter) {
  ...
  PlaceholderStyle placeholder(
      55, 50, PlaceholderAlignment::kBelowBaseline, TextBaseline::kAlphabetic, 903129.129308f);
  builder.addPlaceholder(placeholder);
  builder.addText(text, len);
...
UNIX_ONLY_TEST(SkParagraph_InlinePlaceholderIdeographicBaselineParagraph, reporter) {
  ...
  builder.addText(text, len);
  PlaceholderStyle placeholder(
      55, 50, PlaceholderAlignment::kBaseline, TextBaseline::kIdeographic, 38.347f);
  builder.addPlaceholder(placeholder);
  builder.addText(text, len);
...
UNIX_ONLY_TEST(SkParagraph_InlinePlaceholderBreakParagraph, reporter) {
  ...
  PlaceholderStyle placeholder1(
      50, 50, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 50);
  PlaceholderStyle placeholder2(
      25, 25, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 12.5f);
...
UNIX_ONLY_TEST(SkParagraph_InlinePlaceholderGetRectsParagraph, reporter) {
  ...
  PlaceholderStyle placeholder1(
      50, 50, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 50);
  PlaceholderStyle placeholder2(
      5, 20, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 10);
...
UNIX_ONLY_TEST(SkParagraph_RainbowParagraph, reporter) {
  ...
  text_style2.setFontStyle(SkFontStyle(
      SkFontStyle::kMedium_Weight, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
  text_style2.setLetterSpacing(10);
  text_style2.setDecorationColor(SK_ColorBLACK);
  text_style2.setDecoration((
      TextDecoration)(TextDecoration::kUnderline | TextDecoration::kOverline | TextDecoration::kLineThrough));
  ...
  auto rects = paragraph->getRectsForRange(
      0, impl->text().size(), RectHeightStyle::kMax, RectWidthStyle::kTight);
...
UNIX_ONLY_TEST(SkParagraph_BoldParagraph, reporter) {
  ...
  text_style.setFontStyle(SkFontStyle(
      SkFontStyle::kBlack_Weight, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
  builder.pushStyle(text_style);
  builder.addText(text, len);
  builder.pop();
...
UNIX_ONLY_TEST(SkParagraph_BasicHalfLeading, reporter) {
  ...
  std::vector<TextBox> boxes =
      paragraph->getRectsForRange(0, len, RectHeightStyle::kTight, rect_width_style);
  std::vector<TextBox> lineBoxes =
      paragraph->getRectsForRange(0, len, RectHeightStyle::kMax, rect_width_style);
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(
                    lineBoxes[0].rect.bottom() - boxes[0].rect.bottom(),
                    boxes[0].rect.top() - lineBoxes[0].rect.top()));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(
                    lineBoxes[1].rect.bottom() - boxes[1].rect.bottom(),
                    boxes[1].rect.top() - lineBoxes[1].rect.top()));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(
                    lineBoxes[2].rect.bottom() - boxes[2].rect.bottom(),
                    boxes[2].rect.top() - lineBoxes[2].rect.top()));
...
UNIX_ONLY_TEST(SkParagraph_NearZeroHeightMixedDistribution, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(lineBoxes[0].rect.height(), line_bottom - line_top, EPSILON2));
...
UNIX_ONLY_TEST(SkParagraph_TrimLeadingDistribution, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(lineBoxes[2].rect.bottom(), boxes[2].rect.bottom()));
  ...
  REPORTER_ASSERT(
      reporter,
      SkScalarNearlyEqual(boxes[1].rect.top() - lineBoxes[1].rect.top(), halfLeading, epsilon));
  REPORTER_ASSERT(
      reporter,
      SkScalarNearlyEqual(lineBoxes[1].rect.bottom() - boxes[1].rect.bottom(), halfLeading));
  REPORTER_ASSERT(
      reporter,
      SkScalarNearlyEqual(boxes[2].rect.top() - lineBoxes[2].rect.top(), halfLeading, epsilon));
...
UNIX_ONLY_TEST(SkParagraph_LeftAlignParagraph, reporter) {
  ...
  expected_y += 30 * 10;
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->lines()[13].offset().fY, expected_y, epsilon));

  REPORTER_ASSERT(
      reporter, paragraph_style.getTextAlign() == impl->paragraphStyle().getTextAlign());
...
UNIX_ONLY_TEST(SkParagraph_JustifyAlignParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->lines()[0].offset().fY, expected_y, EPSILON100));
  expected_y += 30;
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->lines()[1].offset().fY, expected_y, EPSILON100));
  expected_y += 30;
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->lines()[2].offset().fY, expected_y, EPSILON100));
  expected_y += 30;
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->lines()[3].offset().fY, expected_y, EPSILON100));
  expected_y += 30 * 9;
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->lines()[12].offset().fY, expected_y, EPSILON100));

  auto calculate = [](const TextLine& line) -> SkScalar { return line.offset().fX; };
...
UNIX_ONLY_TEST(SkParagraph_JustifyRTLNewLine, reporter) {
  ...
  for (auto& line : impl->lines()) {
    ...
    if (num == 0 || num == 5) {
      ...
      REPORTER_ASSERT(
          reporter, SkScalarNearlyEqual(line.width(), TestCanvasWidth - 100, EPSILON100),
...
UNIX_ONLY_TEST(SkParagraph_ItalicsParagraph, reporter) {
  ...
  text_style.setFontStyle(SkFontStyle(
      SkFontStyle::kNormal_Weight, SkFontStyle::kNormal_Width, SkFontStyle::kItalic_Slant));
  builder.pushStyle(text_style);
  builder.addText(text2, strlen(text2));
  builder.pop();
  builder.addText(text3, strlen(text3));
...
UNIX_ONLY_TEST(SkParagraph_ArabicRectsParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter,
      SkScalarNearlyEqual(boxes[0].rect.left(), 538.548f, EPSILON100));  // DIFF: 510.09375
...
UNIX_ONLY_TEST(SkParagraph_ArabicRectsLTRLeftAlignParagraph, reporter) {
  ...
  REPORTER_ASSERT(reporter, boxes.size() == 2ull);
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[0].rect.left(), 83.92f, EPSILON100));  // DIFF: 89.40625
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.top(), -0.27f, EPSILON100));
  REPORTER_ASSERT(
      reporter,
      SkScalarNearlyEqual(boxes[0].rect.right(), 110.16f, EPSILON100));  // DIFF: 121.87891
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.bottom(), 44, EPSILON100));
}
...
UNIX_ONLY_TEST(SkParagraph_ArabicRectsLTRRightAlignParagraph, reporter) {
  ...
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.top(), -0.27f, EPSILON100));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[0].rect.right(), 587.74f, EPSILON100));  // DIFF
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.bottom(), 44, EPSILON100));
}
...
UNIX_ONLY_TEST(SkParagraph_GetRectsForRangeTight, reporter) {
  ...
  S     S   S   S    S     S   S   S    S     S   S   S    S     S   S   S    S     S   S   S    S
  S   S   S    S     S   S   S    S     S   S   S    S     S   S   S    S     S   S G  G G  G  G  G
  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG
  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G
  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G
  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GGG  G G  G  G  G  GG W                  W W W W W W
  W                  W                  W                  W                  W                  W
  W                  W                  W                  W                  W                  W W
...
DEF_TEST_DISABLED(SkParagraph_GetRectsForRangeIncludeCombiningCharacter, reporter) {
  ...
  }
  {
    ...
    REPORTER_ASSERT(
        reporter, first.size() == 0 && second.size() == 0 && third.size() == 1 && last.size() == 1);
...
UNIX_ONLY_TEST(SkParagraph_GetWordBoundaryParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, paragraph->getWordBoundary(outLen - 1) == SkRange<size_t>(outLen - 5, outLen));
}
  ...
  for (auto& line : impl->lines()) {
    line.scanStyles(
        ...
        [&](TextRange textRange, const TextStyle& style, const TextLine::ClipContext& context) {
          ++index;
          switch (index) {
            case 1: REPORTER_ASSERT(reporter, style.getShadowNumber() == 1); break;
            case 2: REPORTER_ASSERT(reporter, style.getShadowNumber() == 3); break;
            case 3: REPORTER_ASSERT(reporter, style.getShadowNumber() == 1); break;
            case 4:
              REPORTER_ASSERT(reporter, style.getShadowNumber() == 4);
              REPORTER_ASSERT(reporter, style.equals(text_style));
              break;
            case 5: REPORTER_ASSERT(reporter, style.getShadowNumber() == 1); break;
            default: REPORTER_ASSERT(reporter, false);
          }
          return true;
        });
  }
...
UNIX_ONLY_TEST(SkParagraph_BaselineParagraph, reporter) {
  ...
  SkRect rect1 = SkRect::MakeXYWH(
      0, paragraph->getIdeographicBaseline(), paragraph->getMaxWidth(),
      paragraph->getIdeographicBaseline());
  SkRect rect2 = SkRect::MakeXYWH(
      0, paragraph->getAlphabeticBaseline(), paragraph->getMaxWidth(),
      paragraph->getAlphabeticBaseline());
  canvas.drawLine(SK_ColorRED, rect1, false);
  canvas.drawLine(SK_ColorGREEN, rect2, false);

  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(paragraph->getIdeographicBaseline(), 79.035f, EPSILON100));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(paragraph->getAlphabeticBaseline(), 63.305f, EPSILON100));
}
...
UNIX_ONLY_TEST(SkParagraph_FontFallbackParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter,
      paragraph->unresolvedGlyphs() == 2);  // From the text1 ("字典" - excluding the last space)
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->runs()[2 + spaceRun].advance().fX, 139.125f, EPSILON100));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->runs()[3 + spaceRun].advance().fX, 27.999f, EPSILON100));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->runs()[4 + spaceRun].advance().fX, 62.248f, EPSILON100));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(impl->runs()[5 + spaceRun].advance().fX, 27.999f, EPSILON100));

  // When a different font is resolved, then the metrics are different.
  REPORTER_ASSERT(
      reporter,
      impl->runs()[3 + spaceRun].correctAscent() != impl->runs()[5 + spaceRun].correctAscent());
  REPORTER_ASSERT(
      reporter,
      impl->runs()[3 + spaceRun].correctDescent() != impl->runs()[5 + spaceRun].correctDescent());
}
...
DEF_TEST_DISABLED(SkParagraph_JSON2, reporter) {
  ...
  for (auto& run : impl->runs()) {
    SkShaperJSONWriter::VisualizeClusters(
        impl->text().begin() + run.textRange().start, 0, run.textRange().width(), run.glyphs(),
        run.clusterIndexes(),
        [&](int codePointCount, SkSpan<const char> utf1to1, SkSpan<const SkGlyphID> glyph1to1) {
          if (cluster == 0) {
            std::string toCheckUtf8{utf1to1.data(), utf1to1.size()};
...
UNIX_ONLY_TEST(SkParagraph_CacheFontRanges, reporter) {
  ...
  auto test = [&](const char* text1, const char* text2, const char* font1, const char* font2,
                  int count, bool expectedToBeFound) {
    ParagraphBuilderImpl builder(paragraph_style, fontCollection);
...
UNIX_ONLY_TEST(SkParagraph_Fallbacks, reporter) {
  ...
  const char* multiScript =
      "A1!"
      "aÀàĀāƁƀḂⱠꜲꬰəͲἀἏЀЖԠꙐꙮՁخ‎ࡔࠇܦআਉઐଘஇఘಧൺඣᭆᯔᮯ᳇ꠈᜅᩌꪈ༇ꥄꡙꫤ᧰៘꧁꧂ᜰᨏᯤᢆᣭᗗꗃⵞ𐒎߷ጩꬤ𖠺‡₩℻Ⅷ↹⋇⏳ⓖ╋▒◛⚧⑆שׁ🅕㊼龜ポ䷤"
      "🂡"
      "\n";
  const size_t len = strlen(multiScript);

  const char* androidFonts[] = {
      "sans-serif", "sans-serif-condensed", "serif", "monospace", "serif-monospace", "casual",
      "cursive",    "sans-serif-smallcaps",
  };
...
UNIX_ONLY_TEST(SkParagraph_Bidi1, reporter) {
  ...
  text_style.setFontStyle(SkFontStyle(
      SkFontStyle::kLight_Weight, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
  builder.pushStyle(text_style);
  builder.addText(DEF);
...
UNIX_ONLY_TEST(SkParagraph_FontStyle, reporter) {
  ...
  SkFontStyle fs = SkFontStyle(
      SkFontStyle::Weight::kLight_Weight, SkFontStyle::Width::kNormal_Width,
  ...
  SkFontStyle bi = SkFontStyle(
      SkFontStyle::Weight::kBold_Weight, SkFontStyle::Width::kNormal_Width,
...
UNIX_ONLY_TEST(SkParagraph_Shaping, reporter) {
  ...
  auto dir =
      "/usr/local/google/home/jlavrova/Sources/flutter/engine/src/out/host_debug_unopt_x86/gen/"
      "flutter/third_party/txt/assets";
  sk_sp<TestFontCollection> fontCollection =
  ...
  SkFontStyle b = SkFontStyle(
      SkFontStyle::Weight::kNormal_Weight, SkFontStyle::Width::kNormal_Width,
      SkFontStyle::Slant::kUpright_Slant);
...
UNIX_ONLY_TEST(SkParagraph_Ellipsis, reporter) {
  ...
  const char* text =
      "This\n"
      "is a wrapping test. It should wrap at manual newlines, and if softWrap is true, also at "
      "spaces.";
  TextStyle text_style;
  text_style.setFontFamilies({SkString("Ahem")});
  text_style.setColor(SK_ColorBLACK);
  ...
  auto relayout = [&](size_t lines, bool ellipsis, SkScalar width, SkScalar height,
                      SkScalar minWidth, SkScalar maxWidth, SkColor bg) {
    ParagraphStyle paragraph_style;
    SkPaint paint;
    paint.setColor(bg);
    ...
    auto result = paragraph->getRectsForRange(
        0, strlen(text), RectHeightStyle::kTight, RectWidthStyle::kTight);
    SkPaint background;
...
UNIX_ONLY_TEST(SkParagraph_LineMetrics, reporter) {
  ...
  paragraph->paint(canvas.get(), 0, 0);
  auto rects =
      paragraph->getRectsForRange(0, len * 4, RectHeightStyle::kMax, RectWidthStyle::kTight);
...
UNIX_ONLY_TEST(SkParagraph_PositionInsideEmoji, reporter) {
  ...
  std::u16string text =
      u"\U0001f469\u200D\U0001f469\u200D\U0001f467\u200D\U0001f467\U0001f469\U0001f469\U0001f467"
      u"\U0001f467";
  ...
  auto family = paragraph->getRectsForRange(
      0, 11, RectHeightStyle::kTight, RectWidthStyle::kTight);  // 00.0000000 + 17.4699993
  auto face01 = paragraph->getRectsForRange(
      11, 13, RectHeightStyle::kTight, RectWidthStyle::kTight);  // 17.4699993 + 17.4699993
  auto face02 = paragraph->getRectsForRange(
      13, 15, RectHeightStyle::kTight, RectWidthStyle::kTight);  // 34.9399986 + 17.4699993
  auto face03 = paragraph->getRectsForRange(
      15, 17, RectHeightStyle::kTight, RectWidthStyle::kTight);  // 52.4099998 + 17.4699993
  auto face04 = paragraph->getRectsForRange(
      17, 19, RectHeightStyle::kTight, RectWidthStyle::kTight);  // 69.8799973 + 17.4699993
  ...
  for (auto i : words) {
    ...
    // SkDebugf("[%d:%d) @%f,%f: %d %s\n", j, i, X - 5, Y, res1.position, res1.affinity ==
    // Affinity::kDownstream ? "D" : "U");
    auto res2 = paragraph->getGlyphPositionAtCoordinate(X + 5, Y);
    // SkDebugf("[%d:%d) @%f,%f: %d %s\n\n", j, i, X + 5, Y, res2.position, res2.affinity ==
    // Affinity::kDownstream ? "D" : "U");
...
UNIX_ONLY_TEST(SkParagraph_PlaceholderWidth, reporter) {
  ...
  text_style.setFontFamilies({SkString("Ahem")});
  PlaceholderStyle placeholder(
      300, 50, PlaceholderAlignment::kBaseline, TextBaseline::kAlphabetic, 0);
...
UNIX_ONLY_TEST(SkParagraph_GlyphPositionsInEmptyLines, reporter) {
  ...
  auto res1 = paragraph->getGlyphPositionAtCoordinate(paragraph->getMinIntrinsicWidth(), 1);
  REPORTER_ASSERT(reporter, res1.position == 1 && res1.affinity == Affinity::kUpstream);

  auto res2 = paragraph->getGlyphPositionAtCoordinate(0, paragraph->getHeight() * 0.5);
  REPORTER_ASSERT(reporter, res2.position == 2 && res2.affinity == Affinity::kDownstream);

  auto res3 = paragraph->getGlyphPositionAtCoordinate(0, paragraph->getHeight() - 1);
...
UNIX_ONLY_TEST(SkParagraph_LTRGlyphPositionsForTrailingSpaces, reporter) {
  ...
  auto test = [&](const char* text) {
    ...
    for (size_t i = 0; i < str.size(); ++i) {
      ...
      // SkDebugf("@%f[%d]: %d %s\n", i * 10.0f, i, res.position, res.affinity ==
      // Affinity::kDownstream ? "D" : "U");
      ...
      REPORTER_ASSERT(
          reporter, res.affinity == (res.position == SkToInt(str.size()) ? Affinity::kUpstream
...
UNIX_ONLY_TEST(SkParagraph_RTLGlyphPositionsForTrailingSpaces, reporter) {
  ...
  auto test = [&](const char* text, int whitespaces) {
    ...
    canvas.get()->translate(0, 20);
    auto res =
        paragraph->getRectsForRange(0, str.size(), RectHeightStyle::kTight, RectWidthStyle::kTight);
    bool even = true;
    for (auto& r : res) {
      if (even) {
        gray.setColor(SK_ColorGRAY);
    ...
    for (int i = 0; i < SkToInt(str.size()); ++i) {
      ...
      // SkDebugf("@%f[%d]: %d %s\n", pointX, i, pos.position, pos.affinity == Affinity::kDownstream
      // ? "D" : "U");
      //  At the beginning there is a control codepoint that makes the string RTL
      REPORTER_ASSERT(
          reporter, (pos.position + i) ==
                        SkToInt(str.size()) - (pos.affinity == Affinity::kDownstream ? 1 : 0));
    }
  };
...
UNIX_ONLY_TEST(SkParagraph_LTRLineMetricsDoesNotIncludeNewLine, reporter) {
  ...
  paragraph->getLineMetrics(metrics);
  for (auto& metric : metrics) {
    // SkDebugf("Line[%d:%d <= %d <=%d)\n", metric.fStartIndex, metric.fEndExcludingWhitespaces,
    // metric.fEndIndex, metric.fEndIncludingNewline);
...
UNIX_ONLY_TEST(SkParagraph_RTLLineMetricsDoesNotIncludeNewLine, reporter) {
  ...
  std::vector<std::tuple<int, int, int, int>> expected = {
      {0, 1, 5,
       6},  //      { just spaces; the end of the text considered as a new line in libtxt?!? }
...
UNIX_ONLY_TEST(SkParagraph_LineEnd, reporter) {
  ...
  /*
  for (auto& lm : lm) {
      SkDebugf("%d %d %d\n", (int)lm.fEndExcludingWhitespaces, (int)lm.fEndIndex,
  (int)lm.fEndIncludingNewline);
  }
  */
  REPORTER_ASSERT(
      reporter, lm[0].fEndExcludingWhitespaces == 05 && lm[0].fEndIndex == 06 &&
                    lm[0].fEndIncludingNewline == 06);
  REPORTER_ASSERT(
      reporter, lm[1].fEndExcludingWhitespaces == 11 && lm[1].fEndIndex == 14 &&
                    lm[1].fEndIncludingNewline == 14);
  REPORTER_ASSERT(
      reporter, lm[2].fEndExcludingWhitespaces == 19 && lm[2].fEndIndex == 19 &&
                    lm[2].fEndIncludingNewline == 20);
  REPORTER_ASSERT(
      reporter, lm[3].fEndExcludingWhitespaces == 25 && lm[3].fEndIndex == 28 &&
                    lm[3].fEndIncludingNewline == 29);
}
...
UNIX_ONLY_TEST(SkParagraph_Utf16Indexes, reporter) {
  ...
  // }
  REPORTER_ASSERT(
      reporter, lm[0].fEndExcludingWhitespaces == 05 && lm[0].fEndIndex == 05 &&
                    lm[0].fEndIncludingNewline == 06);
  REPORTER_ASSERT(
      reporter, lm[1].fEndExcludingWhitespaces == 10 && lm[1].fEndIndex == 10 &&
                    lm[1].fEndIncludingNewline == 10);
}
...
UNIX_ONLY_TEST(SkParagraph_RTLFollowedByLTR, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[1].rect.fRight, paragraph->getMaxIntrinsicWidth()));
  ...
  for (auto w : widths) {
    ...
    REPORTER_ASSERT(
        reporter, pos.affinity == (res < 0 ? Affinity::kDownstream : Affinity::kUpstream));
...
UNIX_ONLY_TEST(SkParagraph_StrutTopLine, reporter) {
  ...
  paragraph->paint(canvas.get(), 0, 0);
  auto boxes = paragraph->getRectsForRange(
      0, 60, RectHeightStyle::kIncludeLineSpacingTop, RectWidthStyle::kMax);
