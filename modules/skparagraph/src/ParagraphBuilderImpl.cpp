...
void ParagraphBuilderImpl::addText(const char* text) { fUtf8.append(text); }

void ParagraphBuilderImpl::addText(const char* text, size_t len) { fUtf8.append(text, len); }
