...
class TextWrapper {
 ...
 public:
  ...
  using AddLineToParagraph = std::function<void(
      TextRange text, TextRange textWithSpaces, ClusterRange clusters, size_t startClip,
      size_t endClip, SkVector offset, SkVector advance, LineMetrics metrics, bool addEllipsis)>;
