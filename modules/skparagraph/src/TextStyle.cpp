...
bool TextStyle::equalsByFonts(const TextStyle& that) const {
  return !fIsPlaceholder && !that.fIsPlaceholder && fFontStyle == that.fFontStyle &&
         ...
         SkScalarNearlyEqual(fFontSize, that.fFontSize) && fLocale == that.fLocale;
}
...
bool TextStyle::matchOneAttribute(StyleType styleType, const TextStyle& other) const {
  switch (styleType) {
    ...
    case kDecorations: return this->fDecoration == other.fDecoration;

    case kLetterSpacing: return fLetterSpacing == other.fLetterSpacing;

    case kWordSpacing: return fWordSpacing == other.fWordSpacing;

    case kAllAttributes: return this->equals(other);
...
bool PlaceholderStyle::equals(const PlaceholderStyle& other) const {
  return SkScalarNearlyEqual(fWidth, other.fWidth) && SkScalarNearlyEqual(fHeight, other.fHeight) &&
