...
class TextLine {
 public:
  ...
  using StyleVisitor =
      std::function<SkScalar(TextRange textRange, const TextStyle& style, SkScalar offsetX)>;
  ...
  SkScalar iterateThroughRuns(
      TextRange textRange, SkScalar offsetX, bool includeEmptyText,
 ...
 private:
  ...
  SkRect measureTextInsideOneRun(
