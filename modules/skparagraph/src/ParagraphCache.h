...
// TODO: we can cache shaped results or line broken results or formatted results or recorded
// picture...
...
class ParagraphCacheKey {
 public:
  ...
  // TODO: Do not check for more than we have to (which is text styles with letter spacing and word
  // spacing)
