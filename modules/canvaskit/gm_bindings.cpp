...
class WasmContextInfo : public sk_gpu_test::ContextInfo {
 public:
  WasmContextInfo(GrDirectContext* context, const GrContextOptions& options)
...
bool IsRenderingGLOrMetalContextType(ContextType ct) { return IsRenderingGLContextType(ct); }
