...
JSArray ToCmds(const SkPath& path) {
  ...
  for (auto [verb, pts, w] : SkPathPriv::Iterate(path)) {
    ...
    switch (verb) {
      case SkPathVerb::kMove: cmd.call<void>("push", MOVE, pts[0].x(), pts[0].y()); break;
      case SkPathVerb::kLine: cmd.call<void>("push", LINE, pts[1].x(), pts[1].y()); break;
      case SkPathVerb::kQuad:
        cmd.call<void>("push", QUAD, pts[1].x(), pts[1].y(), pts[2].x(), pts[2].y());
        break;
      case SkPathVerb::kConic:
        cmd.call<void>("push", CONIC, pts[1].x(), pts[1].y(), pts[2].x(), pts[2].y(), *w);
        break;
      case SkPathVerb::kCubic:
        cmd.call<void>(
            "push", CUBIC, pts[1].x(), pts[1].y(), pts[2].x(), pts[2].y(), pts[3].x(), pts[3].y());
        break;
      case SkPathVerb::kClose: cmd.call<void>("push", CLOSE); break;
    }
...
// cwrap (see
// https://becominghuman.ai/passing-and-returning-webassembly-array-parameters-a0f572c65d97) but
// that requires us to stick to C code and, AFAIK, doesn't allow us to return nice things like
// SkPath or SkOpBuilder.
//
// So, basically, if we are using C++ and EMSCRIPTEN_BINDINGS, we can't have primitive pointers
// in our function type signatures. (this gives an error message like "Cannot call foo due to
// unbound types Pi, Pf").  But, we can just pretend they are numbers and cast them to be pointers
...
void PathAddVerbsPointsWeights(
    SkPath& path, uintptr_t /* uint8_t* */ verbsPtr, int numVerbs, uintptr_t /* float* */ ptsPtr,
    int numPts, uintptr_t /* float* */ wtsPtr, int numWts) {
...
SkPath MakePathFromVerbsPointsWeights(
    uintptr_t /* uint8_t* */ verbsPtr, int numVerbs, uintptr_t ptsPtr, int numPts, uintptr_t wtsPtr,
    int numWts) {
  SkPath path;
...
static sk_sp<SkTextBlob> do_shaping(const ShapedTextOpts& opts, SkPoint* pt) {
  ...
  shaper->shape(
      opts.text.c_str(), opts.text.length(), opts.font, opts.leftToRight, opts.width, &builder);
  *pt = builder.endPoint();
...
void drawShapedText(SkCanvas& canvas, ShapedText st, SkScalar x, SkScalar y, const SkPaint& paint) {
...
EMSCRIPTEN_BINDINGS(Skia) {
  ...
  function(
      ...
      optional_override(
          [](uintptr_t /* uint8_t*  */ iptr, size_t length) -> sk_sp<SkAnimatedImage> {
  ...
  function(
      "_decodeImage",
      optional_override([](uintptr_t /* uint8_t*  */ iptr, size_t length) -> sk_sp<SkImage> {
        uint8_t* imgData = reinterpret_cast<uint8_t*>(iptr);
  ...
  function(
      "_MakeImage",
      optional_override(
          [](SimpleImageInfo ii, uintptr_t /* uint8_t*  */ pPtr, int plen,
  ...
  function(
      ...
      optional_override(
          [](uintptr_t /* float* */ ctmPtr, const SkPath& path, const SkPoint3& zPlaneParams,
             const SkPoint3& lightPos, SkScalar lightRadius, uint32_t flags,
             uintptr_t /* SkRect* */ outPtr) -> bool {
  ...
  function(
      "_MakePicture",
      optional_override([](uintptr_t /* unint8_t* */ dPtr, size_t bytes) -> sk_sp<SkPicture> {
  ...
  class_<SkCanvas>("Canvas")
      ...
      .function(
          "_clipRRect", optional_override([](SkCanvas& self, uintptr_t /* float* */ fPtr,
                                             SkClipOp op, bool doAntiAlias) {
            self.clipRRect(ptrToSkRRect(fPtr), op, doAntiAlias);
          }))
      .function(
          "_clipRect", optional_override([](SkCanvas& self, uintptr_t /* float* */ fPtr,
                                            SkClipOp op, bool doAntiAlias) {
      ...
      .function(
          "_drawArc",
          optional_override([](SkCanvas& self, uintptr_t /* float* */ fPtr, SkScalar startAngle,
      ...
      .function(
          "_drawAtlas",
          optional_override(
              [](SkCanvas& self, const sk_sp<SkImage>& atlas, uintptr_t /* SkRSXform* */ xptr,
          ...
          allow_raw_pointers())
      .function(
          "drawCircle", select_overload<void(SkScalar, SkScalar, SkScalar, const SkPaint& paint)>(
                            &SkCanvas::drawCircle))
      ...
      .function(
          "_drawColor",
          optional_override([](SkCanvas& self, uintptr_t /* float* */ cPtr, SkBlendMode mode) {
      ...
      .function(
          "drawColorInt", optional_override([](SkCanvas& self, SkColor color, SkBlendMode mode) {
            self.drawColor(color, mode);
          }))
      .function(
          "_drawDRRect",
          optional_override([](SkCanvas& self, uintptr_t /* float* */ outerPtr,
                               uintptr_t /* float* */ innerPtr, const SkPaint& paint) {
            self.drawDRRect(ptrToSkRRect(outerPtr), ptrToSkRRect(innerPtr), paint);
          }))
      .function(
          "drawImage",
          select_overload<void(const sk_sp<SkImage>&, SkScalar, SkScalar, const SkPaint*)>(
              &SkCanvas::drawImage),
          allow_raw_pointers())
      .function(
          "drawImageCubic",
      ...
      .function(
          ...
          optional_override(
              [](SkCanvas& self, sk_sp<SkAnimatedImage> aImg, SkScalar left, SkScalar top,
                 const SkPaint* paint) -> void {
      ...
      .function(
          "_drawImageNine",
          optional_override(
              [](SkCanvas& self, const sk_sp<SkImage>& image, uintptr_t /* int* */ centerPtr,
                 uintptr_t /* float* */ dstPtr, SkFilterMode filter, const SkPaint* paint) -> void {
      ...
      .function(
          "_drawImageRect",
          optional_override(
              [](SkCanvas& self, const sk_sp<SkImage>& image, uintptr_t /* float* */ srcPtr,
                 uintptr_t /* float* */ dstPtr, const SkPaint* paint, bool fastSample) -> void {
      ...
      .function(
          ...
          optional_override(
              [](SkCanvas& self, const sk_sp<SkImage>& image, uintptr_t /* float* */ srcPtr,
                 uintptr_t /* float* */ dstPtr, float B,
                 float C,  // See SkSamplingOptions.h for docs.
                 const SkPaint* paint) -> void {
                const SkRect* src = reinterpret_cast<const SkRect*>(srcPtr);
                const SkRect* dst = reinterpret_cast<const SkRect*>(dstPtr);
      ...
      .function(
          ...
          optional_override(
              [](SkCanvas& self, const sk_sp<SkImage>& image, uintptr_t /* float* */ srcPtr,
                 uintptr_t /* float* */ dstPtr, SkFilterMode filter, SkMipmapMode mipmap,
                 const SkPaint* paint) -> void {
                const SkRect* src = reinterpret_cast<const SkRect*>(srcPtr);
                const SkRect* dst = reinterpret_cast<const SkRect*>(dstPtr);
                auto constraint = SkCanvas::kStrict_SrcRectConstraint;  // TODO: get from caller
          ...
          allow_raw_pointers())
      .function(
          "drawLine", select_overload<void(SkScalar, SkScalar, SkScalar, SkScalar, const SkPaint&)>(
                          &SkCanvas::drawLine))
      .function(
          "_drawOval",
          optional_override(
              [](SkCanvas& self, uintptr_t /* float* */ fPtr, const SkPaint& paint) -> void {
                const SkRect* oval = reinterpret_cast<const SkRect*>(fPtr);
      ...
      .function(
          "drawPicture", select_overload<void(const sk_sp<SkPicture>&)>(&SkCanvas::drawPicture))
      .function(
          "_drawPoints", optional_override(
                             [](SkCanvas& self, SkCanvas::PointMode mode,
                                uintptr_t /* SkPoint* */ pptr, int count, SkPaint& paint) -> void {
                               const SkPoint* pts = reinterpret_cast<const SkPoint*>(pptr);
                               self.drawPoints(mode, count, pts, paint);
                             }))
      .function(
          "_drawRRect",
          optional_override([](SkCanvas& self, uintptr_t /* float* */ fPtr, const SkPaint& paint) {
      ...
      .function(
          "_drawShadow",
          optional_override([](SkCanvas& self, const SkPath& path, const SkPoint3& zPlaneParams,
                               const SkPoint3& lightPos, SkScalar lightRadius,
                               uintptr_t /* float* */ ambientColorPtr,
                               uintptr_t /* float* */ spotColorPtr, uint32_t flags) {
      ...
      .function(
          "_drawSimpleText",
          optional_override([](SkCanvas& self, uintptr_t /* char* */ sptr, size_t len, SkScalar x,
      ...
      .function(
          "_findMarkedCTM",
          optional_override(
              [](SkCanvas& self, std::string marker, uintptr_t /* SkScalar* */ mPtr) -> bool {
      ...
      .function(
          "_getLocalToDevice",
          optional_override([](const SkCanvas& self, uintptr_t /* SkScalar*  */ mPtr) {
            SkScalar* sixteenMatrixValues = reinterpret_cast<SkScalar*>(mPtr);
            if (!sixteenMatrixValues) {
      ...
      .function(
          "_getTotalMatrix",
          optional_override([](const SkCanvas& self, uintptr_t /* uint8_t* */ mPtr) {
      ...
      .function(
          "_readPixels",
          optional_override([](SkCanvas& self, SimpleImageInfo di, uintptr_t /* uint8_t* */ pPtr,
      ...
      .function(
          "_saveLayer",
          optional_override(
              [](SkCanvas& self, const SkPaint* p, uintptr_t /* float* */ fPtr,
  ...
  class_<SkColorFilter>("ColorFilter")
      ...
      .class_function(
          "_MakeBlend",
          optional_override(
              [](uintptr_t /* float* */ cPtr, SkBlendMode mode) -> sk_sp<SkColorFilter> {
  ...
  class_<SkContourMeasure>("ContourMeasure")
      ...
      .function(
          "getPosTan", optional_override([](SkContourMeasure& self, SkScalar distance) -> PosTan {
            SkPoint p{0, 0};
            SkVector v{0, 0};
  ...
  class_<SkData>("Data").smart_ptr<sk_sp<SkData>>("sk_sp<Data>>").function("size", &SkData::size);
  ...
  class_<SkFont>("Font")
      ...
      .function(
          ...
          optional_override([](SkFont& self, uintptr_t /* SkGlyphID* */ gPtr, int numGlyphs,
                               uintptr_t /* float* */ wPtr, uintptr_t /* float* */ rPtr,
                               SkPaint* paint) {
      ...
      .function(
          "_getGlyphIDs",
          optional_override(
              [](SkFont& self, uintptr_t /* char* */ sptr, size_t strLen, size_t expectedCodePoints,
      ...
      .function(
          "_getWidths", optional_override(
                            [](SkFont& self, uintptr_t /* char* */ sptr, size_t strLen,
                               size_t expectedCodePoints, uintptr_t /* SkScalar* */ wptr) -> bool {
                              char* str = reinterpret_cast<char*>(sptr);
                              SkScalar* widths = reinterpret_cast<SkScalar*>(wptr);

                              SkGlyphID* glyphStorage = new SkGlyphID[expectedCodePoints];
                              int actualCodePoints = self.textToGlyphs(
                                  str, strLen, SkTextEncoding::kUTF8, glyphStorage,
                                  expectedCodePoints);
                              if (actualCodePoints != expectedCodePoints) {
                                SkDebugf(
                                    "Actually %d glyphs, expected only %d\n", actualCodePoints,
                                    expectedCodePoints);
                                return false;
                              }
  ...
  class_<ShapedText>("ShapedText")
      ...
      .function(
          "_getBounds",
          optional_override([](ShapedText& self, uintptr_t /* float* */ fPtr) -> void {
  ...
  class_<SkFontMgr>("FontMgr")
      ...
      .class_function(
          "_fromData",
          optional_override(
              [](uintptr_t /* uint8_t**  */ dPtr, uintptr_t /* size_t*  */ sPtr,
...
#  endif
      .function(
          ...
          optional_override(
              [](SkFontMgr& self, uintptr_t /* uint8_t*  */ fPtr, int flen) -> sk_sp<SkTypeface> {
  ...
  class_<SkImage>("Image")
      ...
      .function(
          "_encodeToDataWithFormat",
          select_overload<sk_sp<SkData>(SkEncodedImageFormat encodedImageFormat, int quality)
                              const>(&SkImage::encodeToData))
      .function(
      ...
      .function(
          ...
          optional_override(
              [](sk_sp<SkImage> self, SkTileMode tx, SkTileMode ty, SkFilterMode filter,
                 SkMipmapMode mipmap, uintptr_t /* SkScalar*  */ mPtr) -> sk_sp<SkShader> {
      ...
      .function(
          "_readPixels",
          optional_override(
              [](sk_sp<SkImage> self, SimpleImageInfo sii, uintptr_t /* uint8_t*  */ pPtr,
  ...
  class_<SkImageFilter>("ImageFilter")
      ...
      .class_function(
          "_MakeMatrixTransform", optional_override(
                                      [](uintptr_t /* SkScalar*  */ mPtr, SkFilterQuality fq,
                                         sk_sp<SkImageFilter> input) -> sk_sp<SkImageFilter> {
  ...
  class_<SkPaint>("Paint")
      ...
      .function(
          "_getColor", optional_override([](SkPaint& self, uintptr_t /* float* */ cPtr) -> void {
      ...
      .function(
          "_setColor", optional_override([](SkPaint& self, uintptr_t /* float* */ cPtr,
                                            sk_sp<SkColorSpace> colorSpace) {
  ...
  class_<SkPathEffect>("PathEffect")
      ...
      .class_function(
          "_MakeDash",
          optional_override(
              [](uintptr_t /* float* */ cptr, int count, SkScalar phase) -> sk_sp<SkPathEffect> {
  ...
  class_<SkPath>("Path")
      ...
      .function(
          "_addArc", optional_override(
                         [](SkPath& self, uintptr_t /* float* */ fPtr, SkScalar startAngle,
      ...
      .function(
          "_addOval",
          optional_override(
              [](SkPath& self, uintptr_t /* float* */ fPtr, bool ccw, unsigned start) -> void {
                const SkRect* oval = reinterpret_cast<const SkRect*>(fPtr);
      ...
      .function(
          "_addPoly",
          optional_override(
              [](SkPath& self, uintptr_t /* SkPoint* */ fPtr, int count, bool close) -> void {
                const SkPoint* pts = reinterpret_cast<const SkPoint*>(fPtr);
                self.addPoly(pts, count, close);
              }))
      .function(
          "_addRect",
          optional_override([](SkPath& self, uintptr_t /* float* */ fPtr, bool ccw) -> void {
            const SkRect* rect = reinterpret_cast<const SkRect*>(fPtr);
      ...
      .function(
          "_getBounds", optional_override([](SkPath& self, uintptr_t /* float* */ fPtr) -> void {
            SkRect* output = reinterpret_cast<SkRect*>(fPtr);
            output[0] = self.getBounds();
          }))
      .function(
          "_computeTightBounds",
          optional_override([](SkPath& self, uintptr_t /* float* */ fPtr) -> void {
            SkRect* output = reinterpret_cast<SkRect*>(fPtr);
  ...
  class_<SkPathMeasure>("PathMeasure")
      ...
      .function(
          "getPosTan", optional_override([](SkPathMeasure& self, SkScalar distance) -> PosTan {
            SkPoint p{0, 0};
            SkVector v{0, 0};
            if (!self.getPosTan(distance, &p, &v)) {
              SkDebugf("zero-length path in getPosTan\n");
      ...
      .function(
          "getSegment", optional_override(
                            [](SkPathMeasure& self, SkScalar startD, SkScalar stopD,
                               bool startWithMoveTo) -> SkPath {
                              SkPath p;
                              bool ok = self.getSegment(startD, stopD, &p, startWithMoveTo);
                              if (ok) {
  ...
  class_<SkPictureRecorder>("PictureRecorder")
      ...
      .function(
          "_beginRecording",
          optional_override([](SkPictureRecorder& self, uintptr_t /* float* */ fPtr) -> SkCanvas* {
            SkRect* bounds = reinterpret_cast<SkRect*>(fPtr);
  ...
  class_<SkPicture>("Picture")
      ...
      .function(
          "serialize", optional_override([](SkPicture& self) -> sk_sp<SkData> {
  ...
  class_<SkShader>("Shader")
      ...
      .class_function(
          "_MakeColor",
          optional_override(
              [](uintptr_t /* float* */ cPtr, sk_sp<SkColorSpace> colorSpace) -> sk_sp<SkShader> {
                return SkShaders::Color(ptrToSkColor4f(cPtr), colorSpace);
              }))
      .class_function(
          "MakeLerp", select_overload<sk_sp<SkShader>(float, sk_sp<SkShader>, sk_sp<SkShader>)>(
                          &SkShaders::Lerp))
      .class_function(
      ...
      .class_function(
          "_MakeLinearGradient",
          optional_override(
              [](SkPoint start, SkPoint end, uintptr_t cPtr, SkColorType colorType,
                 uintptr_t /* SkScalar*  */ pPtr, int count, SkTileMode mode, uint32_t flags,
      ...
      .class_function(
          "_MakeRadialGradient",
          optional_override(
              [](SkPoint center, SkScalar radius, uintptr_t cPtr, SkColorType colorType,
                 uintptr_t /* SkScalar*  */ pPtr, int count, SkTileMode mode, uint32_t flags,
                 uintptr_t /* SkScalar*  */ mPtr,
                 sk_sp<SkColorSpace> colorSpace) -> sk_sp<SkShader> {
                const SkScalar* positions = reinterpret_cast<const SkScalar*>(pPtr);
                ...
                if (colorType == SkColorType::kRGBA_F32_SkColorType) {
                  ...
                  return SkGradientShader::MakeRadial(
                      center, radius, colors, colorSpace, positions, count, mode, flags,
                      &localMatrix);
                } else if (colorType == SkColorType::kRGBA_8888_SkColorType) {
                  const SkColor* colors = reinterpret_cast<const SkColor*>(cPtr);
                  return SkGradientShader::MakeRadial(
                      center, radius, colors, positions, count, mode, flags, &localMatrix);
                }
                SkDebugf("%d is not an accepted colorType\n", colorType);
                return nullptr;
              }),
      ...
      .class_function(
          "_MakeSweepGradient",
          optional_override(
              [](SkScalar cx, SkScalar cy, uintptr_t cPtr, SkColorType colorType,
                 uintptr_t /* SkScalar*  */ pPtr, int count, SkTileMode mode, SkScalar startAngle,
                 SkScalar endAngle, uint32_t flags, uintptr_t /* SkScalar*  */ mPtr,
                 sk_sp<SkColorSpace> colorSpace) -> sk_sp<SkShader> {
                const SkScalar* positions = reinterpret_cast<const SkScalar*>(pPtr);
                OptionalMatrix localMatrix(mPtr);
                if (colorType == SkColorType::kRGBA_F32_SkColorType) {
      ...
      .class_function(
          ...
          optional_override(
              [](SkPoint start, SkScalar startRadius, SkPoint end, SkScalar endRadius,
                 uintptr_t cPtr, SkColorType colorType, uintptr_t /* SkScalar*  */ pPtr, int count,
                 SkTileMode mode, uint32_t flags, uintptr_t /* SkScalar*  */ mPtr,
                 sk_sp<SkColorSpace> colorSpace) -> sk_sp<SkShader> {
                const SkScalar* positions = reinterpret_cast<const SkScalar*>(pPtr);
                OptionalMatrix localMatrix(mPtr);
                ...
                if (colorType == SkColorType::kRGBA_F32_SkColorType) {
                  ...
                  return SkGradientShader::MakeTwoPointConical(
                      start, startRadius, end, endRadius, colors, colorSpace, positions, count,
                      mode, flags, &localMatrix);
                } else if (colorType == SkColorType::kRGBA_8888_SkColorType) {
                  const SkColor* colors = reinterpret_cast<const SkColor*>(cPtr);
                  return SkGradientShader::MakeTwoPointConical(
                      start, startRadius, end, endRadius, colors, positions, count, mode, flags,
                      &localMatrix);
                }
                SkDebugf("%d is not an accepted colorType\n", colorType);
                return nullptr;
  ...
  class_<SkRuntimeEffect>("RuntimeEffect")
      ...
      .function(
          "_makeShader", optional_override(
                             [](SkRuntimeEffect& self, uintptr_t fPtr, size_t fLen, bool isOpaque,
                                uintptr_t /* SkScalar*  */ mPtr) -> sk_sp<SkShader> {
  ...
  class_<SkSurface>("Surface")
      ...
      .class_function(
          "_makeRasterDirect",
          optional_override(
              [](const SimpleImageInfo ii, uintptr_t /* uint8_t*  */ pPtr,
      ...
      .function(
          "_makeImageSnapshot",
          optional_override([](SkSurface& self, uintptr_t /* int*  */ iPtr) -> sk_sp<SkImage> {
  ...
  class_<SkTextBlob>("TextBlob")
      ...
      .class_function(
          "_MakeFromRSXform",
          optional_override(
              [](uintptr_t /* char* */ sptr, size_t strBtyes, uintptr_t /* SkRSXform* */ xptr,
      ...
      .class_function(
          ...
          optional_override(
              [](uintptr_t /* SkGlyphID* */ gPtr, size_t byteLen, uintptr_t /* SkRSXform* */ xptr,
                 const SkFont& font) -> sk_sp<SkTextBlob> {
                const SkGlyphID* glyphs = reinterpret_cast<const SkGlyphID*>(gPtr);
                const SkRSXform* xforms = reinterpret_cast<const SkRSXform*>(xptr);
      ...
      .class_function(
          "_MakeFromText",
          optional_override(
              [](uintptr_t /* char* */ sptr, size_t len, const SkFont& font) -> sk_sp<SkTextBlob> {
                const char* str = reinterpret_cast<const char*>(sptr);
      ...
      .class_function(
          "_MakeFromGlyphs",
          optional_override(
              [](uintptr_t /* SkGlyphID* */ gPtr, size_t byteLen,
                 const SkFont& font) -> sk_sp<SkTextBlob> {
                const SkGlyphID* glyphs = reinterpret_cast<const SkGlyphID*>(gPtr);
  ...
  class_<SkTypeface>("Typeface").smart_ptr<sk_sp<SkTypeface>>("sk_sp<Typeface>");
#endif

  class_<SkVertices>("Vertices")
      .smart_ptr<sk_sp<SkVertices>>("sk_sp<Vertices>")
      .function(
          "_bounds", optional_override([](SkVertices& self, uintptr_t /* float* */ fPtr) -> void {
            SkRect* output = reinterpret_cast<SkRect*>(fPtr);
  ...
  class_<SkVertices::Builder>("_VerticesBuilder")
      ...
      .function(
          "colors", optional_override([](SkVertices::Builder& self) -> uintptr_t /* SkColor* */ {
      ...
      .function(
          "indices", optional_override([](SkVertices::Builder& self) -> uintptr_t /* uint16_t* */ {
            // Emscripten won't let us return bare pointers, but we can return ints just fine.
            return reinterpret_cast<uintptr_t>(self.indices());
          }))
      .function(
          "positions", optional_override([](SkVertices::Builder& self) -> uintptr_t /* SkPoint* */ {
            // Emscripten won't let us return bare pointers, but we can return ints just fine.
            return reinterpret_cast<uintptr_t>(self.positions());
          }))
      .function(
          "texCoords", optional_override([](SkVertices::Builder& self) -> uintptr_t /* SkPoint* */ {
            // Emscripten won't let us return bare pointers, but we can return ints just fine.
...
#  endif
  ...
  value_array<SkPoint>("Point").element(&SkPoint::fX).element(&SkPoint::fY);
  ...
  // {"w": Number, "h", Number}
  value_object<SkSize>("Size").field("w", &SkSize::fWidth).field("h", &SkSize::fHeight);

  value_object<SkISize>("ISize").field("w", &SkISize::fWidth).field("h", &SkISize::fHeight);
