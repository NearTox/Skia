...
EMSCRIPTEN_BINDINGS(Particles) {
  class_<SkParticleEffect>("ParticleEffect")
      ...
      .function(
          "getEffectUniformName", optional_override([](SkParticleEffect& self, int i) -> JSString {
            auto ec = self.effectCode();
            if (!ec) {
      ...
      .function(
          "getEffectUniform", optional_override([](SkParticleEffect& self, int i) -> SimpleUniform {
            SimpleUniform su;
            auto ec = self.effectCode();
            if (!ec) {
              return su;
      ...
      .function(
          "getParticleUniformFloatCount", optional_override([](SkParticleEffect& self) -> int {
            auto ec = self.particleCode();
            if (!ec) {
              return -1;
            }
      ...
      .function(
          "getParticleUniformName",
          optional_override([](SkParticleEffect& self, int i) -> JSString {
            auto ec = self.particleCode();
            if (!ec) {
              return emscripten::val::null();
            }
      ...
      .function(
          "getParticleUniform",
          optional_override([](SkParticleEffect& self, int i) -> SimpleUniform {
            SimpleUniform su;
            auto ec = self.particleCode();
            if (!ec) {
              return su;
  ...
  function(
      ...
      optional_override(
          [](std::string json, size_t assetCount, uintptr_t /* char**    */ nptr,
             ...
             uintptr_t /* size_t*   */ sptr) -> sk_sp<SkParticleEffect> {
