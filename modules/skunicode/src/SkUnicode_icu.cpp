...
class SkUnicode_icu : public SkUnicode {
 ...
 public:
  ...
  bool isHardBreak(SkUnichar utf8) override { return SkUnicode_icu::isHardLineBreak(utf8); }
  ...
  SkString toUpper(const SkString& str) override {
    ...
    const auto upper16len =
        sk_u_strToUpper(nullptr, 0, (UChar*)(str16.c_str()), str16.size(), nullptr, &icu_err);
    ...
    sk_u_strToUpper(
        (UChar*)(upper16.get()), SkToS32(upper16.size()), (UChar*)(str16.c_str()), str16.size(),
        nullptr, &icu_err);
