...
class SKUNICODE_API SkUnicode {
 public:
  ...
  static SkString convertUtf16ToUtf8(const char16_t* utf16, int utf16Units) {
    ...
    SkUTF::UTF16ToUTF8(utf8.data(), utf8Units, (uint16_t*)utf16, utf16Units);
  ...
  static std::u16string convertUtf8ToUtf16(const char* utf8, int utf8Units) {
    ...
    SkDEBUGCODE(int dstLen =)
    SkUTF::UTF8ToUTF16(utf16.data(), utf16Units, utf8, utf8Units);
  ...
  template <typename Callback>
  void forEachBidiRegion(
      const uint16_t utf16[], int utf16Units, SkBidiIterator::Direction dir, Callback&& callback) {
  ...
  template <typename Callback>
  void forEachBreak(
      const char16_t utf16[], int utf16Units, SkUnicode::BreakType type, Callback&& callback) {
