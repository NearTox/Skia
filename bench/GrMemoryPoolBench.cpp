...
class GrMemoryPoolBenchStack : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "grmemorypool_stack"; }
...
class GrMemoryPoolBenchRandom : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "grmemorypool_random"; }
...
class GrMemoryPoolBenchQueue : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "grmemorypool_queue"; }
