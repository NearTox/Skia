...
enum Align { kLeft_Align, kMiddle_Align, kRight_Align };
...
class BigPathBench : public Benchmark {
 ...
 protected:
  ...
  void onDraw(int loops, SkCanvas* canvas) override {
    ...
    switch (fAlign) {
      case kLeft_Align: canvas->translate(-r.left(), 0); break;
      case kMiddle_Align: break;
      case kRight_Align: canvas->translate(640 - r.right(), 0); break;
    }
