...
DEF_BENCH(SkMatrix m; m.reset(); m.preRotate(15); return new DrawBitmapAABench(false, m, "rotate");)
...
DEF_BENCH(SkMatrix m; m.reset(); m.preRotate(15); return new DrawBitmapAABench(true, m, "rotate");)
