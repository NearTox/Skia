...
class TriangulatorBenchmark : public Benchmark, public GrEagerVertexAllocator {
 public:
  TriangulatorBenchmark(const char* name) { fName.printf("triangulator_%s", name); }
 ...
 public:
  ...
  void doLoop() override {
    for (const SkPath& path : fPaths) {
      bool isLinear;
      GrTriangulator::PathToTriangles(path, kTigerTolerance, SkRect::MakeEmpty(), this, &isLinear);
    }
  }
};
...
TigerPath kTigerPaths[] = {
    ...
    {"mlcccccccccccccclcccccclz",
     {{-34.6f, 266.4f}, {-44.6f, 274.f},   {-44.6f, 274.f},   {-34.2f, 266.4f},  {-30.6f, 267.6f},
      ...
      {-9.f, 272.4f},   {-5.8f, 272.8f},   {-5.8f, 272.8f},   {-4.6f, 279.2f},   {-5.8f, 286.f},
      {-5.8f, 286.f},   {-1.8f, 278.4f},   {2.2f, 280.f},     {2.2f, 280.f},     {8.6f, 278.f},
      {7.8f, 289.6f},   {7.8f, 289.6f},    {7.8f, 300.f},     {7.f, 302.8f},     {7.f, 302.8f},
      {12.6f, 276.4f},  {15.f, 276.f},     {15.f, 276.f},     {23.f, 274.8f},    {27.8f, 283.6f},
      {27.8f, 283.6f},  {23.8f, 276.f},    {28.6f, 278.f},    {28.6f, 278.f},    {39.4f, 279.6f},
      {42.6f, 286.4f},  {42.6f, 286.4f},   {35.8f, 274.4f},   {41.4f, 277.6f},   {49.4f, 284.f},
      {49.4f, 284.f},   {57.8f, 305.2f},   {59.8f, 306.8f},   {59.8f, 306.8f},   {52.2f, 285.2f},
      {53.8f, 285.2f},  {53.8f, 285.2f},   {51.8f, 273.2f},   {57.f, 288.f},     {57.f, 288.f},
      {53.8f, 274.f},   {59.4f, 274.8f},   {65.f, 275.6f},    {69.4f, 285.6f},   {77.8f, 283.2f},
    ...
    {"mccccccccz",
     {{10.272f, -31.448f},   {9.048f, -29.816f},  {14.76f, 5.681f},    {15.984f, 10.985f},
      ...
      {10.272f, -31.448f}}},
    {"mccccccccz", {{44.2f, 36.8f},   {69.4f, 40.4f},    {92.601f, 8.f},    {94.201f, -0.799999f},
