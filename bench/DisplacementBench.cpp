 ...
 protected:
  ...
  void onDraw(int loops, SkCanvas* canvas) override {
    ...
    paint.setImageFilter(SkImageFilters::DisplacementMap(
        SkColorChannel::kR, SkColorChannel::kG, 0.0f, std::move(displ), nullptr));
...
class DisplacementAlphaBench : public DisplacementBaseBench {
 ...
 protected:
  ...
  void onDraw(int loops, SkCanvas* canvas) override {
    ...
    paint.setImageFilter(SkImageFilters::DisplacementMap(
        SkColorChannel::kB, SkColorChannel::kA, 16.0f, std::move(displ), nullptr));
    for (int i = 0; i < loops; i++) {
...
class DisplacementFullBench : public DisplacementBaseBench {
 ...
 protected:
  ...
  void onDraw(int loops, SkCanvas* canvas) override {
    ...
    paint.setImageFilter(SkImageFilters::DisplacementMap(
        SkColorChannel::kR, SkColorChannel::kB, 32.0f, std::move(displ), nullptr));
    for (int i = 0; i < loops; ++i) {
