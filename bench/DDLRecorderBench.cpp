...
static SkSurfaceCharacterization create_characterization(GrContext* context) {
  ...
  SkImageInfo ii = SkImageInfo::Make(32, 32, kRGBA_8888_SkColorType, kPremul_SkAlphaType, nullptr);
  ...
  SkSurfaceCharacterization c = context->threadSafeProxy()->createCharacterization(
      maxResourceBytes, ii, backendFormat, 1, kTopLeft_GrSurfaceOrigin, props, false);
  return c;
}
...
class DDLRecorderBench : public Benchmark {
 ...
 private:
  ...
  void onPostDraw(SkCanvas*) override { fDDLs.clear(); }
