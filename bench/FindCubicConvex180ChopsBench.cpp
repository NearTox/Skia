...
DEF_BENCH(return new FindCubicConvex180ChopsBench(
                     {{{0, 0}, {100, 0}, {50, 100}, {100, 100}}}, "_inflect1");)
DEF_BENCH(
    return new FindCubicConvex180ChopsBench({{{0, 0}, {50, 0}, {100, 50}, {100, 100}}}, "_loop");)
