...
const char* kindstr(Kind k) {
  switch (k) {
    case Kind::k001: return "001";
    case Kind::k011: return "011";
    case Kind::kCentered: return "centered";
...
class HardStopGradientBench_SpecialHardStops : public Benchmark {
 public:
  ...
  SkIPoint onGetSize() override { return SkIPoint::Make(fW, fH); }
  ...
  void onPreDraw(SkCanvas* canvas) override {
    ...
    fPaint.setShader(SkGradientShader::MakeLinear(
        points, colors, positions, count, SkTileMode::kClamp, 0, nullptr));
  }
