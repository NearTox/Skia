...
class RefCntBench_Stack : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "ref_cnt_stack"; }
...
class RefCntBench_Heap : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "ref_cnt_heap"; }
...
class RefCntBench_New : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "ref_cnt_new"; }
...
class WeakRefCntBench_Stack : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "ref_cnt_stack_weak"; }
...
class WeakRefCntBench_Heap : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "ref_cnt_heap_weak"; }
...
class WeakRefCntBench_New : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "ref_cnt_new_weak"; }
