...
class EncodeBench : public Benchmark {
 public:
  ...
  void onDelayedSetup() override { SkAssertResult(GetResourceAsBitmap(fSourceFilename, &fBitmap)); }
...
static bool encode_png(
    SkWStream* dst, const SkPixmap& src, SkPngEncoder::FilterFlag filters, int zlibLevel) {
