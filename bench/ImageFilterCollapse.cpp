...
class TableCollapseBench : public BaseImageFilterCollapseBench {
 protected:
  const char* onGetName() override { return "image_filter_collapse_table"; }
...
static sk_sp<SkColorFilter> make_brightness(float amount) {
  SkScalar matrix[20] = {1, 0, 0, 0, amount, 0, 1, 0, 0, amount, 0, 0, 1, 0, amount, 0, 0, 0, 1, 0};
...
class MatrixCollapseBench : public BaseImageFilterCollapseBench {
 protected:
  const char* onGetName() override { return "image_filter_collapse_matrix"; }
