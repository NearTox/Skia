...
class MergeBench : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return fIsSmall ? "merge_small" : "merge_large"; }
 ...
 private:
  sk_sp<SkImageFilter> mergeBitmaps() {
    return SkMergeImageFilter::Make(
        SkImageSource::Make(fCheckerboard), SkImageSource::Make(fImage));
  }
