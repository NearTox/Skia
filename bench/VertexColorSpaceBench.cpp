  ...
  GP(Mode mode, sk_sp<GrColorSpaceXform> colorSpaceXform)
    ...
    switch (fMode) {
      ...
      case kShader_Mode:
        ...
        break;
      case kFloat_Mode: fInColor = {"inColor", kFloat4_GrVertexAttribType, SkSLType::kHalf4}; break;
      case kHalf_Mode: fInColor = {"inColor", kHalf4_GrVertexAttribType, SkSLType::kHalf4}; break;
    }
