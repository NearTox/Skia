...
class DecodeBench : public Benchmark {
 protected:
  DecodeBench(const char* name, const char* source)
      : fName(SkStringPrintf("decode_%s", name)), fSource(source) {}
...
class BitmapDecodeBench final : public DecodeBench {
 public:
  BitmapDecodeBench(const char* name, const char* source) : INHERITED(name, source) {}
...
class SkottieDecodeBench final : public DecodeBench {
 public:
  SkottieDecodeBench(const char* name, const char* source) : INHERITED(name, source) {}

  void onDraw(int loops, SkCanvas*) override {
    while (loops-- > 0) {
      const auto anim =
          skottie::Animation::Make(reinterpret_cast<const char*>(fData->data()), fData->size());
    }
  }
...
class SkottiePictureDecodeBench final : public DecodeBench {
 public:
  SkottiePictureDecodeBench(const char* name, const char* source) : INHERITED(name, source) {}
...
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_connecting.json",  // 216x216
    "skottie/skottie-phonehub-connecting.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_generic_error.json",  // 216x217
    "skottie/skottie-phonehub-generic-error.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_onboard.json",  // 217x217
...
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_connecting.json", "skottie/skottie-phonehub-svgo-connecting.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_generic_error.json",
    "skottie/skottie-phonehub-svgo-generic-error.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_onboard.json", "skottie/skottie-phonehub-svgo-onboard.json"));
...
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_no_masks_connecting.json",
    "skottie/skottie-phonehub-svgo-no-masks-connecting.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_no_masks_onboard.json",
...
// 3. https://lottiefiles.com/svg-to-lottie
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_no_frills_connecting.json",
...
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_no_frills_onboard.json",
...
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_connecting_min.json", "skottie/skottie-phonehub-connecting_min.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_generic_error_min.json", "skottie/skottie-phonehub-generic-error_min.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_onboard_min.json", "skottie/skottie-phonehub-onboard_min.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_connecting_min.json",
    "skottie/skottie-phonehub-svgo-connecting_min.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_generic_error_min.json",
    "skottie/skottie-phonehub-svgo-generic-error_min.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_onboard_min.json", "skottie/skottie-phonehub-svgo-onboard_min.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_no_masks_connecting_min.json",
    "skottie/skottie-phonehub-svgo-no-masks-connecting_min.json"));
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_no_masks_onboard_min.json",
...
DEF_BENCH(return new SkottieDecodeBench(
    "skottie_phonehub_svgo_no_frills_onboard_min.json",
    "skottie/skottie-phonehub-svgo-no-frills-onboard_min.json"));

DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_large", "skottie/skottie-text-scale-to-fit-minmax.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_medium", "skottie/skottie-sphere-effect.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_small", "skottie/skottie_sample_multiframe.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_connecting.json", "skottie/skottie-phonehub-connecting.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_generic_error.json", "skottie/skottie-phonehub-generic-error.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_onboard.json", "skottie/skottie-phonehub-onboard.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_connecting.json", "skottie/skottie-phonehub-svgo-connecting.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_generic_error.json",
    "skottie/skottie-phonehub-svgo-generic-error.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_onboard.json", "skottie/skottie-phonehub-svgo-onboard.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
...
DEF_BENCH(return new SkottiePictureDecodeBench(
    ...
    "skottie/skottie-phonehub-svgo-no-frills-onboard.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_connecting_min.json", "skottie/skottie-phonehub-connecting_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_generic_error_min.json",
    "skottie/skottie-phonehub-generic-error_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_onboard_min.json", "skottie/skottie-phonehub-onboard_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_connecting_min.json",
    "skottie/skottie-phonehub-svgo-connecting_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_generic_error_min.json",
    "skottie/skottie-phonehub-svgo-generic-error_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_onboard_min.json", "skottie/skottie-phonehub-svgo-onboard_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
