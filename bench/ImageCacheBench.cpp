...
class TestKey : public SkResourceCache::Key {
 public:
  ...
  TestKey(intptr_t value) : fValue(value) { this->init(&gGlobalAddress, 0, sizeof(fValue)); }
};
struct TestRec : public SkResourceCache::Rec {
  ...
  static bool Visitor(const SkResourceCache::Rec&, void*) { return true; }
};
}  // namespace
...
class ImageCacheBench : public Benchmark {
 ...
 protected:
  const char* onGetName() override { return "imagecache"; }
