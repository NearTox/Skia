...
class TextBlobCachedBench : public SkTextBlobBench {
  const char* onGetName() override { return "TextBlobCachedBench"; }
...
class TextBlobFirstTimeBench : public SkTextBlobBench {
  const char* onGetName() override { return "TextBlobFirstTimeBench"; }
...
class TextBlobMakeBench : public SkTextBlobBench {
  const char* onGetName() override { return "TextBlobMakeBench"; }
