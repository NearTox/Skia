...
class SK_API SkAtlasTextTarget {
 public:
   ...
   */
  static std::unique_ptr<SkAtlasTextTarget> Make(
      sk_sp<SkAtlasTextContext>, int width, int height, void* handle);
  ...
  virtual void drawText(
      const SkGlyphID[], const SkPoint[], int glyphCnt, uint32_t color, const SkAtlasTextFont&) = 0;
