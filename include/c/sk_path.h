...
/**
    ...
    point is automatically set to (0,0).
*/
SK_API void sk_pathbuilder_conic_to(
    sk_pathbuilder_t*, float x0, float y0, float x1, float y1, float w);
/**
    ...
    point is automatically set to (0,0).
*/
SK_API void sk_pathbuilder_cubic_to(
    sk_pathbuilder_t*, float x0, float y0, float x1, float y1, float x2, float y2);
/**
