...
SKCMS_API bool skcms_TransferFunction_invert(
    const skcms_TransferFunction*, skcms_TransferFunction*);
...
//                                  D + E|encoded|^C
SKCMS_API bool skcms_TransferFunction_makePQish(
...
SKCMS_API bool skcms_TransferFunction_makeHLGish(
    skcms_TransferFunction*, float R, float G, float a, float b, float c);
...
SKCMS_API bool skcms_ApproximatelyEqualProfiles(
    const skcms_ICCProfile* A, const skcms_ICCProfile* B);
...
SKCMS_API bool skcms_AreApproximateInverses(
    const skcms_Curve* curve, const skcms_TransferFunction* inv_tf);
...
SKCMS_API bool skcms_TRCs_AreApproximateInverse(
...
SKCMS_API bool skcms_Transform(
...
SKCMS_API bool skcms_TransformWithPalette(
    const void* src, skcms_PixelFormat srcFmt, skcms_AlphaFormat srcAlpha,
    const skcms_ICCProfile* srcProfile, void* dst, skcms_PixelFormat dstFmt,
    skcms_AlphaFormat dstAlpha, const skcms_ICCProfile* dstProfile, size_t npixels,
    const void* palette);
...
SKCMS_API bool skcms_PrimariesToXYZD50(
...
static inline void skcms_SetTransferFunction(
    skcms_ICCProfile* p, const skcms_TransferFunction* tf) {
  p->has_trc = true;
  for (int i = 0; i < 3; ++i) {
