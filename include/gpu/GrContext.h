...
class SK_API GrContext : public GrRecordingContext {
 public:
  ...
  bool colorTypeSupportedAsSurface(SkColorType colorType) const {
    if (kR8G8_unorm_SkColorType == colorType || kR16G16_unorm_SkColorType == colorType ||
        kA16_unorm_SkColorType == colorType || kA16_float_SkColorType == colorType ||
        kR16G16_float_SkColorType == colorType || kR16G16B16A16_unorm_SkColorType == colorType ||
   ...
   */
  void flush() { this->flush(GrFlushInfo(), GrPrepareForExternalIORequests()); }
  ...
  GrSemaphoresSubmitted flush(
      GrFlushFlags flags, int numSemaphores, GrBackendSemaphore signalSemaphores[],
  ...
  GrBackendTexture createBackendTexture(
      ...
      GrRenderable, GrProtected = GrProtected::kNo);
  ...
  GrBackendTexture createBackendTexture(
      const SkSurfaceCharacterization& characterization, const SkColor4f& color);
