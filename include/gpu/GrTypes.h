...
#define GR_MAKE_BITFIELD_OPS(X)                                                          \
    ...
    inline X operator&(X a, X b) noexcept { return (X)(+a & +b); }                       \
    inline X& operator&=(X& a, X b) noexcept { return (a = a & b); }                     \
    template <typename T> inline X operator&(T a, X b) noexcept { return (X)(+a & +b); } \
    template <typename T> inline X operator&(X a, T b) noexcept { return (X)(+a & +b); }
...
#define GR_DECL_BITFIELD_OPS_FRIENDS(X)                          \
    ...
    friend X& operator&=(X& a, X b) noexcept;                    \
                                                                 \
    template <typename T> friend X operator&(T a, X b) noexcept; \
                                                                 \
    template <typename T> friend X operator&(X a, T b) noexcept;
