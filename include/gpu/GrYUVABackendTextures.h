...
class SK_API GrYUVABackendTextureInfo {
 public:
  ...
  GrYUVABackendTextureInfo(
      const SkYUVAInfo&, const GrBackendFormat[kMaxPlanes], GrMipmapped, GrSurfaceOrigin);
...
class SK_API GrYUVABackendTextures {
 public:
  ...
  GrYUVABackendTextures(
      const SkYUVAInfo&, const GrBackendTexture[SkYUVAInfo::kMaxPlanes],
      GrSurfaceOrigin textureOrigin);

  const std::array<GrBackendTexture, SkYUVAInfo::kMaxPlanes>& textures() const { return fTextures; }
