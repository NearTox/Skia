...
class SK_API SkAnimatedImage : public SkDrawable {
 public:
   ...
   */
  static sk_sp<SkAnimatedImage> Make(
      std::unique_ptr<SkAndroidCodec>, const SkImageInfo& info, SkIRect cropRect,
   ...
   */
  static sk_sp<SkAnimatedImage> Make(
      std::unique_ptr<SkAndroidCodec>, SkISize scaledSize, SkIRect cropRect,
      sk_sp<SkPicture> postProcess);
 ...
 private:
  ...
  SkAnimatedImage(
      std::unique_ptr<SkAndroidCodec>, SkISize scaledSize, SkImageInfo decodeInfo, SkIRect cropRect,
      sk_sp<SkPicture> postProcess);
