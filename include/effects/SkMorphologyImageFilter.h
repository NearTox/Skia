...
class SK_API SkDilateImageFilter : public SkMorphologyImageFilter {
 public:
  static sk_sp<SkImageFilter> Make(
      int radiusX, int radiusY, sk_sp<SkImageFilter> input, const CropRect* cropRect = nullptr);
...
class SK_API SkErodeImageFilter : public SkMorphologyImageFilter {
 ...
 private:
  ...
  SkErodeImageFilter(int radiusX, int radiusY, sk_sp<SkImageFilter> input, const CropRect* cropRect)
      : INHERITED(radiusX, radiusY, input, cropRect) {}
