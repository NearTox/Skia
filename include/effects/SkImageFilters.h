...
class SK_API SkImageFilters {
 public:
  ...
  static sk_sp<SkImageFilter> ColorFilter(
      sk_sp<SkColorFilter> cf, sk_sp<SkImageFilter> input, const SkIRect* cropRect = nullptr);
  ...
  static sk_sp<SkImageFilter> Merge(
      sk_sp<SkImageFilter>* const filters, int count, const SkIRect* cropRect = nullptr);
  /**
   ...
   */
  static sk_sp<SkImageFilter> Merge(
      sk_sp<SkImageFilter> first, sk_sp<SkImageFilter> second, const SkIRect* cropRect = nullptr) {
  ...
  static sk_sp<SkImageFilter> Offset(
      SkScalar dx, SkScalar dy, sk_sp<SkImageFilter> input, const SkIRect* cropRect = nullptr);
  ...
  static sk_sp<SkImageFilter> Xfermode(
      SkBlendMode, sk_sp<SkImageFilter> background, sk_sp<SkImageFilter> foreground = nullptr,
      const SkIRect* cropRect = nullptr);
  ...
  static sk_sp<SkImageFilter> DistantLitSpecular(
      ...
      SkScalar shininess, sk_sp<SkImageFilter> input, const SkIRect* cropRect = nullptr);
  /**
