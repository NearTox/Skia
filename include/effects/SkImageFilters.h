...
namespace skif {
static constexpr SkRect kNoCropRect = {
 ...
 public:
  ...
  struct CropRect {
    ...
    CropRect(const SkIRect* optionalCrop)
        : fCropRect(optionalCrop ? SkRect::Make(*optionalCrop) : skif::kNoCropRect) {}
    CropRect(const SkRect* optionalCrop)
        : fCropRect(optionalCrop ? *optionalCrop : skif::kNoCropRect) {}
   ...
   */
  static sk_sp<SkImageFilter> AlphaThreshold(
   ...
   */
  static sk_sp<SkImageFilter> Arithmetic(
   ...
   */
  static sk_sp<SkImageFilter> Blend(
      SkBlendMode mode, sk_sp<SkImageFilter> background, sk_sp<SkImageFilter> foreground = nullptr,
      const CropRect& cropRect = {});
   ...
   */
  static sk_sp<SkImageFilter> Blend(
      sk_sp<SkBlender> blender, sk_sp<SkImageFilter> background,
   ...
   *  @param cropRect Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> Blur(
   ...
   *  @param cropRect Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> ColorFilter(
   ...
   */
  static sk_sp<SkImageFilter> DisplacementMap(
   ...
   *  @param cropRect Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> DropShadowOnly(
      SkScalar dx, SkScalar dy, SkScalar sigmaX, SkScalar sigmaY, SkColor color,
      sk_sp<SkImageFilter> input, const CropRect& cropRect = {});
   ...
   */
  static sk_sp<SkImageFilter> Image(
   ...
   *  @param cropRect Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> Magnifier(
   ...
   */
  static sk_sp<SkImageFilter> MatrixTransform(
      const SkMatrix& matrix, const SkSamplingOptions& sampling, sk_sp<SkImageFilter> input);
   ...
   */
  static sk_sp<SkImageFilter> Merge(
   ...
   */
  static sk_sp<SkImageFilter> Merge(
      sk_sp<SkImageFilter> first, sk_sp<SkImageFilter> second, const CropRect& cropRect = {}) {
   ...
   */
  static sk_sp<SkImageFilter> Offset(
   ...
   */
  static sk_sp<SkImageFilter> RuntimeShader(
   ...
   */
  static sk_sp<SkImageFilter> RuntimeShader(
      const SkRuntimeShaderBuilder& builder, const char* childShaderNames[],
      const sk_sp<SkImageFilter> inputs[], int inputCount);
  ...
  static sk_sp<SkImageFilter> Shader(
      sk_sp<SkShader> shader, Dither dither, const CropRect& cropRect = {});
   ...
   */
  static sk_sp<SkImageFilter> Tile(
   ...
   *  @param cropRect     Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> DistantLitDiffuse(
   ...
   *  @param cropRect     Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> PointLitDiffuse(
   ...
   *  @param cropRect        Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> SpotLitDiffuse(
   ...
   *  @param cropRect     Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> DistantLitSpecular(
   ...
   *  @param cropRect     Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> PointLitSpecular(
   ...
   *  @param cropRect        Optional rectangle that crops the input and output.
   */
  static sk_sp<SkImageFilter> SpotLitSpecular(
      const SkPoint3& location, const SkPoint3& target, SkScalar falloffExponent,
