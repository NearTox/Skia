...
static inline bool SkAlphaTypeIsValid(unsigned value) noexcept {
...
static inline bool SkColorTypeIsValid(unsigned value) noexcept {
...
static inline int SkColorTypeMaxBitsPerChannel(SkColorType ct) noexcept {
  switch (ct) {
    case kUnknown_SkColorType: return 0;

    case kARGB_4444_SkColorType: return 4;

    case kRGB_565_SkColorType: return 6;
    ...
    case kRGBA_F32_SkColorType: return 32;
  }
  SkUNREACHABLE;
}
