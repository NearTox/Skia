...
static constexpr inline uint32_t SkColorTypeComponentFlags(SkColorType ct) noexcept {
    switch (ct) {
...
static constexpr inline bool SkColorTypeIsGray(SkColorType ct) noexcept {
...
static inline size_t SkColorTypeComputeOffset(SkColorType ct, int x, int y,
 ...
 */
static inline bool SkImageInfoValidConversion(const SkImageInfo& dst,
                                              const SkImageInfo& src) noexcept {
