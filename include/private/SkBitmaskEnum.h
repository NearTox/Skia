...
template <typename E>
typename std::enable_if<skstd::is_bitmask_enum<E>::value, bool>::type constexpr Any(E e) noexcept {
  return static_cast<typename std::underlying_type<E>::type>(e) != 0;
}
}  // namespace skstd

template <typename E>
typename std::enable_if<skstd::is_bitmask_enum<E>::value, E>::type constexpr operator|(
    E l, E r) noexcept {
