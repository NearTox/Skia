...
class optional {
 public:
  optional(const T& value) : fHasValue(true) { new (&fPayload.fValue) T(value); }

  optional(T&& value) : fHasValue(true) { new (&fPayload.fValue) T(std::move(value)); }
  ...
  optional(optional& other) { *this = other; }
  ...
  bool has_value() const { return fHasValue; }
...
template <typename U>
bool operator==(nullopt_t, const optional<U>& b) {
  return !b.has_value();
}
...
template <typename U>
bool operator<=(nullopt_t, const optional<U>&) {
  return true;
}
...
template <typename T, typename U>
bool operator==(const T& a, const optional<U>& b) {
