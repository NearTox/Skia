...
static constexpr inline uint32_t SkSwizzle_RB(uint32_t c) {
 ...
 */
static inline SkPMColor SkFourByteInterp256(SkPMColor src, SkPMColor dst, unsigned scale) noexcept {
...
static inline SkColor SkPixel16ToColor(U16CPU src) noexcept {
