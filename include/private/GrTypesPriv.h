...
static constexpr bool GrProcessorEdgeTypeIsAA(const GrClipEdgeType edgeType) noexcept {
...
static constexpr GrColorTypeDesc GrGetColorTypeDesc(GrColorType ct) noexcept {
  switch (ct) {
    ...
    case GrColorType::kARGB_4444: return GrColorTypeDesc::MakeRGBA(4, GrColorTypeEncoding::kUnorm);
    case GrColorType::kBGRA_4444: return GrColorTypeDesc::MakeRGBA(4, GrColorTypeEncoding::kUnorm);
  }
  SkUNREACHABLE;
}
