...
static inline bool GrAATypeIsHW(GrAAType type) noexcept {
  switch (type) {
    ...
    case GrAAType::kMixedSamples: return true;
  }
...
static inline GrSRGBEncoded GrPixelConfigIsSRGBEncoded(GrPixelConfig config) noexcept {
  switch (config) {
    ...
    case kRGB_ETC1_GrPixelConfig: return GrSRGBEncoded::kNo;
  }
...
static inline size_t GrBytesPerPixel(GrPixelConfig config) noexcept {
  switch (config) {
    ...
    case kRG_float_GrPixelConfig: return 8;
    case kUnknown_GrPixelConfig:
...
static inline bool GrPixelConfigIsCompressed(GrPixelConfig config) noexcept {
  switch (config) {
    ...
    case kAlpha_half_as_Red_GrPixelConfig:
    case kRGBA_half_GrPixelConfig:
    case kRGBA_half_Clamped_GrPixelConfig: return false;
  }
  SK_ABORT("Invalid pixel config");
  return false;
}
...
static inline GrPixelConfig GrMakePixelConfigUncompressed(GrPixelConfig config) noexcept {
  switch (config) {
    ...
    case kAlpha_half_as_Red_GrPixelConfig:
    case kRGBA_half_GrPixelConfig:
    case kRGBA_half_Clamped_GrPixelConfig: return config;
  }
  SK_ABORT("Invalid pixel config");
  return config;
}
...
static inline GrSLPrecision GrSLSamplerPrecision(GrPixelConfig config) noexcept {
  switch (config) {
    ...
    case kRGBA_float_GrPixelConfig:
    case kRG_float_GrPixelConfig: return kHigh_GrSLPrecision;
    case kAlpha_half_GrPixelConfig:
    case kAlpha_half_as_Red_GrPixelConfig:
    case kRGBA_half_GrPixelConfig:
    case kRGBA_half_Clamped_GrPixelConfig:
    case kRGBA_1010102_GrPixelConfig: return kMedium_GrSLPrecision;
  }
  SK_ABORT("Unexpected type");
...
static inline GrColorType GrPixelConfigToColorTypeAndEncoding(
  ...
  switch (config) {
    ...
    case kAlpha_8_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kAlpha_8;
    case kGray_8_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kGray_8;
    case kRGB_565_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kRGB_565;
    case kRGBA_4444_GrPixelConfig:
    ...
    case kRGB_888_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kRGB_888x;
    case kRGB_888X_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kRGB_888x;
    case kRG_88_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kRG_88;
    case kBGRA_8888_GrPixelConfig:
      *srgbEncoded = GrSRGBEncoded::kNo;
    ...
    case kRG_float_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kRG_F32;
    case kAlpha_half_GrPixelConfig:
      *srgbEncoded = GrSRGBEncoded::kNo;
      return GrColorType::kAlpha_F16;
    case kRGBA_half_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kRGBA_F16;
    case kRGBA_half_Clamped_GrPixelConfig:
      *srgbEncoded = GrSRGBEncoded::kNo;
      return GrColorType::kRGBA_F16_Clamped;
    case kRGB_ETC1_GrPixelConfig: *srgbEncoded = GrSRGBEncoded::kNo; return GrColorType::kRGB_ETC1;
    case kAlpha_8_as_Alpha_GrPixelConfig:
      *srgbEncoded = GrSRGBEncoded::kNo;
...
static inline GrPixelConfig GrColorTypeToPixelConfig(
  ...
  switch (config) {
    ...
    case GrColorType::kAlpha_8:
      return (GrSRGBEncoded::kYes == srgbEncoded) ? kUnknown_GrPixelConfig : kAlpha_8_GrPixelConfig;

    case GrColorType::kGray_8:
      return (GrSRGBEncoded::kYes == srgbEncoded) ? kUnknown_GrPixelConfig : kGray_8_GrPixelConfig;

    case GrColorType::kRGB_565:
      return (GrSRGBEncoded::kYes == srgbEncoded) ? kUnknown_GrPixelConfig : kRGB_565_GrPixelConfig;
    ...
    case GrColorType::kRGB_888x:
      return (GrSRGBEncoded::kYes == srgbEncoded) ? kUnknown_GrPixelConfig : kRGB_888_GrPixelConfig;
    case GrColorType::kRG_88:
      return (GrSRGBEncoded::kYes == srgbEncoded) ? kUnknown_GrPixelConfig : kRG_88_GrPixelConfig;
