 ...
 */
enum GrClipType { kRect_ClipType, kPath_ClipType };
...
inline GrFillRule GrFillRuleForSkPath(const SkPath& path) {
  switch (path.getFillType()) {
    ...
    case SkPath::kInverseEvenOdd_FillType: return GrFillRule::kEvenOdd;
  }
  SkUNREACHABLE;
}
...
static constexpr bool GrAATypeIsHW(GrAAType type) {
  switch (type) {
    ...
    case GrAAType::kMSAA: return true;
  }
  SkUNREACHABLE;
}
...
static constexpr int kGrSLPrecisionCount = kLast_GrSLPrecision + 1;
...
static constexpr bool GrSLTypeIsFloatType(GrSLType type) {
  switch (type) {
    ...
    case kHalf4x4_GrSLType: return true;
    ...
    case kInt4_GrSLType:
    case kUint_GrSLType:
    case kUint2_GrSLType: return false;
  }
  SkUNREACHABLE;
}
...
static inline GrSLType GrSLCombinedSamplerTypeForTextureType(GrTextureType type) {
  switch (type) {
    ...
    case GrTextureType::kExternal: return kTextureExternalSampler_GrSLType;
    default: SK_ABORT("Unexpected texture type"); return kTexture2DSampler_GrSLType;
  }
}
...
static inline bool GrTextureTypeHasRestrictedSampling(GrTextureType type) {
  switch (type) {
    ...
    case GrTextureType::kExternal: return true;
    default: SK_ABORT("Unexpected texture type"); return false;
  }
}
...
static constexpr bool GrSLTypeIsCombinedSamplerType(GrSLType type) {
  switch (type) {
    case kTexture2DSampler_GrSLType:
    case kTextureExternalSampler_GrSLType:
    case kTexture2DRectSampler_GrSLType: return true;
    ...
    case kUShort2_GrSLType:
    case kUShort3_GrSLType:
    case kUShort4_GrSLType: return false;
  }
  SkUNREACHABLE;
}
...
#  define GrCapsDebugf(caps, ...) \
    if (!(caps)->suppressPrints()) SkDebugf(__VA_ARGS__)
#else
#  define GrCapsDebugf(caps, ...) \
    do {                          \
    } while (0)
...
static constexpr size_t GrBytesPerPixel(GrPixelConfig config) {
  switch (config) {
    ...
    case kRGBA_half_GrPixelConfig:
    case kRGBA_half_Clamped_GrPixelConfig: return 8;
    case kRGBA_float_GrPixelConfig: return 16;
    case kUnknown_GrPixelConfig:
    case kRGB_ETC1_GrPixelConfig: return 0;
...
static constexpr bool GrPixelConfigIsAlphaOnly(GrPixelConfig config) {
  switch (config) {
    ...
    case kAlpha_half_GrPixelConfig:
    case kAlpha_half_as_Lum_GrPixelConfig:
    case kAlpha_half_as_Red_GrPixelConfig: return true;
    case kUnknown_GrPixelConfig:
    case kGray_8_GrPixelConfig:
    case kGray_8_as_Lum_GrPixelConfig:
    case kGray_8_as_Red_GrPixelConfig:
...
static inline size_t GrCompressedFormatDataSize(GrPixelConfig config, int width, int height) {
  ...
  switch (config) {
    ...
    default: SK_ABORT("Unknown compressed pixel config"); return 4 * width * height;
  }
...
static constexpr GrSLPrecision GrSLSamplerPrecision(GrPixelConfig config) {
  switch (config) {
    ...
    case kBGRA_8888_GrPixelConfig:
    case kSRGBA_8888_GrPixelConfig:
    case kRGB_ETC1_GrPixelConfig: return kLow_GrSLPrecision;
    case kRGBA_float_GrPixelConfig: return kHigh_GrSLPrecision;
    case kAlpha_half_GrPixelConfig:
    case kAlpha_half_as_Lum_GrPixelConfig:
    case kAlpha_half_as_Red_GrPixelConfig:
    case kRGBA_half_GrPixelConfig:
    ...
    // Experimental (for Y416 and mutant P016/P010)
    case kRGBA_16161616_GrPixelConfig:
    case kRG_half_GrPixelConfig: return kMedium_GrSLPrecision;
  }
  SkUNREACHABLE;
}
...
static constexpr GrColorTypeDesc GrGetColorTypeDesc(GrColorType ct) {
  switch (ct) {
    ...
    case GrColorType::kABGR_4444: return GrColorTypeDesc::MakeRGBA(4, GrColorTypeEncoding::kUnorm);
    case GrColorType::kRGBA_8888: return GrColorTypeDesc::MakeRGBA(8, GrColorTypeEncoding::kUnorm);
    case GrColorType::kRGBA_8888_SRGB:
      return GrColorTypeDesc::MakeRGBA(8, GrColorTypeEncoding::kSRGBUnorm);
    case GrColorType::kRGB_888x: return GrColorTypeDesc::MakeRGB(8, GrColorTypeEncoding::kUnorm);
    case GrColorType::kRG_88: return GrColorTypeDesc::MakeRG(8, GrColorTypeEncoding::kUnorm);
    ...
    case GrColorType::kRGBA_F16: return GrColorTypeDesc::MakeRGBA(16, GrColorTypeEncoding::kFloat);
    case GrColorType::kRGBA_F16_Clamped:
      return GrColorTypeDesc::MakeRGBA(16, GrColorTypeEncoding::kFloat);
    case GrColorType::kRGBA_F32: return GrColorTypeDesc::MakeRGBA(32, GrColorTypeEncoding::kFloat);
    case GrColorType::kR_16: return GrColorTypeDesc::MakeR(16, GrColorTypeEncoding::kUnorm);
    case GrColorType::kRG_1616: return GrColorTypeDesc::MakeRG(16, GrColorTypeEncoding::kUnorm);
    case GrColorType::kRGBA_16161616:
      return GrColorTypeDesc::MakeRGBA(16, GrColorTypeEncoding::kUnorm);
    case GrColorType::kRG_F16: return GrColorTypeDesc::MakeRG(16, GrColorTypeEncoding::kFloat);
  }
  SkUNREACHABLE;
}
...
static constexpr GrColorType GrCompressionTypeClosestColorType(SkImage::CompressionType type) {
  switch (type) {
...
static constexpr GrColorType GrPixelConfigToColorType(GrPixelConfig config) {
  switch (config) {
    ...
    case kAlpha_8_GrPixelConfig: return GrColorType::kAlpha_8;
    case kGray_8_GrPixelConfig: return GrColorType::kGray_8;
    case kRGB_565_GrPixelConfig: return GrColorType::kBGR_565;
    case kRGBA_4444_GrPixelConfig: return GrColorType::kABGR_4444;
    case kRGBA_8888_GrPixelConfig: return GrColorType::kRGBA_8888;
    case kRGB_888_GrPixelConfig: return GrColorType::kRGB_888x;
    case kRGB_888X_GrPixelConfig: return GrColorType::kRGB_888x;
    case kRG_88_GrPixelConfig: return GrColorType::kRG_88;
    case kBGRA_8888_GrPixelConfig: return GrColorType::kBGRA_8888;
    case kSRGBA_8888_GrPixelConfig: return GrColorType::kRGBA_8888_SRGB;
    case kRGBA_1010102_GrPixelConfig: return GrColorType::kRGBA_1010102;
    case kRGBA_float_GrPixelConfig: return GrColorType::kRGBA_F32;
    case kAlpha_half_GrPixelConfig: return GrColorType::kAlpha_F16;
    case kRGBA_half_GrPixelConfig: return GrColorType::kRGBA_F16;
    case kRGBA_half_Clamped_GrPixelConfig: return GrColorType::kRGBA_F16_Clamped;
    case kRGB_ETC1_GrPixelConfig:
      return GrCompressionTypeClosestColorType(SkImage::kETC1_CompressionType);
    case kAlpha_8_as_Alpha_GrPixelConfig: return GrColorType::kAlpha_8;
    case kAlpha_8_as_Red_GrPixelConfig: return GrColorType::kAlpha_8;
    case kAlpha_half_as_Lum_GrPixelConfig:  // fall through
    case kAlpha_half_as_Red_GrPixelConfig: return GrColorType::kAlpha_F16;
    case kGray_8_as_Lum_GrPixelConfig: return GrColorType::kGray_8;
    case kGray_8_as_Red_GrPixelConfig: return GrColorType::kGray_8;
    case kR_16_GrPixelConfig: return GrColorType::kR_16;
    case kRG_1616_GrPixelConfig: return GrColorType::kRG_1616;

    // Experimental (for Y416 and mutant P016/P010)
    case kRGBA_16161616_GrPixelConfig: return GrColorType::kRGBA_16161616;
    case kRG_half_GrPixelConfig: return GrColorType::kRG_F16;
  }
  SkUNREACHABLE;
}
