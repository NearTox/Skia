...
struct SkEncodedInfo {
 public:
  ...
  static SkEncodedInfo Make(
      int width, int height, Color color, Alpha alpha, int bitsPerComponent) noexcept {
  ...
  static SkEncodedInfo Make(
    ...
    switch (color) {
      case kGray_Color: SkASSERT(kOpaque_Alpha == alpha); break;
      case kGrayAlpha_Color: SkASSERT(kOpaque_Alpha != alpha); break;
      case kPalette_Color: SkASSERT(16 != bitsPerComponent); break;
      case kRGB_Color:
      case kBGR_Color:
      case kBGRX_Color:
      ...
      case kYCCK_Color:
        ...
        break;
      case kRGBA_Color: SkASSERT(bitsPerComponent >= 8); break;
      case kBGRA_Color:
      case kYUVA_Color: SkASSERT(8 == bitsPerComponent); break;
      case kXAlpha_Color:
  ...
  uint8_t bitsPerPixel() const noexcept {
    switch (fColor) {
      ...
      case kXAlpha_Color:
      case kGrayAlpha_Color: return 2 * fBitsPerComponent;
      case kPalette_Color: return fBitsPerComponent;
      case kRGB_Color:
      case kBGR_Color:
      case kYUV_Color:
      case k565_Color: return 3 * fBitsPerComponent;
      case kRGBA_Color:
      case kBGRA_Color:
      case kBGRX_Color:
      case kYUVA_Color:
      case kInvertedCMYK_Color:
      case kYCCK_Color: return 4 * fBitsPerComponent;
