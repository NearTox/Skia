...
static inline GrQuadAAFlags SkToGrQuadAAFlags(unsigned flags) noexcept {
...
static constexpr GrColorFormatDesc GrGetColorTypeDesc(GrColorType ct) noexcept {
  switch (ct) {
    ...
    case GrColorType::kR_8xxx: return GrColorFormatDesc::MakeR(8, GrColorTypeEncoding::kUnorm);
...
static constexpr const char* GrSurfaceOriginToStr(GrSurfaceOrigin origin) noexcept {
  switch (origin) {
