...
class SK_API SkImage : public SkRefCnt {
  ...
  */
  static sk_sp<SkImage> MakeFromAdoptedTexture(
      ...
      GrSurfaceOrigin imageOrigin, SkColorType colorType,
  ...
  */
  ...
  sk_sp<SkShader> makeShader(
      SkTileMode tmx, SkTileMode tmy, const SkFilterOptions&,
   ...
   */
  sk_sp<SkShader> makeShader(
      SkTileMode tmx, SkTileMode tmy, CubicResampler, const SkMatrix* localMatrix = nullptr) const;
