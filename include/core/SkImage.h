...
public:
    ...
    */
    ...
    /** Creates a GPU-backed SkImage from compressed data.
        ...
        @return         created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromCompressed(GrContext* context, sk_sp<SkData> data, int width,
    ...
    */
    ...
    /** Creates SkImage from pixmap array representing YUVA data.
        ...
        @return                       created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromYUVAPixmaps(GrContext* context, SkYUVColorSpace yuvColorSpace,
    ...
    */
    bool readPixels(const SkImageInfo& dstInfo, void* dstPixels, size_t dstRowBytes, int srcX,
                    int srcY, CachingHint cachingHint = kAllow_CachingHint) const;
    ...
    */
    sk_sp<SkImage> makeWithFilter(GrContext* context, const SkImageFilter* filter,
