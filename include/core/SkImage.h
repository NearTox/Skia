...
class SK_API SkImage : public SkRefCnt {
  ...
  */
  static sk_sp<SkImage> MakeFromTexture(
      GrRecordingContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin origin,
  ...
  */
  static sk_sp<SkImage> MakeCrossContextFromPixmap(
      GrDirectContext* context, const SkPixmap& pixmap, bool buildMips,
  ...
  */
  static sk_sp<SkImage> MakeFromAdoptedTexture(
      ...
      SkAlphaType alphaType = kPremul_SkAlphaType, sk_sp<SkColorSpace> colorSpace = nullptr);
  ...
  */
  static sk_sp<SkImage> MakeFromYUVATexturesCopyToExternal(
      ...
      sk_sp<SkColorSpace> imageColorSpace = nullptr, TextureReleaseProc yuvaReleaseProc = nullptr,
      ReleaseContext yuvaReleaseContext = nullptr, TextureReleaseProc rgbaReleaseProc = nullptr,
  ...
  */
  static sk_sp<SkImage> MakeFromYUVATextures(
      ...
      GrSurfaceOrigin textureOrigin, sk_sp<SkColorSpace> imageColorSpace = nullptr,
      TextureReleaseProc textureReleaseProc = nullptr, ReleaseContext releaseContext = nullptr);
  ...
  */
  ...
  static sk_sp<SkImage> MakeFromYUVTexturesCopyWithExternalBackend(
      GrRecordingContext* context, SkYUVColorSpace yuvColorSpace,
      const GrBackendTexture yuvTextures[3], GrSurfaceOrigin textureOrigin,
  ...
  */
  static sk_sp<SkImage> MakeFromNV12TexturesCopyWithExternalBackend(
      GrRecordingContext* context, SkYUVColorSpace yuvColorSpace,
      const GrBackendTexture nv12Textures[2], GrSurfaceOrigin textureOrigin,
      const GrBackendTexture& backendTexture, sk_sp<SkColorSpace> imageColorSpace = nullptr,
      TextureReleaseProc textureReleaseProc = nullptr, ReleaseContext releaseContext = nullptr);
  ...
  */
  static sk_sp<SkImage> MakeFromAHardwareBufferWithData(
      GrDirectContext* context, const SkPixmap& pixmap, AHardwareBuffer* hardwareBuffer,
      GrSurfaceOrigin surfaceOrigin = kTopLeft_GrSurfaceOrigin);
#endif
  ...
  */
  ...
  sk_sp<SkShader> makeShader(
      SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions&,
  ...
  */
  sk_sp<SkImage> makeTextureImage(
      GrDirectContext*, GrMipmapped = GrMipmapped::kNo, SkBudgeted = SkBudgeted::kYes) const;
  ...
  */
  sk_sp<SkImage> makeWithFilter(
      GrRecordingContext* context, const SkImageFilter* filter, const SkIRect& subset,
  ...
  */
  static bool MakeBackendTextureFromSkImage(
      GrDirectContext* context, sk_sp<SkImage> image, GrBackendTexture* backendTexture,
  ...
  */
  sk_sp<SkImage> makeColorSpace(
      sk_sp<SkColorSpace> target, GrDirectContext* direct = nullptr) const;
