...
class SK_API SkImage : public SkRefCnt {
  ...
  */
  static sk_sp<SkImage> MakeRasterData(
  ...
  */
  static sk_sp<SkImage> MakeFromRaster(
      const SkPixmap& pixmap, RasterReleaseProc rasterReleaseProc, ReleaseContext releaseContext);
  ...
  */
  ...
  /** Creates SkImage from data returned by imageGenerator. Generated data is owned by SkImage and
      ...
      @return                created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeFromGenerator(
      std::unique_ptr<SkImageGenerator> imageGenerator, const SkIRect* subset = nullptr);
  ...
  */
   ...
   *  @return         created SkImage, or nullptr
   */
  static sk_sp<SkImage> DecodeToRaster(
      const void* encoded, size_t length, const SkIRect* subset = nullptr);
   ...
   *  @return         created SkImage, or nullptr
   */
  static sk_sp<SkImage> DecodeToTexture(
      GrContext* ctx, const void* encoded, size_t length, const SkIRect* subset = nullptr);
  static sk_sp<SkImage> DecodeToTexture(
      GrContext* ctx, const sk_sp<SkData>& data, const SkIRect* subset = nullptr) {
  ...
  /** Creates a GPU-backed SkImage from compressed data.
      ...
      @return            created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeTextureFromCompressed(
      GrContext* context, sk_sp<SkData> data, int width, int height, CompressionType type,
      GrMipMapped mipMapped = GrMipMapped::kNo, GrProtected isProtected = GrProtected::kNo);
  /** To be deprecated. Use MakeTextureFromCompressed.
   */
  static sk_sp<SkImage> MakeFromCompressed(
      GrContext* context, sk_sp<SkData> data, int width, int height, CompressionType type,
      GrMipMapped mipMapped = GrMipMapped::kNo, GrProtected isProtected = GrProtected::kNo) {
    return MakeTextureFromCompressed(context, data, width, height, type, mipMapped, isProtected);
  }
  ...
  /** Creates a CPU-backed SkImage from compressed data.
      ...
      @return         created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeRasterFromCompressed(
      sk_sp<SkData> data, int width, int height, CompressionType type);
  ...
  */
  static sk_sp<SkImage> MakeFromTexture(
      GrContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin origin,
      SkColorType colorType, SkAlphaType alphaType, sk_sp<SkColorSpace> colorSpace) {
    return MakeFromTexture(
        context, backendTexture, origin, colorType, alphaType, colorSpace, nullptr, nullptr);
  }
  ...
  */
  ...
  /** Creates an SkImage from a GPU backend texture. The backend texture must stay
      ...
      @return                    created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeFromCompressedTexture(
      GrContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin origin,
  ...
  /** Creates SkImage from pixmap. SkImage is uploaded to GPU back-end using context.
      ...
      @return                       created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeCrossContextFromPixmap(
      GrContext* context, const SkPixmap& pixmap, bool buildMips,
  ...
  /** Creates SkImage from backendTexture associated with context. backendTexture and
      ...
      @return                created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeFromAdoptedTexture(
      GrContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin surfaceOrigin,
      SkColorType colorType, SkAlphaType alphaType = kPremul_SkAlphaType,
  ...
  /** Creates an SkImage by flattening the specified YUVA planes into a single, interleaved RGBA
      ...
      @return                created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeFromYUVATexturesCopy(
      GrContext* context, SkYUVColorSpace yuvColorSpace, const GrBackendTexture yuvaTextures[],
  ...
  */
  ...
  /** Creates an SkImage by storing the specified YUVA planes into an image, to be rendered
      ...
      @return                   created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeFromYUVATextures(
      GrContext* context, SkYUVColorSpace yuvColorSpace, const GrBackendTexture yuvaTextures[],
      const SkYUVAIndex yuvaIndices[4], SkISize imageSize, GrSurfaceOrigin imageOrigin,
      sk_sp<SkColorSpace> imageColorSpace = nullptr,
      TextureReleaseProc textureReleaseProc = nullptr, ReleaseContext releaseContext = nullptr);
  ...
  */
  ...
  /** To be deprecated.
   */
  static sk_sp<SkImage> MakeFromYUVTexturesCopy(
      GrContext* context, SkYUVColorSpace yuvColorSpace, const GrBackendTexture yuvTextures[3],
      GrSurfaceOrigin imageOrigin, sk_sp<SkColorSpace> imageColorSpace = nullptr);
  ...
  /** Creates SkImage from copy of nv12Textures, an array of textures on GPU.
      ...
      @return                created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeFromNV12TexturesCopy(
      GrContext* context, SkYUVColorSpace yuvColorSpace, const GrBackendTexture nv12Textures[2],
      GrSurfaceOrigin imageOrigin, sk_sp<SkColorSpace> imageColorSpace = nullptr);
  ...
  */
  ...
  /** Creates SkImage from picture. Returned SkImage width and height are set by dimensions.
      ...
      @return            created SkImage, or nullptr
  */
  static sk_sp<SkImage> MakeFromPicture(
  ...
  */
  static sk_sp<SkImage> MakeFromAHardwareBuffer(
      AHardwareBuffer* hardwareBuffer, SkAlphaType alphaType = kPremul_SkAlphaType,
      sk_sp<SkColorSpace> colorSpace = nullptr,
  ...
  */
  ...
  sk_sp<SkShader> makeShader(
      SkTileMode tmx, SkTileMode tmy, const SkMatrix* localMatrix, SkFilterQuality) const;
  ...
  */
  GrBackendTexture getBackendTexture(
      bool flushPendingGrContextIO, GrSurfaceOrigin* origin = nullptr) const;
  ...
  */
  bool scalePixels(
      const SkPixmap& dst, SkFilterQuality filterQuality,
      CachingHint cachingHint = kAllow_CachingHint) const;
  ...
  */
  sk_sp<SkImage> makeWithFilter(
      GrContext* context, const SkImageFilter* filter, const SkIRect& subset,
      const SkIRect& clipBounds, SkIRect* outSubset, SkIPoint* offset) const;

  /** To be deprecated.
   */
  sk_sp<SkImage> makeWithFilter(
      const SkImageFilter* filter, const SkIRect& subset, const SkIRect& clipBounds,
  ...
  */
  static bool MakeBackendTextureFromSkImage(
      GrContext* context, sk_sp<SkImage> image, GrBackendTexture* backendTexture,
  ...
  */
  bool asLegacyBitmap(
      SkBitmap* bitmap, LegacyBitmapMode legacyBitmapMode = kRO_LegacyBitmapMode) const;
  ...
  */
  sk_sp<SkImage> makeColorTypeAndColorSpace(
      SkColorType targetColorType, sk_sp<SkColorSpace> targetColorSpace) const;
