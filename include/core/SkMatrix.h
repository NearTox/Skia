...
class SK_API SkMatrix {
  ...
  */
  ...
  /** Maps pts SkPoint array of length count in place. SkPoint are mapped by multiplying
      ...
      @param count  number of SkPoint to transform
  */
  void mapPoints(SkPoint pts[], int count) const { this->mapPoints(pts, pts, count); }
  ...
  */
  ...
  /** Maps vecs vector array of length count in place, multiplying each vector by
      ...
      @param count  number of vectors to transform
  */
  void mapVectors(SkVector vecs[], int count) const { this->mapVectors(vecs, vecs, count); }
  ...
  */
  bool mapRect(SkRect* rect) const { return this->mapRect(rect, *rect); }
  ...
  */
  ...
  using MapPtsProc =
      void (*)(const SkMatrix& mat, SkPoint dst[], const SkPoint src[], int count) noexcept;
  ...
  static constexpr MapXYProc gMapXYProcs[] = {
  ...
  static constexpr MapPtsProc gMapPtsProcs[] = {
