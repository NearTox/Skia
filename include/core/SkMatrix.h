...
class SK_API SkMatrix {
  ...
  */
  TypeMask getType() const noexcept {
    ...
    return (TypeMask)(fTypeMask & kPublicMask);
  }
  ...
  */
  ...
  static constexpr int kPublicMask =
      kTranslate_Mask | kScale_Mask | kAffine_Mask | kPerspective_Mask;
  ...
  constexpr SkMatrix(
      ...
      SkScalar p1, SkScalar p2, uint32_t typeMask)
  ...
  */
  bool isTriviallyIdentity() const noexcept {
    ...
    return ((fTypeMask & kPublicMask) == 0);
  }
  ...
  static MapXYProc GetMapXYProc(TypeMask mask) {
    // kAllMasks sounds dangerus since is 0x1F and gMapPtsProcs have 0x10 entries
    SkASSERT((mask & ~kPublicMask) == 0);
    return gMapXYProcs[mask & kPublicMask];
  }
  ...
  static MapPtsProc GetMapPtsProc(TypeMask mask) {
    // kAllMasks sounds dangerus since is 0x1F and gMapPtsProcs have 0x10 entries
    SkASSERT((mask & ~kPublicMask) == 0);
    return gMapPtsProcs[mask & kPublicMask];
  }
  ...
  static const MapXYProc gMapXYProcs[kPublicMask + 1];
  ...
  static const MapPtsProc gMapPtsProcs[kPublicMask + 1];
