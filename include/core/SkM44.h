...
class SK_API SkM44 {
 public:
  SkM44(const SkM44& src) noexcept = default;
  SkM44& operator=(const SkM44& src) noexcept = default;
  ...
  static SkM44 RowMajor(const SkScalar r[16]) noexcept {
    return SkM44(
        r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[12], r[13],
        r[14], r[15]);
  }
  static SkM44 ColMajor(const SkScalar c[16]) noexcept {
    return SkM44(
