...
static inline bool SkPathFillType_IsEvenOdd(SkPathFillType ft) noexcept {
  return (static_cast<int>(ft) & 1) != 0;
}

static inline bool SkPathFillType_IsInverse(SkPathFillType ft) noexcept {
  return (static_cast<int>(ft) & 2) != 0;
}

static inline SkPathFillType SkPathFillType_ConvertToNonInverse(SkPathFillType ft) noexcept {
