...
struct SkIPoint {
  ...
  /** Sets fX to x, fY to y.
      ...
      @return   SkIPoint (x, y)
  */
  static constexpr SkIPoint Make(int32_t x, int32_t y) noexcept { return {x, y}; }

  /** Returns x-axis value of SkIPoint.

      @return  fX
  */
  constexpr int32_t x() const noexcept { return fX; }

  /** Returns y-axis value of SkIPoint.

      @return  fY
  */
  constexpr int32_t y() const noexcept { return fY; }
...
struct SK_API SkPoint {
  ...
  /** Sets fX to x, fY to y. Used both to set SkPoint and vector.
      ...
      @return   SkPoint (x, y)
  */
  static constexpr SkPoint Make(SkScalar x, SkScalar y) noexcept { return {x, y}; }

  /** Returns x-axis value of SkPoint or vector.

      @return  fX
  */
  constexpr SkScalar x() const noexcept { return fX; }

  /** Returns y-axis value of SkPoint or vector.

      @return  fY
  */
  constexpr SkScalar y() const noexcept { return fY; }
  ...
  */
  void setAbs(const SkPoint& pt) noexcept {
  ...
  */
  static void Offset(SkPoint points[], int count, const SkVector& offset) noexcept {
  ...
  */
  static void Offset(SkPoint points[], int count, SkScalar dx, SkScalar dy) noexcept {
  ...
  */
  ...
  /** Returns the cross product of vector and vec.
      ...
      @return     area spanned by vectors signed by angle direction
  */
  SkScalar cross(const SkVector& vec) const noexcept { return CrossProduct(*this, vec); }
