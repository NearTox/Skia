...
struct SK_API SkIRect {
  ...
  */
  static constexpr SkIRect SK_WARN_UNUSED_RESULT MakePtSize(SkIPoint pt, SkISize size) noexcept {
  ...
  */
  static constexpr SkIRect SK_WARN_UNUSED_RESULT
  MakeXYWH(int32_t x, int32_t y, int32_t w, int32_t h) noexcept {
  ...
  /** Returns left edge of SkIRect, if sorted.
      ...
      @return  fLeft
  */
  constexpr int32_t left() const noexcept { return fLeft; }
  ...
  /** Returns top edge of SkIRect, if sorted. Call isEmpty() to see if SkIRect may be invalid,
      ...
      @return  fTop
  */
  constexpr int32_t top() const noexcept { return fTop; }
  ...
  /** Returns right edge of SkIRect, if sorted.
      ...
      @return  fRight
  */
  constexpr int32_t right() const noexcept { return fRight; }
  ...
  /** Returns bottom edge of SkIRect, if sorted. Call isEmpty() to see if SkIRect may be invalid,
      ...
      @return  fBottom
  */
  constexpr int32_t bottom() const noexcept { return fBottom; }
  ...
  /** Returns left edge of SkIRect, if sorted. Call isEmpty() to see if SkIRect may be invalid,
      ...
      @return  fLeft
  */
  constexpr int32_t x() const noexcept { return fLeft; }
  ...
  /** Returns top edge of SkIRect, if sorted. Call isEmpty() to see if SkIRect may be invalid,
      ...
      @return  fTop
  */
  constexpr int32_t y() const noexcept { return fTop; }

  // Experimental
  constexpr SkIPoint topLeft() const noexcept { return {fLeft, fTop}; }
  ...
  */
  constexpr int32_t width() const noexcept { return Sk32_can_overflow_sub(fRight, fLeft); }
  ...
  */
  constexpr int32_t height() const noexcept { return Sk32_can_overflow_sub(fBottom, fTop); }
  ...
  */
  constexpr SkISize size() const noexcept { return SkISize::Make(this->width(), this->height()); }
  ...
  */
  ...
  void setWH(int32_t width, int32_t height) noexcept {
    fLeft = 0;
    fTop = 0;
    fRight = width;
    fBottom = height;
  ...
  void setSize(SkISize size) noexcept {
    fLeft = 0;
    fTop = 0;
    fRight = size.width();
    fBottom = size.height();
  ...
  */
  constexpr SkIRect makeOffset(int32_t dx, int32_t dy) const noexcept {
    return {
  ...
  */
  constexpr SkIRect makeOffset(SkIVector offset) const noexcept {
  ...
  */
  ...
  /** Returns true if SkIRect contains r.
      ...
      @return   true if all sides of SkIRect are outside r
  */
  inline bool contains(const SkRect& r) const noexcept;
  ...
  */
   ...
   */
  void join(const SkIRect& r) noexcept;
  ...
  */
  SkIRect makeSorted() const noexcept {
    return MakeLTRB(
        std::min(fLeft, fRight), std::min(fTop, fBottom), std::max(fLeft, fRight),
...
struct SK_API SkRect {
  ...
  */
  ...
  /** Returns left edge of SkRect, if sorted. Call isSorted() to see if SkRect is valid.
      ...
      @return  fLeft
  */
  constexpr SkScalar x() const noexcept { return fLeft; }
  ...
  /** Returns top edge of SkRect, if sorted. Call isEmpty() to see if SkRect may be invalid,
      ...
      @return  fTop
  */
  constexpr SkScalar y() const noexcept { return fTop; }
  ...
  /** Returns left edge of SkRect, if sorted. Call isSorted() to see if SkRect is valid.
      ...
      @return  fLeft
  */
  constexpr SkScalar left() const noexcept { return fLeft; }
  ...
  /** Returns top edge of SkRect, if sorted. Call isEmpty() to see if SkRect may be invalid,
      ...
      @return  fTop
  */
  constexpr SkScalar top() const noexcept { return fTop; }
  ...
  /** Returns right edge of SkRect, if sorted. Call isSorted() to see if SkRect is valid.
      ...
      @return  fRight
  */
  constexpr SkScalar right() const noexcept { return fRight; }
  ...
  /** Returns bottom edge of SkRect, if sorted. Call isEmpty() to see if SkRect may be invalid,
      ...
      @return  fBottom
  */
  constexpr SkScalar bottom() const noexcept { return fBottom; }
  ...
  /** Returns span on the x-axis. This does not check if SkRect is sorted, or if
      ...
      @return  fRight minus fLeft
  */
  constexpr SkScalar width() const noexcept { return fRight - fLeft; }
  ...
  /** Returns span on the y-axis. This does not check if SkRect is sorted, or if
      ...
      @return  fBottom minus fTop
  */
  constexpr SkScalar height() const noexcept { return fBottom - fTop; }
  ...
  */
  constexpr SkScalar centerX() const noexcept {
  ...
  */
  constexpr SkScalar centerY() const noexcept {
   ...
   */
  constexpr SkPoint center() const noexcept { return {this->centerX(), this->centerY()}; }

  // Experimental
  constexpr SkPoint topLeft() const noexcept { return {fLeft, fTop}; }
  ...
  /** Returns spans on the x-axis and y-axis. This does not check if SkIRect is sorted,
      ...
      @return  SkISize (width, height)
  */
  constexpr SkSize size() const noexcept { return SkSize::Make(this->width(), this->height()); }
  ...
  */
  constexpr void set(const SkIRect& src) noexcept {
  ...
  /** Sets SkRect to (left, top, right, bottom).
      ...
      @param bottom  stored in fBottom
  */
  constexpr void setLTRB(SkScalar left, SkScalar top, SkScalar right, SkScalar bottom) noexcept {
    fLeft = left;
    fTop = top;
    fRight = right;
    fBottom = bottom;
  ...
  */
  ...
  void setIWH(int32_t width, int32_t height) noexcept {
  ...
  */
  constexpr SkRect makeOffset(SkScalar dx, SkScalar dy) const noexcept {
  ...
  /** Returns SkRect offset by v.
      ...
      @return    SkRect offset on axes, with original width and height
  */
  constexpr SkRect makeOffset(SkVector v) const noexcept { return this->makeOffset(v.x(), v.y()); }
  ...
  */
  void join(const SkRect& r) noexcept;
  ...
  */
  ...
  /** Sets SkIRect by rounding up fLeft and fTop; and discarding the fractional portion
      ...
      @return  rounded SkIRect
  */
  SkIRect roundIn() const noexcept {
    SkIRect ir;
    this->roundIn(&ir);
    return ir;
  }
