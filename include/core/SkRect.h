...
struct SK_API SkIRect {
    ...
    */
    static constexpr SkIRect SK_WARN_UNUSED_RESULT MakeEmpty() { return SkIRect{0, 0, 0, 0}; }
    ...
    */
    static constexpr SkIRect SK_WARN_UNUSED_RESULT MakeLTRB(int32_t l, int32_t t, int32_t r,
                                                            int32_t b) {
    ...
    */
    static constexpr SkIRect SK_WARN_UNUSED_RESULT MakeXYWH(int32_t x, int32_t y, int32_t w,
                                                            int32_t h) {
    ...
    */
    constexpr int64_t width64() const noexcept { return (int64_t)fRight - (int64_t)fLeft; }
    ...
    */
    constexpr int64_t height64() const noexcept { return (int64_t)fBottom - (int64_t)fTop; }
    ...
    */
    constexpr bool isEmpty64() const noexcept { return fRight <= fLeft || fBottom <= fTop; }
    ...
    */
    constexpr bool contains(const SkIRect& r) const noexcept {
    ...
    */
    constexpr bool SK_WARN_UNUSED_RESULT intersectNoEmptyCheck(const SkIRect& a,
                                                               const SkIRect& b) noexcept {
        SkASSERT(!a.isEmpty64() && !b.isEmpty64());
        SkIRect r = {SkMax32(a.fLeft, b.fLeft), SkMax32(a.fTop, b.fTop),
    ...
    /** Returns true if a intersects b, and sets SkIRect to intersection.
        ...
        @return   true if a and b have area in common
    */
    constexpr bool SK_WARN_UNUSED_RESULT intersect(const SkIRect& a, const SkIRect& b) noexcept {
    ...
    */
    ...
    /** Returns true if a intersects b.
        ...
        @return   true if a and b have area in common
    */
    static constexpr bool Intersects(const SkIRect& a, const SkIRect& b) noexcept {
        SkIRect dummy{};
    ...
    /** Returns true if a intersects b.
        ...
        @return   true if a and b have area in common
    */
    static constexpr bool IntersectsNoEmptyCheck(const SkIRect& a, const SkIRect& b) noexcept {
        SkIRect dummy{};
    ...
    */
    SkIRect makeSorted() const noexcept {
        return MakeLTRB(SkMin32(fLeft, fRight), SkMin32(fTop, fBottom), SkMax32(fLeft, fRight),
...
struct SK_API SkRect {
    ...
    */
    ...
    /** Returns constructed SkRect set to integer values (0, 0, w, h). Does not validate
        ...
        @return   bounds (0, 0, w, h)
    */
    static constexpr SkRect SK_WARN_UNUSED_RESULT MakeIWH(int w, int h) noexcept {
        SkRect r{};
    ...
    */
    ...
    /** Returns constructed SkIRect set to (0, 0, size.width(), size.height()).
        ...
        @return      bounds (0, 0, size.width(), size.height())
    */
    static constexpr SkRect Make(const SkISize& size) noexcept {
    ...
    */
    static constexpr SkRect SK_WARN_UNUSED_RESULT Make(const SkIRect& irect) noexcept {
        SkRect r{};
    ...
    */
    ...
    /** Sets SkRect to (left, top, right, bottom).
        ...
        @param bottom  stored in fBottom
    */
    constexpr void set(SkScalar left, SkScalar top, SkScalar right, SkScalar bottom) noexcept {
        fLeft = left;
        fTop = top;
        fRight = right;
        fBottom = bottom;
...
private:
    static constexpr bool Intersects(SkScalar al, SkScalar at, SkScalar ar, SkScalar ab,
                                     SkScalar bl, SkScalar bt, SkScalar br, SkScalar bb) noexcept {
...
public:
    ...
    */
    ...
    /** Returns true if a intersects b.
        ...
        @return   true if a and b have area in common
    */
    static constexpr bool Intersects(const SkRect& a, const SkRect& b) noexcept {
        return Intersects(a.fLeft, a.fTop, a.fRight, a.fBottom, b.fLeft, b.fTop, b.fRight,
                          b.fBottom);
    }
    ...
    */
    void round(SkIRect* dst) const noexcept {
        SkASSERT(dst);
        dst->set(SkScalarRoundToInt(fLeft), SkScalarRoundToInt(fTop), SkScalarRoundToInt(fRight),
    ...
    */
    void roundOut(SkIRect* dst) const noexcept {
        SkASSERT(dst);
        dst->set(SkScalarFloorToInt(fLeft), SkScalarFloorToInt(fTop), SkScalarCeilToInt(fRight),
    ...
    */
    void roundIn(SkIRect* dst) const noexcept {
        SkASSERT(dst);
        dst->set(SkScalarCeilToInt(fLeft), SkScalarCeilToInt(fTop), SkScalarFloorToInt(fRight),
