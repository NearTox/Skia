...
class SK_API SkSurface : public SkRefCnt {
  ...
  */
  ...
  void asyncRescaleAndReadPixelsYUV420(
      ...
      ReadPixelsCallback callback, ReadPixelsContext);
  ...
  /** Legacy version of asyncRescaleAndReadPixelsYUV420() that passes data directly to the
      ...
      Deprecated.
   */
  using LegacyReadPixelsCallbackYUV420 =
      void(ReadPixelsContext, const void* data[3], size_t rowBytes[3]);
  void asyncRescaleAndReadPixelsYUV420(
      SkYUVColorSpace yuvColorSpace, sk_sp<SkColorSpace> dstColorSpace, const SkIRect& srcRect,
      int dstW, int dstH, RescaleGamma rescaleGamma, SkFilterQuality rescaleQuality,
      LegacyReadPixelsCallbackYUV420 callback, ReadPixelsContext);
  ...
  */
  ...
  GrSemaphoresSubmitted flush(
      ...
      GrBackendSemaphore signalSemaphores[], GrGpuFinishedProc finishedProc = nullptr,
  ...
  /** Deprecated.
   */
  GrSemaphoresSubmitted flushAndSignalSemaphores(
