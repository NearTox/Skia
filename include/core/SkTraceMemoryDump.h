...
class SK_API SkTraceMemoryDump {
 public:
   ...
   */
  virtual void dumpNumericValue(
      const char* dumpName, const char* valueName, const char* units, uint64_t value) = 0;

  virtual void dumpStringValue(
      const char* /*dumpName*/, const char* /*valueName*/, const char* /*value*/) {}
   ...
   */
  virtual void setMemoryBacking(
      const char* dumpName, const char* backingType, const char* backingObjectId) = 0;
