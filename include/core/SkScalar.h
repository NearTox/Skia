...
static constexpr inline SkScalar SkScalarClampMax(SkScalar x, SkScalar max) {
  x = SkTMin(x, max);
  x = SkTMax<SkScalar>(x, 0);
  return x;
}

static constexpr inline SkScalar SkScalarPin(SkScalar x, SkScalar min, SkScalar max) {
...
static constexpr inline SkScalar SkScalarSignAsScalar(SkScalar x) {
...
*/
static constexpr inline SkScalar SkScalarInterp(SkScalar A, SkScalar B, SkScalar t) {
