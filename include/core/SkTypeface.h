...
class SK_API SkTypeface : public SkWeakRefCnt {
 public:
   ...
   *  cannot.
   */
  int getVariationDesignParameters(
  ...
  */
  ...
  std::unique_ptr<SkScalerContext> createScalerContext(
      const SkScalerContextEffects&, const SkDescriptor*, bool allowFailure = false) const;
 ...
 protected:
  ...
  virtual bool onGetKerningPairAdjustments(
      const SkGlyphID glyphs[], int count, int32_t adjustments[]) const;
