...
struct SkISize {
  ...
  constexpr static SkISize Make(int32_t w, int32_t h) { return {w, h}; }

  constexpr static SkISize MakeEmpty() { return {0, 0}; }
...
struct SkSize {
  ...
  constexpr static SkSize Make(SkScalar w, SkScalar h) { return {w, h}; }
  ...
  constexpr static SkSize MakeEmpty() { return {0, 0}; }
