...
SK_API bool SkColorTypeValidateAlphaType(SkColorType colorType, SkAlphaType alphaType,
                                         SkAlphaType* canonical = nullptr) noexcept;
...
public:
    ...
    */
    ...
    /** Creates SkImageInfo from integral dimensions width and height, kN32_SkColorType,
        ...
        @return      created SkImageInfo
    */
    static SkImageInfo MakeN32Premul(const SkISize& size) noexcept {
    ...
    */
    bool operator==(const SkImageInfo& other) const {
        return fDimensions == other.fDimensions && fColorType == other.fColorType &&
    ...
    */
    size_t computeMinByteSize() const noexcept {
...
private:
    ...
    SkImageInfo(int width, int height, SkColorType ct, SkAlphaType at,
                sk_sp<SkColorSpace> cs) noexcept
