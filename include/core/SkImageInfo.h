...
class SK_API SkColorInfo {
  ...
  */
  ...
  SkColorInfo(const SkColorInfo&) noexcept;
  SkColorInfo(SkColorInfo&&) noexcept;

  SkColorInfo& operator=(const SkColorInfo&) noexcept;
  SkColorInfo& operator=(SkColorInfo&&) noexcept;
...
struct SK_API SkImageInfo {
  ...
  */
  static SkImageInfo Make(int width, int height, SkColorType ct, SkAlphaType at) noexcept;
  static SkImageInfo Make(
      int width, int height, SkColorType ct, SkAlphaType at, sk_sp<SkColorSpace> cs) noexcept;
  static SkImageInfo Make(SkISize dimensions, SkColorType ct, SkAlphaType at) noexcept;
  static SkImageInfo Make(
  ...
  */
  ...
  /** Creates SkImageInfo from integral dimensions width and height, kN32_SkColorType,
      ...
      @return        created SkImageInfo
  */
  static SkImageInfo MakeN32(int width, int height, SkAlphaType at) noexcept;
  ...
  */
  ...
  /** Creates SkImageInfo from integral dimensions width and height, kN32_SkColorType,
      ...
      @return        created SkImageInfo
  */
  static SkImageInfo MakeN32Premul(int width, int height) noexcept;
  static SkImageInfo MakeN32Premul(int width, int height, sk_sp<SkColorSpace> cs) noexcept;
  ...
  /** Creates SkImageInfo from integral dimensions width and height, kN32_SkColorType,
      ...
      @return            created SkImageInfo
  */
  static SkImageInfo MakeN32Premul(SkISize dimensions) noexcept;
  static SkImageInfo MakeN32Premul(SkISize dimensions, sk_sp<SkColorSpace> cs) noexcept;
