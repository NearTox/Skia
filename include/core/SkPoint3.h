...
struct SK_API SkPoint3 {
    ...
    static constexpr SkPoint3 Make(SkScalar x, SkScalar y, SkScalar z) noexcept {
        SkPoint3 pt{};
        pt.set(x, y, z);
        return pt;
    }
    ...
    */
     ...
     */
    static constexpr SkScalar DotProduct(const SkPoint3& a, const SkPoint3& b) noexcept {
        return a.fX * b.fX + a.fY * b.fY + a.fZ * b.fZ;
    }
     ...
     */
    static constexpr SkPoint3 CrossProduct(const SkPoint3& a, const SkPoint3& b) noexcept {
        SkPoint3 result{};
