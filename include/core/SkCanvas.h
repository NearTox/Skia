...
public:
    ...
    struct SaveLayerRec {
        ...
        */
        SaveLayerRec(const SkRect* bounds, const SkPaint* paint,
                     SaveLayerFlags saveLayerFlags = 0) noexcept
    ...
    */
    bool quickReject(const SkRect& rect) const noexcept;
    ...
    */
    ...
    struct SK_API ImageSetEntry {
        ImageSetEntry(sk_sp<const SkImage> image, const SkRect& srcRect, const SkRect& dstRect,
                      int matrixIndex, float alpha, unsigned aaFlags, bool hasClip) noexcept;

        ImageSetEntry(sk_sp<const SkImage> image, const SkRect& srcRect, const SkRect& dstRect,
                      float alpha, unsigned aaFlags) noexcept;
