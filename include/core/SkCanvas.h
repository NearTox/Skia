...
class SK_API SkCanvas {
  ...
  */
  ...
  /** Allocates raster SkCanvas specified by inline image specification. Subsequent SkCanvas
      ...
      @return          SkCanvas if all parameters are valid; otherwise, nullptr
  */
  static std::unique_ptr<SkCanvas> MakeRasterDirectN32(
      int width, int height, SkPMColor* pixels, size_t rowBytes) {
  ...
  */
  struct SaveLayerRec {
   ...
   private:
    ...
    SaveLayerRec(
        const SkRect* bounds, const SkPaint* paint, const SkImageFilter* backdrop,
        SkScalar backdropScale, SaveLayerFlags saveLayerFlags) noexcept
        : fBounds(bounds),
          fPaint(paint),
          fBackdrop(backdrop),
  ...
  */
  ...
  /** Fills clip with color color using SkBlendMode::kSrc.
      ...
      @param color  unpremultiplied ARGB
  */
  void clear(SkColor color) { this->clear(SkColor4f::FromColor(color)); }
  ...
  /** Fills clip with color color using SkBlendMode::kSrc.
      ...
      @param color  SkColor4f representing unpremultiplied color.
  */
  void clear(const SkColor4f& color) { this->drawColor(color, SkBlendMode::kSrc); }
  ...
  */
  ...
  void drawImage(
      const sk_sp<SkImage>& image, SkScalar x, SkScalar y, const SkSamplingOptions& sampling,
  ...
  void drawImageRect(
      const SkImage*, const SkRect& dst, const SkSamplingOptions&, const SkPaint* = nullptr);
  void drawImageRect(
      const sk_sp<SkImage>& image, const SkRect& src, const SkRect& dst,
  ...
  void drawImageRect(
      const sk_sp<SkImage>& image, const SkRect& dst, const SkSamplingOptions& sampling,
      const SkPaint* paint = nullptr) {
  ...
  */
  void drawString(
      const char str[], SkScalar x, SkScalar y, const SkFont& font, const SkPaint& paint) {
  ...
  */
  void drawString(
      const SkString& str, SkScalar x, SkScalar y, const SkFont& font, const SkPaint& paint) {
 ...
 private:
  ...
  SkBaseDevice* baseDevice() const noexcept {
  ...
  struct Layer {
    ...
    Layer(
        sk_sp<SkBaseDevice> device, sk_sp<SkImageFilter> imageFilter,
  ...
  class MCRec {
   public:
    ...
    MCRec(SkBaseDevice* device) noexcept;
    MCRec(const MCRec* prev) noexcept;
    ~MCRec();
 ...
 private:
  SkCanvas(
      const SkBitmap&, std::unique_ptr<SkRasterHandleAllocator>, SkRasterHandleAllocator::Handle,
   ...
   */
  sk_sp<sktext::gpu::Slug> convertBlobToSlug(
  ...
  void internalDrawDeviceWithFilter(
      ...
      DeviceCompatibleWithFilter compat, SkScalar scaleFactor = 1.f);
