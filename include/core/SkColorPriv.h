...
#if (SK_A32_SHIFT == SK_RGBA_A32_SHIFT && SK_R32_SHIFT == SK_RGBA_R32_SHIFT && \
     SK_G32_SHIFT == SK_RGBA_G32_SHIFT && SK_B32_SHIFT == SK_RGBA_B32_SHIFT)
#define SK_PMCOLOR_IS_RGBA
#elif (SK_A32_SHIFT == SK_BGRA_A32_SHIFT && SK_R32_SHIFT == SK_BGRA_R32_SHIFT && \
...
static constexpr inline SkPMColor SkPremultiplyARGBInline(U8CPU a, U8CPU r, U8CPU g,
                                                          U8CPU b) noexcept {
    SkA32Assert(a);
    SkR32Assert(r);
    SkG32Assert(g);
