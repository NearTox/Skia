...
class SK_API SkYUVAInfo {
 public:
  ...
  static int PlaneDimensions(
      SkISize imageDimensions, PlanarConfig, SkEncodedOrigin, SkISize planeDimensions[kMaxPlanes]);
...
constexpr int SkYUVAInfo::NumChannelsInPlane(PlanarConfig config, int i) {
  switch (config) {
    ...
    case SkYUVAInfo::PlanarConfig::kY_U_V_410: return i >= 0 && i < 3 ? 1 : 0;
    case SkYUVAInfo::PlanarConfig::kY_U_V_A_4204:
    case SkYUVAInfo::PlanarConfig::kY_V_U_A_4204: return i >= 0 && i < 4 ? 1 : 0;
    ...
    case SkYUVAInfo::PlanarConfig::kUYV_444: return i == 0 ? 3 : 0;
    case SkYUVAInfo::PlanarConfig::kYUVA_4444:
    case SkYUVAInfo::PlanarConfig::kUYVA_4444: return i == 0 ? 4 : 0;
  }
  return 0;
}
