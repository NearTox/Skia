...
class SK_API SkPath {
 public:
  ...
  static SkPath Rect(
      const SkRect&, SkPathDirection = SkPathDirection::kCW, unsigned startIndex = 0);
  static SkPath Oval(const SkRect&, SkPathDirection = SkPathDirection::kCW);
  static SkPath Oval(const SkRect&, SkPathDirection, unsigned startIndex);
  static SkPath Circle(
      SkScalar center_x, SkScalar center_y, SkScalar radius,
      SkPathDirection dir = SkPathDirection::kCW);
  static SkPath RRect(const SkRRect&, SkPathDirection dir = SkPathDirection::kCW);
  static SkPath RRect(const SkRRect&, SkPathDirection, unsigned startIndex);
  static SkPath RRect(
      const SkRect& bounds, SkScalar rx, SkScalar ry, SkPathDirection dir = SkPathDirection::kCW);

  static SkPath Polygon(
      const SkPoint pts[], int count, bool isClosed, SkPathFillType = SkPathFillType::kWinding,
      bool isVolatile = false);

  static SkPath Polygon(
      const std::initializer_list<SkPoint>& list, bool isClosed,
      SkPathFillType fillType = SkPathFillType::kWinding, bool isVolatile = false) {
    return Polygon(list.begin(), SkToInt(list.size()), isClosed, fillType, isVolatile);
  }

  static SkPath Line(const SkPoint a, const SkPoint b) { return Polygon({a, b}, false); }
  ...
  */
  ...
  /** Specifies whether SkPath is volatile; whether it will be altered or discarded
      ...
      @return            reference to SkPath
  */
  SkPath& setIsVolatile(bool isVolatile) noexcept {
  ...
  */
  ...
  /** Adds beginning of contour at SkPoint p.
      ...
      @return   reference to SkPath
  */
  SkPath& moveTo(const SkPoint& p) { return this->moveTo(p.fX, p.fY); }
  ...
  */
  ...
  /** Adds line from last point to SkPoint p. If SkPath is empty, or last SkPath::Verb is
      ...
      @return   reference to SkPath
  */
  SkPath& lineTo(const SkPoint& p) { return this->lineTo(p.fX, p.fY); }
  ...
  */
  SkPath& rCubicTo(
      SkScalar dx1, SkScalar dy1, SkScalar dx2, SkScalar dy2, SkScalar dx3, SkScalar dy3);
  ...
  */
  SkPath& arcTo(
      SkScalar rx, SkScalar ry, SkScalar xAxisRotate, ArcSize largeArc, SkPathDirection sweep,
  ...
  */
  SkPath& arcTo(
      const SkPoint r, SkScalar xAxisRotate, ArcSize largeArc, SkPathDirection sweep,
      const SkPoint xy) {
  ...
  */
  SkPath& addCircle(
      SkScalar x, SkScalar y, SkScalar radius, SkPathDirection dir = SkPathDirection::kCW);
  ...
  */
  SkPath& addRoundRect(
      const SkRect& rect, SkScalar rx, SkScalar ry, SkPathDirection dir = SkPathDirection::kCW);
  ...
  */
  SkPath& addRoundRect(
      const SkRect& rect, const SkScalar radii[], SkPathDirection dir = SkPathDirection::kCW);
  ...
  */
  SkPath& addPath(
      const SkPath& src, SkScalar dx, SkScalar dy, AddPathMode mode = kAppend_AddPathMode);
  ...
  */
  SkPath& addPath(
      const SkPath& src, const SkMatrix& matrix, AddPathMode mode = kAppend_AddPathMode);
  ...
  */
  ...
  /** Offsets SkPoint array by (dx, dy). SkPath is replaced by offset data.
      ...
      @param dy  offset added to SkPoint array y-axis coordinates
  */
  void offset(SkScalar dx, SkScalar dy) { this->offset(dx, dy, this); }
  ...
  */
  void transform(
      const SkMatrix& matrix, SkPath* dst,
  ...
  */
  uint32_t getSegmentMasks() const noexcept;
  ...
  */
  ...
  void setConvexity(SkPathConvexity) const noexcept;

  void setFirstDirection(SkPathFirstDirection) const noexcept;
  SkPathFirstDirection getFirstDirection() const noexcept;
  ...
  */
  ...
  SkPathConvexity getConvexityOrUnknown() const noexcept;
   ...
   */
  void setConvexity(SkPathConvexity convexity) noexcept;
