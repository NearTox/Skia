...
public:
    ...
    */
    ...
    /** Sets FillType, the rule used to fill SkPath. While there is no check
        ...
        @param ft  one of: kWinding_FillType, kEvenOdd_FillType,  kInverseWinding_FillType,
                   kInverseEvenOdd_FillType
    */
    void setFillType(FillType ft) noexcept {
        fFillType = SkToU8(ft);
    }
    ...
    */
    void toggleInverseFillType() noexcept {
        fFillType ^= 2;
    }
    ...
    */
    Convexity getConvexityOrUnknown() const noexcept { return fConvexity.load(std::memory_order_relaxed); }
