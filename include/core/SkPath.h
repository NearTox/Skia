...
public:
    ...
    */
    ...
    SkPath(SkPath&& path) noexcept = default;
    ...
    */
    ...
    SkPath& operator=(SkPath&& path) noexcept = default;
    ...
    */
    static bool IsQuadDegenerate(const SkPoint& p1, const SkPoint& p2, const SkPoint& p3,
                                 bool exact) noexcept;
    ...
    */
    ...
    /** Adds cubic from last point towards vector (dx1, dy1), then towards
        ...
        @return    reference to SkPath
    */
    SkPath& rCubicTo(SkScalar dx1, SkScalar dy1, SkScalar dx2, SkScalar dy2, SkScalar dx3,
                     SkScalar dy3);
    ...
    */
    static constexpr FillType ConvertToNonInverseFillType(FillType fill) noexcept {
        static_assert(0 == kWinding_FillType, "fill_type_mismatch");
        static_assert(1 == kEvenOdd_FillType, "fill_type_mismatch");
        static_assert(2 == kInverseWinding_FillType, "fill_type_mismatch");
        static_assert(3 == kInverseEvenOdd_FillType, "fill_type_mismatch");
...
private:
    ...
    */
    ...
    bool isRectContour(bool allowPartial, int* currVerb, const SkPoint** pts, bool* isClosed,
