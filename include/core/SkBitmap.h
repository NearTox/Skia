...
class SK_API SkBitmap {
  ...
  */
  int bytesPerPixel() const noexcept { return fPixmap.info().bytesPerPixel(); }
  ...
  */
  int rowBytesAsPixels() const noexcept { return fPixmap.rowBytesAsPixels(); }
  ...
  */
  int shiftPerPixel() const noexcept { return fPixmap.shiftPerPixel(); }
  ...
  */
  void* getPixels() const noexcept { return fPixmap.writable_addr(); }
  ...
  */
  size_t computeByteSize() const noexcept { return fPixmap.computeByteSize(); }
  ...
  */
  bool SK_WARN_UNUSED_RESULT tryAllocPixels() { return this->tryAllocPixels((Allocator*)nullptr); }
  ...
  */
  bool readyToDraw() const { return this->getPixels() != nullptr; }
  ...
  */
  ...
  /** Deprecated.
   */
  void eraseArea(const SkIRect& area, SkColor c) const { this->erase(c, area); }
  ...
  */
  SkColor getColor(int x, int y) const { return this->pixmap().getColor(x, y); }
  ...
  */
  inline uint32_t* getAddr32(int x, int y) const noexcept;
  ...
  */
  inline uint16_t* getAddr16(int x, int y) const noexcept;
  ...
  */
  inline uint8_t* getAddr8(int x, int y) const noexcept;
  ...
  */
  bool readPixels(
      const SkImageInfo& dstInfo, void* dstPixels, size_t dstRowBytes, int srcX, int srcY) const;
  ...
  */
  ...
  /** Copies a SkRect of pixels from SkBitmap to dst. Copy starts at (0, 0), and
      ...
      @return     true if pixels are copied to dst
  */
  bool readPixels(const SkPixmap& dst) const { return this->readPixels(dst, 0, 0); }
  ...
  */
  ...
  /** Copies a SkRect of pixels from src. Copy starts at (0, 0), and does not exceed
      ...
      @return     true if src pixels are copied to SkBitmap
  */
  bool writePixels(const SkPixmap& src) { return this->writePixels(src, 0, 0); }
  ...
  */
  bool extractAlpha(
      SkBitmap* dst, const SkPaint* paint, Allocator* allocator, SkIPoint* offset) const;
  ...
  */
  ...
  sk_sp<SkShader> makeShader(
      SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions&, const SkMatrix* = nullptr) const;
  ...
  sk_sp<SkShader> makeShader(
      const SkSamplingOptions& sampling, const SkMatrix* localMatrix = nullptr) const {
...
inline uint32_t* SkBitmap::getAddr32(int x, int y) const noexcept {
  SkASSERT(fPixmap.addr());
  return fPixmap.writable_addr32(x, y);
}

inline uint16_t* SkBitmap::getAddr16(int x, int y) const noexcept {
  SkASSERT(fPixmap.addr());
  return fPixmap.writable_addr16(x, y);
}

inline uint8_t* SkBitmap::getAddr8(int x, int y) const noexcept {
  SkASSERT(fPixmap.addr());
