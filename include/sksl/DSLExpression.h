...
class DSLExpression {
 public:
  ...
  DSLPossibleExpression operator()(
      SkTArray<DSLWrapper<DSLExpression>> args, PositionInfo pos = PositionInfo::Capture());
  ...
  void swap(DSLExpression& other) noexcept;
...
class DSLPossibleExpression {
 public:
  DSLPossibleExpression(std::unique_ptr<SkSL::Expression> expression) noexcept;

  DSLPossibleExpression(DSLPossibleExpression&& other) noexcept;

  ~DSLPossibleExpression();

  bool valid() const noexcept { return fExpression != nullptr; }
