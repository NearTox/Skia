 ...
 */
DSLStatement If(
    DSLExpression test, DSLStatement ifTrue, DSLStatement ifFalse = DSLStatement(),
    PositionInfo pos = PositionInfo::Capture());

DSLGlobalVar InterfaceBlock(
    const DSLModifiers& modifiers, skstd::string_view typeName, SkTArray<DSLField> fields,
    skstd::string_view varName = "", int arraySize = 0, PositionInfo pos = PositionInfo::Capture());

/**
 * return [value];
 */
DSLStatement Return(
    DSLExpression value = DSLExpression(), PositionInfo pos = PositionInfo::Capture());
...
DSLPossibleStatement StaticSwitch(
    DSLExpression value, SkTArray<DSLCase> cases, PositionInfo info = PositionInfo::Capture());
 ...
 */
DSLStatement While(
    DSLExpression test, DSLStatement stmt, PositionInfo info = PositionInfo::Capture());

/**
 * expression.xyz1
 */
DSLExpression Swizzle(
    DSLExpression base, SkSL::SwizzleComponent::Type a, PositionInfo pos = PositionInfo::Capture());
...
DSLExpression Swizzle(
    DSLExpression base, SkSL::SwizzleComponent::Type a, SkSL::SwizzleComponent::Type b,
    SkSL::SwizzleComponent::Type c, PositionInfo pos = PositionInfo::Capture());

DSLExpression Swizzle(
    DSLExpression base, SkSL::SwizzleComponent::Type a, SkSL::SwizzleComponent::Type b,
    SkSL::SwizzleComponent::Type c, SkSL::SwizzleComponent::Type d,
    PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression Clamp(
    DSLExpression x, DSLExpression min, DSLExpression max,
    PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression Distance(
    DSLExpression x, DSLExpression y, PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression Faceforward(
    DSLExpression n, DSLExpression i, DSLExpression nref,
    PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression GreaterThanEqual(
    DSLExpression x, DSLExpression y, PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression Mix(
    DSLExpression x, DSLExpression y, DSLExpression a, PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression Refract(
    DSLExpression i, DSLExpression n, DSLExpression eta,
    PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression Sample(
    DSLExpression target, DSLExpression x, PositionInfo pos = PositionInfo::Capture());
 ...
 */
DSLExpression Sample(
    DSLExpression childProcessor, DSLExpression x, DSLExpression y,
    PositionInfo pos = PositionInfo::Capture());
...
DSLExpression Smoothstep(
    DSLExpression edge1, DSLExpression edge2, DSLExpression x,
    PositionInfo pos = PositionInfo::Capture());
