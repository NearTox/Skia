...
class DSLLayout {
 public:
  constexpr DSLLayout() noexcept = default;
  ...
  DSLLayout& blendSupportAllEquations(Position pos = {}) {
    return this->flag(
        SkSL::Layout::kBlendSupportAllEquations_Flag, "blend_support_all_equations", pos);
  }
  ...
  DSLLayout& location(int location, Position pos = {}) {
    return this->intValue(
        &fSkSLLayout.fLocation, location, SkSL::Layout::kLocation_Flag, "location", pos);
  }

  DSLLayout& offset(int offset, Position pos = {}) {
    return this->intValue(&fSkSLLayout.fOffset, offset, SkSL::Layout::kOffset_Flag, "offset", pos);
  }

  DSLLayout& binding(int binding, Position pos = {}) {
    return this->intValue(
        &fSkSLLayout.fBinding, binding, SkSL::Layout::kBinding_Flag, "binding", pos);
  }
  ...
  DSLLayout& builtin(int builtin, Position pos = {}) {
    return this->intValue(
        &fSkSLLayout.fBuiltin, builtin, SkSL::Layout::kBuiltin_Flag, "builtin", pos);
  }

  DSLLayout& inputAttachmentIndex(int inputAttachmentIndex, Position pos = {}) {
    return this->intValue(
        &fSkSLLayout.fInputAttachmentIndex, inputAttachmentIndex,
        SkSL::Layout::kInputAttachmentIndex_Flag, "input_attachment_index", pos);
  }

 private:
  explicit DSLLayout(SkSL::Layout skslLayout) noexcept : fSkSLLayout(skslLayout) {}
