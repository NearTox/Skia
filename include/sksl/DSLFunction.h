...
class DSLFunction {
 public:
  ...
  template <class... Parameters>
  DSLFunction(
      const DSLModifiers& modifiers, const DSLType& returnType, skstd::string_view name,
  ...
  DSLFunction(
      const DSLType& returnType, skstd::string_view name, SkTArray<DSLParameter*> parameters,
  ...
  DSLFunction(const SkSL::FunctionDeclaration* decl) : fDecl(decl) {}
 ...
 private:
  ...
  void collectArgs(
      SkTArray<DSLWrapper<DSLExpression>>& args, DSLVar& var, RemainingArgs&&... remaining) {
  ...
  template <class... RemainingArgs>
  void collectArgs(
      SkTArray<DSLWrapper<DSLExpression>>& args, DSLExpression expr, RemainingArgs&&... remaining) {
