...
class DSLFunction {
 public:
  ...
  template <class... Parameters>
  DSLFunction(
      const DSLModifiers& modifiers, const DSLType& returnType, std::string_view name,
  ...
  DSLFunction(
      const DSLType& returnType, std::string_view name, SkTArray<DSLParameter*> parameters,
      Position pos = {}) {
