...
Xform::GenID Xform::NextGenID() { return gGenID++; }
...
void Xform::visit(XformResolver* resolver) { this->onVisit(resolver); }
...
void MatrixXF::onVisit(XformResolver* resolver) { resolver->concat(fLocalMatrix); }

void ClipXF::onVisit(XformResolver* resolver) { resolver->clipRect(fRect, fOp); }
