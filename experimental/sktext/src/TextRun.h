...
class TextRun {
 public:
  ...
  void forEachTextChunkInGlyphRange(
      SkSpan<TextIndex> textChunks, GlyphRange runGlyphRange, Callback&& callback) const {
...
struct Position {
  Position(
      PositionType positionType, size_t lineIndex, const TextRun* run, GlyphRange glyphRange,
      TextRange textRange, SkRect rect)
  ...
  Position(PositionType positionType)
      : Position(
            positionType, EMPTY_INDEX, nullptr, EMPTY_RANGE, EMPTY_RANGE, SkRect::MakeEmpty()) {}
