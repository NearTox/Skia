...
bool Paint::drawText(
  ...
  Paint paint;
  paint.paint(
      canvas, SkPoint::Make(x, y), formattedText.get(), SkSpan<DecoratedBlock>(&decoratedBlock, 1));
...
void Paint::onGlyphRun(
    ...
    const uint16_t glyphs[], const SkPoint positions[], const SkPoint offsets[]) {
...
sk_sp<FormattedText> Paint::layout(
