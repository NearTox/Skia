...
TextRun::TextRun(
    const SkShaper::RunHandler::RunInfo& info, TextIndex textStart, SkScalar glyphOffset)
    : fFont(info.fFont),
...
GlyphIndex TextRun::getGlyphIndex(TextIndex textIndex) const { return fGlyphByText[textIndex]; }
