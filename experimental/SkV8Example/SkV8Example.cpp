...
void SkV8ExampleWindow::windowSizeChanged() {
  if (FLAGS_gpu) {
    ...
    GrBackendRenderTarget backendRenderTarget(
        ...
        attachmentInfo.fSampleCount, attachmentInfo.fStencilBits, kSkia8888_GrPixelConfig,
        framebufferInfo);
    SkSafeUnref(fCurSurface);
    fCurSurface =
        SkSurface::MakeFromBackendRenderTarget(
            fCurContext, backendRenderTarget, kBottomLeft_GrSurfaceOrigin, nullptr, nullptr)
            .release();
  }
}
#endif
