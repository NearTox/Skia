...
static editor::Editor::Movement convert(sk_app::Window::Key key) {
    switch (key) {
        case sk_app::Window::Key::kLeft:
            return editor::Editor::Movement::kLeft;
        case sk_app::Window::Key::kRight:
            return editor::Editor::Movement::kRight;
        case sk_app::Window::Key::kUp:
            return editor::Editor::Movement::kUp;
        case sk_app::Window::Key::kDown:
            return editor::Editor::Movement::kDown;
        case sk_app::Window::Key::kHome:
            return editor::Editor::Movement::kHome;
        case sk_app::Window::Key::kEnd:
            return editor::Editor::Movement::kEnd;
        default:
            return editor::Editor::Movement::kNowhere;
    }
}
namespace {
...
struct EditorLayer : public sk_app::Window::Layer {
    ...
    bool onChar(SkUnichar c, uint32_t modifiers) override {
        if (0 == (modifiers &
                  (sk_app::Window::kControl_ModifierKey | sk_app::Window::kOption_ModifierKey |
