...
#define REGISTER_FIDDLE(                                                                           \
    NAME, WIDTH, HEIGHT, TEXT, IMG_INDEX, DURATION, SRGB, F16, OFSCR, OFSCR_WIDTH, OFSCR_HEIGHT,   \
    OFSCR_SAMPLECOUNT, OFSCR_TEXTURABLE, OFSCR_MIPMAP)                                             \
  namespace example_##NAME {                                                                       \
    void draw(SkCanvas*);                                                                          \
  }                                                                                                \
  sk_tools::Registry<fiddle::Example> reg_##NAME(fiddle::Example{                                  \
      &example_##NAME::draw, #NAME, DURATION, IMG_INDEX, WIDTH, HEIGHT, OFSCR_WIDTH, OFSCR_HEIGHT, \
      OFSCR_SAMPLECOUNT, TEXT, SRGB, F16, OFSCR, OFSCR_TEXTURABLE, OFSCR_MIPMAP});                 \
  namespace example_##NAME

#define REG_FIDDLE_SRGB(NAME, W, H, T, I, DURATION, F16) \
  REGISTER_FIDDLE(NAME, W, H, T, I, DURATION, true, F16, false, 64, 64, 0, false, false)

#define REG_FIDDLE_ANIMATED(NAME, W, H, T, I, DURATION) \
  REGISTER_FIDDLE(NAME, W, H, T, I, DURATION, false, false, false, 64, 64, 0, false, false)
