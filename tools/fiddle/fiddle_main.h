...
struct DrawOptions {
  DrawOptions(
      int w, int h, bool r, bool g, bool p, bool k, bool srgb, bool f16, bool textOnly,
      const char* s, GrMipmapped mipMapping, int offScreenWidth, int offScreenHeight,
      int offScreenSampleCount, GrMipmapped offScreenMipMapping)
...
extern sk_sp<GrDirectContext> create_direct_context(
    std::ostringstream& driverinfo, std::unique_ptr<sk_gpu_test::GLTestContext>*);
