...
SkTestFont::~SkTestFont() { delete[] fPaths; }
    ...
    while ((verb = (SkPath::Verb)*verbs++) != SkPath::kDone_Verb) {
      switch (verb) {
        ...
        case SkPath::kCubic_Verb:
          ...
          pts += 6;
          break;
        case SkPath::kClose_Verb: b.close(); break;
...
class SkTestScalerContext : public SkScalerContext {
 public:
  SkTestScalerContext(
      sk_sp<TestTypeface> face, const SkScalerContextEffects& effects, const SkDescriptor* desc)
 ...
 protected:
  TestTypeface* getTestTypeface() const { return static_cast<TestTypeface*>(this->getTypeface()); }
...
SkScalerContext* TestTypeface::onCreateScalerContext(
