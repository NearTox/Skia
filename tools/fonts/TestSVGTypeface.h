...
class TestSVGTypeface : public SkTypeface {
 public:
  TestSVGTypeface(
      const char* name, int upem, const SkFontMetrics& metrics,
 ...
 protected:
  ...
  size_t onGetTableData(
      SkFontTableTag tag, size_t offset, size_t length, void* data) const override {
    return 0;
  }
