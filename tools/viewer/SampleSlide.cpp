...
SampleSlide::SampleSlide(const SampleFactory factory) : fSampleFactory(factory), fClick(nullptr) {
...
void SampleSlide::unload() { fSample.reset(); }
...
bool SampleSlide::onMouse(SkScalar x, SkScalar y, Window::InputState state, uint32_t modifiers) {
  ...
  modifierKeys |=
      (modifiers & Window::kControl_ModifierKey) ? Sample::Click::kControl_ModifierKey : 0;
  modifierKeys |=
      (modifiers & Window::kOption_ModifierKey) ? Sample::Click::kOption_ModifierKey : 0;
  modifierKeys |=
      (modifiers & Window::kCommand_ModifierKey) ? Sample::Click::kCommand_ModifierKey : 0;
