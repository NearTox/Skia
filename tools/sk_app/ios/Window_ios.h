...
class Window_ios : public Window {
 public:
  Window_ios()
      : INHERITED(), fWindow(nullptr), fWindowID(0), fGLContext(nullptr), fMSAASampleCount(1) {}
  ...
  static const Uint32& GetKey(const Window_ios& w) { return w.fWindowID; }

  static uint32_t Hash(const Uint32& winID) { return winID; }
