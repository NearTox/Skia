...
static inline double NanosToSeconds(double nanos) { return nanos * 1e-9; }
...
static inline float PingPong(double time, float period, float phase, float ends, float mid) {
