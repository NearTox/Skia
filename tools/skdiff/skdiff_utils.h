...
bool get_bitmap(
    sk_sp<SkData> fileBits, DiffResource& resource, bool sizeOnly, bool ignoreColorSpace);
 ...
 */
void create_and_write_diff_image(
    DiffRecord* drp, DiffMetricProc dmp, const int colorThreshold, const SkString& outputDir,
