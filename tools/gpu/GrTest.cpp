...
void GrRenderTargetContextPriv::testingOnly_addDrawOp(
    const GrClip* clip, GrOp::Owner op,
...
#define DRAW_OP_TEST_EXTERN(Op) \
  extern GrOp::Owner Op##__Test(GrPaint&&, SkRandom*, GrRecordingContext*, int numSamples)
...
void GrDrawRandomOp(SkRandom* random, GrRenderTargetContext* renderTargetContext, GrPaint&& paint) {
  ...
  using MakeDrawOpFn = GrOp::Owner(GrPaint&&, SkRandom*, GrRecordingContext*, int numSamples);
