...
#define DRAW_OP_TEST_EXTERN(Op)  \
  extern GrOp::Owner Op##__Test( \
      GrPaint&&, SkRandom*, GrRecordingContext*, skgpu::v1::SurfaceDrawContext*, int)
...
void GrDrawRandomOp(SkRandom* random, skgpu::v1::SurfaceDrawContext* sdc, GrPaint&& paint) {
  ...
  using MakeDrawOpFn = GrOp::Owner(
      GrPaint&&, SkRandom*, GrRecordingContext*, skgpu::v1::SurfaceDrawContext*, int numSamples);
  static constexpr MakeDrawOpFn* gFactories[] = {
      DRAW_OP_TEST_ENTRY(AAConvexPathOp), DRAW_OP_TEST_ENTRY(AAFlatteningConvexPathOp),
      DRAW_OP_TEST_ENTRY(AAHairlineOp),   DRAW_OP_TEST_ENTRY(AAStrokeRectOp),
      DRAW_OP_TEST_ENTRY(AtlasTextOp),    DRAW_OP_TEST_ENTRY(ButtCapDashedCircleOp),
      DRAW_OP_TEST_ENTRY(CircleOp),       DRAW_OP_TEST_ENTRY(DashOpImpl),
      DRAW_OP_TEST_ENTRY(DefaultPathOp),  DRAW_OP_TEST_ENTRY(DrawAtlasOp),
      DRAW_OP_TEST_ENTRY(DrawVerticesOp), DRAW_OP_TEST_ENTRY(DIEllipseOp),
      DRAW_OP_TEST_ENTRY(EllipseOp),      DRAW_OP_TEST_ENTRY(FillRectOp),
      DRAW_OP_TEST_ENTRY(NonAALatticeOp), DRAW_OP_TEST_ENTRY(NonAAStrokeRectOp),
      DRAW_OP_TEST_ENTRY(RegionOp),       DRAW_OP_TEST_ENTRY(RRectOp),
      DRAW_OP_TEST_ENTRY(ShadowRRectOp),  DRAW_OP_TEST_ENTRY(SmallPathOp),
      DRAW_OP_TEST_ENTRY(TextureOpImpl),  DRAW_OP_TEST_ENTRY(TriangulatingPathOp),
  };
