...
GrSurfaceProxyView MakeTextureProxyViewFromData(
    GrDirectContext* dContext, GrRenderable renderable, GrSurfaceOrigin origin, GrCPixmap pixmap) {
...
GrProgramInfo* CreateProgramInfo(
    ...
    GrXferBarrierFlags renderPassXferBarriers, GrLoadOp colorLoadOp, GrPipeline::InputFlags flags,
  ...
  return GrSimpleMeshDrawOpHelper::CreateProgramInfo(
      ...
      std::move(processors), primitiveType, renderPassXferBarriers, colorLoadOp, flags,
      stencilSettings);
}
#endif  // SK_GPU_V1
