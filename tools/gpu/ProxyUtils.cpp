...
GrSurfaceProxyView MakeTextureProxyViewFromData(
    GrDirectContext* dContext, GrRenderable renderable, GrSurfaceOrigin origin, GrPixmap pixmap) {
...
GrProgramInfo* CreateProgramInfo(
  ...
  return GrSimpleMeshDrawOpHelper::CreateProgramInfo(
      ...
      primitiveType, renderPassXferBarriers, colorLoadOp, flags, stencilSettings);
}
