...
class GrContextFactory : SkNoncopyable {
 public:
  ...
  static bool IsRenderingContext(ContextType type) {
    switch (type) {
      case kMock_ContextType: return false;
      default: return true;
    }
  }
  ...
  static const char* ContextTypeName(ContextType contextType) {
    switch (contextType) {
      case kGL_ContextType: return "OpenGL";
      case kGLES_ContextType: return "OpenGLES";
      case kANGLE_D3D9_ES2_ContextType: return "ANGLE D3D9 ES2";
      case kANGLE_D3D11_ES2_ContextType: return "ANGLE D3D11 ES2";
 ...
 private:
  ContextInfo getContextInfoInternal(
...
class ContextInfo {
 ...
 private:
  ContextInfo(
      GrContextFactory::ContextType type, TestContext* testContext, GrContext* grContext,
