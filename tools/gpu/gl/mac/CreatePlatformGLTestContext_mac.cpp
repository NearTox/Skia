...
MacGLTestContext::MacGLTestContext(MacGLTestContext* shareContext)
  ...
  // base parameters
    ...
    kCGLPFARendererID,
    (CGLPixelFormatAttribute)kCGLRendererATIRadeonX4000ID,  // Select Radeon
#endif
  ...
  fGLLibrary = dlopen(
      "/System/Library/Frameworks/OpenGL.framework/Versions/A/Libraries/libGL.dylib", RTLD_LAZY);
...
void MacGLTestContext::onPlatformMakeNotCurrent() const { CGLSetCurrentContext(nullptr); }
