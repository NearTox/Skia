...
TestContext::TestContext() : fFenceSync(nullptr), fGpuTimer(nullptr), fCurrentFenceIdx(0) {
...
sk_sp<GrContext> TestContext::makeGrContext(const GrContextOptions&) { return nullptr; }
