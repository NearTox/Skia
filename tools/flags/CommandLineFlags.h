...
class SkFlagInfo {
 public:
   ...
   */
  static bool CreateBoolFlag(
      const char* name, const char* shortName, bool* pBool, bool defaultValue,
   ...
   */
  static bool CreateStringFlag(
      const char* name, const char* shortName, CommandLineFlags::StringArray* pStrings,
  ...
  static bool CreateIntFlag(
      const char* name, const char* shortName, int* pInt, int defaultValue,
      const char* helpString) {
   ...
   *  See comments for CreateBoolFlag.
   */
  static bool CreateDoubleFlag(
      const char* name, double* pDouble, double defaultValue, const char* helpString) {
  ...
  SkString defaultValue() const {
    SkString result;
    switch (fFlagType) {
      case SkFlagInfo::kBool_FlagType: result.printf("%s", fDefaultBool ? "true" : "false"); break;
 ...
 private:
  SkFlagInfo(
      const char* name, const char* shortName, FlagTypes type, const char* helpString,
