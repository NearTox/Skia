  ...
  for (uint8_t i = 0; i < numOps; ++i) {
    ...
    switch (op) {
      ...
      case 24:
        ...
        break;
      case 25: path->addPath(*path); break;
      case 26: path->reverseAddPath(*path); break;
      case 27:
        fuzz_nice_float(fuzz, &a, &b);
      ...
      case 31:
        ...
        path->setLastPt(a, b);
        break;
      case MAX_PATH_OPERATION: SkPathPriv::ShrinkToFit(path); break;
...
void FuzzEvilPath(Fuzz* fuzz, SkPath* path, int last_verb) {
  while (!fuzz->exhausted()) {
    ...
    switch (operation % (last_verb + 1)) {
      ...
      case SkPath::Verb::kClose_Verb: path->close(); break;
