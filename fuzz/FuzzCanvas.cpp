...
static sk_sp<SkColorFilter> make_fuzz_colorfilter(Fuzz* fuzz, int depth) {
  ...
  switch (colorFilterType) {
    ...
    case 6: return SkLumaColorFilter::Make();
    case 7: {
      uint8_t table[256];
...
static sk_sp<SkShader> make_fuzz_shader(Fuzz* fuzz, int depth) {
  ...
  switch (shaderType) {
    case 0: return nullptr;
    case 1: return SkShaders::Empty();
    case 2: fuzz->next(&color); return SkShaders::Color(color);
    case 3:
    ...
    case 8: {
      ...
      return pic->makeShader(
          tmX, tmY, SkFilterMode::kNearest, useMatrix ? &matrix : nullptr,
    ...
    case 10: {
      ...
      return SkGradientShader::MakeLinear(
          pts, colors, usePos ? pos : nullptr, colorCount, tmX, 0, useMatrix ? &matrix : nullptr);
    }
    case 11: {
      constexpr int kMaxColors = 12;
      SkPoint center;
      ...
      return SkGradientShader::MakeRadial(
          center, radius, colors, usePos ? pos : nullptr, colorCount, tmX, 0,
    ...
    case 12: {
      ...
      return SkGradientShader::MakeTwoPointConical(
          start, startRadius, end, endRadius, colors, usePos ? pos : nullptr, colorCount, tmX, 0,
          useMatrix ? &matrix : nullptr);
    }
    case 13: {
      constexpr int kMaxColors = 12;
      ...
      return SkGradientShader::MakeSweep(
          cx, cy, colors, usePos ? pos : nullptr, colorCount, 0, useMatrix ? &matrix : nullptr);
    }
    case 14: {
      ...
      if (turbulence) {
        return SkPerlinNoiseShader::MakeTurbulence(
            baseFrequencyX, baseFrequencyY, numOctaves, seed, useTileSize ? &tileSize : nullptr);
      } else {
  ...
  switch (imageFilterType) {
    case 1:
      ...
      return SkImageFilters::DistantLitDiffuse(
          p, lightColor, surfaceScale, k, std::move(input), useCropRect ? &cropRect : nullptr);
    case 2:
      fuzz->next(&p, &lightColor, &surfaceScale, &k);
      input = make_fuzz_imageFilter(fuzz, depth - 1);
    ...
    case 3:
      ...
      return SkImageFilters::SpotLitDiffuse(
          p, q, specularExponent, cutoffAngle, lightColor, surfaceScale, k, std::move(input),
          useCropRect ? &cropRect : nullptr);
    case 4:
      fuzz->next(&p, &lightColor, &surfaceScale, &k, &shininess);
      input = make_fuzz_imageFilter(fuzz, depth - 1);
      return SkImageFilters::DistantLitSpecular(
          p, lightColor, surfaceScale, k, shininess, std::move(input),
          useCropRect ? &cropRect : nullptr);
    case 5:
      fuzz->next(&p, &lightColor, &surfaceScale, &k, &shininess);
      input = make_fuzz_imageFilter(fuzz, depth - 1);
  ...
  switch (imageFilterType) {
    ...
    case 1: {
      ...
      return SkImageFilters::Blur(
          sigmaX, sigmaY, std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 2: {
      SkMatrix matrix;
      FuzzNiceMatrix(fuzz, &matrix);
    ...
    case 3: {
      ...
      return SkImageFilters::AlphaThreshold(
          region, innerMin, outerMax, std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 4: {
      float k1, k2, k3, k4;
      bool enforcePMColor;
      ...
      return SkImageFilters::Arithmetic(
          k1, k2, k3, k4, enforcePMColor, std::move(background), std::move(foreground),
          useCropRect ? &cropRect : nullptr);
    }
    case 5: {
      ...
      return SkImageFilters::ColorFilter(
          std::move(cf), std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 6: {
    ...
    case 7: {
      ...
      return SkImageFilters::DisplacementMap(
          xChannelSelector, yChannelSelector, scale, std::move(displacement), std::move(color),
          useCropRect ? &cropRect : nullptr);
    }
    case 8: {
      ...
      if (shadowOnly) {
        return SkImageFilters::DropShadowOnly(
            dx, dy, sigmaX, sigmaY, color, std::move(input), useCropRect ? &cropRect : nullptr);
      } else {
        return SkImageFilters::DropShadow(
            dx, dy, sigmaX, sigmaY, color, std::move(input), useCropRect ? &cropRect : nullptr);
      }
    }
    case 9: return SkImageFilters::Image(make_fuzz_image(fuzz));
    case 10: {
    ...
    case 11: return make_fuzz_lighting_imagefilter(fuzz, depth - 1);
    case 12: {
      SkRect srcRect;
      SkScalar inset;
      bool useCropRect;
      ...
      return SkImageFilters::Magnifier(
          srcRect, inset, std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 13: {
      ...
      return SkImageFilters::MatrixConvolution(
          SkISize{n, m}, kernel, gain, bias, SkIPoint{offsetX, offsetY}, tileMode, convolveAlpha,
          std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 14: {
      ...
      return SkImageFilters::Merge(
          std::move(first), std::move(second), useCropRect ? &cropRect : nullptr);
    }
    case 15: {
    ...
    case 16: {
      ...
      sk_sp<SkImageFilter> input = make_fuzz_imageFilter(fuzz, depth - 1);
      return SkImageFilters::Dilate(rx, ry, std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 17: {
      int rx, ry;
      fuzz->next(&rx, &ry);
      ...
      sk_sp<SkImageFilter> input = make_fuzz_imageFilter(fuzz, depth - 1);
      return SkImageFilters::Erode(rx, ry, std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 18: {
      SkScalar dx, dy;
      fuzz->next(&dx, &dy);
      ...
      sk_sp<SkImageFilter> input = make_fuzz_imageFilter(fuzz, depth - 1);
      return SkImageFilters::Offset(dx, dy, std::move(input), useCropRect ? &cropRect : nullptr);
    }
    case 19: {
      SkPaint paint;
    ...
    case 23: {
      ...
      return SkImageFilters::Blend(
          blendMode, std::move(bg), std::move(fg), useCropRect ? &cropRect : nullptr);
    }
    case 24: {
...
static void fuzz_paint(Fuzz* fuzz, SkPaint* paint, int depth) {
  ...
  paint->setStyle(make_fuzz_enum_range<SkPaint::Style>(fuzz, SkPaint::Style::kStrokeAndFill_Style));
...
static SkFont fuzz_font(Fuzz* fuzz) {
  ...
  font.setEdging(make_fuzz_enum_range<SkFont::Edging>(fuzz, SkFont::Edging::kSubpixelAntiAlias));
  return font;
}
...
static void fuzz_canvas(Fuzz* fuzz, SkCanvas* canvas, int depth = 9) {
  ...
  for (unsigned loop = 0; loop < N; ++loop) {
    ...
    switch (drawCommand) {
      case 0: canvas->flush(); break;
      case 1: canvas->save(); break;
      case 2: {
        SkRect bounds;
        fuzz->next(&bounds);
        fuzz_paint(fuzz, &paint, depth - 1);
      ...
      case 4:
        ...
        break;
      case 5: canvas->saveLayer(nullptr, nullptr); break;
      case 6: {
        uint8_t alpha;
        fuzz->next(&alpha);
      ...
      case 18: canvas->resetMatrix(); break;
      case 19: {
        SkRect r;
        int op;
        bool doAntiAlias;
      ...
      case 24: {
        ...
        fuzz->nextRange(&pointMode, SkCanvas::kPoints_PointMode, SkCanvas::kPolygon_PointMode);
        size_t count;
      ...
      case 33: {
        ...
        canvas->drawImage(img.get(), left, top, SkSamplingOptions(), usePaint ? &paint : nullptr);
        break;
      }
      case 35: {
        ...
        SkCanvas::SrcRectConstraint constraint = make_fuzz_t<bool>(fuzz)
                                                     ? SkCanvas::kStrict_SrcRectConstraint
                                                     : SkCanvas::kFast_SrcRectConstraint;
        canvas->drawImageRect(
            img.get(), SkRect::Make(src), dst, SkSamplingOptions(), usePaint ? &paint : nullptr,
            constraint);
        break;
      }
      case 37: {
        ...
        canvas->drawImageNine(
            img.get(), center, dst, SkFilterMode::kNearest, usePaint ? &paint : nullptr);
        break;
      }
      case 44: {
        auto img = make_fuzz_image(fuzz);
        ...
        canvas->drawImageLattice(
            img.get(), lattice, dst, SkFilterMode::kLinear, usePaint ? &paint : nullptr);
        break;
      }
      case 45: {
        fuzz_paint(fuzz, &paint, depth - 1);
        ...
        fuzz->next(&x, &y);
        SkTDArray<uint8_t> text = make_fuzz_text(fuzz, font, encoding);
        canvas->drawSimpleText(text.begin(), SkToSizeT(text.count()), encoding, x, y, font, paint);
        break;
      }
      case 46: {
        // was drawPosText
      ...
      case 52: {
        ...
        auto pic = make_fuzz_picture(fuzz, depth - 1);
        canvas->drawPicture(pic, useMatrix ? &matrix : nullptr, usePaint ? &paint : nullptr);
        break;
      }
      case 53: {
        fuzz_paint(fuzz, &paint, depth - 1);
        ...
        canvas->drawVertices(
            SkVertices::MakeCopy(
                vertexMode, vertexCount, vertices, useTexs ? texs : nullptr,
                useColors ? colors : nullptr, indexCount, indices),
            blendMode, paint);
        break;
      }
      case 54: {
      ...
      case 62: {
        ...
        SkBlendMode mode;
        fuzz->nextEnum(&mode, SkBlendMode::kLastMode);
        canvas->drawPatch(cubics, colors, useTexCoords ? texCoords : nullptr, mode, paint);
        break;
      }
      default: SkASSERT(false); break;
    }
...
DEF_FUZZ(NullCanvas, fuzz) { fuzz_canvas(fuzz, SkMakeNullCanvas().get()); }
...
static void dump_GPU_info(GrDirectContext* context) {
  const GrGLInterface* gl = static_cast<GrGLGpu*>(context->priv().getGpu())->glInterface();
...
DEF_FUZZ(PDFCanvas, fuzz) {
  ...
  fuzz_canvas(
      fuzz,
      doc->beginPage(SkIntToScalar(kCanvasSize.width()), SkIntToScalar(kCanvasSize.height())));
}
