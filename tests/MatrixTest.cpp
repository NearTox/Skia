  ...
  // rectStaysRect test
  {
    static const struct {
      ...
      bool mStaysRect;
        ...
        {0, 0, 0, 0, false}, {0, 0, 0, 1, false}, {0, 0, 1, 0, false}, {0, 0, 1, 1, false},
        {0, 1, 0, 0, false}, {0, 1, 0, 1, false}, {0, 1, 1, 0, true},  {0, 1, 1, 1, false},
        {1, 0, 0, 0, false}, {1, 0, 0, 1, true},  {1, 0, 1, 0, false}, {1, 0, 1, 1, false},
        {1, 1, 0, 0, false}, {1, 1, 0, 1, false}, {1, 1, 1, 0, false}, {1, 1, 1, 1, false}};
...
DEF_TEST(Matrix_mapRect_skbug12335, r) {
  ...
  SkMatrix m = SkMatrix::MakeAll(
      0.000152695269f, 0.00000000f, -6.53848401e-05f, -1.75697533e-05f, 0.000157153074f,
      -1.10847975e-06f, -6.00415362e-08f, 0.00000000f, 0.000169880834f);
