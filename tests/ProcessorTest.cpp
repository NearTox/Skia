...
class TestFP : public GrFragmentProcessor {
 public:
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(
      const SkTArray<GrSurfaceProxyView>& views, const SkTArray<sk_sp<GrGpuBuffer>>& buffers) {
 ...
 private:
  TestFP(const SkTArray<GrSurfaceProxyView>& views, const SkTArray<sk_sp<GrGpuBuffer>>& buffers)
