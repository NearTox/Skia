...
DEF_TEST(RecordDraw_SetMatrixClobber, r) {
  ...
  SkRecordDraw(
      scaleRecord, &translateCanvas, nullptr, nullptr, 0, nullptr /*bbh*/, nullptr /*callback*/);
...
DEF_TEST(RecordDraw_PartialStartStop, r) {
  ...
  SkRecordPartialDraw(
      record, &canvas, nullptr, 0, 1, 2, SkMatrix::I());  // replay just drawRect of r2
...
DEF_TEST(RecordDraw_SaveLayerAffectsClipBounds, r) {
  ...
  paint.setImageFilter(SkDropShadowImageFilter::Make(
      20, 0, 0, 0, SK_ColorBLACK, SkDropShadowImageFilter::kDrawShadowAndForeground_ShadowMode,
      nullptr));
