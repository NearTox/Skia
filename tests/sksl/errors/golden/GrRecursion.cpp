...
class GrGLSLRecursion : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const String factorial_impl = String::printf(
...
GrGLSLFragmentProcessor* GrRecursion::onCreateGLSLInstance() const { return new GrGLSLRecursion(); }
...
#if GR_TEST_UTILS
SkString GrRecursion::onDumpInfo() const { return SkString(); }
#endif
