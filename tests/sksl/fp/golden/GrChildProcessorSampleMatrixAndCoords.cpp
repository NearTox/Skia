...
class GrGLSLChildProcessorSampleMatrixAndCoords : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrChildProcessorSampleMatrixAndCoords& _outer =
        args.fFp.cast<GrChildProcessorSampleMatrixAndCoords>();
    (void)_outer;
    colorVar =
...
void GrChildProcessorSampleMatrixAndCoords::onGetGLSLProcessorKey(
    const GrShaderCaps& caps, GrProcessorKeyBuilder* b) const {}
bool GrChildProcessorSampleMatrixAndCoords::onIsEqual(const GrFragmentProcessor& other) const {
  const GrChildProcessorSampleMatrixAndCoords& that =
      other.cast<GrChildProcessorSampleMatrixAndCoords>();
  (void)that;
  return true;
}
...
#if GR_TEST_UTILS
SkString GrChildProcessorSampleMatrixAndCoords::onDumpInfo() const { return SkString(); }
#endif
