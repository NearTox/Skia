...
class GrChildProcessorSampleMatrixMultipleUniforms : public GrFragmentProcessor {
 public:
  static std::unique_ptr<GrFragmentProcessor> Make(
      std::unique_ptr<GrFragmentProcessor> child, SkMatrix matrixA, SkMatrix matrixB) {
    return std::unique_ptr<GrFragmentProcessor>(
        new GrChildProcessorSampleMatrixMultipleUniforms(std::move(child), matrixA, matrixB));
  }
  GrChildProcessorSampleMatrixMultipleUniforms(
