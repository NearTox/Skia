 ...
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    fragBuilder->codeAppendf(
        R"SkSL(half4 childIn = %s;)SkSL", args.fUniformHandler->getUniformCStr(colorVar));
...
void GrChildProcessorsWithInput::onGetGLSLProcessorKey(
...
bool GrChildProcessorsWithInput::usesExplicitReturn() const { return false; }
...
#if GR_TEST_UTILS
SkString GrChildProcessorsWithInput::onDumpInfo() const { return SkString(); }
#endif
