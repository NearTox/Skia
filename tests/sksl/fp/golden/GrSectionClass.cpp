...
void GrSectionClass::onGetGLSLProcessorKey(
...
bool GrSectionClass::usesExplicitReturn() const { return false; }
...
#if GR_TEST_UTILS
SkString GrSectionClass::onDumpInfo() const { return SkString(); }
#endif
