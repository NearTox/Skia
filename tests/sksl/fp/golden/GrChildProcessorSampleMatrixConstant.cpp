...
void GrChildProcessorSampleMatrixConstant::onGetGLSLProcessorKey(
    const GrShaderCaps& caps, GrProcessorKeyBuilder* b) const {}
bool GrChildProcessorSampleMatrixConstant::onIsEqual(const GrFragmentProcessor& other) const {
  const GrChildProcessorSampleMatrixConstant& that =
      other.cast<GrChildProcessorSampleMatrixConstant>();
  (void)that;
  return true;
}
...
#if GR_TEST_UTILS
SkString GrChildProcessorSampleMatrixConstant::onDumpInfo() const { return SkString(); }
#endif
