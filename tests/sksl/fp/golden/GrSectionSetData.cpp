...
class GrGLSLSectionSetData : public GrGLSLFragmentProcessor {
 ...
 private:
  void onSetData(
      const GrGLSLProgramDataManager& varName, const GrFragmentProcessor& _proc) override {
...
void GrSectionSetData::onGetGLSLProcessorKey(
...
#if GR_TEST_UTILS
SkString GrSectionSetData::onDumpInfo() const { return SkStringPrintf("(provided=%f)", provided); }
#endif
