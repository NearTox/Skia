...
void GrUseExplicitReturn::onGetGLSLProcessorKey(
...
bool GrUseExplicitReturn::usesExplicitReturn() const { return true; }
...
#if GR_TEST_UTILS
SkString GrUseExplicitReturn::onDumpInfo() const { return SkString(); }
#endif
