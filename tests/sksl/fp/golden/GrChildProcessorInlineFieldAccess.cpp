...
class GrGLSLChildProcessorInlineFieldAccess : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrChildProcessorInlineFieldAccess& _outer =
        args.fFp.cast<GrChildProcessorInlineFieldAccess>();
    (void)_outer;
...
void GrChildProcessorInlineFieldAccess::onGetGLSLProcessorKey(
...
#if GR_TEST_UTILS
SkString GrChildProcessorInlineFieldAccess::onDumpInfo() const { return SkString(); }
#endif
