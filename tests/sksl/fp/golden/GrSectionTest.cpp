...
void GrSectionTest::onGetGLSLProcessorKey(
...
bool GrSectionTest::usesExplicitReturn() const { return false; }
...
#if GR_TEST_UTILS
SkString GrSectionTest::onDumpInfo() const { return SkString(); }
#endif
