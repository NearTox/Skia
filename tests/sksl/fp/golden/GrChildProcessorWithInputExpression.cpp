...
class GrGLSLChildProcessorWithInputExpression : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrChildProcessorWithInputExpression& _outer =
        args.fFp.cast<GrChildProcessorWithInputExpression>();
    (void)_outer;
    colorVar =
...
void GrChildProcessorWithInputExpression::onGetGLSLProcessorKey(
    const GrShaderCaps& caps, GrProcessorKeyBuilder* b) const {}
bool GrChildProcessorWithInputExpression::onIsEqual(const GrFragmentProcessor& other) const {
  const GrChildProcessorWithInputExpression& that =
      other.cast<GrChildProcessorWithInputExpression>();
  (void)that;
  return true;
}
...
#if GR_TEST_UTILS
SkString GrChildProcessorWithInputExpression::onDumpInfo() const { return SkString(); }
#endif
