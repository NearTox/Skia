...
/**************************************************************************************************
 *** This file was autogenerated from GrChildProcessorSampleMatrixSingleUniformExpr.fp; do not
 *modify.
 **************************************************************************************************/
...
class GrGLSLChildProcessorSampleMatrixSingleUniformExpr : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrChildProcessorSampleMatrixSingleUniformExpr& _outer =
        args.fFp.cast<GrChildProcessorSampleMatrixSingleUniformExpr>();
    (void)_outer;
    matrixVar = args.fUniformHandler->addUniform(
        &_outer, kFragment_GrShaderFlag, kFloat3x3_GrSLType, "matrix");
    SkString _matrix93 =
        SkStringPrintf("0.5 * %s", args.fUniformHandler->getUniformCStr(matrixVar));
...
GrGLSLFragmentProcessor* GrChildProcessorSampleMatrixSingleUniformExpr::onCreateGLSLInstance()
    const {
  return new GrGLSLChildProcessorSampleMatrixSingleUniformExpr();
}
void GrChildProcessorSampleMatrixSingleUniformExpr::onGetGLSLProcessorKey(
    const GrShaderCaps& caps, GrProcessorKeyBuilder* b) const {}
bool GrChildProcessorSampleMatrixSingleUniformExpr::onIsEqual(
    const GrFragmentProcessor& other) const {
  const GrChildProcessorSampleMatrixSingleUniformExpr& that =
      other.cast<GrChildProcessorSampleMatrixSingleUniformExpr>();
  (void)that;
  return true;
}
...
#if GR_TEST_UTILS
SkString GrChildProcessorSampleMatrixSingleUniformExpr::onDumpInfo() const { return SkString(); }
#endif
