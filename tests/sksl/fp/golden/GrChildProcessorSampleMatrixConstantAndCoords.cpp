...
/**************************************************************************************************
 *** This file was autogenerated from GrChildProcessorSampleMatrixConstantAndCoords.fp; do not
 *modify.
 **************************************************************************************************/
...
class GrGLSLChildProcessorSampleMatrixConstantAndCoords : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrChildProcessorSampleMatrixConstantAndCoords& _outer =
        args.fFp.cast<GrChildProcessorSampleMatrixConstantAndCoords>();
    (void)_outer;
    SkString _sample80 = this->invokeChildWithMatrix(0, args);
    fragBuilder->codeAppendf(R"SkSL(%s = %s;)SkSL", args.fOutputColor, _sample80.c_str());
...
GrGLSLFragmentProcessor* GrChildProcessorSampleMatrixConstantAndCoords::onCreateGLSLInstance()
    const {
  return new GrGLSLChildProcessorSampleMatrixConstantAndCoords();
}
void GrChildProcessorSampleMatrixConstantAndCoords::onGetGLSLProcessorKey(
    const GrShaderCaps& caps, GrProcessorKeyBuilder* b) const {}
bool GrChildProcessorSampleMatrixConstantAndCoords::onIsEqual(
    const GrFragmentProcessor& other) const {
  const GrChildProcessorSampleMatrixConstantAndCoords& that =
      other.cast<GrChildProcessorSampleMatrixConstantAndCoords>();
  (void)that;
  return true;
}
...
#if GR_TEST_UTILS
SkString GrChildProcessorSampleMatrixConstantAndCoords::onDumpInfo() const { return SkString(); }
#endif
