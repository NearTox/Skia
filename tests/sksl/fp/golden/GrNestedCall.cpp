...
class GrGLSLNestedCall : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const String func1_impl = String::printf(
        R"SkSL(return %s();
)SkSL",
        func2_name.c_str());
    fragBuilder->emitFunction(
        kHalf4_GrSLType, func1_name.c_str(), {func1_args, 0}, func1_impl.c_str());
    const String func2_impl = String::printf(
        R"SkSL(return %s();
)SkSL",
        func3_name.c_str());
    fragBuilder->emitFunction(
...
#if GR_TEST_UTILS
SkString GrNestedCall::onDumpInfo() const { return SkString(); }
#endif
