...
GrGLSLFragmentProcessor* GrUniform::onCreateGLSLInstance() const { return new GrGLSLUniform(); }
...
bool GrUniform::usesExplicitReturn() const { return false; }
...
#if GR_TEST_UTILS
SkString GrUniform::onDumpInfo() const { return SkString(); }
#endif
