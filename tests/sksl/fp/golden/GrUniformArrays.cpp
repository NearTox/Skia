...
class GrGLSLUniformArrays : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    (void)_outer;
    scalarArrayVar = args.fUniformHandler->addUniformArray(
        &_outer, kFragment_GrShaderFlag, kHalf_GrSLType, "scalarArray", 4);
...
void GrUniformArrays::onGetGLSLProcessorKey(
...
#if GR_TEST_UTILS
SkString GrUniformArrays::onDumpInfo() const { return SkString(); }
#endif
