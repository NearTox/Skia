...
class GrGLSLNestedChildProcessors : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    SkString _input118 = SkStringPrintf(
        "%s * %s", args.fUniformHandler->getUniformCStr(colorVar), _sample141.c_str());
...
void GrNestedChildProcessors::onGetGLSLProcessorKey(
...
bool GrNestedChildProcessors::usesExplicitReturn() const { return false; }
...
#if GR_TEST_UTILS
SkString GrNestedChildProcessors::onDumpInfo() const { return SkString(); }
#endif
