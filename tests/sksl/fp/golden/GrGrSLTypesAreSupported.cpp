 ...
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    fragBuilder->emitFunction(
        kInt_GrSLType, "test_i", 1, test_i_args,
        R"SkSL(for (; ; ) {
    return a;
}
)SkSL",
    ...
    fragBuilder->emitFunction(
        kInt2_GrSLType, "test_i2", 1, test_i2_args,
        R"SkSL(for (; ; ) {
    return a;
}
)SkSL",
    ...
    fragBuilder->emitFunction(
        kInt3_GrSLType, "test_i3", 1, test_i3_args,
        R"SkSL(for (; ; ) {
    return a;
}
)SkSL",
    ...
    fragBuilder->emitFunction(
        kInt4_GrSLType, "test_i4", 1, test_i4_args,
        R"SkSL(for (; ; ) {
    return a;
}
)SkSL",
    ...
    fragBuilder->emitFunction(
        kHalf3x4_GrSLType, "test_h3x4", 1, test_h3x4_args,
        R"SkSL(for (; ; ) {
    return a;
}
)SkSL",
    ...
    fragBuilder->emitFunction(
        kFloat2x4_GrSLType, "test_f2x4", 1, test_f2x4_args,
        R"SkSL(for (; ; ) {
    return a;
}
)SkSL",
