...
static void test(
    skiatest::Reporter* r, const char* src, const SkSL::Program::Settings& settings,
...
static void test(
    skiatest::Reporter* r, const char* src, const GrShaderCaps& caps, const char* expected,
    SkSL::Program::Kind kind = SkSL::Program::kFragment_Kind) {
...
DEF_TEST(SkSLHelloWorld, r) {
  test(
      r, "void main() { sk_FragColor = half4(0.75); }", *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
...
DEF_TEST(SkSLFunctions, r) {
  test(
      ...
      *SkSL::ShaderCapsFactory::Default(),
      ...
      "        {\n"
      "            _inlineResultfloatfoofloat20 = _inlineArgfloatfoofloat21_0[0] * "
      "_inlineArgfloatfoofloat21_0[1];\n"
      "        }\n"
...
DEF_TEST(SkSLVersion, r) {
  test(
      r, "in float test; void main() { sk_FragColor.r = half(test); }",
...
DEF_TEST(SkSLNegatedAtan, r) {
  test(
      r, "void main() { float2 x = float2(sqrt(2)); sk_FragColor.r = half(atan(x.x, -x.y)); }",
      *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "out vec4 sk_FragColor;\n"
      "void main() {\n"
...
DEF_TEST(SkSLDerivatives, r) {
  test(
      r, "void main() { sk_FragColor.r = half(dFdx(1)); }", *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "out vec4 sk_FragColor;\n"
      "void main() {\n"
  ...
  test(
      ...
      *SkSL::ShaderCapsFactory::ShaderDerivativeExtensionString(),
      ...
      "}\n");
  test(
      r, "void main() { sk_FragColor.r = half(dFdx(1)); }",
      *SkSL::ShaderCapsFactory::ShaderDerivativeExtensionString(),
      "#version 400\n"
  ...
  SkSL::Program::Inputs inputs;
  test(
      r, "void main() { sk_FragColor.r = half(dFdx(1)), sk_FragColor.g = half(dFdy(1)); }",
      settings,
      "#version 400\n"
      "out vec4 sk_FragColor;\n"
      "void main() {\n"
...
DEF_TEST(SkSLFragCoord, r) {
  ...
  SkSL::Program::Inputs inputs;
  test(
      r, "void main() { sk_FragColor.xy = half2(sk_FragCoord.xy); }", settings,
      "#version 110\n"
  ...
  test(
      r, "in float4 pos; void main() { sk_Position = pos; }",
  ...
  test(
      r, "uniform float4 sk_RTAdjust; in float4 pos; void main() { sk_Position = pos; }",
      *SkSL::ShaderCapsFactory::CannotUseFragCoord(),
      "#version 400\n"
      "out vec4 sk_FragCoord_Workaround;\n"
  ...
  test(
      r, "void main() { sk_FragColor.xy = half2(sk_FragCoord.xy); }",
      *SkSL::ShaderCapsFactory::CannotUseFragCoord(),
      "#version 400\n"
...
DEF_TEST(SkSLWidthAndHeight, r) {
  ...
  SkSL::Program::Inputs inputs;
  test(
      r, "void main() { sk_FragColor.r = half(sk_FragCoord.x / sk_Width); }", settings,
      "#version 400\n"
  ...
  test(
      r, "void main() { sk_FragColor.r = half(sk_FragCoord.y / sk_Height); }", settings,
      "#version 400\n"
      "uniform float u_skRTHeight;\n"
      "out vec4 sk_FragColor;\n"
      "void main() {\n"
...
DEF_TEST(SkSLClockwise, r) {
  test(
      r, "void main() { sk_FragColor = half4(sk_Clockwise ? +1 : -1); }",
      *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "out vec4 sk_FragColor;\n"
      "void main() {\n"
...
DEF_TEST(SkSLSampleMask, r) {
  test(
      r, "void main() { sk_SampleMask[0] |= 8; }", *SkSL::ShaderCapsFactory::SampleMaskSupport(),
      "#version 400\n"
      "void main() {\n"
      "    gl_SampleMask[0] |= 8;\n"
      "}\n");
...
DEF_TEST(SkSLVertexID, r) {
  test(
      r, "out int id; void main() { id = sk_VertexID; }", *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "out int id;\n"
      "void main() {\n"
      "    id = gl_VertexID;\n"
...
DEF_TEST(SkSLInstanceID, r) {
  test(
      r, "out int id; void main() { id = sk_InstanceID; }", *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "out int id;\n"
      "void main() {\n"
      "    id = gl_InstanceID;\n"
...
DEF_TEST(SkSLClipDistance, r) {
  test(
      r, "void main() { sk_ClipDistance[0] = 0; }", *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "void main() {\n"
      ...
      SkSL::Program::kVertex_Kind);
  test(
      r, "void main() { sk_FragColor = half4(half(sk_ClipDistance[0])); }",
      *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "out vec4 sk_FragColor;\n"
      "void main() {\n"
...
DEF_TEST(SkSLNormalization, r) {
  test(
      r, "uniform float4 sk_RTAdjust; void main() { sk_Position = half4(1); }",
      *SkSL::ShaderCapsFactory::Default(),
      "#version 400\n"
      "uniform vec4 sk_RTAdjust;\n"
      "void main() {\n"
