...
static void codec_yuv(skiatest::Reporter* reporter, const char path[], SkISize expectedSizes[4]) {
...

  {
    ...
    for (int i = 0; i < SkYUVASizeInfo::kMaxCount; ++i) {
      ...
      REPORTER_ASSERT(reporter, info.fWidthBytes[i] == (uint32_t)SkAlign8(info.fSizes[i].width()));
    }
  }
