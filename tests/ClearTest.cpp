...
static bool check_rect(
    GrDirectContext* dContext, GrRenderTargetContext* rtc, const SkIRect& rect,
...
static void clear_op_test(skiatest::Reporter* reporter, GrDirectContext* dContext) {
  ...
  if (!check_rect(
      ...
      !check_rect(dContext, rtContext.get(), outerTopEdge, kColor1, &actualValue, &failX, &failY) ||
      !check_rect(
  ...
  if (!check_rect(
      ...
      !check_rect(dContext, rtContext.get(), innerTopEdge, kColor2, &actualValue, &failX, &failY) ||
      !check_rect(
