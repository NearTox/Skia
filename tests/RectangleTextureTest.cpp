...
static void test_basic_draw_as_src(
  ...
  for (auto filter : {GrSamplerState::Filter::kNearest, GrSamplerState::Filter::kBilerp,
    ...
    test_read_pixels(reporter, rtContext.get(), expectedPixelValues, "RectangleTexture-basic-draw");
  }
}
...
static void test_copy_to_surface(
  ...
  for (auto renderable : {GrRenderable::kNo, GrRenderable::kYes}) {
    ...
    auto src = sk_gpu_test::MakeTextureProxyFromData(
        ...
        kPremul_SkAlphaType, origin, pixels.get(), 0);
