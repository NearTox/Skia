    ...
    for (auto renderable : {GrRenderable::kNo, GrRenderable::kYes}) {
      ...
      if (GrRenderable::kYes == renderable) {
        sk_sp<SkSurface> surface = SkSurface::MakeFromBackendTexture(
            dContext, backendTex, kTopLeft_GrSurfaceOrigin, 0, kRGBA_8888_SkColorType, nullptr,
            nullptr);
        ...
        image = SkImage::MakeFromTexture(
            dContext, backendTex, kTopLeft_GrSurfaceOrigin, kRGBA_8888_SkColorType,
    ...
    for (auto isWrapped : {false, true}) {
      ...
      if (isWrapped) {
        ...
        surface = SkSurface::MakeRenderTarget(
            dContext, SkBudgeted::kYes, info, 0, kTopLeft_GrSurfaceOrigin, nullptr, willUseMips);
      }
