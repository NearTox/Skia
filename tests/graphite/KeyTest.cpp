...
DEF_GRAPHITE_TEST_FOR_CONTEXTS(KeyTest, reporter, context) {
  ...
  {
    static const int kMaxBlockDataSize =
        SkPaintParamsKey::kMaxBlockSize - SkPaintParamsKey::kBlockHeaderSizeInBytes;
    ...
    int dummySnippetID1 =
        dict->addUserDefinedSnippet("keyAlmostTooBig", SkMakeSpan(kDataFields1, kNumFields1));
  ...
  // Too big
  {
    ...
    int dummySnippetID2 =
        dict->addUserDefinedSnippet("keyTooBig", SkMakeSpan(kDataFields2, kNumFields2));
