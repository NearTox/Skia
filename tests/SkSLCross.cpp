...
static void run_test(
    skiatest::Reporter*, GrDirectContext*, skgpu::v1::SurfaceDrawContext*, SkVector a, SkVector b,
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(SkSLCross, reporter, ctxInfo) {
  ...
  auto sdc = skgpu::v1::SurfaceDrawContext::Make(
      dContext, GrColorType::kRGBA_8888, nullptr, SkBackingFit::kExact, {1, 1}, SkSurfaceProps());
  if (!sdc) {
    ...
    class Impl : public ProgramImpl {
     public:
      void emitCode(EmitArgs& args) override {
        ...
        const char *a, *b;
        fAUniform = args.fUniformHandler->addUniform(
            &fp, kFragment_GrShaderFlag, GrSLType::kFloat2_GrSLType, "a", &a);
        fBUniform = args.fUniformHandler->addUniform(
            &fp, kFragment_GrShaderFlag, GrSLType::kFloat2_GrSLType, "b", &b);
...
static void run_test(
    skiatest::Reporter* reporter, GrDirectContext* directContext,
    skgpu::v1::SurfaceDrawContext* sdc, SkVector a, SkVector b, float expectedCrossProduct) {
