...
DEF_TEST(OffsetSimplePoly, reporter) {
  ...
  *rrectPoly.push() = SkPoint::Make(-100 - 2.5f, 50 + 4.330127f);
  ...
  bool result = SkOffsetSimplePolygon(rrectPoly.begin(), rrectPoly.count(), bounds, 3, &offsetPoly);
  ...
  *clippedRRectPoly.push() = SkPoint::Make(342.289948f, 432.947998f);
  ...
  REPORTER_ASSERT(reporter, SkIsConvexPolygon(clippedRRectPoly.begin(), clippedRRectPoly.count()));

  result = SkOffsetSimplePolygon(
      clippedRRectPoly.begin(), clippedRRectPoly.count(), bounds, 32.3699417f, &offsetPoly);
  REPORTER_ASSERT(reporter, result);
  REPORTER_ASSERT(reporter, SkIsConvexPolygon(offsetPoly.begin(), offsetPoly.count()));
  ...
  *starPoly.push() = SkPoint::Make(-14.43f, -25.0f);
  ...
  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, 0.1f, &offsetPoly);
  REPORTER_ASSERT(reporter, result);
  REPORTER_ASSERT(reporter, SkIsSimplePolygon(offsetPoly.begin(), offsetPoly.count()));

  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, 5.665f, &offsetPoly);
  REPORTER_ASSERT(reporter, result);
  REPORTER_ASSERT(reporter, SkIsSimplePolygon(offsetPoly.begin(), offsetPoly.count()));

  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, 28, &offsetPoly);
  REPORTER_ASSERT(reporter, result);
  REPORTER_ASSERT(reporter, SkIsSimplePolygon(offsetPoly.begin(), offsetPoly.count()));

  // down to a point
  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, 28.866f, &offsetPoly);
  REPORTER_ASSERT(reporter, !result);

  // and past
  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, 50.5f, &offsetPoly);
  REPORTER_ASSERT(reporter, !result);
  ...
  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, -5.6665f, &offsetPoly);
  REPORTER_ASSERT(reporter, result);
  REPORTER_ASSERT(reporter, SkIsSimplePolygon(offsetPoly.begin(), offsetPoly.count()));

  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, -50, &offsetPoly);
  REPORTER_ASSERT(reporter, result);
  REPORTER_ASSERT(reporter, SkIsSimplePolygon(offsetPoly.begin(), offsetPoly.count()));

  result = SkOffsetSimplePolygon(starPoly.begin(), starPoly.count(), bounds, -100, &offsetPoly);
  REPORTER_ASSERT(reporter, result);
  REPORTER_ASSERT(reporter, SkIsSimplePolygon(offsetPoly.begin(), offsetPoly.count()));
