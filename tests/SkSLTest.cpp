...
static void test_one_permutation(
  ...
  REPORTER_ASSERT(
      ...
      "Expected: solid green. Actual: A=%02X R=%02X G=%02X B=%02X.", SkColorGetA(color),
      SkColorGetR(color), SkColorGetG(color), SkColorGetB(color));
}

static void test_permutations(
    skiatest::Reporter* r, SkSurface* surface, const char* testFile, bool worksInES2) {
...
#define SKSL_TEST_CPU(name, path) \
  DEF_TEST(name##_CPU, r) { test_cpu(r, path); }
...
SKSL_TEST_ES3(
    SkSLDoWhileBodyMustBeInlinedIntoAScope, "inliner/DoWhileBodyMustBeInlinedIntoAScope.sksl")
...
SKSL_TEST_ES3(
    SkSLForInitializerExpressionsCanBeInlined, "inliner/ForInitializerExpressionsCanBeInlined.sksl")
...
SKSL_TEST(
    SkSLInlinerElidesTempVarForReturnsInsideBlock,
    "inliner/InlinerElidesTempVarForReturnsInsideBlock.sksl")
SKSL_TEST(
    SkSLInlinerUsesTempVarForMultipleReturns, "inliner/InlinerUsesTempVarForMultipleReturns.sksl")
SKSL_TEST(
    SkSLInlinerUsesTempVarForReturnsInsideBlockWithVar,
...
SKSL_TEST(
    SkSLShortCircuitEvaluationsCannotInlineRightHandSide,
...
SKSL_TEST_ES3(SkSLWhileBodyMustBeInlinedIntoAScope, "inliner/WhileBodyMustBeInlinedIntoAScope.sksl")
...
SKSL_TEST_CPU(
    SkSLInlinerHonorsGLSLOutParamSemantics, "inliner/InlinerHonorsGLSLOutParamSemantics.sksl")
