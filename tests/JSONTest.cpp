...
static void check_vector(
    skiatest::Reporter* reporter, const Value& v, size_t expected_size, bool is_vector) {
...
DEF_TEST(JSON_ParseNumber, reporter) {
  static constexpr struct {
    ...
    SkScalar value, tolerance;
      ...
      {"20."
       "0011118144444444444444444444444444444444444444444444444444444444444444444444444444444444444"
       "44444444444444444444444444444473",
       20.001f, 0.001f},
  };
