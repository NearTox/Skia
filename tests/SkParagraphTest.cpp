...
DEF_TEST(SkParagraph_InlinePlaceholderParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[1].rect.right(), 90.921f + 50 - 0.5f, EPSILON2));
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[3].rect.right(), 231.343f + 50 - 0.5f, EPSILON2));
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[4].rect.right(), 281.343f + 5 - 0.5f, EPSILON2));
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[6].rect.right(), 336.343f + 5 - 0.5f, EPSILON2));
...
DEF_TEST(SkParagraph_InlinePlaceholderBaselineParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[0].rect.right(), 90.921f + 55 - 0.5f, EPSILON2));
...
DEF_TEST(SkParagraph_InlinePlaceholderBottomParagraph, reporter) {
  ...
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.top(), 0, EPSILON100));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[0].rect.right(), 90.921f + 55 - 0.5f, EPSILON50));
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.bottom(), 50, EPSILON100));
...
DEF_TEST(SkParagraph_InlinePlaceholderIdeographicBaselineParagraph, reporter) {
  ...
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.top(), 0, EPSILON100));
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[0].rect.right(), 162.5f + 55 - 0.5f, EPSILON50));
  REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.bottom(), 50, EPSILON100));
...
DEF_TEST(SkParagraph_InlinePlaceholderBreakParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[11].rect.right(), 631.343f - 0.5f, EPSILON20));
...
DEF_TEST(SkParagraph_InlinePlaceholderGetRectsParagraph, reporter) {
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[16].rect.right(), 850.921f - 0.5f, EPSILON20));
  ...
  REPORTER_ASSERT(
      reporter, SkScalarNearlyEqual(boxes[33].rect.right(), 508.382f - 0.5f, EPSILON10));
