...
static bool check_read(
    skiatest::Reporter* reporter, const SkBitmap& expectedBitmap, const SkBitmap& actualBitmap) {
  bool result = true;
...
static void basic_draw_test_helper(
  ...
  sk_sp<SkImage> image =
      SkImage::MakeFromAHardwareBuffer(buffer, kPremul_SkAlphaType, nullptr, surfaceOrigin);
...
// surface.
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(GrAHardwareBuffer_BasicDrawTest, reporter, context_info) {
...
static void surface_draw_test_helper(
  ...
  sk_sp<SkSurface> surface =
      SkSurface::MakeFromAHardwareBuffer(context, buffer, surfaceOrigin, nullptr, nullptr);
  if (!surface) {
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(GrAHardwareBuffer_ImportAsSurface, reporter, context_info) {
