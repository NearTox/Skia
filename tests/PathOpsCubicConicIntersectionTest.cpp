...
// More work to be done to figure this out.
    ...
    {{{{188.60000610351562, 2041.5999755859375},
       {188.60000610351562, 2065.39990234375},
       {208, 2084.800048828125},
       {231.80000305175781, 2084.800048828125}}},
     {{{{231.80000305175781, 2084.800048828125},
        {188.60000610351562, 2084.800048828125},
        {188.60000610351562, 2041.5999755859375}}},
      0.707107008f}},

    {{{{231.80000305175781, 2084.800048828125},
       {255.60000610351562, 2084.800048828125},
       {275, 2065.39990234375},
       {275, 2041.5999755859375}}},
     {{{{275, 2041.5999755859375},
        {275, 2084.800048828125},
        {231.80000305175781, 2084.800048828125}}},
      0.707107008f}},
};
...
static void cubicConicIntersection(skiatest::Reporter* reporter, int index) {
  ...
  for (int pt = 0; pt < roots; ++pt) {
    ...
    if (!xy1.approximatelyEqual(xy2)) {
      SkDebugf(
          "%s [%d,%d] x!= t1=%g (%g,%g) t2=%g (%g,%g)\n", __FUNCTION__, index, pt, tt1, xy1.fX,
...
DEF_TEST(PathOpsCubicConicIntersectionOneOff, reporter) { cubicConicIntersection(reporter, 0); }
