...
static const CubicPts tests[] = {
    {{{0, 0}, {1, 1}, {2, 2}, {0, 3}}},      {{{0, 0}, {1, 1}, {2, 2}, {3, 0}}},
    {{{0, 0}, {5, 0}, {-2, 4}, {3, 4}}},     {{{0, 2}, {1, 0}, {2, 0}, {3, 0}}},
    {{{0, .2}, {1, 0}, {2, 0}, {3, 0}}},     {{{0, .02}, {1, 0}, {2, 0}, {3, 0}}},
    {{{0, .002}, {1, 0}, {2, 0}, {3, 0}}},   {{{0, .0002}, {1, 0}, {2, 0}, {3, 0}}},
    {{{0, .00002}, {1, 0}, {2, 0}, {3, 0}}}, {{{0, FLT_EPSILON * 2}, {1, 0}, {2, 0}, {3, 0}}},
};
  ...
  for (size_t index = 0; index < tests_count; ++index) {
    ...
    for (inner = 0; inner < 2; ++inner) {
      ...
      SkDebugf(
          ...
          __FUNCTION__, static_cast<int>(index), (int)inner, denormalizedDistance[inner],
          answers[index][inner], distSq, answersSq, normalSquared);
    }
    ...
    for (inner = 0; inner < 2; ++inner) {
      ...
      SkDebugf(
          ...
          static_cast<int>(index), (int)inner, normalizedDistance[inner], answers[index][inner]);
