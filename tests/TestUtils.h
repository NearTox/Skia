...
void test_read_pixels(
    skiatest::Reporter*, GrSurfaceContext* srcContext, uint32_t expectedPixelValues[],
    const char* testName);
...
void test_write_pixels(
    skiatest::Reporter*, GrSurfaceContext* srcContext, bool expectedToWork, const char* testName);
...
bool create_backend_texture(
    GrContext*, GrBackendTexture* backendTex, const SkImageInfo& ii, const SkColor4f& color,
