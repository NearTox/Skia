...
void TestReadPixels(
    skiatest::Reporter*, GrDirectContext*, GrSurfaceContext* srcContext,
...
void TestWritePixels(
    skiatest::Reporter*, GrDirectContext*, GrSurfaceContext* srcContext, bool expectedToWork,
    const char* testName);
...
void TestCopyFromSurface(
    skiatest::Reporter*, GrDirectContext*, GrSurfaceProxy* proxy, GrSurfaceOrigin origin,
...
bool CreateBackendTexture(
    GrDirectContext*, GrBackendTexture* backendTex, int width, int height, SkColorType colorType,
    const SkColor4f& color, GrMipmapped, GrRenderable, GrProtected = GrProtected::kNo);
