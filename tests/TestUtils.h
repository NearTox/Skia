...
void test_copy_from_surface(
    skiatest::Reporter*, GrContext*, GrSurfaceProxy* proxy, uint32_t expectedPixelValues[],
...
void test_copy_to_surface(
    skiatest::Reporter*, GrContext*, GrSurfaceContext* dstContext, const char* testName);
...
bool create_backend_texture(
    GrContext*, GrBackendTexture* backendTex, const SkImageInfo& ii, GrMipMapped mipMapped,
    SkColor color, GrRenderable);
