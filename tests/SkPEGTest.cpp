...
void test_LIT(skiatest::Reporter* r) {
  static const struct {
    ...
    bool fMatch;
      ...
      {"", false}, {" ", false}, {"x", false}, {"X", true}, {"xX", false}, {"Xx", true},
  };
...
void test_Alpha(skiatest::Reporter* r) {
  static const struct {
    ...
    char fMatchValue;
      ...
      {"", false, 0},   {"\r", false, 0},  {"\n", false, 0},  {"\t", false, 0}, {"0", false, 0},
      {"9", false, 0},  {"a", true, 'a'},  {"a", true, 'a'},  {"z", true, 'z'}, {"A", true, 'A'},
      {"Z", true, 'Z'}, {"az", true, 'a'}, {"a0", true, 'a'}, {"0a", false, 0},
  };
...
void test_Digit(skiatest::Reporter* r) {
  static const struct {
    ...
    uint8_t fMatchValue;
      ...
      {"", false, 0},   {"/", false, 0}, {":", false, 0}, {"x", false, 0},
      {"x0", false, 0}, {"0", true, 0},  {"1x", true, 1}, {"9 a", true, 9},
  };
...
void test_Opt(skiatest::Reporter* r) {
  static const struct {
    ...
    bool fMatch;
      ...
      {"", false}, {"fo", false}, {" foo", false}, {"foo", true}, {"foobar", true},
  };
...
void test_AnySome(skiatest::Reporter* r) {
  ...
  for (size_t i = 0; i < SK_ARRAY_COUNT(gTests); ++i) {
    ...
    REPORTER_ASSERT(r, !matchSome || matchSome->get<1>().fValues.count() == gTests[i].fCount - 1);
  }
...
void test_Complex(skiatest::Reporter* r) {
  // [0-9]+(,[0-9]+)?$
  using P0 = Seq<Some<Digit>, Opt<Seq<LIT<','>, Some<Digit>>>, EOS>;
  ...
  // [ ]*[Ff]oo([Bb]ar)+[Bb]az[ ]*$
  using P1 =
      Seq<Any<LIT<' '>>, Choice<LIT<'F'>, LIT<'f'>>, LIT<'o', 'o'>,
          Some<Seq<Choice<LIT<'B'>, LIT<'b'>>, LIT<'a', 'r'>>>, Choice<LIT<'B'>, LIT<'b'>>,
          LIT<'a', 'z'>, Any<LIT<' '>>, EOS>;
