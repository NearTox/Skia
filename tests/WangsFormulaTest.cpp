...
DEF_TEST(wangs_formula_worst_case_cubic, r) {
  {
    ...
    REPORTER_ASSERT(
        r, wangs_formula::worst_case_cubic(kPrecision, 100, 100) ==
               wangs_formula_cubic_reference_impl(kPrecision, worstP));
    REPORTER_ASSERT(
        r, wangs_formula::worst_case_cubic_log2(kPrecision, 100, 100) ==
  ...
  auto check_worst_case_cubic = [&](const SkPoint* pts) {
    ...
    int worst_log2 = wangs_formula::worst_case_cubic_log2(kPrecision, bbox.width(), bbox.height());
