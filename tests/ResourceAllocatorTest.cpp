...
static sk_sp<GrSurfaceProxy> make_backend(
    GrDirectContext* dContext, const ProxyParams& p, GrBackendTexture* backendTex) {
  ...
  CreateBackendTexture(
      dContext, backendTex, p.fSize, p.fSize, skColorType, SkColors::kTransparent, GrMipmapped::kNo,
      GrRenderable::kNo);
...
sk_sp<GrSurfaceProxy> make_lazy(
  ...
  return proxyProvider->createLazyProxy(
      ...
      GrMipmapStatus::kNotAllocated, flags, p.fFit, p.fBudgeted, GrProtected::kNo,
