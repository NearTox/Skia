...
DEF_TEST(SkPDF_ToUnicode, reporter) {
  ...
  SkPDFAppendCmapSections(
      &glyphToUnicode[0], &subset, &buffer, true, 0, SkTMin<SkGlyphID>(0xFFFF, lastGlyphID));
...
endbfrange\n";
  ...
  SkPDFAppendCmapSections(
      &glyphToUnicode[0], &subset, &buffer, true, 8, SkTMin<SkGlyphID>(0x00FF, lastGlyphID));
...
endbfrange\n";
  ...
  SkPDFAppendCmapSections(
      &glyphToUnicode[0], &subset, &buffer, true, 0x00D, SkTMin<SkGlyphID>(0x00FE, lastGlyphID));
...
endbfchar\n";
  ...
  SkPDFAppendCmapSections(
      &glyphToUnicode[0], nullptr, &buffer, false, 0xFC, SkTMin<SkGlyphID>(0x110, lastGlyphID));
...
endbfrange\n";
  ...
  SkPDFAppendCmapSections(
      &glyphToUnicode[0], &subset2, &buffer2, true, 0, SkTMin<SkGlyphID>(0xFFFF, lastGlyphID));
