    ...
    for (SkClipOp op : {SkClipOp::kDifference, SkClipOp::kIntersect}) {
      ...
      if (nonEmptyAA != nonEmptyBW || clip2.getBounds() != rgn2.getBounds()) {
        ERRORF(
            ...
            r0.bottom(), op == SkClipOp::kDifference ? "DIFF" : "INTERSECT", r1.fLeft, r1.fTop,
            r1.right(), r1.bottom(), rgn2.getBounds().fLeft, rgn2.getBounds().fTop,
            rgn2.getBounds().right(), rgn2.getBounds().bottom(), clip2.getBounds().fLeft,
            clip2.getBounds().fTop, clip2.getBounds().right(), clip2.getBounds().bottom());
      }
