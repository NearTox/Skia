...
static GrQuad make_2d_quad() { return GrQuad(SkRect::MakeLTRB(1.f, 2.f, 3.f, 4.f)); }
...
TEST(Add2D) {
  ...
  ASSERTF(
      list2D.quadType() == GrQuadType::kRect, "Unexpected quad type: %d",
  ...
  ASSERTF(
      list2D.quadType() == GrQuadType::kPerspective,
...
TEST(AddWithMetadata2D) {
  ...
  ASSERTF(is_2d_quad(list2D[0]), "Incorrect quad at i=0");
  ASSERTF(
      list2D.metadata(0).fItem1 == 1 && list2D.metadata(0).fItem2 == 1.f,
      "Incorrect metadata at i=0");
  ASSERTF(is_2d_persp_quad(list2D[1]), "Incorrect quad at i=1");
  ASSERTF(
      list2D.metadata(1).fItem1 == 2 && list2D.metadata(1).fItem2 == 2.f,
  ...
  ASSERTF(is_3d_persp_quad(list2D[2]), "Incorrect quad at i=2");
  ASSERTF(
      list2D.metadata(2).fItem1 == 3 && list2D.metadata(2).fItem2 == 3.f,
...
TEST(AddWithMetadata3D) {
  ...
  ASSERTF(is_3d_persp_quad(list3D[0]), "Incorrect quad at i=0");
  ASSERTF(
      list3D.metadata(0).fItem1 == 3 && list3D.metadata(0).fItem2 == 3.f,
      "Incorrect metadata at i=0");
  ASSERTF(is_2d_persp_quad(list3D[1]), "Incorrect quad at i=1");
  ASSERTF(
      list3D.metadata(1).fItem1 == 2 && list3D.metadata(1).fItem2 == 2.f,
      "Incorrect metadata at i=1");
  ASSERTF(is_2d_quad(list3D[2]), "Incorrect quad at i=2");
  ASSERTF(
      list3D.metadata(2).fItem1 == 1 && list3D.metadata(2).fItem2 == 1.f,
      "Incorrect metadata at i=2");
}
...
TEST(Concat2DWith2DMetadata) {
  ...
  ASSERTF(is_2d_quad(a2D[0]), "Incorrect quad at i=0");
  ASSERTF(
      a2D.metadata(0).fItem1 == 1 && a2D.metadata(0).fItem2 == 1.f, "Incorrect metadata at i=0");
  ASSERTF(is_2d_persp_quad(a2D[1]), "Incorrect quad at i=1");
  ASSERTF(
      a2D.metadata(1).fItem1 == 2 && a2D.metadata(1).fItem2 == 2.f, "Incorrect metadata at i=1");
}
...
TEST(Concat3DWith2DMetadata) {
  ...
  ASSERTF(is_3d_persp_quad(a3D[0]), "Incorrect quad at i=0");
  ASSERTF(
      a3D.metadata(0).fItem1 == 1 && a3D.metadata(0).fItem2 == 1.f, "Incorrect metadata at i=0");
  ASSERTF(is_2d_quad(a3D[1]), "Incorrect quad at i=1");
  ASSERTF(
      a3D.metadata(1).fItem1 == 2 && a3D.metadata(1).fItem2 == 2.f, "Incorrect metadata at i=1");
}
...
TEST(WriteMetadata) {
  ...
  ASSERTF(
      list.metadata(0).fItem1 == 1 && list.metadata(0).fItem2 == 1.f,
  ...
  ASSERTF(
      list.metadata(0).fItem1 == 2 && list.metadata(0).fItem2 == 2.f,
