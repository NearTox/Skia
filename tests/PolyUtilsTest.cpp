...
DEF_TEST(PolyUtils, reporter) {
  ...
  *poly.push() = SkPoint::Make(102.5f, 54.330127f);
  ...
  REPORTER_ASSERT(
      reporter, SkTriangulateSimplePolygon(poly.begin(), indexMap, poly.count(), &triangleIndices));
...
#define PTSET(array) \
  ...
  const SkPoint b1[] = {
      {24.8219f, 8.05052f}, {26.0616f, 24.4895f}, {8.49582f, 16.815f},
      {27.3047f, 7.75211f}, {21.927f, 27.2051f},
  };
  const SkPoint b2[] = {
