...
void wrap_tex_test(skiatest::Reporter* reporter, GrContext* context) {
  ...
  GrBackendTexture origBackendTex =
      context->createBackendTexture(kW, kH, kColorType, GrMipMapped::kNo, GrRenderable::kNo);
...
void wrap_rt_test(skiatest::Reporter* reporter, GrContext* context) {
  ...
  GrBackendTexture origBackendTex =
      context->createBackendTexture(kW, kH, kColorType, GrMipMapped::kNo, GrRenderable::kYes);
