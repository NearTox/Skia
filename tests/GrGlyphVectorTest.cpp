...
class TestingPeer {
 public:
  ...
  static SkSpan<GlyphVector::Variant> GetGlyphs(const GlyphVector& v) { return v.fGlyphs; }
};
...
DEF_TEST(GlyphVector_Serialization, r) {
  ...
  GlyphVector src =
      GlyphVector::Make(strikeSpec.findOrCreateStrike(), SkMakeSpan(glyphs, N), &alloc);
