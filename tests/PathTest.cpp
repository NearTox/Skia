...
static void check_convexity(
    skiatest::Reporter* reporter, const SkPath& path, SkPathConvexityType expected) {
  SkPath copy(path);  // we make a copy so that we don't cache the result on the passed in path.
...
static void test_convexity(skiatest::Reporter* reporter) {
  ...
  static const struct {
    ...
    SkPathPriv::FirstDirection fExpectedDirection;
      ...
      {"0 0 10 10 20 20 0 0 10 10", SkPathConvexityType::kConcave,
  ...
  for (int index = 0; index < (int)(11 * axisAlignedPtsCount); ++index) {
    ...
    if (curveSelect == 0 || curveSelect == 1 || curveSelect == 2 || curveSelect == 5) {
      ...
      SkPathConvexityType c = copy.getConvexityType();
      REPORTER_ASSERT(
          reporter, SkPathConvexityType::kUnknown == c || SkPathConvexityType::kConcave == c);
    }
  }
...
static void check_simple_closed_rect(
    skiatest::Reporter* reporter, const SkPath& path, const SkRect& rect, SkPathDirection dir,
    unsigned start) {
...
static void test_is_simple_closed_rect(skiatest::Reporter* reporter) {
  ...
  for (int start = 0; start < 4; ++start) {
    for (auto dir : {SkPathDirection::kCCW, SkPathDirection::kCW}) {
      ...
      SkPathDirection swapDir =
          (dir == SkPathDirection::kCW) ? SkPathDirection::kCCW : SkPathDirection::kCW;
...
static void write_and_read_back(skiatest::Reporter* reporter, const SkPath& p) {
  ...
  REPORTER_ASSERT(reporter, readBack.getConvexityTypeOrUnknown() == p.getConvexityTypeOrUnknown());
...
static void test_zero_length_paths(skiatest::Reporter* reporter) {
  ...
  static const SkPath::Verb resultVerbs4[] = {
      SkPath::kMove_Verb, SkPath::kClose_Verb, SkPath::kMove_Verb, SkPath::kClose_Verb};
  static const SkPath::Verb resultVerbs5[] = {SkPath::kMove_Verb, SkPath::kLine_Verb};
  static const SkPath::Verb resultVerbs6[] = {
      SkPath::kMove_Verb, SkPath::kLine_Verb, SkPath::kMove_Verb, SkPath::kLine_Verb};
  static const SkPath::Verb resultVerbs7[] = {
      SkPath::kMove_Verb, SkPath::kLine_Verb, SkPath::kClose_Verb};
  ...
  static const SkPath::Verb resultVerbs10[] = {
      SkPath::kMove_Verb, SkPath::kQuad_Verb, SkPath::kMove_Verb, SkPath::kQuad_Verb};
  static const SkPath::Verb resultVerbs11[] = {
      SkPath::kMove_Verb, SkPath::kQuad_Verb, SkPath::kClose_Verb};
  ...
  static const SkPath::Verb resultVerbs14[] = {
      SkPath::kMove_Verb, SkPath::kCubic_Verb, SkPath::kMove_Verb, SkPath::kCubic_Verb};
  static const SkPath::Verb resultVerbs15[] = {
      SkPath::kMove_Verb, SkPath::kCubic_Verb, SkPath::kClose_Verb};
...
static void test_iter(skiatest::Reporter* reporter) {
  ...
  static const SkPath::Verb resultVerbs2[] = {
      SkPath::kMove_Verb, SkPath::kLine_Verb, SkPath::kMove_Verb, SkPath::kClose_Verb,
      SkPath::kDone_Verb};
...
static void test_rrect_convexity_is_unknown(
    skiatest::Reporter* reporter, SkPath* path, SkPathDirection dir) {
  REPORTER_ASSERT(reporter, path->isConvex());
  REPORTER_ASSERT(
      reporter, SkPathPriv::CheapIsFirstDirection(*path, SkPathPriv::AsFirstDirection(dir)));
  path->setConvexityType(SkPathConvexityType::kUnknown);
...
DEF_TEST(Path_isRect, reporter) {
  ...
  SkPath::Verb verbs15[] = {
      SkPath::kMove_Verb, SkPath::kLine_Verb, SkPath::kLine_Verb, SkPath::kLine_Verb,
      SkPath::kMove_Verb};
