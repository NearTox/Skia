...
DEF_TEST(SkVM, r) {
...

  {
    ...
    skvm::I32 x = b.splat(1), y = b.add(x, b.splat(2));
  ...
  test_jit_and_interpreter(
      r, SrcoverBuilder_F32{Fmt::RGBA_8888, Fmt::G8}.done(), [&](const skvm::Program& program) {
        uint32_t src[9];
  ...
  test_jit_and_interpreter(
      r, SrcoverBuilder_F32{Fmt::A8, Fmt::A8}.done(), [&](const skvm::Program& program) {
...
DEF_TEST(SkVM_i16x2, r) {
  skvm::Builder b;
  {
    ...
    skvm::I32 x = b.load32(buf), y = b.add_16x2(x, x),  // y = 2x
...
DEF_TEST(SkVM_Assembler, r) {
  ...
  test_asm(
      ...
      },
      {
          ...
          0x48, 0x81,         0b11'000'110, 0x80, 0x00, 0x00, 0x00,         0x49,
          0x81, 0b11'101'000, 0x40,         0x42, 0x0f, 0x00,
      });
  ...
  test_asm(
      ...
      {
          0xc5, 0xf5, 0x76, 0xc2, 0xc5, 0xf5, 0x66, 0xc2, 0xc5, 0xf4, 0xc2, 0xc2, 0x00, 0xc5,
          0xf4, 0xc2, 0xc2, 0x01, 0xc5, 0xf4, 0xc2, 0xc2, 0x02, 0xc5, 0xf4, 0xc2, 0xc2, 0x04,
      });
  ...
  test_asm(
      ...
      },
      {
          ...
          0x48, 0x83, 0xfa, 0x00, 0x48, 0x83, 0xf8, 0x0c, 0x49, 0x81, 0xfe, 0x00, 0x94, 0x35, 0x77,
      });
  ...
  test_asm(
      ...
      {
          0x0f, 0xb6, 0x06, 0x41, 0x0f, 0xb6, 0x00, 0x44, 0x0f, 0xb6, 0x06, 0x44, 0x0f,
          0xb6, 0x46, 12,   0x44, 0x0f, 0xb6, 0x86, 0x90, 0x01, 0x00, 0x00,
          ...
          0x88, 0x02, 0x44, 0x88, 0x02, 0x41, 0x88, 0x00,
      });
  ...
  test_asm(
      ...
      {
          0xc5, 0xfd, 0x6f, 0xda, 0xc5, 0xfe, 0x5b, 0xda, 0xc5, 0xfc,
          0x5b, 0xda, 0xc5, 0xfd, 0x5b, 0xda, 0xc5, 0xfc, 0x51, 0xda,
      });
  ...
  test_asm(
      ...
      {
          0x48, 0x8b, 0x07, 0x48, 0x8b, 0x47, 0x01, 0x48, 0x8b, 0x87, 0x00, 0x02, 0x00,
          0x00, 0x4d, 0x8b, 0x7d, 0x2a, 0x49, 0x8b, 0x45, 0x2a, 0x4c, 0x8b, 0x78, 0x2a,
      });
