...
DEF_GPUTEST_FOR_GL_RENDERING_CONTEXTS(EGLImageTest, reporter, ctxInfo) {
  ...
  {
    auto temp = context0->priv().makeSFCFromBackendTexture(
        colorInfo, backendTex, 1, origin,
  ...
  TestCopyFromSurface(
      reporter, context0, surfaceContext->asSurfaceProxyRef(), surfaceContext->origin(),
