...
static void test_isRectFinite(skiatest::Reporter* reporter) {
  static const SkPoint gF0[] = {{0, 0}, {1, 1}};
  static const SkPoint gF1[] = {{0, 0}, {1, 1}, {99.234f, -42342}};
  ...
  static const struct {
    ...
    bool fIsFinite;
      ...
      {gF0, SK_ARRAY_COUNT(gF0), true},  {gF1, SK_ARRAY_COUNT(gF1), true},

      {gI0, SK_ARRAY_COUNT(gI0), false}, {gI1, SK_ARRAY_COUNT(gI1), false},
      {gI2, SK_ARRAY_COUNT(gI2), false}, {gI3, SK_ARRAY_COUNT(gI3), false},
  };
...
static bool isFinite2_and(float x, float y, IsFiniteProc1 proc) { return proc(x) && proc(y); }
...
static void test_isfinite(skiatest::Reporter* reporter) {
  ...
  const Rec data[] = {
      ...
      {max * 0.75f, true}, {max, true},  {-max * 0.75f, true},
      {-max, true},        {inf, false}, {-inf, false},
      {nan, false},
  };

  const IsFiniteProc1 gProc1[] = {isFinite_int, isFinite_float, isFinite_mulzero};
  const IsFiniteProc2 gProc2[] = {isFinite2_and, isFinite2_mulzeroadd};
