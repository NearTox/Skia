...
static void test(
    skiatest::Reporter* r, const char* src, const GrShaderCaps& caps,
...
DEF_TEST(SkSLFPUniform, r) {
  test(
      ...
      "sk_OutColor = color;"
      "}",
      *SkSL::ShaderCapsFactory::Default(), {"static std::unique_ptr<GrFragmentProcessor> Make()"},
      {
  ...
  test(
      ...
      *SkSL::ShaderCapsFactory::Default(),
      ...
      {"SkRect colorPrev = SkRect::MakeEmpty();",
       ...
       "if (colorPrev.isEmpty() || colorPrev != colorValue) {", "colorPrev = colorValue;",
  ...
  test(
      ...
      *SkSL::ShaderCapsFactory::Default(),
      ...
      {"SkPMColor4f colorPrev = {SK_FloatNaN, SK_FloatNaN, SK_FloatNaN, SK_FloatNaN}",
       "auto test = _outer.test;", "if (test) {",
       "colorVar = args.fUniformHandler->addUniform(kFragment_GrShaderFlag, kHalf4_GrSLType, "
       "\"color\");",
       "if (colorVar.isValid()) {", "const SkPMColor4f& colorValue = _outer.color;",
       "if (colorPrev != colorValue) {", "colorPrev = colorValue;",
...
DEF_TEST(SkSLFPSections, r) {
  test(
      ...
      "sk_OutColor = half4(1);"
      "}",
      *SkSL::ShaderCapsFactory::Default(), {"header section"}, {});
  test(
      r,
      "@class { class section }"
      "void main() {"
  ...
  test(
      ...
      "sk_OutColor = half4(1);"
      "}",
      *SkSL::ShaderCapsFactory::Default(), {}, {"cpp section"});
  test(
      r,
      ...
      *SkSL::ShaderCapsFactory::Default(),
      {"Make(float w,  int x, float y, std::vector<float> z )",
       ...
       "GrTest(float w,  int x, float y, std::vector<float> z )", ", w(w) {"},
      {});
  test(
      r,
      ...
      "sk_OutColor = half4(1);"
      "}",
      *SkSL::ShaderCapsFactory::Default(), {"private:\n constructor section"}, {});
  test(
      r,
  ...
  test(
      ...
      *SkSL::ShaderCapsFactory::Default(), {},
      {"void onSetData(const GrGLSLProgramDataManager& varName, "
       "const GrFragmentProcessor& _proc) override {\n",
       "UniformHandle& calculated = calculatedVar;", "auto provided = _outer.provided;",
...
DEF_TEST(SkSLFPChildProcessors, r) {
  test(
      ...
      *SkSL::ShaderCapsFactory::Default(),
      ...
      {"SkString _child0(\"_child0\");", "this->emitChild(_outer.child1_index, &_child0, args);",
       "SkString _child1(\"_child1\");", "this->emitChild(_outer.child2_index, &_child1, args);",
...
DEF_TEST(SkSLFPChildProcessorsWithInput, r) {
  test(
      ...
      *SkSL::ShaderCapsFactory::Default(),
      {"this->registerChildProcessor(std::move(child1));",
       "this->registerChildProcessor(std::move(child2));"},
      {"SkString _input0(\"childIn\");", "SkString _child0(\"_child0\");",
       "this->emitChild(_outer.child1_index, _input0.c_str(), &_child0, args);",
       "SkString _input1(\"childOut1\");", "SkString _child1(\"_child1\");",
  ...
  test(
      ...
      *SkSL::ShaderCapsFactory::Default(), {"this->registerChildProcessor(std::move(child));"},
      {"opaque = _outer.childProcessor(_outer.child_index).preservesOpaqueInput();",
       ...
       "(opaque ? \"true\" : \"false\"));",
       "SkString _child0(\"_child0\");", "this->emitChild(_outer.child_index, &_child0, args);",
       "fragBuilder->codeAppendf(\"\\n    %s = %s;\\n} else {\\n    %s = half4(0.5);\\n}\\n\""
       ", args.fOutputColor, _child0.c_str(), args.fOutputColor);",
       "this->registerChildProcessor(src.childProcessor(child_index).clone());"});
}
