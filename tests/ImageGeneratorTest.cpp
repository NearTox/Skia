...
DEF_TEST(ImageGenerator, reporter) {
  ...
  SkYUVAInfo yuvaInfo(
      {250, 250}, SkYUVAInfo::PlaneConfig::kY_UV, SkYUVAInfo::Subsampling::k420,
      kJPEG_Full_SkYUVColorSpace);
  yuvaPixmapInfo = SkYUVAPixmapInfo(
...
DEF_TEST(PictureImageGenerator, reporter) {
  ...
  auto gen = SkImageGenerator::MakeFromPicture(
      {100, 100}, picture, nullptr, nullptr, SkImage::BitDepth::kU8, colorspace);
