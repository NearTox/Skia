...
class SurfaceParameters {
 public:
  ...
  void modify(int i) {
    switch (i) {
      case 0: fWidth = 63; break;
      case 1: fHeight = 63; break;
      case 2: fOrigin = kBottomLeft_GrSurfaceOrigin; break;
      case 3: fColorType = kRGBA_F16_SkColorType; break;
      case 4:
        ...
        break;
      case kSampleCount: fSampleCount = 4; break;
      case 6: fSurfaceProps = SkSurfaceProps(0x0, kRGB_H_SkPixelGeometry); break;
      case 7:
        fSurfaceProps = SkSurfaceProps(
            SkSurfaceProps::kUseDeviceIndependentFonts_Flag, kUnknown_SkPixelGeometry);
        break;
      case 8: fShouldCreateMipMaps = false; break;
      case 9:
      ...
      case 10:
        ...
        break;
      case 11:
        fIsProtected = GrProtected::kYes == fIsProtected ? GrProtected::kNo : GrProtected::kYes;
        break;
    }
  }
  ...
  sk_sp<SkSurface> make(GrDirectContext* dContext, GrBackendTexture* backend) const {
    ...
    GrMipmapped mipmapped = !fIsTextureable ? GrMipmapped::kNo : GrMipmapped(fShouldCreateMipMaps);
    ...
    CreateBackendTexture(
        dContext, backend, fWidth, fHeight, fColorType, SkColors::kTransparent, mipmapped,
        GrRenderable::kYes, fIsProtected);
    if (!backend->isValid()) {
      return nullptr;
    }
    ...
    if (!fIsTextureable) {
      ...
      surface = SkSurface::MakeFromBackendTextureAsRenderTarget(
          dContext, *backend, fOrigin, fSampleCount, fColorType, fColorSpace, &fSurfaceProps);
    } else {
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(DDLWrapBackendTest, reporter, ctxInfo) {
  ...
  CreateBackendTexture(
      dContext, &backendTex, kSize, kSize, kRGBA_8888_SkColorType, SkColors::kTransparent,
  ...
  sk_sp<SkImage> image = SkImage::MakeFromTexture(
      rContext, backendTex, kTopLeft_GrSurfaceOrigin, kRGBA_8888_SkColorType, kPremul_SkAlphaType,
      nullptr, TextureReleaseChecker::Release, &releaseChecker);
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(DDLInvalidRecorder, reporter, ctxInfo) {
...

  {
    ...
    sk_sp<SkImage> image = recorder.makePromiseTexture(
        ...
        kPremul_SkAlphaType, nullptr, dummy_fulfill_proc, dummy_release_proc, dummy_done_proc,
        nullptr, SkDeferredDisplayListRecorder::PromiseImageApiVersion::kNew);
    REPORTER_ASSERT(reporter, !image);
  }
}
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(DDLSkSurfaceFlush, reporter, ctxInfo) {
  ...
  if (!CreateBackendTexture(
          context, &backendTexture, ii, SkColors::kCyan, GrMipmapped::kNo, GrRenderable::kNo)) {
...

  {
    ...
    sk_sp<SkImage> promiseImage = recorder.makePromiseTexture(
        ...
        tracking_done_proc, &fulfillInfo,
