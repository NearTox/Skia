...
static bool digests_equal(
    const SkMD5::Digest& expectedDigest, const SkMD5::Digest& computedDigest) {
...
static void md5_test(
    const char* string, const SkMD5::Digest& expectedDigest, skiatest::Reporter* reporter) {
