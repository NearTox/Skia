...
static SkRRect path_contains_rrect(
    skiatest::Reporter* reporter, const SkPath& path, SkPath::Direction* dir, unsigned* start) {
  SkRRect out;
...
static SkRRect inner_path_contains_rrect(
    skiatest::Reporter* reporter, const SkRRect& in, SkPath::Direction dir, unsigned start) {
  switch (in.getType()) {
    case SkRRect::kEmpty_Type:
    case SkRRect::kRect_Type:
    case SkRRect::kOval_Type: return in;
    default: break;
  }
  SkPath path;
...
static void path_contains_rrect_check(
    skiatest::Reporter* reporter, const SkRRect& in, SkPath::Direction dir, unsigned start) {
...
static void path_contains_rrect_nocheck(
    skiatest::Reporter* reporter, const SkRRect& in, SkPath::Direction dir, unsigned start) {
  SkRRect out = inner_path_contains_rrect(reporter, in, dir, start);
  if (in == out) {
    SkDebugf("");
...
static void path_contains_rrect_check(
    skiatest::Reporter* reporter, const SkRect& r, SkVector v[4], SkPath::Direction dir,
    unsigned start) {
  SkRRect rrect;
...
static void force_path_contains_rrect(
    skiatest::Reporter* reporter, SkPath& path, SkPath::Direction dir, unsigned start) {
