...
static SkRRect path_contains_rrect(
    skiatest::Reporter* reporter, const SkPath& path, SkPathDirection* dir, unsigned* start) {
  SkRRect out;
...
static SkRRect inner_path_contains_rrect(
    skiatest::Reporter* reporter, const SkRRect& in, SkPathDirection dir, unsigned start) {
  switch (in.getType()) {
...
static void path_contains_rrect_check(
    skiatest::Reporter* reporter, const SkRect& r, SkVector v[4], SkPathDirection dir,
    unsigned start) {
  SkRRect rrect;
...
static void force_path_contains_rrect(
    skiatest::Reporter* reporter, SkPath& path, SkPathDirection dir, unsigned start) {
