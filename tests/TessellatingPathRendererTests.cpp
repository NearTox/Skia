...
static void test_path(
    ...
    const SkMatrix& matrix = SkMatrix::I(), AATypeFlags aaTypeFlags = AATypeFlags::kNone,
...
DEF_GPUTEST_FOR_ALL_CONTEXTS(TessellatingPathRendererTests, reporter, ctxInfo) {
  ...
  test_path(
      ctx, rtc.get(), create_path_17(), nonInvertibleMatrix, AATypeFlags::kCoverage, std::move(fp));
