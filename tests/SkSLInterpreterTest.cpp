...
void test(
    skiatest::Reporter* r, const char* src, float* in, float* expected, bool exactCompare = false) {
...
void test(
  ...
  if (program) {
    ...
    if (inoutColor[0].fFloat[0] != expectedR || inoutColor[1].fFloat[0] != expectedG ||
      ...
      printf("for program: %s\n", src);
      printf(
          "    expected (%f, %f, %f, %f), but received (%f, %f, %f, %f)\n", expectedR, expectedG,
          expectedB, expectedA, inoutColor[0].fFloat[0], inoutColor[1].fFloat[0],
          inoutColor[2].fFloat[0], inoutColor[3].fFloat[0]);
      main->disassemble();
    }
...
DEF_TEST(SkSLInterpreterAdd, r) {
  test(
      r, "void main(inout half4 color) { color.r = color.r + color.g; }", 0.25, 0.75, 0, 0, 1, 0.75,
      0, 0);
  test(r, "void main(inout half4 color) { color += half4(1, 2, 3, 4); }", 4, 3, 2, 1, 5, 5, 5, 5);
  test(
      r, "void main(inout half4 color) { half4 c = color; color += c; }", 0.25, 0.5, 0.75, 1, 0.5,
      1, 1.5, 2);
  test(
      r, "void main(inout half4 color) { color.r = int(color.r) + int(color.g); }", 1, 3, 0, 0, 4,
      3, 0, 0);
  test(
      r, "void main(inout half4 color) { color.rg = color.r + color.gb; }", 1, 2, 3, 4, 3, 4, 3, 4);
  test(
      r, "void main(inout half4 color) { color.rg = color.rg + color.b; }", 1, 2, 3, 4, 4, 5, 3, 4);
}

DEF_TEST(SkSLInterpreterSubtract, r) {
  test(
      r, "void main(inout half4 color) { color.r = color.r - color.g; }", 1, 0.75, 0, 0, 0.25, 0.75,
      0, 0);
  test(r, "void main(inout half4 color) { color -= half4(1, 2, 3, 4); }", 5, 5, 5, 5, 4, 3, 2, 1);
  test(r, "void main(inout half4 color) { half4 c = color; color -= c; }", 4, 3, 2, 1, 0, 0, 0, 0);
  ...
  test(
      r, "void main(inout half4 color) { color.r = int(color.r) - int(color.g); }", 3, 1, 0, 0, 2,
      1, 0, 0);
  test(
      r, "void main(inout half4 color) { color.rg = color.r - color.gb; }", 1, 2, 3, 4, -1, -2, 3,
      4);
  test(
      r, "void main(inout half4 color) { color.rg = color.rg - color.b; }", 1, 2, 3, 4, -2, -1, 3,
      4);
}

DEF_TEST(SkSLInterpreterMultiply, r) {
  test(r, "void main(inout half4 color) { color.r = color.r * color.g; }", 2, 3, 0, 0, 6, 3, 0, 0);
  test(r, "void main(inout half4 color) { color *= half4(1, 2, 3, 4); }", 2, 3, 4, 5, 2, 6, 12, 20);
  test(r, "void main(inout half4 color) { half4 c = color; color *= c; }", 4, 3, 2, 1, 16, 9, 4, 1);
  test(
      r, "void main(inout half4 color) { color.r = int(color.r) * int(color.g); }", 3, -2, 0, 0, -6,
      -2, 0, 0);
  test(
      r, "void main(inout half4 color) { color.rg = color.r * color.gb; }", 5, 2, 3, 4, 10, 15, 3,
      4);
  test(
      r, "void main(inout half4 color) { color.rg = color.rg * color.b; }", 1, 2, 3, 4, 3, 6, 3, 4);
}

DEF_TEST(SkSLInterpreterDivide, r) {
  test(
      r, "void main(inout half4 color) { color.r = color.r / color.g; }", 1, 2, 0, 0, 0.5, 2, 0, 0);
  test(
      r, "void main(inout half4 color) { color /= half4(1, 2, 3, 4); }", 12, 12, 12, 12, 12, 6, 4,
      3);
  test(r, "void main(inout half4 color) { half4 c = color; color /= c; }", 4, 3, 2, 1, 1, 1, 1, 1);
  test(
      r, "void main(inout half4 color) { color.r = int(color.r) / int(color.g); }", 8, -2, 0, 0, -4,
      -2, 0, 0);
  test(
      r, "void main(inout half4 color) { color.rg = color.r / color.gb; }", 12, 2, 3, 4, 6, 4, 3,
      4);
  test(
      r, "void main(inout half4 color) { color.rg = color.rg / color.b; }", 6, 3, 3, 4, 2, 1, 3, 4);
}

DEF_TEST(SkSLInterpreterRemainder, r) {
  test(
      r, "void main(inout half4 color) { color.r = color.r % color.g; }", 3.125, 2, 0, 0, 1.125, 2,
      0, 0);
  test(
      r, "void main(inout half4 color) { color %= half4(1, 2, 3, 4); }", 9.5, 9.5, 9.5, 9.5, 0.5,
      1.5, 0.5, 1.5);
  test(
      r, "void main(inout half4 color) { color.r = int(color.r) % int(color.g); }", 8, 3, 0, 0, 2,
      3, 0, 0);
  test(
      r,
      "void main(inout half4 color) { color.rg = half2(int2(int(color.r), int(color.g)) % "
      "int(color.b)); }",
      8, 10, 6, 0, 2, 4, 6, 0);
  test(
      r, "void main(inout half4 color) { color.rg = color.r + color.gb; }", 1, 2, 3, 4, 3, 4, 3, 4);
  test(
      r, "void main(inout half4 color) { color.rg = color.rg + color.b; }", 1, 2, 3, 4, 4, 5, 3, 4);
  test(
      r, "void main(inout half4 color) { color.rg = color.r % color.gb; }", 10, 2, 3, 4, 0, 1, 3,
      4);
  test(
      r, "void main(inout half4 color) { color.rg = color.rg % color.b; }", 6, 3, 4, 4, 2, 3, 4, 4);
}

DEF_TEST(SkSLInterpreterAnd, r) {
  test(
      r,
      "void main(inout half4 color) { if (color.r > color.g && color.g > color.b) "
      "color = half4(color.a); }",
      2, 1, 0, 3, 3, 3, 3, 3);
  test(
      r,
  ...
  test(
      r,
      "int global; bool update() { global = 123; return true; }"
      "void main(inout half4 color) { global = 0;  if (color.r > color.g && update()) "
      "color = half4(color.a); color.a = global; }",
      2, 1, 1, 3, 3, 3, 3, 123);
  test(
      r,
      "int global; bool update() { global = 123; return true; }"
...
DEF_TEST(SkSLInterpreterBitwise, r) {
  test(
      r, "void main(inout half4 color) { color.r = half(int(color.r) | 3); }", 5, 0, 0, 0, 7, 0, 0,
      0);
  test(
      r, "void main(inout half4 color) { color.r = half(int(color.r) & 3); }", 6, 0, 0, 0, 2, 0, 0,
      0);
  test(
      r, "void main(inout half4 color) { color.r = half(int(color.r) ^ 3); }", 5, 0, 0, 0, 6, 0, 0,
      0);
  test(
      r, "void main(inout half4 color) { color.r = half(~int(color.r) & 3); }", 6, 0, 0, 0, 1, 0, 0,
      0);

  test(
      r, "void main(inout half4 color) { color.r = half(uint(color.r) | 3); }", 5, 0, 0, 0, 7, 0, 0,
      0);
  test(
      r, "void main(inout half4 color) { color.r = half(uint(color.r) & 3); }", 6, 0, 0, 0, 2, 0, 0,
      0);
  test(
      r, "void main(inout half4 color) { color.r = half(uint(color.r) ^ 3); }", 5, 0, 0, 0, 6, 0, 0,
      0);
  test(
      r, "void main(inout half4 color) { color.r = half(~uint(color.r) & 3); }", 6, 0, 0, 0, 1, 0,
      0, 0);
...
DEF_TEST(SkSLInterpreterMatrix, r) {
  ...
  expected[0] = 2.0f;
  test(
      r, "float main(float x) { float4x4 m = float4x4(x); return m[1][1] + m[1][2] + m[2][2]; }",
      in, expected);

  // With non-square matrix
  test(
      r, "float main(float x) { float3x2 m = float3x2(x); return m[0][0] + m[1][1] + m[2][1]; }",
      in, expected);
  ...
  expected[0] = 6.0f;
  test(
      r, "float main(float4 v) { float2x2 m = float2x2(v); return m[0][1] + m[1][0]; }", in,
      expected);
  ...
  // M*M
  {
    ...
    test(
        r, "float4x4 main(float4x4 m) { return m * float4x4(m[1], m[2], m[3], m[0]); }", in,
        (float*)&m);
  }
}
...
DEF_TEST(SkSLInterpreterTernary, r) {
  test(
      r, "void main(inout half4 color) { color.r = color.g > color.b ? color.g : color.b; }", 0, 1,
      2, 0, 2, 1, 2, 0);
  test(
      r, "void main(inout half4 color) { color.r = color.g > color.b ? color.g : color.b; }", 0, 3,
      2, 0, 3, 3, 2, 0);
}
...
DEF_TEST(SkSLInterpreterIf, r) {
  test(
      r, "void main(inout half4 color) { if (color.r > color.g) color.a = 1; }", 5, 3, 0, 0, 5, 3,
      0, 1);
  test(
      r, "void main(inout half4 color) { if (color.r > color.g) color.a = 1; }", 5, 5, 0, 0, 5, 5,
      0, 0);
  test(
      r, "void main(inout half4 color) { if (color.r > color.g) color.a = 1; }", 5, 6, 0, 0, 5, 6,
      0, 0);
  test(
      r, "void main(inout half4 color) { if (color.r < color.g) color.a = 1; }", 3, 5, 0, 0, 3, 5,
      0, 1);
  test(
      r, "void main(inout half4 color) { if (color.r < color.g) color.a = 1; }", 5, 5, 0, 0, 5, 5,
      0, 0);
  test(
      r, "void main(inout half4 color) { if (color.r < color.g) color.a = 1; }", 6, 5, 0, 0, 6, 5,
      0, 0);
  test(
      r, "void main(inout half4 color) { if (color.r >= color.g) color.a = 1; }", 5, 3, 0, 0, 5, 3,
      0, 1);
  ...
  test(
      ...
      0, 0);
  test(
      r, "void main(inout half4 color) { if (color.r == color.g) color.a = 1; }", 2, 2, 0, 0, 2, 2,
      0, 1);
  test(
      r, "void main(inout half4 color) { if (color.r == color.g) color.a = 1; }", 2, -2, 0, 0, 2,
      -2, 0, 0);
  test(
      r, "void main(inout half4 color) { if (color.r != color.g) color.a = 1; }", 2, 2, 0, 0, 2, 2,
      0, 0);
  ...
  test(
      r,
      "void main(inout half4 color) { if (color.r == color.g) color.a = 1; else "
      "color.a = 2; }",
      1, 1, 0, 0, 1, 1, 0, 1);
  test(
      r,
...
DEF_TEST(SkSLInterpreterIfVector, r) {
  test(
      r, "void main(inout half4 color) { if (color.rg == color.ba) color.a = 1; }", 1, 2, 1, 2, 1,
      2, 1, 1);
  test(
      r, "void main(inout half4 color) { if (color.rg == color.ba) color.a = 1; }", 1, 2, 1, 3, 1,
      2, 1, 3);
  test(
      r, "void main(inout half4 color) { if (color.rg == color.ba) color.a = 1; }", 1, 2, 3, 2, 1,
      2, 3, 2);
  test(
      r, "void main(inout half4 color) { if (color.rg != color.ba) color.a = 1; }", 1, 2, 1, 2, 1,
      2, 1, 2);
...
DEF_TEST(SkSLInterpreterWhile, r) {
  test(
      r, "void main(inout half4 color) { while (color.r < 8) { color.r++; } }", 1, 2, 3, 4, 8, 2, 3,
      4);
  test(
      r, "void main(inout half4 color) { while (color.r < 1) color.r += 0.25; }", 0, 0, 0, 0, 1, 0,
      0, 0);
  test(
      r, "void main(inout half4 color) { while (color.r > 1) color.r -= 0.25; }", 0, 0, 0, 0, 0, 0,
      0, 0);
  test(
      r,
      "void main(inout half4 color) { while (true) { color.r += 0.5; "
      "if (color.r > 5) break; } }",
      0, 0, 0, 0, 5.5, 0, 0, 0);
  test(
      r,
      "void main(inout half4 color) { while (color.r < 10) { color.r += 0.5; "
      "if (color.r < 5) continue; break; } }",
      0, 0, 0, 0, 5, 0, 0, 0);
  test(
      r,
...
DEF_TEST(SkSLInterpreterDo, r) {
  test(
      r, "void main(inout half4 color) { do color.r += 0.25; while (color.r < 1); }", 0, 0, 0, 0, 1,
      0, 0, 0);
  test(
      r, "void main(inout half4 color) { do color.r -= 0.25; while (color.r > 1); }", 0, 0, 0, 0,
      -0.25, 0, 0, 0);
  test(
      r,
      "void main(inout half4 color) { do { color.r += 0.5; if (color.r > 1) break; } while "
      "(true); }",
      0, 0, 0, 0, 1.5, 0, 0, 0);
  test(
      r,
      "void main(inout half4 color) {do { color.r += 0.5; if (color.r < 5) "
      "continue; if (color.r >= 5) break; } while (true); }",
      0, 0, 0, 0, 5, 0, 0, 0);
  test(
      r, "void main(inout half4 color) { do { color.r += 0.5; } while (false); }", 0, 0, 0, 0, 0.5,
      0, 0, 0);
}

DEF_TEST(SkSLInterpreterFor, r) {
  test(
      r, "void main(inout half4 color) { for (int i = 1; i <= 10; ++i) color.r += i; }", 0, 0, 0, 0,
      55, 0, 0, 0);
  test(
      r,
      "void main(inout half4 color) {"
...
DEF_TEST(SkSLInterpreterSwizzle, r) {
  ...
  test(
      r, "void main(inout half4 color) { color.rgb = half4(5, 6, 7, 8).bbg; }", 1, 2, 3, 4, 7, 7, 6,
      4);
  test(r, "void main(inout half4 color) { color.bgr = int3(5, 6, 7); }", 1, 2, 3, 4, 7, 6, 5, 4);
}

DEF_TEST(SkSLInterpreterGlobal, r) {
  test(r, "int x; void main(inout half4 color) { x = 10; color.b = x; }", 1, 2, 3, 4, 1, 2, 10, 4);
  test(
      r, "float4 x; void main(inout float4 color) { x = color * 2; color = x; }", 1, 2, 3, 4, 2, 4,
      6, 8);
  test(
      r, "float4 x; void main(inout float4 color) { x = float4(5, 6, 7, 8); color = x.wzyx; }", 1,
      2, 3, 4, 8, 7, 6, 5);
  test(
      r, "float4 x; void main(inout float4 color) { x.wzyx = float4(5, 6, 7, 8); color = x; }", 1,
      2, 3, 4, 8, 7, 6, 5);
}
...
DEF_TEST(SkSLInterpreterCompound, r) {
  ...
  auto rect_height = byteCode->getFunction("rect_height"),
       ...
       median = byteCode->getFunction("median"), sums = byteCode->getFunction("sums"),
...

  {
    ...
    REPORTER_ASSERT(r, success);
    RectAndColor result{
        {geti(out), geti(out + 1), geti(out + 2), geti(out + 3)},
...
DEF_TEST(SkSLInterpreterMathFunctions, r) {
  ...
  value[0] = 90.0f;
  expected[0] = sk_float_degrees_to_radians(value[0]);
  test(r, "float main(float x) { return radians(x); }", value, expected);

  value[0] = 1.0f;
  value[1] = -1.0f;
  expected[0] = 1.0f / SK_FloatSqrt2;
  expected[1] = -1.0f / SK_FloatSqrt2;
...
DEF_TEST(SkSLInterpreterMix, r) {
  ...
  test(
      r, "float4 main(float4 x, float4 y) { return mix(x, y, 0.5); }", valueVectors,
      expectedVector);
}

DEF_TEST(SkSLInterpreterCross, r) {
  float args[] = {1.0f, 4.0f, -6.0f, -2.0f, 7.0f, -3.0f};
  SkV3 cross = SkV3::Cross({args[0], args[1], args[2]}, {args[3], args[4], args[5]});
...
DEF_TEST(SkSLInterpreterDot, r) {
  ...
  float expected = args[0] * args[2] + args[1] * args[3];
  test(r, "float main(float2 x, float2 y) { return dot(x, y); }", args, &expected);

  expected = args[0] * args[3] + args[1] * args[4] + args[2] * args[5];
  test(r, "float main(float3 x, float3 y) { return dot(x, y); }", args, &expected);

  expected = args[0] * args[4] + args[1] * args[5] + args[2] * args[6] + args[3] * args[7];
...
static const SkSL::Type& type_of(const skjson::Value* value, SkSL::Compiler* compiler) {
  switch (value->getType()) {
    ...
    case skjson::Value::Type::kBool: return *compiler->context().fBool_Type;
    default: return *compiler->context().fVoid_Type;
  }
}
...
class JSONExternalValue : public SkSL::ExternalValue {
 public:
  JSONExternalValue(const char* name, const skjson::Value* value, SkSL::Compiler* compiler)
      : INHERITED(name, type_of(value, compiler)), fValue(*value), fCompiler(*compiler) {}
  ...
  SkSL::ExternalValue* getChild(const char* name) const override {
    if (fValue.getType() == skjson::Value::Type::kObject) {
      ...
      return (SkSL::ExternalValue*)fCompiler.takeOwnership(
          std::unique_ptr<Symbol>(new JSONExternalValue(name, &v, &fCompiler)));
    }
    return nullptr;
  }
...
class PointerExternalValue : public SkSL::ExternalValue {
 public:
  PointerExternalValue(const char* name, const SkSL::Type& type, void* data, size_t size)
      : INHERITED(name, type), fData(data), fSize(size) {}
...
DEF_TEST(SkSLInterpreterExternalValues, r) {
  ...
  int32_t outValue = -1;
  compiler.registerExternalValue((SkSL::ExternalValue*)compiler.takeOwnership(
      std::unique_ptr<SkSL::Symbol>(new PointerExternalValue(
...
DEF_TEST(SkSLInterpreterExternalValuesCall, r) {
  ...
  const char* src =
      ...
      "}";
  compiler.registerExternalValue((SkSL::ExternalValue*)compiler.takeOwnership(
      std::unique_ptr<SkSL::Symbol>(new FunctionExternalValue(
...
class VectorFunctionExternalValue : public SkSL::ExternalValue {
 public:
  VectorFunctionExternalValue(
      const char* name, void (*function)(float[4], float[4]), SkSL::Compiler& compiler)
...
DEF_TEST(SkSLInterpreterExternalValuesVectorCall, r) {
  ...
  const char* src =
      ...
      "}";
  compiler.registerExternalValue((SkSL::ExternalValue*)compiler.takeOwnership(
      std::unique_ptr<SkSL::Symbol>(new VectorFunctionExternalValue(
          "external",
