...
DEF_TEST(SkPath_RangeIter, r) {
  ...
  Verb verbs[] = {Verb::kImplicitMove, Verb::kLine,  Verb::kConic, Verb::kClose,
                  Verb::kImplicitMove, Verb::kCubic, Verb::kMove,  Verb::kConic,
                  Verb::kLine,         Verb::kClose, Verb::kMove,  Verb::kMove};
  ...
  for (Verb verb : verbs) {
    switch (verb) {
      case Verb::kImplicitMove: break;
      case Verb::kMove: path.moveTo(genData.p()); break;
      case Verb::kLine: path.lineTo(genData.p()); break;
      case Verb::kQuad: {
        auto a = genData.p();
        auto b = genData.p();
        path.quadTo(a, b);
      ...
      case Verb::kClose: path.close(); break;
    }
  }
  ...
  for (Verb verb : verbs) {
    ...
    switch (verb) {
      ...
      case Verb::kConic:
        ...
        lastPt = pathPts[2];
        break;
      case Verb::kClose: REPORTER_ASSERT(r, pathPts[0] == lastPt); break;
    }
  }
