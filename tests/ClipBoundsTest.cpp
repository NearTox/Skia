...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(GrClipBounds, reporter, ctxInfo) {
  ...
  stack.getConservativeBounds(0, 0, kXSize, kYSize, &devStackBounds, &isIntersectionOfRects);
  ...
  clipData.getConservativeBounds(kXSize, kYSize, &devGrClipBound, &isIntersectionOfRects);
