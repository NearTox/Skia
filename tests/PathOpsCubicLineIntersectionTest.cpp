...
static lineCubic lineCubicTests[] = {
    ...
    {{{{0.468027353, 4}, {1.06734705, 1.33333337}, {1.36700678, 0}, {3, 0}}}, {{{2, 1}, {0, 1}}}},
...
static void testOne(skiatest::Reporter* reporter, int iIndex) {
  ...
  if (order1 == 4 && order2 == 2) {
    ...
    SkDebugf(
        "prevD=%1.9g dist=%1.9g nextD=%1.9g\n", prev.distance(nextL), sect.distance(i.pt(0)),
        cubic[3].distance(prevL));
#endif
  }
}
