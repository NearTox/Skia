...
class PathOpsAngleTester {
 public:
  ...
  static int AllOnOneSide(SkOpAngle& lh, SkOpAngle& rh) { return lh.lineOnOneSide(&rh, false); }

  static int ConvexHullOverlaps(SkOpAngle& lh, SkOpAngle& rh) { return lh.convexHullOverlaps(&rh); }

  static int Orderable(SkOpAngle& lh, SkOpAngle& rh) { return lh.orderable(&rh); }

  static int EndsIntersect(SkOpAngle& lh, SkOpAngle& rh) { return lh.endsIntersect(&rh); }

  static void SetNext(SkOpAngle& lh, SkOpAngle& rh) { lh.fNext = &rh; }
};

class PathOpsSegmentTester {
 public:
  static void DebugReset(SkOpSegment* segment) { segment->debugReset(); }
};
...
static CircleData circleDataSet[] = {
    ...
    {{{{313.0155029296875, 207.90290832519531},
...
DEF_TEST(PathOpsAngleCircle, reporter) {
  ...
  for (int index = 0; index < circleDataSetSize; ++index) {
    ...
    switch (data.fPtCount) {
      case 2: contour.addLine(data.fShortPts); break;
      case 3: contour.addQuad(data.fShortPts); break;
      case 4: contour.addCubic(data.fShortPts); break;
    }
  }
...
static IntersectData intersectDataSet1[] = {
    {{{{322.935669, 231.030273}, {312.832214, 220.393295}, {312.832214, 203.454178}}},
     ...
     0.154740299,
     {}},
    {{{{322.12738, 233.397751}, {295.718353, 159.505829}}}, 2, 0.345028807, 0.0786326511, {}},
    {{{{322.935669, 231.030273}, {312.832214, 220.393295}, {312.832214, 203.454178}}},
     3,
     0.865309956,
     1,
     {}},
    {{{{322.12738, 233.397751}, {295.718353, 159.505829}}}, 2, 0.345028807, 1, {}},
};

static IntersectData intersectDataSet2[] = {
    {{{{364.390686, 157.898193}, {375.281769, 136.674606}, {396.039917, 136.674606}}},
     3,
     0.578520747,
     1,
     {}},
    {{{{364.390686, 157.898193}, {375.281769, 136.674606}, {396.039917, 136.674606}}},
     ...
     0.536512973,
     {}},
    {{{{366.608826, 151.196014}, {378.803101, 136.674606}, {398.164948, 136.674606}}},
     3,
     0.490456543,
     1,
     {}},
...
static IntersectData intersectDataSet6[] = {
    ...
    {{{{0.000, 1.000}, {3.000, 4.000}, {1.000, 0.000}, {3.000, 0.000}}},
     4,
     0.0925339054,
     0,
     {}},  // pathops_visualizer.htm:3616
    {{{{0.000, 1.000}, {0.000, 3.000}, {1.000, 0.000}, {4.000, 3.000}}},
     4,
     0.453872386,
     0,
     {}},  // pathops_visualizer.htm:3616
...
static IntersectData intersectDataSet7[] = {
    ...
    {{{{0.000, 1.000}, {0.000, 2.000}, {2.000, 0.000}, {2.000, 1.000}}},
     4,
     0.5,
     1,
...
static IntersectData intersectDataSet8[] = {
    ...
    {{{{0.000, 1.000}, {2.000, 3.000}, {5.000, 1.000}, {4.000, 3.000}}},
     4,
     0.311007457,
     0.285714286,
     {}},  // pathops_visualizer.htm:4152
    {{{{1.000, 5.000}, {3.000, 4.000}, {1.000, 0.000}, {3.000, 2.000}}},
     4,
     0.589885081,
     0.999982974,
     {}},  // pathops_visualizer.htm:4152
...
static IntersectData intersectDataSet10[] = {
    ...
    {{{{0.000, 1.000}, {1.000, 6.000}, {1.000, 0.000}, {1.000, 0.000}}},
     4,
     0.788195121,
     0.726275769,
     {}},  // pathops_visualizer.htm:4144
    {{{{0.000, 1.000}, {0.000, 1.000}, {1.000, 0.000}, {6.000, 1.000}}},
     4,
     0.473378977,
     1,
     {}},  // pathops_visualizer.htm:4144
...
static IntersectData intersectDataSet11[] = {
    ...
    {{{{979.305, 561.000}, {1036.695, 291.000}}},
     2,
     0.888888874,
     0.11111108,
     {}},  // pathops_visualizer.htm:4662
    {{{{1006.695, 291.000}, {1023.264, 291.000}, {1033.840, 304.431}, {1030.318, 321.000}}},
     4,
     1,
     0,
     {}},  // pathops_visualizer.htm:4662
...
static IntersectData intersectDataSet12[] = {
    ...
    {{{{67.000, 913.000}, {67.000, 917.389}, {67.224, 921.726}, {67.662, 926.000}}},
     4,
     0,
     1,
     {}},  // pathops_visualizer.htm:5439
    {{{{194.000, 1041.000}, {123.860, 1041.000}, {67.000, 983.692}, {67.000, 913.000}}},
     4,
     1,
     0,
     {}},  // pathops_visualizer.htm:5439
...
static IntersectData intersectDataSet13[] = {
    ...
    {{{{0.000, 1.000}, {0.000, 6.000}, {4.000, 0.000}, {6.000, 1.000}}},
     4,
     0.5,
     0.833333333,
     {}},  // pathops_visualizer.htm:5693
    {{{{0.000, 1.000}, {0.000, 6.000}, {4.000, 0.000}, {6.000, 1.000}}},
     4,
     0.5,
     0.379043969,
...
static IntersectData intersectDataSet14[] = {
    ...
    {{{{0.000, 1.000}, {4.000, 6.000}, {2.000, 1.000}, {2.000, 0.000}}},
     4,
     0.0756502183,
     0.0594570973,
     {}},  // pathops_visualizer.htm:5833
    {{{{1.000, 2.000}, {0.000, 2.000}, {1.000, 0.000}, {6.000, 4.000}}},
     4,
     0.0756502184,
     0,
     {}},  // pathops_visualizer.htm:5833
...
static IntersectData intersectDataSet15[] = {
    ...
    {{{{490.435, 879.407}, {405.593, 909.436}}},
     2,
     0.500554405,
     1,
     {}},  // pathops_visualizer.htm:6538
    {{{{447.967, 894.438}, {448.007, 894.424}, {448.014, 894.422}}},
     3,
     0,
     1,
     {}},  // pathops_visualizer.htm:6538
...
static IntersectData intersectDataSet16[] = {
    ...
    {{{{1.000, 4.000}, {4.000, 5.000}, {3.000, 2.000}, {6.000, 3.000}}},
     4,
     0.5,
     0,
     {}},  // pathops_visualizer.htm:7377
    {{{{2.000, 3.000}, {3.000, 6.000}, {4.000, 1.000}, {5.000, 4.000}}},
     4,
     0.5,
     0.112701665,
     {}},                                                 // pathops_visualizer.htm:7377
...
void SkOpSegment::debugAddAngle(double startT, double endT) {
  SkOpPtT* startPtT = startT == 0 ? fHead.ptT() : startT == 1 ? fTail.ptT() : this->addT(startT);
  SkOpPtT* endPtT = endT == 0 ? fHead.ptT() : endT == 1 ? fTail.ptT() : this->addT(endT);
