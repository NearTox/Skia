...
DEF_TEST(Codec_frames, r) {
  ...
  static const struct {
    ...
    {"images/alphabetAnim.gif",
     ...
     0,
     {kKeep, kRestorePrev, kRestorePrev, kRestorePrev, kRestorePrev, kRestoreBG, kKeep, kRestoreBG,
      kRestoreBG, kKeep, kKeep, kRestoreBG, kKeep}},
    ...
    {"images/colorTables.gif", 2, {0}, {kOpaque}, {1000, 1000}, 5, {kKeep, kKeep}},
