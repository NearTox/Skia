...
static inline bool SkShouldPostMessageToBus(const TestMessage&, uint32_t) { return true; }
...
static inline bool SkShouldPostMessageToBus(
    const AddressedMessage& msg, GrDirectContext::DirectContextID msgBusUniqueID) {
...
DEF_TEST(MessageBus_SkShouldPostMessageToBus, r) {
  ...
  ID idInvalid;
  ID id1 = ID::Next(), id2 = ID::Next(), id3 = ID::Next();
