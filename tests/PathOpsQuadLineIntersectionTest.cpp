...
static int doIntersect(
    SkIntersections& intersections, const SkDQuad& quad, const SkDLine& line, bool& flipped) {
  int result;
  flipped = false;
...
static struct oneLineQuad {
  ...
  SkDLine line;
    ...
    {{{{97.9337616, 100}, {88, 112.94265}, {88, 130}}}, {{{88.919838, 120}, {107.058823, 120}}}},
    {{{{447.96701049804687, 894.4381103515625},
       {448.007080078125, 894.4239501953125},
       {448.0140380859375, 894.4215087890625}}},
     {{{490.43548583984375, 879.40740966796875}, {405.59262084960937, 909.435546875}}}},
    {{{{142.589081, 102.283646}, {149.821579, 100}, {158, 100}}}, {{{90, 230}, {160, 60}}}},
...
DEF_TEST(PathOpsQuadLineIntersectionOneOff, reporter) { testOneOffs(reporter); }
