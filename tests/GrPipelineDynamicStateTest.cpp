...
class GrPipelineDynamicStateTestProcessor : public GrGeometryProcessor {
 public:
  static GrGeometryProcessor* Make(SkArenaAlloc* arena) {
    return arena->make([&](void* ptr) { return new (ptr) GrPipelineDynamicStateTestProcessor(); });
  }
...
GrGLSLPrimitiveProcessor* GrPipelineDynamicStateTestProcessor::createGLSLInstance(
 ...
 private:
  ...
  void onExecute(GrOpFlushState* flushState, const SkRect& chainBounds) override {
    ...
    GrProgramInfo programInfo(
        flushState->writeView(), &pipeline, &GrUserStencilSettings::kUnused, geomProc,
