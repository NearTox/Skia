...
static void test_crbug131181() {
  /*
   ...
   fY = 129.13121
   */
  uint32_t data[] = {0x419727af, 0x43011f0c, 0x41972663, 0x43011f27,
...
static void test_crbug_1239558(skiatest::Reporter* reporter) {
  ...
  path.moveTo(7.34684e-40f, 194.25f);
  path.cubicTo(5.07266e-39f, 56.0488f, 0.0119172f, 0.f, 7.34684e-40f, 194.25f);
...
static void test_crbug_472147_simple(skiatest::Reporter* reporter) {
  ...
  SkVector radii[4] = {{13.0f, 8.0f}, {170.0f, 2.0}, {256.0f, 33554430.0f}, {120.0f, 5.0f}};
  SkRRect rr;
