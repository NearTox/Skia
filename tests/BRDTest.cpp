...
DEF_TEST(BRD_types, r) {
  static const struct {
    ...
    bool supported;
      ...
      {"images/arrow.png", true},        {"images/box.gif", false},
      {"images/baby_tux.webp", true},    {"images/brickwork-texture.jpg", true},
      {"images/color_wheel.ico", false},
#  ifdef SK_CODEC_DECODES_RAW
      {"images/sample_1mp.dng", false},
#  endif
      {"images/mandrill.wbmp", false},   {"images/randPixels.bmp", false},
  };
