...
static void test_tables(skiatest::Reporter* reporter) {
  static const char* const gNames[] = {
      ...
      "Courier New", "Terminal", "MS Sans Serif", "Hiragino Mincho ProN", "MS PGothic",
  };
...
static void test_advances(skiatest::Reporter* reporter) {
  static const char* const faces[] = {
      nullptr,  // default font
      "Arial",   "Times",       "Times New Roman", "Helvetica",
      "Courier", "Courier New", "Verdana",         "monospace",
  };
  ...
  static const struct {
    ...
    bool subpixel;
      ...
      {SkFontHinting::kNone, false, false},   {SkFontHinting::kNone, true, false},
      {SkFontHinting::kNone, false, true},    {SkFontHinting::kSlight, false, false},
      {SkFontHinting::kSlight, true, false},  {SkFontHinting::kSlight, false, true},
      {SkFontHinting::kNormal, false, false}, {SkFontHinting::kNormal, true, false},
