  ...
  void drawTest(SkCanvas* canvas, SkScalar w, SkScalar h, SkColor fg, SkColor bg) {
    ...
    for (auto i = 1; i < 5; ++i) {
      ...
      for (auto para : gParagraph) {
        ...
        std::string name =
            " " + std::get<0>(para) + " " + (std::get<1>(para) ? ", bold" : "") +
...
class ParagraphView2 : public ParagraphView_Base {
 protected:
  ...
  void drawText(
      SkCanvas* canvas, SkScalar w, SkScalar h, std::vector<const char*>& text,
      SkColor fg = SK_ColorDKGRAY, SkColor bg = SK_ColorWHITE, const char* ff = "sans-serif",
      SkScalar fs = 24, size_t lineLimit = 30, const std::u16string& ellipsis = u"\u2026") {
    SkAutoCanvasRestore acr(canvas, true);
  ...
  void drawLine(
      SkCanvas* canvas, SkScalar w, SkScalar h, const std::string& text, TextAlign align) {
    SkAutoCanvasRestore acr(canvas, true);
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    canvas->translate(width, 0);
    drawText(
        canvas, width, height / 2, text, SK_ColorBLACK, SK_ColorWHITE, "Roboto", 20, 100,
        u"\u2026");
...
class ParagraphView3 : public ParagraphView_Base {
 protected:
  ...
  void drawLine(
      SkCanvas* canvas, SkScalar w, SkScalar h, const std::string& text, TextAlign align,
      size_t lineLimit = std::numeric_limits<size_t>::max(), bool RTL = false,
      SkColor background = SK_ColorGRAY, const std::u16string& ellipsis = u"\u2026") {
    SkAutoCanvasRestore acr(canvas, true);
...
class ParagraphView4 : public ParagraphView_Base {
 protected:
  ...
  void drawFlutter(
      SkCanvas* canvas, SkScalar w, SkScalar h, const char* ff = "Google Sans", SkScalar fs = 30,
...
class ParagraphView5 : public ParagraphView_Base {
 protected:
  ...
  void bidi(
      SkCanvas* canvas, SkScalar w, SkScalar h, const std::u16string& text,
      const std::u16string& expected, size_t lineLimit = std::numeric_limits<size_t>::max(),
      const char* ff = "Roboto", SkScalar fs = 30, const std::u16string& ellipsis = u"\u2026") {
    SkAutoCanvasRestore acr(canvas, true);
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    bidi(
        canvas, width, height, u"123 456 7890 \u202EZYXWV UTS RQP ONM LKJ IHG FED CBA\u202C.", u"",
        2);
    canvas->translate(0, height);
...
class ParagraphView6 : public ParagraphView_Base {
 protected:
  ...
  void hangingS(SkCanvas* canvas, SkScalar w, SkScalar h, SkScalar fs = 60.0) {
    ...
    SkFontStyle fontStyle(
        SkFontStyle::kBold_Weight, SkFontStyle::kNormal_Width, SkFontStyle::kItalic_Slant);
...
class ParagraphView7 : public ParagraphView_Base {
 protected:
  ...
  void drawText(
      SkCanvas* canvas, SkColor background, SkScalar letterSpace, SkScalar w, SkScalar h) {
    SkAutoCanvasRestore acr(canvas, true);
    canvas->clipRect(SkRect::MakeWH(w, h));
 ...
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    text_style.setFontFamilies(
        {SkString("Roboto"), SkString("Noto Color Emoji"), SkString("Noto Serif CJK JP")});
...
class ParagraphView11 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    auto text =
        "\U0001f469\U0000200D\U0001f469\U0000200D\U0001f466\U0001f469\U0000200D\U0001f469\U0000200D"
        "\U0001f467\U0000200D\U0001f467\U0001f1fa\U0001f1f8";
    ...
    auto fontCollection =
        sk_make_sp<TestFontCollection>(GetResourcePath("fonts").c_str(), true, true);
    ParagraphBuilderImpl builder(paragraph_style, fontCollection);
    builder.addText(text, strlen(text));
    auto paragraph = builder.Build();
    ...
    pair hit1[] = {
        {0, 8},   {1, 33},  {2, 34},  {3, 19},  {4, 20},  {5, 21},  {6, 22},  {7, 23},
        {8, 24},  {9, 25},  {10, 26}, {11, 27}, {12, 28}, {13, 21}, {14, 22}, {15, 23},
        {16, 24}, {17, 21}, {18, 22}, {19, 21}, {20, 24}, {21, 23},
    };

    pair miss[] = {
        {0, 4},   {1, 17},  {2, 18},  {3, 11},  {4, 12},  {5, 13},  {6, 14},
        {7, 15},  {8, 16},  {9, 17},  {10, 18}, {11, 19}, {12, 20}, {13, 17},
        {14, 18}, {15, 19}, {16, 20}, {17, 19}, {18, 20}, {20, 22},
    };
    ...
    for (auto& query : miss) {
      auto miss = paragraph->getRectsForRange(
          query.fX, query.fY, RectHeightStyle::kTight, RectWidthStyle::kTight);
      if (miss.empty()) {
      } else {
        SkDebugf("-[%d:%d): Bad\n", query.fX, query.fY);
...
class ParagraphView12 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    auto result =
        paragraph->getRectsForRange(65, 66, RectHeightStyle::kTight, RectWidthStyle::kTight);
    paragraph->paint(canvas, 0, 0);
...
class ParagraphView17 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    const char* text =
        ">Sͬ͑̀͐̈͒̈́̋̎ͮͩ̽̓ͬ̂̆̔͗́̓ͣͧ͊ͫ͛̉͌̐̑ͪ͗̚͝҉̴͉͢k̡̊̓ͫͭͩ͂͊ͨͪͬ̑ͫ̍̌̄͛̌̂̑̂̋̊̔ͫ͛̽̑ͨ̍ͭ̓̀ͪͪ̉͐͗̌̓̃̚͟͝҉̢͏̫̞̙͇͖̮͕̗̟͕͇͚̻͈̣̻̪͉̰̲̣̫ͅͅP̴̅̍͒̿͗͗̇ͩ̃͆͌̀̽͏̧̡͕͖̝̖̼̺̰̣̬͔͖͔̼͙̞̦̫͓̘͜a̸̴̸̴̢̢̨̨̫͍͓̥̼̭̼̻̤̯̙̤̻̠͚̍̌͋̂ͦͨ̽̇͌͌͆̀̽̎͒̄ͪ̐ͦ̈ͫ͐͗̓̚̚͜ͅr͐͐ͤͫ̐ͥ͂̈́̿́ͮ̃͗̓̏ͫ̀̿͏̸̵̧́͘̕͟͝͠͞͠҉̷̧͚͢͟a̓̽̎̄͗̔͛̄̐͊͛ͫ͂͌̂̂̈̈̓̔̅̅̄͊̉́ͪ̑̄͆ͬ̍͆ͭ͋̐ͬ͏̷̵̨̢̩̹̖͓̥̳̰͔̱̬͖̙͓̙͇̀̀̕͜͟͟͢͟͜͠͡g̨̅̇ͦ͋̂ͦͨͭ̓͐͆̏̂͛̉ͧ̑ͫ̐̒͛ͫ̍̒͛́̚҉̷̨̛̛̀͜͢͞҉̩̘̲͍͎̯̹̝̭̗̱͇͉̲̱͔̯̠̹̥̻͉̲̜̤̰̪̗̺̖̺r̷͌̓̇̅ͭ̀̐̃̃ͭ͑͗̉̈̇̈́ͥ̓ͣ́ͤ͂ͤ͂̏͌̆̚҉̴̸̧̢̢̛̫͉̦̥̤̙͈͉͈͉͓̙̗̟̳̜͈̗̺̟̠̠͖͓̖̪͕̠̕̕͝ͅả̸̴̡̡̧͠͞͡͞҉̛̕͟͏̷̘̪̱͈̲͉̞̠̞̪̫͎̲̬̖̀̀͟͝͞͞͠p̛͂̈͐̚͠҉̵̸̡̢̢̩̹͙̯͖̙̙̮̥̙͚̠͔̥̭̮̞̣̪̬̥̠̖̝̥̪͎́̀̕͜͡͡ͅͅh̵̷̵̡̛ͤ̂͌̐̓̐̋̋͊̒̆̽́̀̀̀͢͠͞͞҉̷̸̢̕҉͚̯͖̫̜̞̟̠̱͉̝̲̹̼͉̟͉̩̮͔̤͖̞̭̙̹ͅ"
        "̬"
        "<";
...
class Zalgo {
 private:
  std::u16string COMBINING_DOWN =
      u"\u0316\u0317\u0318\u0319\u031c\u031d\u031e\u031f\u0320\u0324\u0325\u0326\u0329\u032a\u032b"
      u"\u032c\u032d\u032e\u032f\u0330\u0331\u0332\u0333\u0339\u033a\u033b\u033c\u0345\u0347\u0348"
      u"\u0349\u034d\u034e\u0353\u0354\u0355\u0356\u0359\u035a\u0323";
  std::u16string COMBINING_UP =
      u"\u030d\u030e\u0304\u0305\u033f\u0311\u0306\u0310\u0352\u0357\u0351\u0307\u0308\u030a\u0342"
      u"\u0343\u0344\u034a\u034b\u034c\u0303\u0302\u030c\u0350\u0300\u0301\u030b\u030f\u0312\u0313"
      u"\u0314\u033d\u0309\u0363\u0364\u0365\u0366\u0367\u0368\u0369\u036a\u036b\u036c\u036d\u036e"
      u"\u035b\u0346\u031a";
  std::u16string COMBINING_MIDDLE =
      u"\u0315\u031b\u0340\u0341\u0358\u0321\u0322\u0327\u0328\u0334\u0335\u0336\u034f\u035c\u035d"
      u"\u035e\u035f\u0360\u0362\u0338\u0337\u0361\u0489";
...
class ParagraphView18 : public ParagraphView_Base {
 protected:
  ...
  bool onChar(SkUnichar uni) override {
    switch (uni) {
      case ' ': fLimit = 400; return true;
      case 's': fLimit += 10; return true;
      case 'f':
        if (fLimit > 10) {
          fLimit -= 10;
        }
...
class ParagraphView22 : public ParagraphView_Base {
 protected:
  ...
  bool onChar(SkUnichar uni) override {
    switch (uni) {
      case 'l': direction = true; return true;
      case 'r': direction = false; return true;
      default: break;
    }
    return false;
  }
...
class ParagraphView25 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    Shell: layout('Go to device settings ￼ and set up a passcode. ￼', 280.000000): 280.000000
    * 38.000000
     */
...
class ParagraphView26 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    ParagraphBuilderImpl builder(paragraphStyle, fontCollection);
    builder.addText(
        u"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut dolor ornare, "
        u"fermentum nibh in, consectetur libero. Ut id semper est. Sed malesuada, est id bibendum "
        u"egestas, urna risus tristique nibh, euismod interdum risus turpis nec purus. Maecenas "
        u"dolor nisl, consectetur in vestibulum et, tincidunt id leo. Duis maximus, odio eget "
        u"tristique commodo, lacus tellus dapibus leo, consequat pellentesque arcu nisi sit amet "
        u"diam. Quisque euismod venenatis egestas. Mauris posuere volutpat iaculis. Suspendisse "
        u"finibus tempor urna, dignissim venenatis sapien finibus eget. Donec interdum lacus ac "
        u"venenatis fringilla. Curabitur eget lacinia augue. Vestibulum eu vulputate odio. Quisque "
        u"nec imperdiet");
...
class ParagraphView27 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    auto draw = [&](SkScalar width, SkScalar height, TextDirection td, TextAlign ta,
                    const char* t) {
      SkDebugf(
          "draw '%s' dir:%s align:%s\n", t, td == TextDirection::kLtr ? "left" : "right",
      ...
      for (auto& line : impl->lines()) {
        ...
        line.iterateThroughVisualRuns(
            true, [&](const Run* run, SkScalar runOffset, TextRange textRange, SkScalar* width) {
              *width = line.measureTextInsideOneRun(textRange, run, runOffset, 0, true, false)
                           .clip.width();
              SkDebugf(
                  "%d[%d: %d) @%f + %f %s\n", run->index(), textRange.start, textRange.end,
                  runOffset, *width, run->leftToRight() ? "left" : "right");
              return true;
            });
      }
      auto boxes =
          paragraph->getRectsForRange(0, 100, RectHeightStyle::kTight, RectWidthStyle::kTight);
      bool even = true;
      for (auto& box : boxes) {
        SkDebugf(
 ...
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    SkDebugf(
        ...
        f2.position, f2.affinity == Affinity::kUpstream ? "up" : "down", i.position,
        i.affinity == Affinity::kUpstream ? "up" : "down");

    auto rf1 =
        paragraph->getRectsForRange(0, 1, RectHeightStyle::kTight, RectWidthStyle::kTight)[0];
    auto rf2 =
        paragraph->getRectsForRange(1, 2, RectHeightStyle::kTight, RectWidthStyle::kTight)[0];
    auto rfi =
        paragraph->getRectsForRange(2, 3, RectHeightStyle::kTight, RectWidthStyle::kTight)[0];
 ...
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    const std::u16string text =
        u"\U0001f600\U0001f1e6\U0001f1f9\U0001f601\U0001f9f1\U0001f61a\U0001f431\U0001f642"
        u"\U0001f38e\U0001f60d\U0001f3b9\U0001f917\U0001f6bb\U0001f609\U0001f353\U0001f618"
        u"\U0001f1eb\U0001f1f0\U0001f468\u200D\U0001f469\u200D\U0001f466\u200D\U0001f466\U0001f468"
        u"\u200D\U0001f469\u200D\U0001f467\u200D\U0001f466\U0001f468\u200D\U0001f469\u200D"
        u"\U0001f467\U0001f46a";
    canvas->drawColor(SK_ColorWHITE);
    ...
    SkColor colors[] = {SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorMAGENTA, SK_ColorYELLOW};
    SkPaint paint;
    size_t color = 0;
 ...
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    auto text =
        ...
        "ن";
    // auto text = "ى،😗😃😄😍بب";
    // auto text1 = "World domination is such an ugly phrase - I prefer to call it world
    // optimisation";
    auto fontCollection = sk_make_sp<FontCollection>();
    fontCollection->setDefaultFontManager(SkFontMgr::RefDefault());
    fontCollection->enableFontFallback();
...
class ParagraphView35 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    auto text =
        u"hzbzzj sjsjjs sjkkahgafa\u09A4\u09A1\u09A4\u09A0\u09A4\u09A0 jsjzjgvsh sjsjsksbsbsjs "
        u"sjjajajahhav jssjbxx jsisudg \u09AF\u09A0\u09AF\u09A0\u09A4\u09A0\u09A4\u09A0\u09A5 "
        u"\u062A\u0624\u062A\u064A\u0646\u0646\u064A\u0621\u0646\u0627\u0644\u0631\u0631\u064A"
        u"\u0644\u0627 \u062A\u062A\u0644\u0649 \u062A\u0627\u0631\u064A\u062E "
        u"\u062A\u0633\u0628\u0628 "
        u"\u0624\u062A\u064A\u062A\u0624\u062A\u0624\u062A\u0624\u062A\u0624 dhishsbs "
        u"\u7238\u7238\u4E0D\u5BF9\u52B2\u5927\u5BB6\u90FD\u597D\u8BB0\u5F97\u8BB0\u5F97hshs\u099B"
        u"\u09A1\u099B\u09A1\u099A jdjdj jdjdjd "
        u"dbbdbdbdbddbnd\u09A2\u099B\u09A1\u09A2\u09A3\u099B\u09B0\u099A\u0998\u09A0\u09A0\u09B8"
        u"\u09AB\u0997\u09A3\u09A4\u099C\u09B0\u09A5\u099B\u099B\u09A5\u09A6\u099D\u09A6\u09B2"
        u"\u09A5\u09A4\u09A3\u09A2\u0997\u0996\u09A0\u0998\u0999\u09A3\u099A\u09A5\u09A4\u09A3"
        u"\u062A\u0628\u0646\u064A\u0646 \u09A5\u09A3\u09A3 \u09A4\u0998\u0998\u0998\u099B\u09A4 "
        u"\u09A4\u09A3 "
        ...
        u"\u09C7\u09C2\u09C0\u09C2\u099A\u09A3\u09A2\u09A4\u09A5\u09A5\u0632\u064A\u09C7\u09C2"
        u"\u09C0\u09C2\u099A\u09A3\u09A2\u09AE\u09A4\u09A5\u09A5 "
        u"\U0001f34d\U0001f955\U0001f4a7\U0001f4a7\U0001f4a6\U0001f32a";
    auto fontCollection = sk_make_sp<FontCollection>();
    fontCollection->setDefaultFontManager(SkFontMgr::RefDefault());
    fontCollection->enableFontFallback();
    ...
    // auto res1 = paragraph->getGlyphPositionAtCoordinate(line.width() + line.spacesWidth() / 2,
    // line.offset().fY + 10); auto res2 = paragraph->getWordBoundary(res1.position);
    auto res1 =
        paragraph->getRectsForRange(360, 361, RectHeightStyle::kTight, RectWidthStyle::kTight);
    auto res2 =
        paragraph->getRectsForRange(359, 360, RectHeightStyle::kTight, RectWidthStyle::kTight);
    auto res3 =
        paragraph->getRectsForRange(358, 359, RectHeightStyle::kTight, RectWidthStyle::kTight);
...
class ParagraphView36 : public ParagraphView_Base {
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    auto text =
        "其实就是要 English 却又无法预览 English 功能强大起来 English 了我觉得自己也 English "
        "可以的时候我们";
    auto fontCollection = sk_make_sp<FontCollection>();
    fontCollection->setDefaultFontManager(SkFontMgr::RefDefault());
    fontCollection->enableFontFallback();
    ...
    auto res1 =
        paragraph->getRectsForRange(63, 64, RectHeightStyle::kTight, RectWidthStyle::kTight);
    auto rect = res1[0].rect;
    auto res2 =
        paragraph->getGlyphPositionAtCoordinate(rect.fLeft + rect.width() / 2, rect.height());
