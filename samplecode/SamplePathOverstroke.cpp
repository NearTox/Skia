...
class OverstrokeView : public Sample {
 ...
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    SkPath path;
    switch (fPathType) {
      case 0: path = quadPath(p1, p2); break;
      case 1: path = cubicPath(p1, p2); break;
      case 2: path = rectPath(p1); break;
      case 3: path = linSemicirclePath(p1, p2); break;
      default: path = quadPath(p1, p2); break;
    }
