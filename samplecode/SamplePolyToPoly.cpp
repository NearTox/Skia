...
public:
    PolyToPolyView() {
        // tests
        {
            ...
            const SkScalar src1[] = {0, 0, 0, 427, 316, 427, 316, 0};
            const SkScalar dst1[] = {158, 177.5f, 158, 249.5f, 158, 604.5f, 158, -177.5f};
...
protected:
    ...
    static void doDraw(SkCanvas* canvas, SkPaint* paint, const SkFont& font, const int isrc[],
        ...
        SkString str;
        str.appendS32(count);
        SkTextUtils::DrawString(canvas, str.c_str(), x, y, font, *paint,
