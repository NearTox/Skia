...
struct data {
  SkIPoint pt[4];
    ...
    // Enable the 2nd #if and replace the second 'i = ##' with the value of datCount that shows the
    // bug.
    {{
 ...
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    canvas->drawSimpleText(
        timeStr.c_str(), timeStr.size(), SkTextEncoding::kUTF8, 20, 20, SkFont(), SkPaint());
    SkDebugf("");
  }
