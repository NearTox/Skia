...
static void draw_normal_geom(SkCanvas* canvas, const SkPoint& offset, int geom, bool useAA) {
  ...
  switch (geom) {
    ...
    case kRectAndRect_Geometry: canvas->drawRect(create_rect(offset), p); break;
    case kRRect_Geometry:  // fall thru
    case kRectAndRRect_Geometry: canvas->drawRRect(create_rrect(offset), p); break;
    case kCircle_Geometry: canvas->drawRRect(create_circle(offset), p); break;
    case kConvexPath_Geometry:  // fall thru
    case kRectAndConvex_Geometry: canvas->drawPath(create_convex_path(offset), p); break;
    case kConcavePath_Geometry:  // fall thru
    case kRectAndConcave_Geometry: canvas->drawPath(create_concave_path(offset), p); break;
  }
}
...
class ClipDrawMatchView : public Sample {
 ...
 protected:
  ...
  void drawClippedGeom(SkCanvas* canvas, const SkPoint& offset, bool useAA) {
    ...
    switch (fGeom) {
      case kRect_Geometry: canvas->clipRect(create_rect(offset), useAA); break;
      case kRRect_Geometry: canvas->clipRRect(create_rrect(offset), useAA); break;
      case kCircle_Geometry: canvas->clipRRect(create_circle(offset), useAA); break;
      case kConvexPath_Geometry: canvas->clipPath(create_convex_path(offset), useAA); break;
      case kConcavePath_Geometry: canvas->clipPath(create_concave_path(offset), useAA); break;
