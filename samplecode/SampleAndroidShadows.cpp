...
protected:
    void onOnceBeforeDraw() override {
        ...
        fCubicPath.cubicTo(100 * SK_Scalar1, 50 * SK_Scalar1, 20 * SK_Scalar1, 100 * SK_Scalar1,
        ...
        fStarPath.lineTo(-43.30f, -25.0f);
        fStarPath.lineTo(-14.43f, -25.0f);
        fSquareRRectPath.addRRect(
                SkRRect::MakeRectXY(SkRect::MakeXYWH(-50, -50, 100, 100), 10, 10));
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        canvas->translate(-250, 110);
        zPlaneParams.fZ = SkTMax(1.0f, 8 + fZDelta);
        this->drawShadowedPath(canvas, fFunkyRRPath, zPlaneParams, paint,
                               fAnimAlpha * kAmbientAlpha, lightPos, kLightWidth,
        ...
        zPlaneParams.fZ = SkTMax(1.0f, 8 + fZDelta);
        this->drawShadowedPath(canvas, fStarPath, zPlaneParams, paint, kAmbientAlpha, lightPos,
                               kLightWidth, kSpotAlpha);

        paint.setColor(SK_ColorWHITE);
        canvas->translate(150, 0);
        zPlaneParams.fZ = SkTMax(1.0f, 2 + fZDelta);
        this->drawShadowedPath(canvas, fNotchPath, zPlaneParams, paint, kAmbientAlpha, lightPos,
                               kLightWidth, kSpotAlpha);

        paint.setColor(SK_ColorWHITE);
        canvas->translate(200, 0);
        zPlaneParams.fZ = SkTMax(1.0f, 16 + fZDelta);
        this->drawShadowedPath(canvas, fTabPath, zPlaneParams, paint, kAmbientAlpha, lightPos,
                               kLightWidth, kSpotAlpha);
        ...
        this->drawShadowedPath(canvas, tmpPath, zPlaneParams, paint, .1f, lightPos, kLightWidth,
                               .5f);
        ...
        this->drawShadowedPath(canvas, fWideRectPath, zPlaneParams, paint, .1f, lightPos,
                               kLightWidth, .5f);
        ...
        this->drawShadowedPath(canvas, fWideOvalPath, zPlaneParams, paint, .1f, lightPos,
                               kLightWidth, .5f);
        ...
        this->drawShadowedPath(canvas, fStarPath, zPlaneParams, paint, .1f, lightPos, kLightWidth,
                               .5f);
    }
