...
static void testop(
    const SkIRect& r0, const SkIRect& r1, SkRegion::Op op, const SkIRect& expectedR) {
  SkAAClip c0, c1, c2;
  c0.setRect(r0);
  c1.setRect(r1);
  c2.op(c0, c1, op);
...
static void drawClip(SkCanvas* canvas, const SkAAClip& clip) {
  ...
  SkPaint paint;
  canvas->drawBitmap(bm, SK_Scalar1 * mask.fBounds.fLeft, SK_Scalar1 * mask.fBounds.fTop, &paint);
}
