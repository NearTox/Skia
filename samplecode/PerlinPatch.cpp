...
class PerlinPatchView : public Sample {
 ...
 public:
  PerlinPatchView()
      : fXFreq(0.025f), fYFreq(0.025f), fSeed(0.0f), fTexX(100.0), fTexY(50.0), fTexScale(1.0f) {
    const SkScalar s = 2;
    ...
    fShader0 =
        SkGradientShader::MakeLinear(points, colors, nullptr, 3, SkTileMode::kMirror, 0, nullptr);
  }
 ...
 protected:
  ...
  void onDrawContent(SkCanvas* canvas) override {
    ...
    fShader1 =
        SkPerlinNoiseShader::MakeImprovedNoise(fXFreq / scaleFreq, fYFreq / scaleFreq, 4, fSeed);
