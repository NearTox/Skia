...
enum class VerbType { kTriangles, kQuadratics, kCubics, kConics };
...
void StrokeVerbView::updatePath() {
  ...
  switch (fVerbType) {
    case VerbType::kCubics: fPath.cubicTo(fPoints[1], fPoints[2], fPoints[3]); break;
    case VerbType::kQuadratics: fPath.quadTo(fPoints[1], fPoints[3]); break;
    case VerbType::kConics: fPath.conicTo(fPoints[1], fPoints[3], fConicWeight); break;
