    ...
    void drawShadowedPath(SkCanvas* canvas, const SkPath& path, const SkPoint3& zPlaneParams,
        ...
        if (fTwoPassColor) {
            ...
            if (paint.getColor() != SK_ColorBLACK) {
                ...
                uint8_t max =
                        SkTMax(SkTMax(SkColorGetR(color), SkColorGetG(color)), SkColorGetB(color));
                uint8_t min =
                        SkTMin(SkTMin(SkColorGetR(color), SkColorGetG(color)), SkColorGetB(color));
            ...
            SkColor color = paint.getColor();
            SkColor baseAmbient =
                    SkColorSetARGB(ambientAlpha * SkColorGetA(color), SkColorGetR(color),
                                   SkColorGetG(color), SkColorGetB(color));
            SkColor baseSpot = SkColorSetARGB(spotAlpha * SkColorGetA(color), SkColorGetR(color),
                                              SkColorGetG(color), SkColorGetB(color));
