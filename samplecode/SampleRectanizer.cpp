...
public:
    RectanizerView()
        ...
        fRectanizers.push_back(std::unique_ptr<Rectanizer>(new RectanizerPow2(kWidth, kHeight)));
        fRectanizers.push_back(std::unique_ptr<Rectanizer>(new RectanizerSkyline(kWidth, kHeight)));
    }
